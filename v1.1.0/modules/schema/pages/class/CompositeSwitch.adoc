...
//| [[slots_table.compositeSwitchType]]<<compositeSwitchType,`compositeSwitchType`>>
| 0..1 +
...
[.text-left]
--
<<slots_table.compositeSwitchType,&#10548;>>
--
////
...
| xref::class/Switch.adoc[`Switch`] | xref::class/Switch.adoc#CompositeSwitch[`CompositeSwitch`]
