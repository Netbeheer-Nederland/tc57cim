...
| xref::class/Design.adoc[`Design`] | xref::class/Design.adoc#ErpBOMs[`ErpBOMs`]



| xref::class/ErpBomItemData.adoc[`ErpBomItemData`] | xref::class/ErpBomItemData.adoc#ErpBOM[`ErpBOM`]
