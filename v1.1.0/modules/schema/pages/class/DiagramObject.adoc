...
| xref::class/Diagram.adoc[`Diagram`] | xref::class/Diagram.adoc#DiagramElements[`DiagramElements`]



| xref::class/DiagramObjectPoint.adoc[`DiagramObjectPoint`] | xref::class/DiagramObjectPoint.adoc#DiagramObject[`DiagramObject`]



| xref::class/DiagramObjectStyle.adoc[`DiagramObjectStyle`] | xref::class/DiagramObjectStyle.adoc#StyledObjects[`StyledObjects`]



| xref::class/IdentifiedObject.adoc[`IdentifiedObject`] | xref::class/IdentifiedObject.adoc#DiagramObjects[`DiagramObjects`]



| xref::class/VisibilityLayer.adoc[`VisibilityLayer`] | xref::class/VisibilityLayer.adoc#VisibleObjects[`VisibleObjects`]
