...
| +++The normal limit on voltage. High or low limit nature of the limit depends upon the properties of the operational limit...+++
| _n/a_
...
| 0..1 +
xref::class/Voltage.adoc[`Voltage`]
| +++Limit on voltage. High or low limit nature of the limit depends upon the properties of the operational limit type. The...+++
| _n/a_
