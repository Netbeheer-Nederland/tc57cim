...
//| [[slots_table.changeType]]<<changeType,`changeType`>>
| 0..1 +
...
//| [[slots_table.activePeriod]]<<activePeriod,`activePeriod`>>
| 0..1 +
...
//| [[slots_table.restrictedValue]]<<restrictedValue,`restrictedValue`>>
| 0..1 +
...
|===
| URI
| `cim:OperationalUpdatedRating.changeType`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
|===
| URI
| `cim:OperationalUpdatedRating.PlannedOutage`
| Cardinality
| 1
| Type
| xref::class/PlannedOutage.adoc[`PlannedOutage`]
...
| xref::class/PlannedOutage.adoc[`PlannedOutage`] | xref::class/PlannedOutage.adoc#UpdatedRatings[`UpdatedRatings`]
