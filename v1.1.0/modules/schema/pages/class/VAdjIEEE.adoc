...
| <<adjslew,`adjslew`>>
//| [[slots_table.adjslew]]<<adjslew,`adjslew`>>
| 0..1 +
...
| <<vadjmax,`vadjmax`>>
//| [[slots_table.vadjmax]]<<vadjmax,`vadjmax`>>
| 0..1 +
...
| <<vadjmin,`vadjmin`>>
//| [[slots_table.vadjmin]]<<vadjmin,`vadjmin`>>
| 0..1 +
xref::class/PU.adoc[`PU`]
