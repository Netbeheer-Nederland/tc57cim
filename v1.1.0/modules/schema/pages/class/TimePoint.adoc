...
| +++Absolute date and time for this time point. For calendar-based time point, it is typically manually entered, while for...+++
| _n/a_

| <<relativeTimeInterval,`relativeTimeInterval`>>
//| [[slots_table.relativeTimeInterval]]<<relativeTimeInterval,`relativeTimeInterval`>>
| 0..1 +
...
| <<window,`window`>>
//| [[slots_table.window]]<<window,`window`>>
| 0..1 +
...
[.text-left]
--
<<slots_table.relativeTimeInterval,&#10548;>>
--
////
...
| xref::class/TimeSchedule.adoc[`TimeSchedule`] | xref::class/TimeSchedule.adoc#TimePoints[`TimePoints`]
