...
| +++Asynchronous machine model with which this mechanical load model is associated. MechanicalLoadDynamics shall have either an...+++
| xref::class/MechanicalLoadDynamics.adoc[`MechanicalLoadDynamics`]
...
| +++Synchronous machine model with which this mechanical load model is associated. MechanicalLoadDynamics shall have either an...+++
| xref::class/MechanicalLoadDynamics.adoc[`MechanicalLoadDynamics`]
...
|===
| URI
| `cim:MechanicalLoadUserDefined.ProprietaryParameterDynamics`
| Cardinality
| 0..*
| Type
| xref::class/ProprietaryParameterDynamics.adoc[`ProprietaryParameterDynamics`]
...
| xref::class/ProprietaryParameterDynamics.adoc[`ProprietaryParameterDynamics`] | xref::class/ProprietaryParameterDynamics.adoc#MechanicalLoadUserDefined[`MechanicalLoadUserDefined`]
