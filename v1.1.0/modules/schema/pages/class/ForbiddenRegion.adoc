...
| <<crossTime,`crossTime`>>
//| [[slots_table.crossTime]]<<crossTime,`crossTime`>>
| 0..1 +
...
//| [[slots_table.crossingCost]]<<crossingCost,`crossingCost`>>
| 0..1 +
...
| <<highMW,`highMW`>>
//| [[slots_table.highMW]]<<highMW,`highMW`>>
| 0..1 +
https://w3id.org/linkml/Float[`float`]
...
|===
| URI
| `cim:ForbiddenRegion.crossingCost`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Float[`float`]
...
| xref::class/RegisteredResource.adoc[`RegisteredResource`] | xref::class/RegisteredResource.adoc#ForbiddenRegion[`ForbiddenRegion`]
