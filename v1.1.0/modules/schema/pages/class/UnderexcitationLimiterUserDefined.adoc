...
| xref::class/ProprietaryParameterDynamics.adoc[`ProprietaryParameterDynamics`] | xref::class/ProprietaryParameterDynamics.adoc#UnderexcitationLimiterUserDefined[`UnderexcitationLimiterUserDefined`]
