...
|===
| URI
| `cim:MarketStatement.referenceNumber`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
|===
| URI
| `cim:MarketStatement.transactionDate`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Date[`date`]
...
| xref::class/MarketStatementLineItem.adoc[`MarketStatementLineItem`] | xref::class/MarketStatementLineItem.adoc#MarketStatement[`MarketStatement`]
