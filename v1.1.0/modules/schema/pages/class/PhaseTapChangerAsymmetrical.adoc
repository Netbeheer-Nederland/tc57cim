...
| <<windingConnectionAngle,`windingConnectionAngle`>>
//| [[slots_table.windingConnectionAngle]]<<windingConnectionAngle,`windingConnectionAngle`>>
| 0..1 +
xref::class/AngleDegrees.adoc[`AngleDegrees`]
| +++The phase angle between the in-phase winding and the out-of -phase winding used for creating phase shift. The out-of-phase...+++
| _n/a_

| <<voltageStepIncrement,`voltageStepIncrement`>>
//| [[slots_table.voltageStepIncrement]]<<voltageStepIncrement,`voltageStepIncrement`>>
| 0..1 +
xref::class/PerCent.adoc[`PerCent`]
| +++The voltage step increment on the out of phase winding (the PowerTransformerEnd where the TapChanger is located) specified...+++
| xref::class/PhaseTapChangerNonLinear.adoc[`PhaseTapChangerNonLinear`]
...
| 0..1 +
xref::class/Reactance.adoc[`Reactance`]
| +++The reactance depend on the tap position according to a "u" shaped curve. The minimum reactance (xMin) appear at the mid tap...+++
| xref::class/PhaseTapChangerNonLinear.adoc[`PhaseTapChangerNonLinear`]
...
[.text-left]
--
<<slots_table.voltageStepIncrement,&#10548;>>
--
////
...
[.text-left]
--
<<slots_table.windingConnectionAngle,&#10548;>>
--
////
