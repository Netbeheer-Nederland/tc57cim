...
//| [[slots_table.AnalogValue]]<<AnalogValue,`AnalogValue`>>
| 1 +
...
| xref::class/ValueAliasSet.adoc[`ValueAliasSet`] | xref::class/ValueAliasSet.adoc#RaiseLowerCommands[`RaiseLowerCommands`]
