...
//| [[slots_table.ConformLoadGroup]]<<ConformLoadGroup,`ConformLoadGroup`>>
| 1 +
...
| xref::class/ConformLoadGroup.adoc[`ConformLoadGroup`] | xref::class/ConformLoadGroup.adoc#ConformLoadSchedules[`ConformLoadSchedules`]
