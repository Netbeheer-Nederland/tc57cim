...
//| [[slots_table.MerchantAccounts]]<<MerchantAccounts,`MerchantAccounts`>>
| 0..* +
...
|===
| URI
| `cim:MerchantAgreement.MerchantAccounts`
| Cardinality
| 0..*
| Type
| xref::class/MerchantAccount.adoc[`MerchantAccount`]
...
| xref::class/MerchantAccount.adoc[`MerchantAccount`] | xref::class/MerchantAccount.adoc#MerchantAgreement[`MerchantAgreement`]
