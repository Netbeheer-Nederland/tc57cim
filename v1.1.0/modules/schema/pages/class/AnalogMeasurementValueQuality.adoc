...
| <<scadaQualityCode,`scadaQualityCode`>>
//| [[slots_table.scadaQualityCode]]<<scadaQualityCode,`scadaQualityCode`>>
| 0..1 +
...
|===
| URI
| `cim:AnalogMeasurementValueQuality.scadaQualityCode`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
