...
| <<ifdlim,`ifdlim`>>
//| [[slots_table.ifdlim]]<<ifdlim,`ifdlim`>>
| 0..1 +
xref::class/PU.adoc[`PU`]
...
| <<ifdmax,`ifdmax`>>
//| [[slots_table.ifdmax]]<<ifdmax,`ifdmax`>>
| 0..1 +
xref::class/PU.adoc[`PU`]
