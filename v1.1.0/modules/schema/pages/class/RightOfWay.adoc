...
//| [[slots_table.propertyData]]<<propertyData,`propertyData`>>
| 0..1 +
https://w3id.org/linkml/String[`string`]
| +++Property related information that describes the ROW's land parcel. For example, it may be a deed book number, deed book page...+++
| _n/a_
...
| xref::class/LandProperty.adoc[`LandProperty`] | xref::class/LandProperty.adoc#RightOfWays[`RightOfWays`]
