...
|===
| URI
| `cim:StandardIndustryCode.CustomerAgreements`
| Cardinality
| 0..*
| Type
| xref::class/CustomerAgreement.adoc[`CustomerAgreement`]
...
| xref::class/CustomerAgreement.adoc[`CustomerAgreement`] | xref::class/CustomerAgreement.adoc#StandardIndustryCode[`StandardIndustryCode`]
