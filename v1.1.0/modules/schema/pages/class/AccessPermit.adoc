...
//| [[slots_table.applicationNumber]]<<applicationNumber,`applicationNumber`>>
| 0..1 +
...
//| [[slots_table.expirationDate]]<<expirationDate,`expirationDate`>>
| 0..1 +
https://w3id.org/linkml/Date[`date`]
...
| <<payment,`payment`>>
//| [[slots_table.payment]]<<payment,`payment`>>
| 0..1 +
...
| <<permitID,`permitID`>>
//| [[slots_table.permitID]]<<permitID,`permitID`>>
| 0..1 +
https://w3id.org/linkml/String[`string`]
| +++Permit identifier.+++
| _n/a_
...
|===
| URI
| `cim:AccessPermit.applicationNumber`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
|===
| URI
| `cim:AccessPermit.effectiveDate`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Date[`date`]
...
|===
| URI
| `cim:AccessPermit.expirationDate`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Date[`date`]
