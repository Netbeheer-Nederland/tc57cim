...
| +++Phase of this energy consumer component.   If the energy consumer is wye connected, the connection is from the indicated...+++
| _n/a_
...
| 0..1 +
xref::class/PerCent.adoc[`PerCent`]
| +++Fixed reactive power as per cent of load group fixed reactive power. Load sign convention is used, i.e. positive sign means...+++
| _n/a_
...
|===
| URI
| `cim:EnergyConsumerPhase.EnergyConsumer`
| Cardinality
| 1
| Type
| xref::class/EnergyConsumer.adoc[`EnergyConsumer`]
...
| xref::class/EnergyConsumer.adoc[`EnergyConsumer`] | xref::class/EnergyConsumer.adoc#EnergyConsumerPhase[`EnergyConsumerPhase`]
