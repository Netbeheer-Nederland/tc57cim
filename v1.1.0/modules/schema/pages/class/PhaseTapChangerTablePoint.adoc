...
| +++The angle difference in degrees. A positive value indicates a positive angle variation from the Terminal at the ...+++
| _n/a_
...
| xref::class/PhaseTapChangerTable.adoc[`PhaseTapChangerTable`] | xref::class/PhaseTapChangerTable.adoc#PhaseTapChangerTablePoint[`PhaseTapChangerTablePoint`]
