...
| xref::class/Equipment.adoc[`Equipment`] | xref::class/Equipment.adoc#OperationalRestrictions[`OperationalRestrictions`]



| xref::class/ProductAssetModel.adoc[`ProductAssetModel`] | xref::class/ProductAssetModel.adoc#OperationalRestrictions[`OperationalRestrictions`]
