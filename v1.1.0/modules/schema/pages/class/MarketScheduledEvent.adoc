...
|===
| URI
| `cim:MarketScheduledEvent.category`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
|===
| URI
| `cim:MarketScheduledEvent.duration`
| Cardinality
| 0..1
| Type
| xref::class/Seconds.adoc[`Seconds`]
...
| xref::class/MajorChargeGroup.adoc[`MajorChargeGroup`] | xref::class/MajorChargeGroup.adoc#MktScheduledEvent[`MktScheduledEvent`]
