...
//| [[slots_table.ReactiveCapabilityCurve]]<<ReactiveCapabilityCurve,`ReactiveCapabilityCurve`>>
| 0..1 +
...
| +++Maximum reactive power of the injection.  Used for modelling of infeed for load flow exchange. Not used for short circuit...+++
| _n/a_
...
| 0..1 +
xref::class/ReactivePower.adoc[`ReactivePower`]
| +++Minimum reactive power of the injection.  Used for modelling of infeed for load flow exchange. Not used for short circuit...+++
| _n/a_
...
Usage : Extended-Ward is a result of network...+++
| _n/a_
...
//| [[slots_table.regulationTarget]]<<regulationTarget,`regulationTarget`>>
| 0..1 +
...
[.text-left]
--
<<slots_table.ReactiveCapabilityCurve,&#10548;>>
--
////
...
| xref::class/ReactiveCapabilityCurve.adoc[`ReactiveCapabilityCurve`] | xref::class/ReactiveCapabilityCurve.adoc#EquivalentInjection[`EquivalentInjection`]
