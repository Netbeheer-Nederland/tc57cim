...
| <<DCTopologicalNodes,`DCTopologicalNodes`>>
//| [[slots_table.DCTopologicalNodes]]<<DCTopologicalNodes,`DCTopologicalNodes`>>
| 1..* +
...
[.text-left]
--
<<slots_table.DCTopologicalNodes,&#10548;>>
--
////
...
| xref::class/DCTopologicalNode.adoc[`DCTopologicalNode`] | xref::class/DCTopologicalNode.adoc#DCTopologicalIsland[`DCTopologicalIsland`]
