...
| xref::class/ProprietaryParameterDynamics.adoc[`ProprietaryParameterDynamics`] | xref::class/ProprietaryParameterDynamics.adoc#WindType1or2UserDefined[`WindType1or2UserDefined`]
