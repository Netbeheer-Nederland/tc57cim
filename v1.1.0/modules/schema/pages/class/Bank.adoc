...
| <<iban,`iban`>>
//| [[slots_table.iban]]<<iban,`iban`>>
| 0..1 +
https://w3id.org/linkml/String[`string`]
| +++International bank account number defined in ISO 13616; for countries where IBAN is not in operation, the existing BIC or...+++
| _n/a_
...
| xref::class/BankAccount.adoc[`BankAccount`] | xref::class/BankAccount.adoc#Bank[`Bank`]
