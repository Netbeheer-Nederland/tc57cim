...
| <<tariffCycle,`tariffCycle`>>
//| [[slots_table.tariffCycle]]<<tariffCycle,`tariffCycle`>>
| 0..1 +
https://w3id.org/linkml/String[`string`]
| +++The frequency at which the tariff charge schedule is repeated. Examples are: once off on a specified date and time; hourly;...+++
| _n/a_
...
|===
| URI
| `cim:TariffProfile.ConsumptionTariffIntervals`
| Cardinality
| 0..*
| Type
| xref::class/ConsumptionTariffInterval.adoc[`ConsumptionTariffInterval`]
...
|===
| URI
| `cim:TariffProfile.TimeTariffIntervals`
| Cardinality
| 0..*
| Type
| xref::class/TimeTariffInterval.adoc[`TimeTariffInterval`]
...
| xref::class/ConsumptionTariffInterval.adoc[`ConsumptionTariffInterval`] | xref::class/ConsumptionTariffInterval.adoc#TariffProfiles[`TariffProfiles`]



| xref::class/Tariff.adoc[`Tariff`] | xref::class/Tariff.adoc#TariffProfiles[`TariffProfiles`]



| xref::class/TimeTariffInterval.adoc[`TimeTariffInterval`] | xref::class/TimeTariffInterval.adoc#TariffProfiles[`TariffProfiles`]
