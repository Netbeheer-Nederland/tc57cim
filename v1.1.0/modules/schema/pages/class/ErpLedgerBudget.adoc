...
| <<ErpLedBudLineItems,`ErpLedBudLineItems`>>
//| [[slots_table.ErpLedBudLineItems]]<<ErpLedBudLineItems,`ErpLedBudLineItems`>>
| 0..* +
...
|===
| URI
| `cim:ErpLedgerBudget.ErpLedBudLineItems`
| Cardinality
| 0..*
| Type
| xref::class/ErpLedBudLineItem.adoc[`ErpLedBudLineItem`]
...
[.text-left]
--
<<slots_table.ErpLedBudLineItems,&#10548;>>
--
////
...
| xref::class/ErpLedBudLineItem.adoc[`ErpLedBudLineItem`] | xref::class/ErpLedBudLineItem.adoc#ErpLedgerBudget[`ErpLedgerBudget`]
