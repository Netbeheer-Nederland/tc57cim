...
| <<ErpRecDelvLineItems,`ErpRecDelvLineItems`>>
//| [[slots_table.ErpRecDelvLineItems]]<<ErpRecDelvLineItems,`ErpRecDelvLineItems`>>
| 0..* +
...
|===
| URI
| `cim:ErpReceiveDelivery.ErpRecDelvLineItems`
| Cardinality
| 0..*
| Type
| xref::class/ErpRecDelvLineItem.adoc[`ErpRecDelvLineItem`]
...
[.text-left]
--
<<slots_table.ErpRecDelvLineItems,&#10548;>>
--
////
...
| xref::class/ErpRecDelvLineItem.adoc[`ErpRecDelvLineItem`] | xref::class/ErpRecDelvLineItem.adoc#ErpReceiveDelivery[`ErpReceiveDelivery`]
