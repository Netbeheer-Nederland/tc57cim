...
| <<manualReplaceIndicator,`manualReplaceIndicator`>>
//| [[slots_table.manualReplaceIndicator]]<<manualReplaceIndicator,`manualReplaceIndicator`>>
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++Switch Manual Replace Indicator. Flag indicating that the switch is manual replace.+++
| _n/a_

| <<removeFromOperationIndicator,`removeFromOperationIndicator`>>
//| [[slots_table.removeFromOperationIndicator]]<<removeFromOperationIndicator,`removeFromOperationIndicator`>>
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
...
|===
| URI
| `cim:DiscreteMeasurementValueQuality.manualReplaceIndicator`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Boolean[`boolean`]
...
[.text-left]
--
<<slots_table.manualReplaceIndicator,&#10548;>>
--
////
...
|===
| URI
| `cim:DiscreteMeasurementValueQuality.removeFromOperationIndicator`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Boolean[`boolean`]
...
[.text-left]
--
<<slots_table.removeFromOperationIndicator,&#10548;>>
--
////
