...
| +++Interharmonic denominator. Value 0 means not applicable. Value 2 is used in combination with 'numerator'=1 to represent...+++
| _n/a_
...
| 0..1 +
https://w3id.org/linkml/Integer[`integer`]
| +++Interharmonic numerator. Value 0 means not applicable. Value 1 is used in combination with 'denominator'=2 to represent...+++
| _n/a_
|===
...
| xref::class/ReadingType.adoc[`ReadingType`] | xref::class/ReadingType.adoc#interharmonic[`interharmonic`]
