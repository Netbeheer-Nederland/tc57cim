...
//| [[slots_table.subCategory]]<<subCategory,`subCategory`>>
| 0..1 +
https://w3id.org/linkml/String[`string`]
...
| <<systemId,`systemId`>>
//| [[slots_table.systemId]]<<systemId,`systemId`>>
| 0..1 +
https://w3id.org/linkml/String[`string`]
...
|===
| URI
| `cim:ReadingQualityType.ReadingQualities`
| Cardinality
| 0..*
| Type
| xref::class/ReadingQuality.adoc[`ReadingQuality`]
...
| xref::class/ReadingQuality.adoc[`ReadingQuality`] | xref::class/ReadingQuality.adoc#ReadingQualityType[`ReadingQualityType`]
