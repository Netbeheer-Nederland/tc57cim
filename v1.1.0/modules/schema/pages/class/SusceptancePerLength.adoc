...
| xref::class/PerLengthSequenceImpedance.adoc[`PerLengthSequenceImpedance`] | xref::class/PerLengthSequenceImpedance.adoc#bch[`bch`]



| xref::class/PhaseImpedanceData.adoc[`PhaseImpedanceData`] | xref::class/PhaseImpedanceData.adoc#b[`b`]
