...
| <<mwLimit,`mwLimit`>>
//| [[slots_table.mwLimit]]<<mwLimit,`mwLimit`>>
| 0..1 +
xref::class/ActivePower.adoc[`ActivePower`]
| +++Binding MW limit.+++
| _n/a_
...
|===
| URI
| `cim:SecurityConstraintsClearing.mwFlow`
| Cardinality
| 0..1
| Type
| xref::class/ActivePower.adoc[`ActivePower`]
...
|===
| URI
| `cim:SecurityConstraintsClearing.mwLimit`
| Cardinality
| 0..1
| Type
| xref::class/ActivePower.adoc[`ActivePower`]
...
|===
| URI
| `cim:SecurityConstraintsClearing.shadowPrice`
| Cardinality
| 0..1
| Type
| xref::class/Money.adoc[`Money`]
