...
//| [[slots_table.VcompIEEEType2]]<<VcompIEEEType2,`VcompIEEEType2`>>
| 1 +
...
| <<rcij,`rcij`>>
//| [[slots_table.rcij]]<<rcij,`rcij`>>
| 0..1 +
xref::class/PU.adoc[`PU`]
| +++<font color="#0f0f0f">Resistive component of compensation of generator associated with this IEEE type 2 voltage compensator...+++
| _n/a_

| <<xcij,`xcij`>>
//| [[slots_table.xcij]]<<xcij,`xcij`>>
| 0..1 +
xref::class/PU.adoc[`PU`]
| +++<font color="#0f0f0f">Reactive component of compensation of generator associated with this IEEE type 2 voltage compensator...+++
| _n/a_
...
| xref::class/SynchronousMachineDynamics.adoc[`SynchronousMachineDynamics`] | xref::class/SynchronousMachineDynamics.adoc#GenICompensationForGenJ[`GenICompensationForGenJ`]



| xref::class/VCompIEEEType2.adoc[`VCompIEEEType2`] | xref::class/VCompIEEEType2.adoc#GenICompensationForGenJ[`GenICompensationForGenJ`]
