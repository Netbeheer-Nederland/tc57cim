...
|===
| URI
| `cim:ParticulateDensity.multiplier`
| Cardinality
| 0..1
| Type
| xref::enumeration/UnitMultiplier.adoc[`UnitMultiplier`]
...
| xref::class/VolcanicAshCloud.adoc[`VolcanicAshCloud`] | xref::class/VolcanicAshCloud.adoc#density[`density`]
