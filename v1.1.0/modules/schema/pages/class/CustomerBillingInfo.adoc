...
//| [[slots_table.billingDate]]<<billingDate,`billingDate`>>
| 0..1 +
...
| 0..1 +
https://w3id.org/linkml/Date[`date`]
| +++Calculated date upon which a customer billing amount is due, used in the invoicing process to determine when a Customer's...+++
| _n/a_
...
//| [[slots_table.lastPaymentAmt]]<<lastPaymentAmt,`lastPaymentAmt`>>
| 0..1 +
xref::class/Money.adoc[`Money`]
| +++Amount of the last payment received from the customer. It is retained in the Customer Billing system, although the details...+++
| _n/a_

| <<lastPaymentDate,`lastPaymentDate`>>
//| [[slots_table.lastPaymentDate]]<<lastPaymentDate,`lastPaymentDate`>>
| 0..1 +
https://w3id.org/linkml/Date[`date`]
| +++Date of the last payment received from the customer. It is retained in the Customer Billing system, although the details of...+++
| _n/a_

| <<outBalance,`outBalance`>>
//| [[slots_table.outBalance]]<<outBalance,`outBalance`>>
| 0..1 +
xref::class/Money.adoc[`Money`]
...
//| [[slots_table.pymtPlanAmt]]<<pymtPlanAmt,`pymtPlanAmt`>>
| 0..1 +
xref::class/Money.adoc[`Money`]
...
//| [[slots_table.pymtPlanType]]<<pymtPlanType,`pymtPlanType`>>
| 0..1 +
...
| xref::class/CustomerAccount.adoc[`CustomerAccount`] | xref::class/CustomerAccount.adoc#CustomerBillingInfos[`CustomerBillingInfos`]



| xref::class/ErpInvoiceLineItem.adoc[`ErpInvoiceLineItem`] | xref::class/ErpInvoiceLineItem.adoc#CustomerBillingInfos[`CustomerBillingInfos`]
