...
| 0..1 +
xref::class/PU.adoc[`PU`]
| +++Desired field voltage if <i>m</i> = false or desired field current if <i>m </i>= true (<i>EFD</i><i><sub>DES</sub></i>). ...+++
| _n/a_
...
| +++Time to trip the exciter at the low voltage or current point on the inverse time characteristic...+++
| _n/a_
...
| 0..1 +
xref::class/Seconds.adoc[`Seconds`]
| +++Time to trip the exciter at the mid voltage or current point on the inverse time characteristic...+++
| _n/a_
...
| 0..1 +
xref::class/Seconds.adoc[`Seconds`]
| +++Time to trip the exciter at the high voltage or current point on the inverse time characteristic...+++
| _n/a_
