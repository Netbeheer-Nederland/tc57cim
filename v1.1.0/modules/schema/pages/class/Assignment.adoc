...
//| [[slots_table.effectivePeriod]]<<effectivePeriod,`effectivePeriod`>>
| 0..1 +
...
|===
| URI
| `cim:Assignment.effectivePeriod`
| Cardinality
| 0..1
| Type
| xref::class/DateTimeInterval.adoc[`DateTimeInterval`]
...
| xref::class/OldCrew.adoc[`OldCrew`] | xref::class/OldCrew.adoc#Assignments[`Assignments`]
