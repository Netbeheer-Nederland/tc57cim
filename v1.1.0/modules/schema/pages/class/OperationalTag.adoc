...
| <<TagAction,`TagAction`>>
//| [[slots_table.TagAction]]<<TagAction,`TagAction`>>
| 0..1 +
...
|===
| URI
| `cim:OperationalTag.PowerSystemResource`
| Cardinality
| 0..1
| Type
| xref::class/PowerSystemResource.adoc[`PowerSystemResource`]
...
| xref::class/Asset.adoc[`Asset`] | xref::class/Asset.adoc#OperationalTags[`OperationalTags`]



| xref::class/PowerSystemResource.adoc[`PowerSystemResource`] | xref::class/PowerSystemResource.adoc#OperationalTags[`OperationalTags`]



| xref::class/TagAction.adoc[`TagAction`] | xref::class/TagAction.adoc#OperationalTag[`OperationalTag`]
