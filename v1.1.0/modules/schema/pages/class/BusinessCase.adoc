...
|===
| URI
| `cim:BusinessCase.corporateCode`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
| xref::class/Project.adoc[`Project`] | xref::class/Project.adoc#BusinessCase[`BusinessCase`]



| xref::class/Work.adoc[`Work`] | xref::class/Work.adoc#BusinessCase[`BusinessCase`]
