...
| <<AngleRefTopologicalNode,`AngleRefTopologicalNode`>>
//| [[slots_table.AngleRefTopologicalNode]]<<AngleRefTopologicalNode,`AngleRefTopologicalNode`>>
| 0..1 +
...
| <<TopologicalNodes,`TopologicalNodes`>>
//| [[slots_table.TopologicalNodes]]<<TopologicalNodes,`TopologicalNodes`>>
| 1..* +
xref::class/TopologicalNode.adoc[`TopologicalNode`]
...
[.text-left]
--
<<slots_table.AngleRefTopologicalNode,&#10548;>>
--
////
...
| xref::class/TopologicalNode.adoc[`TopologicalNode`] | xref::class/TopologicalNode.adoc#AngleRefTopologicalIsland[`AngleRefTopologicalIsland`]
