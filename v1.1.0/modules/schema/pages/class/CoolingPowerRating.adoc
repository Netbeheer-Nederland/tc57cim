...
//| [[slots_table.coolingKind]]<<coolingKind,`coolingKind`>>
| 0..1 +
...
//| [[slots_table.powerRating]]<<powerRating,`powerRating`>>
| 0..1 +
...
|===
| URI
| `cim:CoolingPowerRating.coolingKind`
| Cardinality
| 0..1
| Type
| xref::enumeration/CoolingKind.adoc[`CoolingKind`]
...
|===
| URI
| `cim:CoolingPowerRating.powerRating`
| Cardinality
| 0..1
| Type
| xref::class/ApparentPower.adoc[`ApparentPower`]
...
|===
| URI
| `cim:CoolingPowerRating.Reconditionings`
| Cardinality
| 0..*
| Type
| xref::class/Reconditioning.adoc[`Reconditioning`]
...
| xref::class/Reconditioning.adoc[`Reconditioning`] | xref::class/Reconditioning.adoc#PowerRatings[`PowerRatings`]
