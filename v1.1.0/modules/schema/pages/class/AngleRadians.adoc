...
| xref::class/EnergySource.adoc[`EnergySource`] | xref::class/EnergySource.adoc#voltageAngle[`voltageAngle`]



| xref::class/SynchrocheckRelay.adoc[`SynchrocheckRelay`] | xref::class/SynchrocheckRelay.adoc#maxAngleDiff[`maxAngleDiff`]
