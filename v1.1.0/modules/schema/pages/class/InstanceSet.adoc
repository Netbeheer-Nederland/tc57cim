...
//| [[slots_table.DatasetArg]]<<DatasetArg,`DatasetArg`>>
| 0..* +
...
//| [[slots_table.InstanceSetMember]]<<InstanceSetMember,`InstanceSetMember`>>
| 0..* +
...
| xref::class/DatasetArg.adoc[`DatasetArg`] | xref::class/DatasetArg.adoc#Dataset[`Dataset`]



| xref::class/IdentifiedObject.adoc[`IdentifiedObject`] | xref::class/IdentifiedObject.adoc#InstanceSet[`InstanceSet`]
