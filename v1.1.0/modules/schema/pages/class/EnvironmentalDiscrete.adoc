...
|===
| URI
| `cim:EnvironmentalDiscrete.EnvironmentalInformation`
| Cardinality
| 0..1
| Type
| xref::class/EnvironmentalInformation.adoc[`EnvironmentalInformation`]
...
|===
| URI
| `cim:EnvironmentalDiscrete.kind`
| Cardinality
| 1
| Type
| xref::enumeration/EnvironmentalDiscreteKind.adoc[`EnvironmentalDiscreteKind`]
...
| xref::class/EnvironmentalInformation.adoc[`EnvironmentalInformation`] | xref::class/EnvironmentalInformation.adoc#EnvironmentalDiscrete[`EnvironmentalDiscrete`]
