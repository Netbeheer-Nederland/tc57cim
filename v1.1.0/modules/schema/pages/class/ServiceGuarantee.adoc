...
//| [[slots_table.applicationPeriod]]<<applicationPeriod,`applicationPeriod`>>
| 0..1 +
...
//| [[slots_table.automaticPay]]<<automaticPay,`automaticPay`>>
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++True if utility must autmatically pay the specified amount whenever the condition is not satisified, otherwise customer must...+++
| _n/a_

| <<payAmount,`payAmount`>>
//| [[slots_table.payAmount]]<<payAmount,`payAmount`>>
| 0..1 +
...
//| [[slots_table.serviceRequirement]]<<serviceRequirement,`serviceRequirement`>>
| 0..1 +
...
|===
| URI
| `cim:ServiceGuarantee.applicationPeriod`
| Cardinality
| 0..1
| Type
| xref::class/DateTimeInterval.adoc[`DateTimeInterval`]
...
|===
| URI
| `cim:ServiceGuarantee.automaticPay`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Boolean[`boolean`]
...
|===
| URI
| `cim:ServiceGuarantee.payAmount`
| Cardinality
| 0..1
| Type
| xref::class/Money.adoc[`Money`]
...
|===
| URI
| `cim:ServiceGuarantee.serviceRequirement`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
[.text-left]
--
<<slots_table.serviceRequirement,&#10548;>>
--
////
