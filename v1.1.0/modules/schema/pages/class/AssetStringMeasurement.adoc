...
|===
| URI
| `cim:AssetStringMeasurement.kind`
| Cardinality
| 0..1
| Type
| xref::enumeration/AssetStringKind.adoc[`AssetStringKind`]
...
|===
| URI
| `cim:AssetStringMeasurement.TestStandard`
| Cardinality
| 0..1
| Type
| xref::class/TestStandard.adoc[`TestStandard`]
...
| xref::class/TestStandard.adoc[`TestStandard`] | xref::class/TestStandard.adoc#AssetString[`AssetString`]
