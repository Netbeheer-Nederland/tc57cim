...
| xref::class/PFVArControllerType1Dynamics.adoc[`PFVArControllerType1Dynamics`] | xref::class/PFVArControllerType1Dynamics.adoc#VoltageAdjusterDynamics[`VoltageAdjusterDynamics`]
