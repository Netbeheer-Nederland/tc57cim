...
| <<pmwset,`pmwset`>>
//| [[slots_table.pmwset]]<<pmwset,`pmwset`>>
| 0..1 +
xref::class/ActivePower.adoc[`ActivePower`]
...
//| [[slots_table.speedReferenceGovernor]]<<speedReferenceGovernor,`speedReferenceGovernor`>>
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++Type of turbine governor reference (<i>Type</i>).
true = speed reference governor
false = load reference...+++
| _n/a_
...
[.text-left]
--
<<slots_table.speedReferenceGovernor,&#10548;>>
--
////
