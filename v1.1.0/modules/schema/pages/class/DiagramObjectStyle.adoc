...
| <<StyledObjects,`StyledObjects`>>
//| [[slots_table.StyledObjects]]<<StyledObjects,`StyledObjects`>>
| 0..* +
...
|===
| URI
| `cim:DiagramObjectStyle.StyledObjects`
| Cardinality
| 0..*
| Type
| xref::class/DiagramObject.adoc[`DiagramObject`]
...
| xref::class/DiagramObject.adoc[`DiagramObject`] | xref::class/DiagramObject.adoc#DiagramObjectStyle[`DiagramObjectStyle`]
