...
//| [[slots_table.LandProperty]]<<LandProperty,`LandProperty`>>
| 0..1 +
...
| +++Property related information that describes the Grant's land parcel. For example, it may be a deed book number, deed book...+++
| _n/a_
...
|===
| URI
| `cim:LocationGrant.LandProperty`
| Cardinality
| 0..1
| Type
| xref::class/LandProperty.adoc[`LandProperty`]
...
|===
| URI
| `cim:LocationGrant.propertyData`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
| xref::class/LandProperty.adoc[`LandProperty`] | xref::class/LandProperty.adoc#LocationGrants[`LocationGrants`]
