...
//| [[slots_table.explosivesUsed]]<<explosivesUsed,`explosivesUsed`>>
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++True if explosives have been or are planned to be used.+++
| _n/a_

| <<markedIndicator,`markedIndicator`>>
//| [[slots_table.markedIndicator]]<<markedIndicator,`markedIndicator`>>
| 0..1 +
https://w3id.org/linkml/Boolean[`boolean`]
| +++True if work location has been marked, for example for a dig area.+++
| _n/a_

| <<markingInstruction,`markingInstruction`>>
//| [[slots_table.markingInstruction]]<<markingInstruction,`markingInstruction`>>
| 0..1 +
...
|===
| URI
| `cim:OneCallRequest.explosivesUsed`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Boolean[`boolean`]
...
|===
| URI
| `cim:OneCallRequest.markedIndicator`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/Boolean[`boolean`]
...
|===
| URI
| `cim:OneCallRequest.markingInstruction`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
[.text-left]
--
<<slots_table.markingInstruction,&#10548;>>
--
////
...
|===
| URI
| `cim:OneCallRequest.WorkLocations`
| Cardinality
| 0..*
| Type
| xref::class/WorkLocation.adoc[`WorkLocation`]
...
| xref::class/WorkLocation.adoc[`WorkLocation`] | xref::class/WorkLocation.adoc#OneCallRequest[`OneCallRequest`]
