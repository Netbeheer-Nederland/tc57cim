...
| xref::class/ReadingType.adoc[`ReadingType`] | xref::class/ReadingType.adoc#Channel[`Channel`]



| xref::class/Register.adoc[`Register`] | xref::class/Register.adoc#Channels[`Channels`]
