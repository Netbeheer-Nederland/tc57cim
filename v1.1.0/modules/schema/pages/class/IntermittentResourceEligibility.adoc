...
//| [[slots_table.eligibilityStatus]]<<eligibilityStatus,`eligibilityStatus`>>
| 0..1 +
...
|===
| URI
| `cim:IntermittentResourceEligibility.eligibilityStatus`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
| xref::class/RegisteredResource.adoc[`RegisteredResource`] | xref::class/RegisteredResource.adoc#IntermittentResourceEligibility[`IntermittentResourceEligibility`]
