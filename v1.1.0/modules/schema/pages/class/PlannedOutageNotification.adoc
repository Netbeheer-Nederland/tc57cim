...
|===
| URI
| `cim:PlannedOutageNotification.Customer`
| Cardinality
| 0..*
| Type
| xref::class/Customer.adoc[`Customer`]
...
|===
| URI
| `cim:PlannedOutageNotification.SwitchingPlan`
| Cardinality
| 0..1
| Type
| xref::class/SwitchingPlan.adoc[`SwitchingPlan`]
...
|===
| URI
| `cim:PlannedOutageNotification.UsagePoint`
| Cardinality
| 0..*
| Type
| xref::class/UsagePoint.adoc[`UsagePoint`]
...
| xref::class/Customer.adoc[`Customer`] | xref::class/Customer.adoc#PlannedOutageNotification[`PlannedOutageNotification`]



| xref::class/SwitchingPlan.adoc[`SwitchingPlan`] | xref::class/SwitchingPlan.adoc#PlannedOutageNotification[`PlannedOutageNotification`]



| xref::class/UsagePoint.adoc[`UsagePoint`] | xref::class/UsagePoint.adoc#PlannedOutageNotification[`PlannedOutageNotification`]
