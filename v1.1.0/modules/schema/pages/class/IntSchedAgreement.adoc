...
| <<defaultIntegrationMethod,`defaultIntegrationMethod`>>
//| [[slots_table.defaultIntegrationMethod]]<<defaultIntegrationMethod,`defaultIntegrationMethod`>>
| 0..1 +
https://w3id.org/linkml/String[`string`]
| +++The default method by which interchange schedules are to be integrated to obtain hourly MWh schedules for accounting. Method...+++
| _n/a_
...
|===
| URI
| `cim:IntSchedAgreement.defaultIntegrationMethod`
| Cardinality
| 0..1
| Type
| https://w3id.org/linkml/String[`string`]
...
[.text-left]
--
<<slots_table.defaultIntegrationMethod,&#10548;>>
--
////
