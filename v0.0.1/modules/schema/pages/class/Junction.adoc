...
Junction -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Junction -> SvStatus: SvStatus


Junction -> ProtectionEquipment: ProtectionEquipments
...
Junction -> JumperAction: JumpingAction


Junction -> GroundAction: GroundingAction


Junction -> Outage: Outage


Junction -> WeatherStation: WeatherStation


Junction -> OperationalLimitSet: OperationalLimitSet


Junction -> ContingencyEquipment: ContingencyEquipment


Junction -> EquipmentContainer: EquipmentContainer


Junction -> Fault: Faults


Junction -> LimitDependency: LimitDependencyModel


Junction -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Junction -> ProtectiveActionEquipment: ProtectiveActionEquipment


Junction -> PinEquipment: PinEquipment


Junction -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Junction -> EquipmentContainer: AdditionalEquipmentContainer


Junction -> UsagePoint: UsagePoints


Junction -> Outage: Outages


Junction -> OperationalRestriction: OperationalRestrictions


Junction -> Control: Controls


Junction -> Measurement: Measurements


Junction -> PSRType: PSRType


Junction -> ConfigurationEvent: ConfigurationEvent


Junction -> ReportingGroup: ReportingGroup


Junction -> OperatingShare: OperatingShare


Junction -> AssetInfo: AssetDatasheet


Junction -> VerificationAction: VerificationAction


Junction -> ClearanceDocument: Clearances


Junction -> GenericAction: GenericAction


Junction -> PSREvent: PSREvents
...
Junction -> OperationalTag: OperationalTags


Junction -> DiagramObject: DiagramObjects


Junction -> InstanceSet: InstanceSet


Junction -> Name: Names


Junction -> ChangeSetMember: PropertiesCIMDataObject


Junction -> ChangeSetMember: TargetingCIMDataObject
