...
SteamSendoutSchedule -> CogenerationPlant: CogenerationPlant



SteamSendoutSchedule -> RegularTimePoint: TimePoints


SteamSendoutSchedule -> DiagramObject: DiagramObjects


SteamSendoutSchedule -> InstanceSet: InstanceSet


SteamSendoutSchedule -> Name: Names


SteamSendoutSchedule -> ChangeSetMember: PropertiesCIMDataObject


SteamSendoutSchedule -> ChangeSetMember: TargetingCIMDataObject
