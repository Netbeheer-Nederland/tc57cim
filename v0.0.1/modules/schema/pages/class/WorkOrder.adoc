...
WorkOrder -> Status: docStatus


WorkOrder -> ElectronicAddress: electronicAddress


WorkOrder -> Status: status


WorkOrder -> ActivityRecord: ActivityRecord


WorkOrder -> ConfigurationEvent: ConfigurationEvents


WorkOrder -> Author: Author


WorkOrder -> Editor: Editor


WorkOrder -> Approver: Approver


WorkOrder -> Issuer: Issuer


WorkOrder -> DiagramObject: DiagramObjects


WorkOrder -> InstanceSet: InstanceSet


WorkOrder -> Name: Names


WorkOrder -> ChangeSetMember: PropertiesCIMDataObject


WorkOrder -> ChangeSetMember: TargetingCIMDataObject
