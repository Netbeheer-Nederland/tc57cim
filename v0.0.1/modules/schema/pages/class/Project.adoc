...
Project -> BusinessCase: BusinessCase


Project -> ErpProjectAccounting: ErpProjectAccounting


Project -> Work: Works


Project -> Status: docStatus


Project -> ElectronicAddress: electronicAddress


Project -> Status: status


Project -> ActivityRecord: ActivityRecord


Project -> ConfigurationEvent: ConfigurationEvents
...
Project -> DiagramObject: DiagramObjects


Project -> InstanceSet: InstanceSet


Project -> Name: Names


Project -> ChangeSetMember: PropertiesCIMDataObject


Project -> ChangeSetMember: TargetingCIMDataObject
