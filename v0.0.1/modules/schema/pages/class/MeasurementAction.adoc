...
MeasurementAction -> SwitchingPlan: SwitchingPlan


MeasurementAction -> Operator: Operator


MeasurementAction -> Crew: Crew


MeasurementAction -> SwitchingEvent: SwitchingEvent


MeasurementAction -> SwitchingStep: SwitchingStep


MeasurementAction -> DiagramObject: DiagramObjects


MeasurementAction -> InstanceSet: InstanceSet


MeasurementAction -> Name: Names


MeasurementAction -> ChangeSetMember: PropertiesCIMDataObject


MeasurementAction -> ChangeSetMember: TargetingCIMDataObject
