...
Recloser -> ProtectionEquipment: OperatedByProtectionEquipment


Recloser -> RecloseSequence: RecloseSequences



Recloser -> SwitchPhase: SwitchPhase


Recloser -> SwitchSchedule: SwitchSchedules


Recloser -> CompositeSwitch: CompositeSwitch


Recloser -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


Recloser -> SvSwitch: SvSwitch


Recloser -> ConnectDisconnectFunction: ConnectDisconnectFunctions


Recloser -> SwitchAction: SwitchAction


Recloser -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Recloser -> SvStatus: SvStatus


Recloser -> ProtectionEquipment: ProtectionEquipments


Recloser -> BaseVoltage: BaseVoltage


Recloser -> Terminal: Terminals


Recloser -> JumperAction: JumpingAction


Recloser -> GroundAction: GroundingAction


Recloser -> Outage: Outage


Recloser -> WeatherStation: WeatherStation


Recloser -> OperationalLimitSet: OperationalLimitSet


Recloser -> ContingencyEquipment: ContingencyEquipment


Recloser -> EquipmentContainer: EquipmentContainer


Recloser -> Fault: Faults


Recloser -> LimitDependency: LimitDependencyModel


Recloser -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Recloser -> ProtectiveActionEquipment: ProtectiveActionEquipment


Recloser -> PinEquipment: PinEquipment


Recloser -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Recloser -> EquipmentContainer: AdditionalEquipmentContainer


Recloser -> UsagePoint: UsagePoints


Recloser -> Outage: Outages


Recloser -> OperationalRestriction: OperationalRestrictions


Recloser -> Control: Controls


Recloser -> Measurement: Measurements


Recloser -> PSRType: PSRType


Recloser -> ConfigurationEvent: ConfigurationEvent


Recloser -> ReportingGroup: ReportingGroup


Recloser -> OperatingShare: OperatingShare


Recloser -> AssetInfo: AssetDatasheet


Recloser -> VerificationAction: VerificationAction


Recloser -> ClearanceDocument: Clearances


Recloser -> GenericAction: GenericAction


Recloser -> PSREvent: PSREvents


Recloser -> Asset: Assets


Recloser -> Location: Location


Recloser -> OperationalTag: OperationalTags


Recloser -> DiagramObject: DiagramObjects


Recloser -> InstanceSet: InstanceSet


Recloser -> Name: Names


Recloser -> ChangeSetMember: PropertiesCIMDataObject


Recloser -> ChangeSetMember: TargetingCIMDataObject
