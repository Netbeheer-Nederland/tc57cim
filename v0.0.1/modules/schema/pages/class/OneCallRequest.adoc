...
OneCallRequest -> WorkLocation: WorkLocations


OneCallRequest -> Status: docStatus


OneCallRequest -> ElectronicAddress: electronicAddress


OneCallRequest -> Status: status


OneCallRequest -> ActivityRecord: ActivityRecord


OneCallRequest -> ConfigurationEvent: ConfigurationEvents


OneCallRequest -> Author: Author


OneCallRequest -> Editor: Editor


OneCallRequest -> Approver: Approver


OneCallRequest -> Issuer: Issuer


OneCallRequest -> DiagramObject: DiagramObjects


OneCallRequest -> InstanceSet: InstanceSet


OneCallRequest -> Name: Names


OneCallRequest -> ChangeSetMember: PropertiesCIMDataObject


OneCallRequest -> ChangeSetMember: TargetingCIMDataObject
