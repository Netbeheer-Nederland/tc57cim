...
IncrementalHeatRateCurve -> ThermalGeneratingUnit: ThermalGeneratingUnit


IncrementalHeatRateCurve -> CurveData: CurveDatas


IncrementalHeatRateCurve -> DiagramObject: DiagramObjects


IncrementalHeatRateCurve -> InstanceSet: InstanceSet


IncrementalHeatRateCurve -> Name: Names


IncrementalHeatRateCurve -> ChangeSetMember: PropertiesCIMDataObject


IncrementalHeatRateCurve -> ChangeSetMember: TargetingCIMDataObject
