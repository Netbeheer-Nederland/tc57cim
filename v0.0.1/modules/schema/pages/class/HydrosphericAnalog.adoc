...
HydrosphericAnalog -> ReportingCapability: ReportingCapability


HydrosphericAnalog -> EnvironmentalInformation: EnvironmentalInformation


HydrosphericAnalog -> ClassificationCondition: ClassificationCondition


HydrosphericAnalog -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


HydrosphericAnalog -> AnalogValue: AnalogValues


HydrosphericAnalog -> AnalogLimitSet: LimitSets


HydrosphericAnalog -> ACDCTerminal: Terminal


HydrosphericAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


HydrosphericAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


HydrosphericAnalog -> PowerSystemResource: PowerSystemResource


HydrosphericAnalog -> PinMeasurement: PinMeasurement


HydrosphericAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


HydrosphericAnalog -> Asset: Asset


HydrosphericAnalog -> MeasurementAction: MeasurementAction


HydrosphericAnalog -> Location: Locations


HydrosphericAnalog -> Procedure: Procedures


HydrosphericAnalog -> DiagramObject: DiagramObjects


HydrosphericAnalog -> InstanceSet: InstanceSet


HydrosphericAnalog -> Name: Names


HydrosphericAnalog -> ChangeSetMember: PropertiesCIMDataObject


HydrosphericAnalog -> ChangeSetMember: TargetingCIMDataObject
