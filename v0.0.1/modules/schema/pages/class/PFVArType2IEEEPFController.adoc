...
PFVArType2IEEEPFController -> ExcitationSystemDynamics: ExcitationSystemDynamics


PFVArType2IEEEPFController -> DiagramObject: DiagramObjects


PFVArType2IEEEPFController -> InstanceSet: InstanceSet


PFVArType2IEEEPFController -> Name: Names


PFVArType2IEEEPFController -> ChangeSetMember: PropertiesCIMDataObject


PFVArType2IEEEPFController -> ChangeSetMember: TargetingCIMDataObject
