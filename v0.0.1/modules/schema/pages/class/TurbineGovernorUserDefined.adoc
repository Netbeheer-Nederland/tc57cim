...
TurbineGovernorUserDefined -> AsynchronousMachineDynamics: AsynchronousMachineDynamics


TurbineGovernorUserDefined -> TurbineLoadControllerDynamics: TurbineLoadControllerDynamics


TurbineGovernorUserDefined -> SynchronousMachineDynamics: SynchronousMachineDynamics


TurbineGovernorUserDefined -> DiagramObject: DiagramObjects


TurbineGovernorUserDefined -> InstanceSet: InstanceSet


TurbineGovernorUserDefined -> Name: Names


TurbineGovernorUserDefined -> ChangeSetMember: PropertiesCIMDataObject


TurbineGovernorUserDefined -> ChangeSetMember: TargetingCIMDataObject
