...
DCBaseTerminal -> BusNameMarker: BusNameMarker


DCBaseTerminal -> OperationalLimitSet: OperationalLimitSet


DCBaseTerminal -> Measurement: Measurements


DCBaseTerminal -> DiagramObject: DiagramObjects


DCBaseTerminal -> InstanceSet: InstanceSet


DCBaseTerminal -> Name: Names


DCBaseTerminal -> ChangeSetMember: PropertiesCIMDataObject


DCBaseTerminal -> ChangeSetMember: TargetingCIMDataObject
