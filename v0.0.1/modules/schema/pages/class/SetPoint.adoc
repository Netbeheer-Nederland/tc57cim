...
SetPoint -> AnalogValue: AnalogValue


SetPoint -> RemoteControl: RemoteControl


SetPoint -> PowerSystemResource: PowerSystemResource


SetPoint -> ControlAction: ControlAction


SetPoint -> ProvidedBilateralPoint: BilateralToIOPoint


SetPoint -> IOPointSource: IOPointSource


SetPoint -> DiagramObject: DiagramObjects


SetPoint -> InstanceSet: InstanceSet


SetPoint -> Name: Names


SetPoint -> ChangeSetMember: PropertiesCIMDataObject


SetPoint -> ChangeSetMember: TargetingCIMDataObject
