...
AltTieMeas -> TieFlow: TieFlow


AltTieMeas -> AnalogValue: AnalogValue


AltTieMeas -> DiagramObject: DiagramObjects


AltTieMeas -> InstanceSet: InstanceSet


AltTieMeas -> Name: Names


AltTieMeas -> ChangeSetMember: PropertiesCIMDataObject


AltTieMeas -> ChangeSetMember: TargetingCIMDataObject
