...
BankAccount -> ServiceSupplier: ServiceSupplier


BankAccount -> Status: docStatus


BankAccount -> ElectronicAddress: electronicAddress


BankAccount -> Status: status


BankAccount -> ActivityRecord: ActivityRecord


BankAccount -> ConfigurationEvent: ConfigurationEvents


BankAccount -> Author: Author


BankAccount -> Editor: Editor


BankAccount -> Approver: Approver


BankAccount -> Issuer: Issuer


BankAccount -> DiagramObject: DiagramObjects


BankAccount -> InstanceSet: InstanceSet


BankAccount -> Name: Names


BankAccount -> ChangeSetMember: PropertiesCIMDataObject


BankAccount -> ChangeSetMember: TargetingCIMDataObject
