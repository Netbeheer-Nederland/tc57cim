...
PssSTAB2A -> ExcitationSystemDynamics: ExcitationSystemDynamics


PssSTAB2A -> RemoteInputSignal: RemoteInputSignal


PssSTAB2A -> DiagramObject: DiagramObjects


PssSTAB2A -> InstanceSet: InstanceSet


PssSTAB2A -> Name: Names


PssSTAB2A -> ChangeSetMember: PropertiesCIMDataObject


PssSTAB2A -> ChangeSetMember: TargetingCIMDataObject
