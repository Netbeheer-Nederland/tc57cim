...
EquipmentFault -> Terminal: Terminal


EquipmentFault -> FaultImpedance: impedance


EquipmentFault -> Equipment: FaultyEquipment


EquipmentFault -> FaultCauseType: FaultCauseTypes


EquipmentFault -> Location: Location


EquipmentFault -> Outage: Outage


EquipmentFault -> DiagramObject: DiagramObjects


EquipmentFault -> InstanceSet: InstanceSet


EquipmentFault -> Name: Names


EquipmentFault -> ChangeSetMember: PropertiesCIMDataObject


EquipmentFault -> ChangeSetMember: TargetingCIMDataObject
