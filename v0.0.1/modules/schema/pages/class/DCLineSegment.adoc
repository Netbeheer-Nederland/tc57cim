...
DCLineSegment -> PerLengthDCLineParameter: PerLengthParameter



DCLineSegment -> DCTerminal: DCTerminals


DCLineSegment -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


DCLineSegment -> WeatherStation: WeatherStation


DCLineSegment -> OperationalLimitSet: OperationalLimitSet


DCLineSegment -> ContingencyEquipment: ContingencyEquipment


DCLineSegment -> EquipmentContainer: EquipmentContainer


DCLineSegment -> Fault: Faults


DCLineSegment -> LimitDependency: LimitDependencyModel


DCLineSegment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


DCLineSegment -> ProtectiveActionEquipment: ProtectiveActionEquipment


DCLineSegment -> PinEquipment: PinEquipment


DCLineSegment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


DCLineSegment -> EquipmentContainer: AdditionalEquipmentContainer


DCLineSegment -> UsagePoint: UsagePoints


DCLineSegment -> Outage: Outages


DCLineSegment -> OperationalRestriction: OperationalRestrictions


DCLineSegment -> Control: Controls


DCLineSegment -> Measurement: Measurements


DCLineSegment -> PSRType: PSRType


DCLineSegment -> ConfigurationEvent: ConfigurationEvent


DCLineSegment -> ReportingGroup: ReportingGroup


DCLineSegment -> OperatingShare: OperatingShare


DCLineSegment -> AssetInfo: AssetDatasheet


DCLineSegment -> VerificationAction: VerificationAction


DCLineSegment -> ClearanceDocument: Clearances


DCLineSegment -> GenericAction: GenericAction


DCLineSegment -> PSREvent: PSREvents


DCLineSegment -> Asset: Assets


DCLineSegment -> Location: Location


DCLineSegment -> OperationalTag: OperationalTags


DCLineSegment -> DiagramObject: DiagramObjects


DCLineSegment -> InstanceSet: InstanceSet


DCLineSegment -> Name: Names


DCLineSegment -> ChangeSetMember: PropertiesCIMDataObject


DCLineSegment -> ChangeSetMember: TargetingCIMDataObject
