...
EquivalentInjection -> EquivalentNetwork: EquivalentNetwork


EquivalentInjection -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EquivalentInjection -> SvStatus: SvStatus


EquivalentInjection -> ProtectionEquipment: ProtectionEquipments
...
EquivalentInjection -> JumperAction: JumpingAction


EquivalentInjection -> GroundAction: GroundingAction


EquivalentInjection -> Outage: Outage


EquivalentInjection -> WeatherStation: WeatherStation


EquivalentInjection -> OperationalLimitSet: OperationalLimitSet


EquivalentInjection -> ContingencyEquipment: ContingencyEquipment


EquivalentInjection -> EquipmentContainer: EquipmentContainer


EquivalentInjection -> Fault: Faults


EquivalentInjection -> LimitDependency: LimitDependencyModel


EquivalentInjection -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


EquivalentInjection -> ProtectiveActionEquipment: ProtectiveActionEquipment


EquivalentInjection -> PinEquipment: PinEquipment


EquivalentInjection -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


EquivalentInjection -> EquipmentContainer: AdditionalEquipmentContainer


EquivalentInjection -> UsagePoint: UsagePoints


EquivalentInjection -> Outage: Outages


EquivalentInjection -> OperationalRestriction: OperationalRestrictions


EquivalentInjection -> Control: Controls


EquivalentInjection -> Measurement: Measurements


EquivalentInjection -> PSRType: PSRType


EquivalentInjection -> ConfigurationEvent: ConfigurationEvent


EquivalentInjection -> ReportingGroup: ReportingGroup


EquivalentInjection -> OperatingShare: OperatingShare


EquivalentInjection -> AssetInfo: AssetDatasheet


EquivalentInjection -> VerificationAction: VerificationAction


EquivalentInjection -> ClearanceDocument: Clearances


EquivalentInjection -> GenericAction: GenericAction


EquivalentInjection -> PSREvent: PSREvents


EquivalentInjection -> Asset: Assets


EquivalentInjection -> Location: Location


EquivalentInjection -> OperationalTag: OperationalTags


EquivalentInjection -> DiagramObject: DiagramObjects


EquivalentInjection -> InstanceSet: InstanceSet


EquivalentInjection -> Name: Names


EquivalentInjection -> ChangeSetMember: PropertiesCIMDataObject


EquivalentInjection -> ChangeSetMember: TargetingCIMDataObject
