...
WorkBillingInfo -> ErpInvoiceLineItem: ErpLineItems


WorkBillingInfo -> Work: Works


WorkBillingInfo -> CustomerAccount: CustomerAccount


WorkBillingInfo -> Status: docStatus


WorkBillingInfo -> ElectronicAddress: electronicAddress


WorkBillingInfo -> Status: status


WorkBillingInfo -> ActivityRecord: ActivityRecord


WorkBillingInfo -> ConfigurationEvent: ConfigurationEvents


WorkBillingInfo -> Author: Author


WorkBillingInfo -> Editor: Editor


WorkBillingInfo -> Approver: Approver


WorkBillingInfo -> Issuer: Issuer


WorkBillingInfo -> DiagramObject: DiagramObjects


WorkBillingInfo -> InstanceSet: InstanceSet


WorkBillingInfo -> Name: Names


WorkBillingInfo -> ChangeSetMember: PropertiesCIMDataObject


WorkBillingInfo -> ChangeSetMember: TargetingCIMDataObject
