...
StartMainFuelCurve -> StartupModel: StartupModel


StartMainFuelCurve -> CurveData: CurveDatas


StartMainFuelCurve -> DiagramObject: DiagramObjects


StartMainFuelCurve -> InstanceSet: InstanceSet


StartMainFuelCurve -> Name: Names


StartMainFuelCurve -> ChangeSetMember: PropertiesCIMDataObject


StartMainFuelCurve -> ChangeSetMember: TargetingCIMDataObject
