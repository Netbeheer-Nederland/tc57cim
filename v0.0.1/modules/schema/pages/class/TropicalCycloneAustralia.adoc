...
TropicalCycloneAustralia -> RelativeDisplacement: altitude


TropicalCycloneAustralia -> RelativeDisplacement: base
...
TropicalCycloneAustralia -> DateTimeInterval: timeInterval


TropicalCycloneAustralia -> EnvironmentalLocationType: EnvironmentalLocationKind


TropicalCycloneAustralia -> PhenomenonClassification: PhenomenonClassification


TropicalCycloneAustralia -> EnvironmentalInformation: EnvironmentalInformation
