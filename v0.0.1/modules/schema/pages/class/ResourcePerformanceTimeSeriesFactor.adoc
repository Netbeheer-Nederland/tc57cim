...
ResourcePerformanceTimeSeriesFactor -> ResourcePerformanceEvaluation: ResourcePerformanceEvaluation



ResourcePerformanceTimeSeriesFactor -> RegularTimePoint: TimePoints


ResourcePerformanceTimeSeriesFactor -> DiagramObject: DiagramObjects


ResourcePerformanceTimeSeriesFactor -> InstanceSet: InstanceSet


ResourcePerformanceTimeSeriesFactor -> Name: Names


ResourcePerformanceTimeSeriesFactor -> ChangeSetMember: PropertiesCIMDataObject


ResourcePerformanceTimeSeriesFactor -> ChangeSetMember: TargetingCIMDataObject
