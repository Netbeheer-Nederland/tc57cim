...
InfoQuestion -> Status: docStatus


InfoQuestion -> ElectronicAddress: electronicAddress


InfoQuestion -> Status: status


InfoQuestion -> ActivityRecord: ActivityRecord


InfoQuestion -> ConfigurationEvent: ConfigurationEvents


InfoQuestion -> Author: Author


InfoQuestion -> Editor: Editor


InfoQuestion -> Approver: Approver


InfoQuestion -> Issuer: Issuer


InfoQuestion -> DiagramObject: DiagramObjects


InfoQuestion -> InstanceSet: InstanceSet


InfoQuestion -> Name: Names


InfoQuestion -> ChangeSetMember: PropertiesCIMDataObject


InfoQuestion -> ChangeSetMember: TargetingCIMDataObject
