...
FormerReference -> RegisteredResource: RegisteredResource


FormerReference -> DiagramObject: DiagramObjects


FormerReference -> InstanceSet: InstanceSet


FormerReference -> Name: Names


FormerReference -> ChangeSetMember: PropertiesCIMDataObject


FormerReference -> ChangeSetMember: TargetingCIMDataObject
