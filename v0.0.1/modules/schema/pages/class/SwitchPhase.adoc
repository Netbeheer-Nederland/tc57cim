...
SwitchPhase -> Switch: Switch


SwitchPhase -> Control: Controls


SwitchPhase -> Measurement: Measurements


SwitchPhase -> PSRType: PSRType


SwitchPhase -> ConfigurationEvent: ConfigurationEvent


SwitchPhase -> ReportingGroup: ReportingGroup


SwitchPhase -> OperatingShare: OperatingShare


SwitchPhase -> AssetInfo: AssetDatasheet


SwitchPhase -> VerificationAction: VerificationAction


SwitchPhase -> ClearanceDocument: Clearances


SwitchPhase -> GenericAction: GenericAction


SwitchPhase -> PSREvent: PSREvents


SwitchPhase -> Asset: Assets


SwitchPhase -> Location: Location


SwitchPhase -> OperationalTag: OperationalTags


SwitchPhase -> DiagramObject: DiagramObjects


SwitchPhase -> InstanceSet: InstanceSet


SwitchPhase -> Name: Names


SwitchPhase -> ChangeSetMember: PropertiesCIMDataObject


SwitchPhase -> ChangeSetMember: TargetingCIMDataObject
