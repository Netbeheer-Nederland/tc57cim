...
ExcitationSystemUserDefined -> SynchronousMachineDynamics: SynchronousMachineDynamics


ExcitationSystemUserDefined -> PowerSystemStabilizerDynamics: PowerSystemStabilizerDynamics


ExcitationSystemUserDefined -> PFVArControllerType1Dynamics: PFVArControllerType1Dynamics


ExcitationSystemUserDefined -> OverexcitationLimiterDynamics: OverexcitationLimiterDynamics


ExcitationSystemUserDefined -> DiscontinuousExcitationControlDynamics: DiscontinuousExcitationControlDynamics


ExcitationSystemUserDefined -> PFVArControllerType2Dynamics: PFVArControllerType2Dynamics


ExcitationSystemUserDefined -> UnderexcitationLimiterDynamics: UnderexcitationLimiterDynamics


ExcitationSystemUserDefined -> VoltageCompensatorDynamics: VoltageCompensatorDynamics


ExcitationSystemUserDefined -> DiagramObject: DiagramObjects


ExcitationSystemUserDefined -> InstanceSet: InstanceSet


ExcitationSystemUserDefined -> Name: Names


ExcitationSystemUserDefined -> ChangeSetMember: PropertiesCIMDataObject


ExcitationSystemUserDefined -> ChangeSetMember: TargetingCIMDataObject
