...
Sensor -> Terminal: Terminal


Sensor -> WeatherStation: WeatherStation


Sensor -> OperationalLimitSet: OperationalLimitSet


Sensor -> ContingencyEquipment: ContingencyEquipment


Sensor -> EquipmentContainer: EquipmentContainer


Sensor -> Fault: Faults


Sensor -> LimitDependency: LimitDependencyModel


Sensor -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Sensor -> ProtectiveActionEquipment: ProtectiveActionEquipment


Sensor -> PinEquipment: PinEquipment


Sensor -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Sensor -> EquipmentContainer: AdditionalEquipmentContainer


Sensor -> UsagePoint: UsagePoints


Sensor -> Outage: Outages


Sensor -> OperationalRestriction: OperationalRestrictions


Sensor -> Control: Controls


Sensor -> Measurement: Measurements


Sensor -> PSRType: PSRType


Sensor -> ConfigurationEvent: ConfigurationEvent


Sensor -> ReportingGroup: ReportingGroup


Sensor -> OperatingShare: OperatingShare


Sensor -> AssetInfo: AssetDatasheet


Sensor -> VerificationAction: VerificationAction


Sensor -> ClearanceDocument: Clearances


Sensor -> GenericAction: GenericAction


Sensor -> PSREvent: PSREvents
...
Sensor -> OperationalTag: OperationalTags


Sensor -> DiagramObject: DiagramObjects


Sensor -> InstanceSet: InstanceSet


Sensor -> Name: Names


Sensor -> ChangeSetMember: PropertiesCIMDataObject


Sensor -> ChangeSetMember: TargetingCIMDataObject
