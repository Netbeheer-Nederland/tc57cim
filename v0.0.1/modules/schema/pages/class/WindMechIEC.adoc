...
WindMechIEC -> DiagramObject: DiagramObjects


WindMechIEC -> InstanceSet: InstanceSet


WindMechIEC -> Name: Names


WindMechIEC -> ChangeSetMember: PropertiesCIMDataObject


WindMechIEC -> ChangeSetMember: TargetingCIMDataObject
