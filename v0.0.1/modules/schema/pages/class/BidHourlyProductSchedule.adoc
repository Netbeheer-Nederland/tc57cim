...
BidHourlyProductSchedule -> ProductBid: ProductBid



BidHourlyProductSchedule -> RegularTimePoint: TimePoints


BidHourlyProductSchedule -> DiagramObject: DiagramObjects


BidHourlyProductSchedule -> InstanceSet: InstanceSet


BidHourlyProductSchedule -> Name: Names


BidHourlyProductSchedule -> ChangeSetMember: PropertiesCIMDataObject


BidHourlyProductSchedule -> ChangeSetMember: TargetingCIMDataObject
