...
DCChopper -> DCTerminal: DCTerminals


DCChopper -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


DCChopper -> WeatherStation: WeatherStation


DCChopper -> OperationalLimitSet: OperationalLimitSet


DCChopper -> ContingencyEquipment: ContingencyEquipment


DCChopper -> EquipmentContainer: EquipmentContainer


DCChopper -> Fault: Faults


DCChopper -> LimitDependency: LimitDependencyModel


DCChopper -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


DCChopper -> ProtectiveActionEquipment: ProtectiveActionEquipment


DCChopper -> PinEquipment: PinEquipment


DCChopper -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


DCChopper -> EquipmentContainer: AdditionalEquipmentContainer


DCChopper -> UsagePoint: UsagePoints


DCChopper -> Outage: Outages


DCChopper -> OperationalRestriction: OperationalRestrictions


DCChopper -> Control: Controls


DCChopper -> Measurement: Measurements


DCChopper -> PSRType: PSRType


DCChopper -> ConfigurationEvent: ConfigurationEvent


DCChopper -> ReportingGroup: ReportingGroup


DCChopper -> OperatingShare: OperatingShare


DCChopper -> AssetInfo: AssetDatasheet


DCChopper -> VerificationAction: VerificationAction


DCChopper -> ClearanceDocument: Clearances


DCChopper -> GenericAction: GenericAction


DCChopper -> PSREvent: PSREvents


DCChopper -> Asset: Assets


DCChopper -> Location: Location


DCChopper -> OperationalTag: OperationalTags


DCChopper -> DiagramObject: DiagramObjects


DCChopper -> InstanceSet: InstanceSet


DCChopper -> Name: Names


DCChopper -> ChangeSetMember: PropertiesCIMDataObject


DCChopper -> ChangeSetMember: TargetingCIMDataObject
