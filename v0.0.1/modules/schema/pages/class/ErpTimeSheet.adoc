...
ErpTimeSheet -> ErpTimeEntry: ErpTimeEntries


ErpTimeSheet -> Status: docStatus


ErpTimeSheet -> ElectronicAddress: electronicAddress


ErpTimeSheet -> Status: status


ErpTimeSheet -> ActivityRecord: ActivityRecord


ErpTimeSheet -> ConfigurationEvent: ConfigurationEvents


ErpTimeSheet -> Author: Author


ErpTimeSheet -> Editor: Editor


ErpTimeSheet -> Approver: Approver


ErpTimeSheet -> Issuer: Issuer


ErpTimeSheet -> DiagramObject: DiagramObjects


ErpTimeSheet -> InstanceSet: InstanceSet


ErpTimeSheet -> Name: Names


ErpTimeSheet -> ChangeSetMember: PropertiesCIMDataObject


ErpTimeSheet -> ChangeSetMember: TargetingCIMDataObject
