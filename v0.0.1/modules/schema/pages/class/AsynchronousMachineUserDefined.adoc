...
AsynchronousMachineUserDefined -> AsynchronousMachine: AsynchronousMachine


AsynchronousMachineUserDefined -> TurbineGovernorDynamics: TurbineGovernorDynamics


AsynchronousMachineUserDefined -> MechanicalLoadDynamics: MechanicalLoadDynamics


AsynchronousMachineUserDefined -> WindTurbineType1or2Dynamics: WindTurbineType1or2Dynamics





AsynchronousMachineUserDefined -> DiagramObject: DiagramObjects


AsynchronousMachineUserDefined -> InstanceSet: InstanceSet


AsynchronousMachineUserDefined -> Name: Names


AsynchronousMachineUserDefined -> ChangeSetMember: PropertiesCIMDataObject


AsynchronousMachineUserDefined -> ChangeSetMember: TargetingCIMDataObject
