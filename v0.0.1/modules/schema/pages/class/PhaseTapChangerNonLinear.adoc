...
PhaseTapChangerNonLinear -> TransformerEnd: TransformerEnd





PhaseTapChangerNonLinear -> TapChangerControl: TapChangerControl


PhaseTapChangerNonLinear -> SvTapStep: SvTapStep


PhaseTapChangerNonLinear -> TapSchedule: TapSchedules


PhaseTapChangerNonLinear -> Control: Controls


PhaseTapChangerNonLinear -> Measurement: Measurements


PhaseTapChangerNonLinear -> PSRType: PSRType


PhaseTapChangerNonLinear -> ConfigurationEvent: ConfigurationEvent


PhaseTapChangerNonLinear -> ReportingGroup: ReportingGroup


PhaseTapChangerNonLinear -> OperatingShare: OperatingShare


PhaseTapChangerNonLinear -> AssetInfo: AssetDatasheet


PhaseTapChangerNonLinear -> VerificationAction: VerificationAction


PhaseTapChangerNonLinear -> ClearanceDocument: Clearances


PhaseTapChangerNonLinear -> GenericAction: GenericAction


PhaseTapChangerNonLinear -> PSREvent: PSREvents


PhaseTapChangerNonLinear -> Asset: Assets


PhaseTapChangerNonLinear -> Location: Location


PhaseTapChangerNonLinear -> OperationalTag: OperationalTags


PhaseTapChangerNonLinear -> DiagramObject: DiagramObjects


PhaseTapChangerNonLinear -> InstanceSet: InstanceSet


PhaseTapChangerNonLinear -> Name: Names


PhaseTapChangerNonLinear -> ChangeSetMember: PropertiesCIMDataObject


PhaseTapChangerNonLinear -> ChangeSetMember: TargetingCIMDataObject
