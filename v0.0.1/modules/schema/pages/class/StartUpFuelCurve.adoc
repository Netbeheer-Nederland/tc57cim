...
StartUpFuelCurve -> RegisteredGenerator: RegisteredGenerator


StartUpFuelCurve -> CurveData: CurveDatas


StartUpFuelCurve -> DiagramObject: DiagramObjects


StartUpFuelCurve -> InstanceSet: InstanceSet


StartUpFuelCurve -> Name: Names


StartUpFuelCurve -> ChangeSetMember: PropertiesCIMDataObject


StartUpFuelCurve -> ChangeSetMember: TargetingCIMDataObject
