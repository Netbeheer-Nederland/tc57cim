...
DCTopologicalNode -> DiagramObject: DiagramObjects


DCTopologicalNode -> InstanceSet: InstanceSet


DCTopologicalNode -> Name: Names


DCTopologicalNode -> ChangeSetMember: PropertiesCIMDataObject


DCTopologicalNode -> ChangeSetMember: TargetingCIMDataObject
