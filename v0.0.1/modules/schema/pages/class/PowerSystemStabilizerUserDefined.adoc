...
PowerSystemStabilizerUserDefined -> ExcitationSystemDynamics: ExcitationSystemDynamics


PowerSystemStabilizerUserDefined -> RemoteInputSignal: RemoteInputSignal


PowerSystemStabilizerUserDefined -> DiagramObject: DiagramObjects


PowerSystemStabilizerUserDefined -> InstanceSet: InstanceSet


PowerSystemStabilizerUserDefined -> Name: Names


PowerSystemStabilizerUserDefined -> ChangeSetMember: PropertiesCIMDataObject


PowerSystemStabilizerUserDefined -> ChangeSetMember: TargetingCIMDataObject
