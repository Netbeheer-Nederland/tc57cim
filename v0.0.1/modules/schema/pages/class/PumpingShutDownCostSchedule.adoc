...
PumpingShutDownCostSchedule -> ProductBid: ProductBid



PumpingShutDownCostSchedule -> RegularTimePoint: TimePoints


PumpingShutDownCostSchedule -> DiagramObject: DiagramObjects


PumpingShutDownCostSchedule -> InstanceSet: InstanceSet


PumpingShutDownCostSchedule -> Name: Names


PumpingShutDownCostSchedule -> ChangeSetMember: PropertiesCIMDataObject


PumpingShutDownCostSchedule -> ChangeSetMember: TargetingCIMDataObject
