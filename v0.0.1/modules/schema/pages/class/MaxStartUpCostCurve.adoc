...
MaxStartUpCostCurve -> CurveData: CurveDatas


MaxStartUpCostCurve -> DiagramObject: DiagramObjects


MaxStartUpCostCurve -> InstanceSet: InstanceSet


MaxStartUpCostCurve -> Name: Names


MaxStartUpCostCurve -> ChangeSetMember: PropertiesCIMDataObject


MaxStartUpCostCurve -> ChangeSetMember: TargetingCIMDataObject
