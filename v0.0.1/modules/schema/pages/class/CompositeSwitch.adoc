...
CompositeSwitch -> Switch: Switches


CompositeSwitch -> WeatherStation: WeatherStation


CompositeSwitch -> OperationalLimitSet: OperationalLimitSet


CompositeSwitch -> ContingencyEquipment: ContingencyEquipment


CompositeSwitch -> EquipmentContainer: EquipmentContainer


CompositeSwitch -> Fault: Faults


CompositeSwitch -> LimitDependency: LimitDependencyModel


CompositeSwitch -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


CompositeSwitch -> ProtectiveActionEquipment: ProtectiveActionEquipment


CompositeSwitch -> PinEquipment: PinEquipment


CompositeSwitch -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


CompositeSwitch -> EquipmentContainer: AdditionalEquipmentContainer


CompositeSwitch -> UsagePoint: UsagePoints


CompositeSwitch -> Outage: Outages


CompositeSwitch -> OperationalRestriction: OperationalRestrictions


CompositeSwitch -> Control: Controls


CompositeSwitch -> Measurement: Measurements


CompositeSwitch -> PSRType: PSRType


CompositeSwitch -> ConfigurationEvent: ConfigurationEvent


CompositeSwitch -> ReportingGroup: ReportingGroup


CompositeSwitch -> OperatingShare: OperatingShare


CompositeSwitch -> AssetInfo: AssetDatasheet


CompositeSwitch -> VerificationAction: VerificationAction


CompositeSwitch -> ClearanceDocument: Clearances


CompositeSwitch -> GenericAction: GenericAction


CompositeSwitch -> PSREvent: PSREvents


CompositeSwitch -> Asset: Assets


CompositeSwitch -> Location: Location


CompositeSwitch -> OperationalTag: OperationalTags


CompositeSwitch -> DiagramObject: DiagramObjects


CompositeSwitch -> InstanceSet: InstanceSet


CompositeSwitch -> Name: Names


CompositeSwitch -> ChangeSetMember: PropertiesCIMDataObject


CompositeSwitch -> ChangeSetMember: TargetingCIMDataObject
