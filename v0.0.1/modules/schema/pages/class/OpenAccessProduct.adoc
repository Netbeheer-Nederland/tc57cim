...
OpenAccessProduct -> DateTimeInterval: validityInterval


OpenAccessProduct -> Status: docStatus


OpenAccessProduct -> ElectronicAddress: electronicAddress


OpenAccessProduct -> Status: status


OpenAccessProduct -> ActivityRecord: ActivityRecord


OpenAccessProduct -> ConfigurationEvent: ConfigurationEvents


OpenAccessProduct -> Author: Author


OpenAccessProduct -> Editor: Editor


OpenAccessProduct -> Approver: Approver


OpenAccessProduct -> Issuer: Issuer


OpenAccessProduct -> DiagramObject: DiagramObjects


OpenAccessProduct -> InstanceSet: InstanceSet


OpenAccessProduct -> Name: Names


OpenAccessProduct -> ChangeSetMember: PropertiesCIMDataObject


OpenAccessProduct -> ChangeSetMember: TargetingCIMDataObject
