...
CoordinateSystem -> DiagramObject: DiagramObjects


CoordinateSystem -> InstanceSet: InstanceSet


CoordinateSystem -> Name: Names


CoordinateSystem -> ChangeSetMember: PropertiesCIMDataObject


CoordinateSystem -> ChangeSetMember: TargetingCIMDataObject
