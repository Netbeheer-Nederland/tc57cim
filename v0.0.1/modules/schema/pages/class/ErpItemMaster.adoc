...
ErpItemMaster -> Status: status


ErpItemMaster -> Asset: Asset


ErpItemMaster -> DiagramObject: DiagramObjects


ErpItemMaster -> InstanceSet: InstanceSet


ErpItemMaster -> Name: Names


ErpItemMaster -> ChangeSetMember: PropertiesCIMDataObject


ErpItemMaster -> ChangeSetMember: TargetingCIMDataObject
