...
ContingencyEquipment -> DiagramObject: DiagramObjects


ContingencyEquipment -> InstanceSet: InstanceSet


ContingencyEquipment -> Name: Names


ContingencyEquipment -> ChangeSetMember: PropertiesCIMDataObject


ContingencyEquipment -> ChangeSetMember: TargetingCIMDataObject
