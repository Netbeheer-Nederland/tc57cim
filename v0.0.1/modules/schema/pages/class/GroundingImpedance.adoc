...
GroundingImpedance -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


GroundingImpedance -> SvStatus: SvStatus


GroundingImpedance -> ProtectionEquipment: ProtectionEquipments
...
GroundingImpedance -> JumperAction: JumpingAction


GroundingImpedance -> GroundAction: GroundingAction


GroundingImpedance -> Outage: Outage


GroundingImpedance -> WeatherStation: WeatherStation


GroundingImpedance -> OperationalLimitSet: OperationalLimitSet


GroundingImpedance -> ContingencyEquipment: ContingencyEquipment


GroundingImpedance -> EquipmentContainer: EquipmentContainer


GroundingImpedance -> Fault: Faults


GroundingImpedance -> LimitDependency: LimitDependencyModel


GroundingImpedance -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


GroundingImpedance -> ProtectiveActionEquipment: ProtectiveActionEquipment


GroundingImpedance -> PinEquipment: PinEquipment


GroundingImpedance -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


GroundingImpedance -> EquipmentContainer: AdditionalEquipmentContainer


GroundingImpedance -> UsagePoint: UsagePoints


GroundingImpedance -> Outage: Outages


GroundingImpedance -> OperationalRestriction: OperationalRestrictions


GroundingImpedance -> Control: Controls


GroundingImpedance -> Measurement: Measurements


GroundingImpedance -> PSRType: PSRType


GroundingImpedance -> ConfigurationEvent: ConfigurationEvent


GroundingImpedance -> ReportingGroup: ReportingGroup


GroundingImpedance -> OperatingShare: OperatingShare


GroundingImpedance -> AssetInfo: AssetDatasheet


GroundingImpedance -> VerificationAction: VerificationAction


GroundingImpedance -> ClearanceDocument: Clearances


GroundingImpedance -> GenericAction: GenericAction


GroundingImpedance -> PSREvent: PSREvents


GroundingImpedance -> Asset: Assets


GroundingImpedance -> Location: Location


GroundingImpedance -> OperationalTag: OperationalTags


GroundingImpedance -> DiagramObject: DiagramObjects


GroundingImpedance -> InstanceSet: InstanceSet


GroundingImpedance -> Name: Names


GroundingImpedance -> ChangeSetMember: PropertiesCIMDataObject


GroundingImpedance -> ChangeSetMember: TargetingCIMDataObject
