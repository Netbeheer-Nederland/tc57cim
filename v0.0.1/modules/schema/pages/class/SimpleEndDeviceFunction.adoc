...
SimpleEndDeviceFunction -> EndDevice: EndDevice


SimpleEndDeviceFunction -> Register: Registers


SimpleEndDeviceFunction -> Asset: Asset


SimpleEndDeviceFunction -> DiagramObject: DiagramObjects


SimpleEndDeviceFunction -> InstanceSet: InstanceSet


SimpleEndDeviceFunction -> Name: Names


SimpleEndDeviceFunction -> ChangeSetMember: PropertiesCIMDataObject


SimpleEndDeviceFunction -> ChangeSetMember: TargetingCIMDataObject
