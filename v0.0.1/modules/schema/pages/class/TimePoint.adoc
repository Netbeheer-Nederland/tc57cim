...
TimePoint -> Status: status


TimePoint -> DateTimeInterval: window


TimePoint -> TimeSchedule: TimeSchedule


TimePoint -> DiagramObject: DiagramObjects


TimePoint -> InstanceSet: InstanceSet


TimePoint -> Name: Names


TimePoint -> ChangeSetMember: PropertiesCIMDataObject


TimePoint -> ChangeSetMember: TargetingCIMDataObject
