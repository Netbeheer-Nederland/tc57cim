...
SurgeArrester -> Terminal: Terminal


SurgeArrester -> WeatherStation: WeatherStation


SurgeArrester -> OperationalLimitSet: OperationalLimitSet


SurgeArrester -> ContingencyEquipment: ContingencyEquipment


SurgeArrester -> EquipmentContainer: EquipmentContainer


SurgeArrester -> Fault: Faults


SurgeArrester -> LimitDependency: LimitDependencyModel


SurgeArrester -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


SurgeArrester -> ProtectiveActionEquipment: ProtectiveActionEquipment


SurgeArrester -> PinEquipment: PinEquipment


SurgeArrester -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


SurgeArrester -> EquipmentContainer: AdditionalEquipmentContainer


SurgeArrester -> UsagePoint: UsagePoints


SurgeArrester -> Outage: Outages


SurgeArrester -> OperationalRestriction: OperationalRestrictions


SurgeArrester -> Control: Controls


SurgeArrester -> Measurement: Measurements


SurgeArrester -> PSRType: PSRType


SurgeArrester -> ConfigurationEvent: ConfigurationEvent


SurgeArrester -> ReportingGroup: ReportingGroup


SurgeArrester -> OperatingShare: OperatingShare


SurgeArrester -> AssetInfo: AssetDatasheet


SurgeArrester -> VerificationAction: VerificationAction


SurgeArrester -> ClearanceDocument: Clearances


SurgeArrester -> GenericAction: GenericAction


SurgeArrester -> PSREvent: PSREvents


SurgeArrester -> Asset: Assets


SurgeArrester -> Location: Location


SurgeArrester -> OperationalTag: OperationalTags


SurgeArrester -> DiagramObject: DiagramObjects


SurgeArrester -> InstanceSet: InstanceSet


SurgeArrester -> Name: Names


SurgeArrester -> ChangeSetMember: PropertiesCIMDataObject


SurgeArrester -> ChangeSetMember: TargetingCIMDataObject
