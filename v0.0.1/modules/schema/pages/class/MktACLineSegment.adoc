...
MktACLineSegment -> BranchEndFlow: EndBFlow


MktACLineSegment -> BranchEndFlow: EndAFlow
...
MktACLineSegment -> Clamp: Clamp


MktACLineSegment -> WireSpacingInfo: WireSpacingInfo


MktACLineSegment -> PerLengthImpedance: PerLengthImpedance


MktACLineSegment -> Cut: Cut


MktACLineSegment -> LineFault: LineFaults


MktACLineSegment -> ACLineSegmentPhase: ACLineSegmentPhases


MktACLineSegment -> GroundAction: LineGroundingAction


MktACLineSegment -> JumperAction: LineJumpingAction



MktACLineSegment -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


MktACLineSegment -> SvStatus: SvStatus


MktACLineSegment -> ProtectionEquipment: ProtectionEquipments


MktACLineSegment -> BaseVoltage: BaseVoltage


MktACLineSegment -> Terminal: Terminals


MktACLineSegment -> JumperAction: JumpingAction


MktACLineSegment -> GroundAction: GroundingAction


MktACLineSegment -> Outage: Outage


MktACLineSegment -> WeatherStation: WeatherStation


MktACLineSegment -> OperationalLimitSet: OperationalLimitSet


MktACLineSegment -> ContingencyEquipment: ContingencyEquipment


MktACLineSegment -> EquipmentContainer: EquipmentContainer


MktACLineSegment -> Fault: Faults


MktACLineSegment -> LimitDependency: LimitDependencyModel


MktACLineSegment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


MktACLineSegment -> ProtectiveActionEquipment: ProtectiveActionEquipment


MktACLineSegment -> PinEquipment: PinEquipment


MktACLineSegment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


MktACLineSegment -> EquipmentContainer: AdditionalEquipmentContainer


MktACLineSegment -> UsagePoint: UsagePoints


MktACLineSegment -> Outage: Outages


MktACLineSegment -> OperationalRestriction: OperationalRestrictions


MktACLineSegment -> Control: Controls


MktACLineSegment -> Measurement: Measurements


MktACLineSegment -> PSRType: PSRType


MktACLineSegment -> ConfigurationEvent: ConfigurationEvent


MktACLineSegment -> ReportingGroup: ReportingGroup


MktACLineSegment -> OperatingShare: OperatingShare


MktACLineSegment -> AssetInfo: AssetDatasheet


MktACLineSegment -> VerificationAction: VerificationAction


MktACLineSegment -> ClearanceDocument: Clearances


MktACLineSegment -> GenericAction: GenericAction


MktACLineSegment -> PSREvent: PSREvents


MktACLineSegment -> Asset: Assets


MktACLineSegment -> Location: Location


MktACLineSegment -> OperationalTag: OperationalTags


MktACLineSegment -> DiagramObject: DiagramObjects


MktACLineSegment -> InstanceSet: InstanceSet


MktACLineSegment -> Name: Names


MktACLineSegment -> ChangeSetMember: PropertiesCIMDataObject


MktACLineSegment -> ChangeSetMember: TargetingCIMDataObject
