...
HydroGeneratingUnit -> TailbayLossCurve: TailbayLossCurve


HydroGeneratingUnit -> HydroPowerPlant: HydroPowerPlant


HydroGeneratingUnit -> HydroGeneratingEfficiencyCurve: HydroGeneratingEfficiencyCurves


HydroGeneratingUnit -> PenstockLossCurve: PenstockLossCurve
...
HydroGeneratingUnit -> RotatingMachine: RotatingMachine


HydroGeneratingUnit -> GenUnitOpSchedule: GenUnitOpSchedule


HydroGeneratingUnit -> ControlAreaGeneratingUnit: ControlAreaGeneratingUnit


HydroGeneratingUnit -> GrossToNetActivePowerCurve: GrossToNetActivePowerCurves


HydroGeneratingUnit -> GenUnitOpCostCurve: GenUnitOpCostCurves


HydroGeneratingUnit -> WeatherStation: WeatherStation


HydroGeneratingUnit -> OperationalLimitSet: OperationalLimitSet


HydroGeneratingUnit -> ContingencyEquipment: ContingencyEquipment


HydroGeneratingUnit -> EquipmentContainer: EquipmentContainer


HydroGeneratingUnit -> Fault: Faults


HydroGeneratingUnit -> LimitDependency: LimitDependencyModel


HydroGeneratingUnit -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


HydroGeneratingUnit -> ProtectiveActionEquipment: ProtectiveActionEquipment


HydroGeneratingUnit -> PinEquipment: PinEquipment


HydroGeneratingUnit -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


HydroGeneratingUnit -> EquipmentContainer: AdditionalEquipmentContainer


HydroGeneratingUnit -> UsagePoint: UsagePoints


HydroGeneratingUnit -> Outage: Outages


HydroGeneratingUnit -> OperationalRestriction: OperationalRestrictions


HydroGeneratingUnit -> Control: Controls


HydroGeneratingUnit -> Measurement: Measurements


HydroGeneratingUnit -> PSRType: PSRType


HydroGeneratingUnit -> ConfigurationEvent: ConfigurationEvent


HydroGeneratingUnit -> ReportingGroup: ReportingGroup


HydroGeneratingUnit -> OperatingShare: OperatingShare


HydroGeneratingUnit -> AssetInfo: AssetDatasheet


HydroGeneratingUnit -> VerificationAction: VerificationAction


HydroGeneratingUnit -> ClearanceDocument: Clearances


HydroGeneratingUnit -> GenericAction: GenericAction


HydroGeneratingUnit -> PSREvent: PSREvents


HydroGeneratingUnit -> Asset: Assets


HydroGeneratingUnit -> Location: Location


HydroGeneratingUnit -> OperationalTag: OperationalTags


HydroGeneratingUnit -> DiagramObject: DiagramObjects


HydroGeneratingUnit -> InstanceSet: InstanceSet


HydroGeneratingUnit -> Name: Names


HydroGeneratingUnit -> ChangeSetMember: PropertiesCIMDataObject


HydroGeneratingUnit -> ChangeSetMember: TargetingCIMDataObject
