...
LoadBreakSwitch -> ProtectionEquipment: OperatedByProtectionEquipment


LoadBreakSwitch -> RecloseSequence: RecloseSequences



LoadBreakSwitch -> SwitchPhase: SwitchPhase


LoadBreakSwitch -> SwitchSchedule: SwitchSchedules


LoadBreakSwitch -> CompositeSwitch: CompositeSwitch


LoadBreakSwitch -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


LoadBreakSwitch -> SvSwitch: SvSwitch


LoadBreakSwitch -> ConnectDisconnectFunction: ConnectDisconnectFunctions


LoadBreakSwitch -> SwitchAction: SwitchAction


LoadBreakSwitch -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


LoadBreakSwitch -> SvStatus: SvStatus


LoadBreakSwitch -> ProtectionEquipment: ProtectionEquipments
...
LoadBreakSwitch -> JumperAction: JumpingAction


LoadBreakSwitch -> GroundAction: GroundingAction


LoadBreakSwitch -> Outage: Outage


LoadBreakSwitch -> WeatherStation: WeatherStation


LoadBreakSwitch -> OperationalLimitSet: OperationalLimitSet


LoadBreakSwitch -> ContingencyEquipment: ContingencyEquipment


LoadBreakSwitch -> EquipmentContainer: EquipmentContainer


LoadBreakSwitch -> Fault: Faults


LoadBreakSwitch -> LimitDependency: LimitDependencyModel


LoadBreakSwitch -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


LoadBreakSwitch -> ProtectiveActionEquipment: ProtectiveActionEquipment


LoadBreakSwitch -> PinEquipment: PinEquipment


LoadBreakSwitch -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


LoadBreakSwitch -> EquipmentContainer: AdditionalEquipmentContainer


LoadBreakSwitch -> UsagePoint: UsagePoints


LoadBreakSwitch -> Outage: Outages


LoadBreakSwitch -> OperationalRestriction: OperationalRestrictions


LoadBreakSwitch -> Control: Controls


LoadBreakSwitch -> Measurement: Measurements


LoadBreakSwitch -> PSRType: PSRType


LoadBreakSwitch -> ConfigurationEvent: ConfigurationEvent


LoadBreakSwitch -> ReportingGroup: ReportingGroup


LoadBreakSwitch -> OperatingShare: OperatingShare


LoadBreakSwitch -> AssetInfo: AssetDatasheet


LoadBreakSwitch -> VerificationAction: VerificationAction


LoadBreakSwitch -> ClearanceDocument: Clearances


LoadBreakSwitch -> GenericAction: GenericAction


LoadBreakSwitch -> PSREvent: PSREvents


LoadBreakSwitch -> Asset: Assets


LoadBreakSwitch -> Location: Location


LoadBreakSwitch -> OperationalTag: OperationalTags


LoadBreakSwitch -> DiagramObject: DiagramObjects


LoadBreakSwitch -> InstanceSet: InstanceSet


LoadBreakSwitch -> Name: Names


LoadBreakSwitch -> ChangeSetMember: PropertiesCIMDataObject


LoadBreakSwitch -> ChangeSetMember: TargetingCIMDataObject
