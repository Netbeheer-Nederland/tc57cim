...
ErpBOM -> Design: Design


ErpBOM -> ErpBomItemData: ErpBomItemDatas


ErpBOM -> Status: docStatus


ErpBOM -> ElectronicAddress: electronicAddress


ErpBOM -> Status: status


ErpBOM -> ActivityRecord: ActivityRecord


ErpBOM -> ConfigurationEvent: ConfigurationEvents


ErpBOM -> Author: Author


ErpBOM -> Editor: Editor


ErpBOM -> Approver: Approver


ErpBOM -> Issuer: Issuer


ErpBOM -> DiagramObject: DiagramObjects


ErpBOM -> InstanceSet: InstanceSet


ErpBOM -> Name: Names


ErpBOM -> ChangeSetMember: PropertiesCIMDataObject


ErpBOM -> ChangeSetMember: TargetingCIMDataObject
