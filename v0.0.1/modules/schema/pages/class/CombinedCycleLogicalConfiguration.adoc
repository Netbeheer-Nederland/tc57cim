...
CombinedCycleLogicalConfiguration -> CombinedCycleConfiguration: CombinedCycleConfiguration


CombinedCycleLogicalConfiguration -> MktCombinedCyclePlant: MktCombinedCyclePlant


CombinedCycleLogicalConfiguration -> DiagramObject: DiagramObjects


CombinedCycleLogicalConfiguration -> InstanceSet: InstanceSet


CombinedCycleLogicalConfiguration -> Name: Names


CombinedCycleLogicalConfiguration -> ChangeSetMember: PropertiesCIMDataObject


CombinedCycleLogicalConfiguration -> ChangeSetMember: TargetingCIMDataObject
