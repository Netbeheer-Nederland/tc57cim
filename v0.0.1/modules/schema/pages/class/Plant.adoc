...
Plant -> Equipment: Equipments


Plant -> Equipment: AdditionalGroupedEquipment


Plant -> TopologicalNode: TopologicalNode


Plant -> ConnectivityNode: ConnectivityNodes


Plant -> Control: Controls


Plant -> Measurement: Measurements


Plant -> PSRType: PSRType


Plant -> ConfigurationEvent: ConfigurationEvent


Plant -> ReportingGroup: ReportingGroup


Plant -> OperatingShare: OperatingShare


Plant -> AssetInfo: AssetDatasheet


Plant -> VerificationAction: VerificationAction


Plant -> ClearanceDocument: Clearances


Plant -> GenericAction: GenericAction


Plant -> PSREvent: PSREvents
...
Plant -> OperationalTag: OperationalTags


Plant -> DiagramObject: DiagramObjects


Plant -> InstanceSet: InstanceSet


Plant -> Name: Names


Plant -> ChangeSetMember: PropertiesCIMDataObject


Plant -> ChangeSetMember: TargetingCIMDataObject
