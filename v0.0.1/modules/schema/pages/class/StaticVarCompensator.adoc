...
StaticVarCompensator -> StaticVarCompensatorDynamics: StaticVarCompensatorDynamics


StaticVarCompensator -> RegulatingControl: RegulatingControl


StaticVarCompensator -> EnergyComponent: EnergyComponent


StaticVarCompensator -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


StaticVarCompensator -> SvStatus: SvStatus


StaticVarCompensator -> ProtectionEquipment: ProtectionEquipments


StaticVarCompensator -> BaseVoltage: BaseVoltage


StaticVarCompensator -> Terminal: Terminals


StaticVarCompensator -> JumperAction: JumpingAction


StaticVarCompensator -> GroundAction: GroundingAction


StaticVarCompensator -> Outage: Outage


StaticVarCompensator -> WeatherStation: WeatherStation


StaticVarCompensator -> OperationalLimitSet: OperationalLimitSet


StaticVarCompensator -> ContingencyEquipment: ContingencyEquipment


StaticVarCompensator -> EquipmentContainer: EquipmentContainer


StaticVarCompensator -> Fault: Faults


StaticVarCompensator -> LimitDependency: LimitDependencyModel


StaticVarCompensator -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


StaticVarCompensator -> ProtectiveActionEquipment: ProtectiveActionEquipment


StaticVarCompensator -> PinEquipment: PinEquipment


StaticVarCompensator -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


StaticVarCompensator -> EquipmentContainer: AdditionalEquipmentContainer


StaticVarCompensator -> UsagePoint: UsagePoints


StaticVarCompensator -> Outage: Outages


StaticVarCompensator -> OperationalRestriction: OperationalRestrictions


StaticVarCompensator -> Control: Controls


StaticVarCompensator -> Measurement: Measurements


StaticVarCompensator -> PSRType: PSRType


StaticVarCompensator -> ConfigurationEvent: ConfigurationEvent


StaticVarCompensator -> ReportingGroup: ReportingGroup


StaticVarCompensator -> OperatingShare: OperatingShare


StaticVarCompensator -> AssetInfo: AssetDatasheet


StaticVarCompensator -> VerificationAction: VerificationAction


StaticVarCompensator -> ClearanceDocument: Clearances


StaticVarCompensator -> GenericAction: GenericAction


StaticVarCompensator -> PSREvent: PSREvents


StaticVarCompensator -> Asset: Assets


StaticVarCompensator -> Location: Location


StaticVarCompensator -> OperationalTag: OperationalTags


StaticVarCompensator -> DiagramObject: DiagramObjects


StaticVarCompensator -> InstanceSet: InstanceSet


StaticVarCompensator -> Name: Names


StaticVarCompensator -> ChangeSetMember: PropertiesCIMDataObject


StaticVarCompensator -> ChangeSetMember: TargetingCIMDataObject
