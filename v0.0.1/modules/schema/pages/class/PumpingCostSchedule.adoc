...
PumpingCostSchedule -> ProductBid: ProductBid



PumpingCostSchedule -> RegularTimePoint: TimePoints


PumpingCostSchedule -> DiagramObject: DiagramObjects


PumpingCostSchedule -> InstanceSet: InstanceSet


PumpingCostSchedule -> Name: Names


PumpingCostSchedule -> ChangeSetMember: PropertiesCIMDataObject


PumpingCostSchedule -> ChangeSetMember: TargetingCIMDataObject
