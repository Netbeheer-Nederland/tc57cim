...
RecloseSequence -> ProtectedSwitch: ProtectedSwitch


RecloseSequence -> DiagramObject: DiagramObjects


RecloseSequence -> InstanceSet: InstanceSet


RecloseSequence -> Name: Names


RecloseSequence -> ChangeSetMember: PropertiesCIMDataObject


RecloseSequence -> ChangeSetMember: TargetingCIMDataObject
