...
MktTapChanger -> TapChangerDynamicData: TapChangerDynamicData





MktTapChanger -> TapChangerControl: TapChangerControl


MktTapChanger -> SvTapStep: SvTapStep


MktTapChanger -> TapSchedule: TapSchedules


MktTapChanger -> Control: Controls


MktTapChanger -> Measurement: Measurements


MktTapChanger -> PSRType: PSRType


MktTapChanger -> ConfigurationEvent: ConfigurationEvent


MktTapChanger -> ReportingGroup: ReportingGroup


MktTapChanger -> OperatingShare: OperatingShare


MktTapChanger -> AssetInfo: AssetDatasheet


MktTapChanger -> VerificationAction: VerificationAction


MktTapChanger -> ClearanceDocument: Clearances


MktTapChanger -> GenericAction: GenericAction


MktTapChanger -> PSREvent: PSREvents


MktTapChanger -> Asset: Assets


MktTapChanger -> Location: Location


MktTapChanger -> OperationalTag: OperationalTags


MktTapChanger -> DiagramObject: DiagramObjects


MktTapChanger -> InstanceSet: InstanceSet


MktTapChanger -> Name: Names


MktTapChanger -> ChangeSetMember: PropertiesCIMDataObject


MktTapChanger -> ChangeSetMember: TargetingCIMDataObject
