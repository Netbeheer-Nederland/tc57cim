...
DCEquipmentContainer -> Equipment: Equipments


DCEquipmentContainer -> Equipment: AdditionalGroupedEquipment


DCEquipmentContainer -> TopologicalNode: TopologicalNode


DCEquipmentContainer -> ConnectivityNode: ConnectivityNodes


DCEquipmentContainer -> Control: Controls


DCEquipmentContainer -> Measurement: Measurements


DCEquipmentContainer -> PSRType: PSRType


DCEquipmentContainer -> ConfigurationEvent: ConfigurationEvent


DCEquipmentContainer -> ReportingGroup: ReportingGroup


DCEquipmentContainer -> OperatingShare: OperatingShare


DCEquipmentContainer -> AssetInfo: AssetDatasheet


DCEquipmentContainer -> VerificationAction: VerificationAction


DCEquipmentContainer -> ClearanceDocument: Clearances


DCEquipmentContainer -> GenericAction: GenericAction


DCEquipmentContainer -> PSREvent: PSREvents


DCEquipmentContainer -> Asset: Assets


DCEquipmentContainer -> Location: Location


DCEquipmentContainer -> OperationalTag: OperationalTags


DCEquipmentContainer -> DiagramObject: DiagramObjects


DCEquipmentContainer -> InstanceSet: InstanceSet


DCEquipmentContainer -> Name: Names


DCEquipmentContainer -> ChangeSetMember: PropertiesCIMDataObject


DCEquipmentContainer -> ChangeSetMember: TargetingCIMDataObject
