...
BaseCaseConstraintLimit -> SecurityConstraintSum: SecurityConstraintSum


BaseCaseConstraintLimit -> CurveData: CurveDatas


BaseCaseConstraintLimit -> DiagramObject: DiagramObjects


BaseCaseConstraintLimit -> InstanceSet: InstanceSet


BaseCaseConstraintLimit -> Name: Names


BaseCaseConstraintLimit -> ChangeSetMember: PropertiesCIMDataObject


BaseCaseConstraintLimit -> ChangeSetMember: TargetingCIMDataObject
