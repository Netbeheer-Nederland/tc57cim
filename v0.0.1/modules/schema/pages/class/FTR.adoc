...
FTR -> EnergyPriceCurve: EnergyPriceCurve


FTR -> Flowgate: Flowgate


FTR -> DateTimeInterval: validityInterval


FTR -> Status: docStatus


FTR -> ElectronicAddress: electronicAddress


FTR -> Status: status


FTR -> ActivityRecord: ActivityRecord


FTR -> ConfigurationEvent: ConfigurationEvents
...
FTR -> Approver: Approver


FTR -> Issuer: Issuer


FTR -> DiagramObject: DiagramObjects


FTR -> InstanceSet: InstanceSet


FTR -> Name: Names


FTR -> ChangeSetMember: PropertiesCIMDataObject


FTR -> ChangeSetMember: TargetingCIMDataObject
