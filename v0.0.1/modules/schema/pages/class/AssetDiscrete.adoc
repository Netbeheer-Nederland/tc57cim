...
AssetDiscrete -> TestStandard: TestStandard


AssetDiscrete -> DiscreteValue: DiscreteValues


AssetDiscrete -> ValueAliasSet: ValueAliasSet


AssetDiscrete -> ACDCTerminal: Terminal


AssetDiscrete -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


AssetDiscrete -> CalculationMethodHierarchy: CalculationMethodHierarchy


AssetDiscrete -> PowerSystemResource: PowerSystemResource


AssetDiscrete -> PinMeasurement: PinMeasurement


AssetDiscrete -> MeasurementCalculatorInput: MeasurementCalculatorInput


AssetDiscrete -> Asset: Asset


AssetDiscrete -> MeasurementAction: MeasurementAction


AssetDiscrete -> Location: Locations


AssetDiscrete -> Procedure: Procedures


AssetDiscrete -> DiagramObject: DiagramObjects


AssetDiscrete -> InstanceSet: InstanceSet


AssetDiscrete -> Name: Names


AssetDiscrete -> ChangeSetMember: PropertiesCIMDataObject


AssetDiscrete -> ChangeSetMember: TargetingCIMDataObject
