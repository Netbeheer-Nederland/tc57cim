...
LoadGenericNonLinear -> EnergyConsumer: EnergyConsumer


LoadGenericNonLinear -> DiagramObject: DiagramObjects


LoadGenericNonLinear -> InstanceSet: InstanceSet


LoadGenericNonLinear -> Name: Names


LoadGenericNonLinear -> ChangeSetMember: PropertiesCIMDataObject


LoadGenericNonLinear -> ChangeSetMember: TargetingCIMDataObject
