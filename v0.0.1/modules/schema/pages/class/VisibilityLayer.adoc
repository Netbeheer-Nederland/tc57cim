...
VisibilityLayer -> DiagramObject: DiagramObjects


VisibilityLayer -> InstanceSet: InstanceSet


VisibilityLayer -> Name: Names


VisibilityLayer -> ChangeSetMember: PropertiesCIMDataObject


VisibilityLayer -> ChangeSetMember: TargetingCIMDataObject
