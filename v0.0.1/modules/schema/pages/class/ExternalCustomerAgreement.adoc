...
ExternalCustomerAgreement -> DateTimeInterval: validityInterval


ExternalCustomerAgreement -> Status: docStatus


ExternalCustomerAgreement -> ElectronicAddress: electronicAddress


ExternalCustomerAgreement -> Status: status


ExternalCustomerAgreement -> ActivityRecord: ActivityRecord


ExternalCustomerAgreement -> ConfigurationEvent: ConfigurationEvents


ExternalCustomerAgreement -> Author: Author


ExternalCustomerAgreement -> Editor: Editor


ExternalCustomerAgreement -> Approver: Approver


ExternalCustomerAgreement -> Issuer: Issuer


ExternalCustomerAgreement -> DiagramObject: DiagramObjects


ExternalCustomerAgreement -> InstanceSet: InstanceSet


ExternalCustomerAgreement -> Name: Names


ExternalCustomerAgreement -> ChangeSetMember: PropertiesCIMDataObject


ExternalCustomerAgreement -> ChangeSetMember: TargetingCIMDataObject
