...
ConductingEquipment -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


ConductingEquipment -> SvStatus: SvStatus


ConductingEquipment -> ProtectionEquipment: ProtectionEquipments
...
ConductingEquipment -> JumperAction: JumpingAction


ConductingEquipment -> GroundAction: GroundingAction


ConductingEquipment -> Outage: Outage


ConductingEquipment -> WeatherStation: WeatherStation


ConductingEquipment -> OperationalLimitSet: OperationalLimitSet


ConductingEquipment -> ContingencyEquipment: ContingencyEquipment


ConductingEquipment -> EquipmentContainer: EquipmentContainer


ConductingEquipment -> Fault: Faults


ConductingEquipment -> LimitDependency: LimitDependencyModel


ConductingEquipment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ConductingEquipment -> ProtectiveActionEquipment: ProtectiveActionEquipment


ConductingEquipment -> PinEquipment: PinEquipment


ConductingEquipment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ConductingEquipment -> EquipmentContainer: AdditionalEquipmentContainer


ConductingEquipment -> UsagePoint: UsagePoints


ConductingEquipment -> Outage: Outages


ConductingEquipment -> OperationalRestriction: OperationalRestrictions


ConductingEquipment -> Control: Controls
...
ConductingEquipment -> ConfigurationEvent: ConfigurationEvent


ConductingEquipment -> ReportingGroup: ReportingGroup


ConductingEquipment -> OperatingShare: OperatingShare


ConductingEquipment -> AssetInfo: AssetDatasheet


ConductingEquipment -> VerificationAction: VerificationAction


ConductingEquipment -> ClearanceDocument: Clearances


ConductingEquipment -> GenericAction: GenericAction


ConductingEquipment -> PSREvent: PSREvents
...
ConductingEquipment -> OperationalTag: OperationalTags


ConductingEquipment -> DiagramObject: DiagramObjects


ConductingEquipment -> InstanceSet: InstanceSet


ConductingEquipment -> Name: Names


ConductingEquipment -> ChangeSetMember: PropertiesCIMDataObject


ConductingEquipment -> ChangeSetMember: TargetingCIMDataObject
