...
EquipmentContainer -> Equipment: AdditionalGroupedEquipment


EquipmentContainer -> TopologicalNode: TopologicalNode


EquipmentContainer -> ConnectivityNode: ConnectivityNodes


EquipmentContainer -> Control: Controls
...
EquipmentContainer -> ConfigurationEvent: ConfigurationEvent


EquipmentContainer -> ReportingGroup: ReportingGroup


EquipmentContainer -> OperatingShare: OperatingShare


EquipmentContainer -> AssetInfo: AssetDatasheet


EquipmentContainer -> VerificationAction: VerificationAction


EquipmentContainer -> ClearanceDocument: Clearances


EquipmentContainer -> GenericAction: GenericAction


EquipmentContainer -> PSREvent: PSREvents
...
EquipmentContainer -> OperationalTag: OperationalTags


EquipmentContainer -> DiagramObject: DiagramObjects


EquipmentContainer -> InstanceSet: InstanceSet


EquipmentContainer -> Name: Names


EquipmentContainer -> ChangeSetMember: PropertiesCIMDataObject


EquipmentContainer -> ChangeSetMember: TargetingCIMDataObject
