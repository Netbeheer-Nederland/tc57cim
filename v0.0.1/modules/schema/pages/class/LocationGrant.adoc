...
LocationGrant -> LandProperty: LandProperty


LocationGrant -> DateTimeInterval: validityInterval


LocationGrant -> Status: docStatus


LocationGrant -> ElectronicAddress: electronicAddress


LocationGrant -> Status: status


LocationGrant -> ActivityRecord: ActivityRecord


LocationGrant -> ConfigurationEvent: ConfigurationEvents


LocationGrant -> Author: Author


LocationGrant -> Editor: Editor


LocationGrant -> Approver: Approver


LocationGrant -> Issuer: Issuer


LocationGrant -> DiagramObject: DiagramObjects


LocationGrant -> InstanceSet: InstanceSet


LocationGrant -> Name: Names


LocationGrant -> ChangeSetMember: PropertiesCIMDataObject


LocationGrant -> ChangeSetMember: TargetingCIMDataObject
