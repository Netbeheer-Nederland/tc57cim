...
ErpChartOfAccounts -> Status: docStatus


ErpChartOfAccounts -> ElectronicAddress: electronicAddress


ErpChartOfAccounts -> Status: status


ErpChartOfAccounts -> ActivityRecord: ActivityRecord


ErpChartOfAccounts -> ConfigurationEvent: ConfigurationEvents


ErpChartOfAccounts -> Author: Author


ErpChartOfAccounts -> Editor: Editor


ErpChartOfAccounts -> Approver: Approver


ErpChartOfAccounts -> Issuer: Issuer


ErpChartOfAccounts -> DiagramObject: DiagramObjects


ErpChartOfAccounts -> InstanceSet: InstanceSet


ErpChartOfAccounts -> Name: Names


ErpChartOfAccounts -> ChangeSetMember: PropertiesCIMDataObject


ErpChartOfAccounts -> ChangeSetMember: TargetingCIMDataObject
