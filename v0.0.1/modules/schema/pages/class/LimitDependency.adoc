...
LimitDependency -> OperationalLimit: OperationalLimit


LimitDependency -> DiagramObject: DiagramObjects


LimitDependency -> InstanceSet: InstanceSet


LimitDependency -> Name: Names


LimitDependency -> ChangeSetMember: PropertiesCIMDataObject


LimitDependency -> ChangeSetMember: TargetingCIMDataObject
