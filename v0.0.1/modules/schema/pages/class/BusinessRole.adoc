...
BusinessRole -> Organisation: Organisation


BusinessRole -> ConfigurationEvent: ConfigurationEvents


BusinessRole -> DiagramObject: DiagramObjects


BusinessRole -> InstanceSet: InstanceSet


BusinessRole -> Name: Names


BusinessRole -> ChangeSetMember: PropertiesCIMDataObject


BusinessRole -> ChangeSetMember: TargetingCIMDataObject
