...
InspectionDataSet -> ScheduledEventData: AccordingToSchedules


InspectionDataSet -> WorkTask: WorkTask


InspectionDataSet -> TransformerObservation: TransformerObservations


InspectionDataSet -> MeasurementValue: MeasurementValue


InspectionDataSet -> Asset: Asset


InspectionDataSet -> UserAttribute: Properties


InspectionDataSet -> Procedure: Procedure


InspectionDataSet -> Status: docStatus


InspectionDataSet -> ElectronicAddress: electronicAddress


InspectionDataSet -> Status: status


InspectionDataSet -> ActivityRecord: ActivityRecord


InspectionDataSet -> ConfigurationEvent: ConfigurationEvents


InspectionDataSet -> Author: Author


InspectionDataSet -> Editor: Editor


InspectionDataSet -> Approver: Approver


InspectionDataSet -> Issuer: Issuer


InspectionDataSet -> DiagramObject: DiagramObjects


InspectionDataSet -> InstanceSet: InstanceSet


InspectionDataSet -> Name: Names


InspectionDataSet -> ChangeSetMember: PropertiesCIMDataObject


InspectionDataSet -> ChangeSetMember: TargetingCIMDataObject
