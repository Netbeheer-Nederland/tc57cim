...
WindGenType3IEC -> DiagramObject: DiagramObjects


WindGenType3IEC -> InstanceSet: InstanceSet


WindGenType3IEC -> Name: Names


WindGenType3IEC -> ChangeSetMember: PropertiesCIMDataObject


WindGenType3IEC -> ChangeSetMember: TargetingCIMDataObject
