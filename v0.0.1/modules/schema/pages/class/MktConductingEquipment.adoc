...
MktConductingEquipment -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


MktConductingEquipment -> SvStatus: SvStatus


MktConductingEquipment -> ProtectionEquipment: ProtectionEquipments


MktConductingEquipment -> BaseVoltage: BaseVoltage


MktConductingEquipment -> Terminal: Terminals


MktConductingEquipment -> JumperAction: JumpingAction


MktConductingEquipment -> GroundAction: GroundingAction


MktConductingEquipment -> Outage: Outage


MktConductingEquipment -> WeatherStation: WeatherStation


MktConductingEquipment -> OperationalLimitSet: OperationalLimitSet


MktConductingEquipment -> ContingencyEquipment: ContingencyEquipment


MktConductingEquipment -> EquipmentContainer: EquipmentContainer


MktConductingEquipment -> Fault: Faults


MktConductingEquipment -> LimitDependency: LimitDependencyModel


MktConductingEquipment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


MktConductingEquipment -> ProtectiveActionEquipment: ProtectiveActionEquipment


MktConductingEquipment -> PinEquipment: PinEquipment


MktConductingEquipment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


MktConductingEquipment -> EquipmentContainer: AdditionalEquipmentContainer


MktConductingEquipment -> UsagePoint: UsagePoints


MktConductingEquipment -> Outage: Outages


MktConductingEquipment -> OperationalRestriction: OperationalRestrictions


MktConductingEquipment -> Control: Controls


MktConductingEquipment -> Measurement: Measurements


MktConductingEquipment -> PSRType: PSRType


MktConductingEquipment -> ConfigurationEvent: ConfigurationEvent


MktConductingEquipment -> ReportingGroup: ReportingGroup


MktConductingEquipment -> OperatingShare: OperatingShare


MktConductingEquipment -> AssetInfo: AssetDatasheet


MktConductingEquipment -> VerificationAction: VerificationAction


MktConductingEquipment -> ClearanceDocument: Clearances


MktConductingEquipment -> GenericAction: GenericAction


MktConductingEquipment -> PSREvent: PSREvents


MktConductingEquipment -> Asset: Assets


MktConductingEquipment -> Location: Location


MktConductingEquipment -> OperationalTag: OperationalTags


MktConductingEquipment -> DiagramObject: DiagramObjects


MktConductingEquipment -> InstanceSet: InstanceSet


MktConductingEquipment -> Name: Names


MktConductingEquipment -> ChangeSetMember: PropertiesCIMDataObject


MktConductingEquipment -> ChangeSetMember: TargetingCIMDataObject
