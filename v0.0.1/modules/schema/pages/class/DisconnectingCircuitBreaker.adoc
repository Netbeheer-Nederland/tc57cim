...
DisconnectingCircuitBreaker -> ProtectionEquipment: OperatedByProtectionEquipment


DisconnectingCircuitBreaker -> RecloseSequence: RecloseSequences



DisconnectingCircuitBreaker -> SwitchPhase: SwitchPhase


DisconnectingCircuitBreaker -> SwitchSchedule: SwitchSchedules


DisconnectingCircuitBreaker -> CompositeSwitch: CompositeSwitch


DisconnectingCircuitBreaker -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


DisconnectingCircuitBreaker -> SvSwitch: SvSwitch


DisconnectingCircuitBreaker -> ConnectDisconnectFunction: ConnectDisconnectFunctions


DisconnectingCircuitBreaker -> SwitchAction: SwitchAction


DisconnectingCircuitBreaker -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


DisconnectingCircuitBreaker -> SvStatus: SvStatus


DisconnectingCircuitBreaker -> ProtectionEquipment: ProtectionEquipments


DisconnectingCircuitBreaker -> BaseVoltage: BaseVoltage


DisconnectingCircuitBreaker -> Terminal: Terminals


DisconnectingCircuitBreaker -> JumperAction: JumpingAction


DisconnectingCircuitBreaker -> GroundAction: GroundingAction


DisconnectingCircuitBreaker -> Outage: Outage


DisconnectingCircuitBreaker -> WeatherStation: WeatherStation


DisconnectingCircuitBreaker -> OperationalLimitSet: OperationalLimitSet


DisconnectingCircuitBreaker -> ContingencyEquipment: ContingencyEquipment


DisconnectingCircuitBreaker -> EquipmentContainer: EquipmentContainer


DisconnectingCircuitBreaker -> Fault: Faults


DisconnectingCircuitBreaker -> LimitDependency: LimitDependencyModel


DisconnectingCircuitBreaker -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


DisconnectingCircuitBreaker -> ProtectiveActionEquipment: ProtectiveActionEquipment


DisconnectingCircuitBreaker -> PinEquipment: PinEquipment


DisconnectingCircuitBreaker -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


DisconnectingCircuitBreaker -> EquipmentContainer: AdditionalEquipmentContainer


DisconnectingCircuitBreaker -> UsagePoint: UsagePoints


DisconnectingCircuitBreaker -> Outage: Outages


DisconnectingCircuitBreaker -> OperationalRestriction: OperationalRestrictions


DisconnectingCircuitBreaker -> Control: Controls


DisconnectingCircuitBreaker -> Measurement: Measurements


DisconnectingCircuitBreaker -> PSRType: PSRType


DisconnectingCircuitBreaker -> ConfigurationEvent: ConfigurationEvent


DisconnectingCircuitBreaker -> ReportingGroup: ReportingGroup


DisconnectingCircuitBreaker -> OperatingShare: OperatingShare


DisconnectingCircuitBreaker -> AssetInfo: AssetDatasheet


DisconnectingCircuitBreaker -> VerificationAction: VerificationAction


DisconnectingCircuitBreaker -> ClearanceDocument: Clearances


DisconnectingCircuitBreaker -> GenericAction: GenericAction


DisconnectingCircuitBreaker -> PSREvent: PSREvents


DisconnectingCircuitBreaker -> Asset: Assets


DisconnectingCircuitBreaker -> Location: Location


DisconnectingCircuitBreaker -> OperationalTag: OperationalTags


DisconnectingCircuitBreaker -> DiagramObject: DiagramObjects


DisconnectingCircuitBreaker -> InstanceSet: InstanceSet


DisconnectingCircuitBreaker -> Name: Names


DisconnectingCircuitBreaker -> ChangeSetMember: PropertiesCIMDataObject


DisconnectingCircuitBreaker -> ChangeSetMember: TargetingCIMDataObject
