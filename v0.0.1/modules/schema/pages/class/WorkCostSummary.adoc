...
WorkCostSummary -> WorkCostDetail: WorkCostDetail


WorkCostSummary -> Status: docStatus


WorkCostSummary -> ElectronicAddress: electronicAddress


WorkCostSummary -> Status: status


WorkCostSummary -> ActivityRecord: ActivityRecord


WorkCostSummary -> ConfigurationEvent: ConfigurationEvents


WorkCostSummary -> Author: Author


WorkCostSummary -> Editor: Editor


WorkCostSummary -> Approver: Approver


WorkCostSummary -> Issuer: Issuer


WorkCostSummary -> DiagramObject: DiagramObjects


WorkCostSummary -> InstanceSet: InstanceSet


WorkCostSummary -> Name: Names


WorkCostSummary -> ChangeSetMember: PropertiesCIMDataObject


WorkCostSummary -> ChangeSetMember: TargetingCIMDataObject
