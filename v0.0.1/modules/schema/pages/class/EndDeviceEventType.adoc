...
EndDeviceEventType -> EndDeviceEvent: EndDeviceEvents


EndDeviceEventType -> DiagramObject: DiagramObjects


EndDeviceEventType -> InstanceSet: InstanceSet


EndDeviceEventType -> Name: Names


EndDeviceEventType -> ChangeSetMember: PropertiesCIMDataObject


EndDeviceEventType -> ChangeSetMember: TargetingCIMDataObject
