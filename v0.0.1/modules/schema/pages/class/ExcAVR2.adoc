...
ExcAVR2 -> SynchronousMachineDynamics: SynchronousMachineDynamics


ExcAVR2 -> PowerSystemStabilizerDynamics: PowerSystemStabilizerDynamics


ExcAVR2 -> PFVArControllerType1Dynamics: PFVArControllerType1Dynamics


ExcAVR2 -> OverexcitationLimiterDynamics: OverexcitationLimiterDynamics


ExcAVR2 -> DiscontinuousExcitationControlDynamics: DiscontinuousExcitationControlDynamics


ExcAVR2 -> PFVArControllerType2Dynamics: PFVArControllerType2Dynamics


ExcAVR2 -> UnderexcitationLimiterDynamics: UnderexcitationLimiterDynamics


ExcAVR2 -> VoltageCompensatorDynamics: VoltageCompensatorDynamics


ExcAVR2 -> DiagramObject: DiagramObjects


ExcAVR2 -> InstanceSet: InstanceSet


ExcAVR2 -> Name: Names


ExcAVR2 -> ChangeSetMember: PropertiesCIMDataObject


ExcAVR2 -> ChangeSetMember: TargetingCIMDataObject
