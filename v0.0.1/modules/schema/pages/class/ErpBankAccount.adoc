...
ErpBankAccount -> Bank: Bank


ErpBankAccount -> ServiceSupplier: ServiceSupplier


ErpBankAccount -> Status: docStatus


ErpBankAccount -> ElectronicAddress: electronicAddress


ErpBankAccount -> Status: status


ErpBankAccount -> ActivityRecord: ActivityRecord


ErpBankAccount -> ConfigurationEvent: ConfigurationEvents


ErpBankAccount -> Author: Author


ErpBankAccount -> Editor: Editor


ErpBankAccount -> Approver: Approver


ErpBankAccount -> Issuer: Issuer


ErpBankAccount -> DiagramObject: DiagramObjects


ErpBankAccount -> InstanceSet: InstanceSet


ErpBankAccount -> Name: Names


ErpBankAccount -> ChangeSetMember: PropertiesCIMDataObject


ErpBankAccount -> ChangeSetMember: TargetingCIMDataObject
