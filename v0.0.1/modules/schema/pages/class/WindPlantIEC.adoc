...
WindPlantIEC -> WindTurbineType3or4Dynamics: WindTurbineType3or4Dynamics


WindPlantIEC -> RemoteInputSignal: RemoteInputSignal


WindPlantIEC -> DiagramObject: DiagramObjects


WindPlantIEC -> InstanceSet: InstanceSet


WindPlantIEC -> Name: Names


WindPlantIEC -> ChangeSetMember: PropertiesCIMDataObject


WindPlantIEC -> ChangeSetMember: TargetingCIMDataObject
