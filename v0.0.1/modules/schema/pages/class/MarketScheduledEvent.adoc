...
MarketScheduledEvent -> Status: status


MarketScheduledEvent -> MajorChargeGroup: MajorChargeGroup


MarketScheduledEvent -> DiagramObject: DiagramObjects


MarketScheduledEvent -> InstanceSet: InstanceSet


MarketScheduledEvent -> Name: Names


MarketScheduledEvent -> ChangeSetMember: PropertiesCIMDataObject


MarketScheduledEvent -> ChangeSetMember: TargetingCIMDataObject
