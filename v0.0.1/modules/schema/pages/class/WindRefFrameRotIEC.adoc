...
WindRefFrameRotIEC -> DiagramObject: DiagramObjects


WindRefFrameRotIEC -> InstanceSet: InstanceSet


WindRefFrameRotIEC -> Name: Names


WindRefFrameRotIEC -> ChangeSetMember: PropertiesCIMDataObject


WindRefFrameRotIEC -> ChangeSetMember: TargetingCIMDataObject
