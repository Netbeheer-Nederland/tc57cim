...
ErpPurchaseOrder -> ErpPOLineItem: ErpPOLineItems


ErpPurchaseOrder -> Status: docStatus


ErpPurchaseOrder -> ElectronicAddress: electronicAddress


ErpPurchaseOrder -> Status: status


ErpPurchaseOrder -> ActivityRecord: ActivityRecord


ErpPurchaseOrder -> ConfigurationEvent: ConfigurationEvents


ErpPurchaseOrder -> Author: Author


ErpPurchaseOrder -> Editor: Editor


ErpPurchaseOrder -> Approver: Approver


ErpPurchaseOrder -> Issuer: Issuer


ErpPurchaseOrder -> DiagramObject: DiagramObjects


ErpPurchaseOrder -> InstanceSet: InstanceSet


ErpPurchaseOrder -> Name: Names


ErpPurchaseOrder -> ChangeSetMember: PropertiesCIMDataObject


ErpPurchaseOrder -> ChangeSetMember: TargetingCIMDataObject
