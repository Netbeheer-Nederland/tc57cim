...
ControlAction -> SwitchingPlan: SwitchingPlan
...
ControlAction -> SwitchingEvent: SwitchingEvent


ControlAction -> SwitchingStep: SwitchingStep


ControlAction -> DiagramObject: DiagramObjects


ControlAction -> InstanceSet: InstanceSet


ControlAction -> Name: Names


ControlAction -> ChangeSetMember: PropertiesCIMDataObject


ControlAction -> ChangeSetMember: TargetingCIMDataObject
