...
InflowForecast -> RegularTimePoint: TimePoints


InflowForecast -> DiagramObject: DiagramObjects


InflowForecast -> InstanceSet: InstanceSet


InflowForecast -> Name: Names


InflowForecast -> ChangeSetMember: PropertiesCIMDataObject


InflowForecast -> ChangeSetMember: TargetingCIMDataObject
