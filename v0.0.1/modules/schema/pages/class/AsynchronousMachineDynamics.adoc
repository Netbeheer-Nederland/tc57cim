...
AsynchronousMachineDynamics -> AsynchronousMachine: AsynchronousMachine


AsynchronousMachineDynamics -> TurbineGovernorDynamics: TurbineGovernorDynamics


AsynchronousMachineDynamics -> MechanicalLoadDynamics: MechanicalLoadDynamics


AsynchronousMachineDynamics -> WindTurbineType1or2Dynamics: WindTurbineType1or2Dynamics





AsynchronousMachineDynamics -> DiagramObject: DiagramObjects


AsynchronousMachineDynamics -> InstanceSet: InstanceSet


AsynchronousMachineDynamics -> Name: Names


AsynchronousMachineDynamics -> ChangeSetMember: PropertiesCIMDataObject


AsynchronousMachineDynamics -> ChangeSetMember: TargetingCIMDataObject
