...
MarketSkill -> DateTimeInterval: certificationPeriod


MarketSkill -> MarketQualificationRequirement: MarketQualificationRequirements


MarketSkill -> MarketPerson: MarketPerson


MarketSkill -> Status: docStatus


MarketSkill -> ElectronicAddress: electronicAddress


MarketSkill -> Status: status


MarketSkill -> ActivityRecord: ActivityRecord


MarketSkill -> ConfigurationEvent: ConfigurationEvents


MarketSkill -> Author: Author


MarketSkill -> Editor: Editor


MarketSkill -> Approver: Approver


MarketSkill -> Issuer: Issuer


MarketSkill -> DiagramObject: DiagramObjects


MarketSkill -> InstanceSet: InstanceSet


MarketSkill -> Name: Names


MarketSkill -> ChangeSetMember: PropertiesCIMDataObject


MarketSkill -> ChangeSetMember: TargetingCIMDataObject
