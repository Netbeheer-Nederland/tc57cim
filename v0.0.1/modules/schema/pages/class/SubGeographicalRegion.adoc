...
SubGeographicalRegion -> DiagramObject: DiagramObjects


SubGeographicalRegion -> InstanceSet: InstanceSet


SubGeographicalRegion -> Name: Names


SubGeographicalRegion -> ChangeSetMember: PropertiesCIMDataObject


SubGeographicalRegion -> ChangeSetMember: TargetingCIMDataObject
