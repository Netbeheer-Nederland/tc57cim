...
EnvironmentalAnalog -> ReportingCapability: ReportingCapability


EnvironmentalAnalog -> EnvironmentalInformation: EnvironmentalInformation


EnvironmentalAnalog -> ClassificationCondition: ClassificationCondition


EnvironmentalAnalog -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


EnvironmentalAnalog -> AnalogValue: AnalogValues


EnvironmentalAnalog -> AnalogLimitSet: LimitSets


EnvironmentalAnalog -> ACDCTerminal: Terminal


EnvironmentalAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EnvironmentalAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


EnvironmentalAnalog -> PowerSystemResource: PowerSystemResource


EnvironmentalAnalog -> PinMeasurement: PinMeasurement


EnvironmentalAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


EnvironmentalAnalog -> Asset: Asset


EnvironmentalAnalog -> MeasurementAction: MeasurementAction


EnvironmentalAnalog -> Location: Locations


EnvironmentalAnalog -> Procedure: Procedures


EnvironmentalAnalog -> DiagramObject: DiagramObjects


EnvironmentalAnalog -> InstanceSet: InstanceSet


EnvironmentalAnalog -> Name: Names


EnvironmentalAnalog -> ChangeSetMember: PropertiesCIMDataObject


EnvironmentalAnalog -> ChangeSetMember: TargetingCIMDataObject
