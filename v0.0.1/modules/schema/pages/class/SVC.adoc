...
SVC -> ShuntCompensatorPhase: ShuntCompensatorPhase


SVC -> ShuntCompensatorAction: ShuntCompensatorAction


SVC -> SvShuntCompensatorSections: SvShuntCompensatorSections


SVC -> RegulatingControl: RegulatingControl


SVC -> EnergyComponent: EnergyComponent


SVC -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


SVC -> SvStatus: SvStatus


SVC -> ProtectionEquipment: ProtectionEquipments


SVC -> BaseVoltage: BaseVoltage


SVC -> Terminal: Terminals


SVC -> JumperAction: JumpingAction


SVC -> GroundAction: GroundingAction


SVC -> Outage: Outage


SVC -> WeatherStation: WeatherStation


SVC -> OperationalLimitSet: OperationalLimitSet


SVC -> ContingencyEquipment: ContingencyEquipment


SVC -> EquipmentContainer: EquipmentContainer


SVC -> Fault: Faults


SVC -> LimitDependency: LimitDependencyModel


SVC -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


SVC -> ProtectiveActionEquipment: ProtectiveActionEquipment


SVC -> PinEquipment: PinEquipment


SVC -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


SVC -> EquipmentContainer: AdditionalEquipmentContainer


SVC -> UsagePoint: UsagePoints


SVC -> Outage: Outages


SVC -> OperationalRestriction: OperationalRestrictions


SVC -> Control: Controls


SVC -> Measurement: Measurements


SVC -> PSRType: PSRType


SVC -> ConfigurationEvent: ConfigurationEvent


SVC -> ReportingGroup: ReportingGroup


SVC -> OperatingShare: OperatingShare


SVC -> AssetInfo: AssetDatasheet


SVC -> VerificationAction: VerificationAction


SVC -> ClearanceDocument: Clearances


SVC -> GenericAction: GenericAction


SVC -> PSREvent: PSREvents
...
SVC -> OperationalTag: OperationalTags


SVC -> DiagramObject: DiagramObjects


SVC -> InstanceSet: InstanceSet


SVC -> Name: Names


SVC -> ChangeSetMember: PropertiesCIMDataObject


SVC -> ChangeSetMember: TargetingCIMDataObject
