...
ProtectionEquipment -> ProtectedSwitch: ProtectedSwitches


ProtectionEquipment -> ConductingEquipment: ConductingEquipments


ProtectionEquipment -> ProtectiveAction: ProtectiveAction


ProtectionEquipment -> WeatherStation: WeatherStation


ProtectionEquipment -> OperationalLimitSet: OperationalLimitSet


ProtectionEquipment -> ContingencyEquipment: ContingencyEquipment


ProtectionEquipment -> EquipmentContainer: EquipmentContainer


ProtectionEquipment -> Fault: Faults


ProtectionEquipment -> LimitDependency: LimitDependencyModel


ProtectionEquipment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ProtectionEquipment -> ProtectiveActionEquipment: ProtectiveActionEquipment


ProtectionEquipment -> PinEquipment: PinEquipment


ProtectionEquipment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ProtectionEquipment -> EquipmentContainer: AdditionalEquipmentContainer


ProtectionEquipment -> UsagePoint: UsagePoints


ProtectionEquipment -> Outage: Outages


ProtectionEquipment -> OperationalRestriction: OperationalRestrictions


ProtectionEquipment -> Control: Controls


ProtectionEquipment -> Measurement: Measurements


ProtectionEquipment -> PSRType: PSRType


ProtectionEquipment -> ConfigurationEvent: ConfigurationEvent


ProtectionEquipment -> ReportingGroup: ReportingGroup


ProtectionEquipment -> OperatingShare: OperatingShare


ProtectionEquipment -> AssetInfo: AssetDatasheet


ProtectionEquipment -> VerificationAction: VerificationAction


ProtectionEquipment -> ClearanceDocument: Clearances


ProtectionEquipment -> GenericAction: GenericAction


ProtectionEquipment -> PSREvent: PSREvents


ProtectionEquipment -> Asset: Assets


ProtectionEquipment -> Location: Location


ProtectionEquipment -> OperationalTag: OperationalTags


ProtectionEquipment -> DiagramObject: DiagramObjects


ProtectionEquipment -> InstanceSet: InstanceSet


ProtectionEquipment -> Name: Names


ProtectionEquipment -> ChangeSetMember: PropertiesCIMDataObject


ProtectionEquipment -> ChangeSetMember: TargetingCIMDataObject
