...
BidPriceSchedule -> BidPriceCurve: BidPriceCurve


BidPriceSchedule -> ProductBid: ProductBid



BidPriceSchedule -> RegularTimePoint: TimePoints


BidPriceSchedule -> DiagramObject: DiagramObjects


BidPriceSchedule -> InstanceSet: InstanceSet


BidPriceSchedule -> Name: Names


BidPriceSchedule -> ChangeSetMember: PropertiesCIMDataObject


BidPriceSchedule -> ChangeSetMember: TargetingCIMDataObject
