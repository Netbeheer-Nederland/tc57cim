...
OperationalTag -> Asset: Asset


OperationalTag -> PowerSystemResource: PowerSystemResource


OperationalTag -> TagAction: TagAction


OperationalTag -> Status: docStatus


OperationalTag -> ElectronicAddress: electronicAddress


OperationalTag -> Status: status


OperationalTag -> ActivityRecord: ActivityRecord


OperationalTag -> ConfigurationEvent: ConfigurationEvents


OperationalTag -> Author: Author


OperationalTag -> Editor: Editor


OperationalTag -> Approver: Approver


OperationalTag -> Issuer: Issuer


OperationalTag -> DiagramObject: DiagramObjects


OperationalTag -> InstanceSet: InstanceSet


OperationalTag -> Name: Names


OperationalTag -> ChangeSetMember: PropertiesCIMDataObject


OperationalTag -> ChangeSetMember: TargetingCIMDataObject
