...
ErpInventory -> Status: status


ErpInventory -> Asset: Asset


ErpInventory -> DiagramObject: DiagramObjects


ErpInventory -> InstanceSet: InstanceSet


ErpInventory -> Name: Names


ErpInventory -> ChangeSetMember: PropertiesCIMDataObject


ErpInventory -> ChangeSetMember: TargetingCIMDataObject
