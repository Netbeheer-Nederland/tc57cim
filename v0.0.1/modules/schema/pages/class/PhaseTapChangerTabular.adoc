...
PhaseTapChangerTabular -> TransformerEnd: TransformerEnd





PhaseTapChangerTabular -> TapChangerControl: TapChangerControl


PhaseTapChangerTabular -> SvTapStep: SvTapStep


PhaseTapChangerTabular -> TapSchedule: TapSchedules


PhaseTapChangerTabular -> Control: Controls


PhaseTapChangerTabular -> Measurement: Measurements


PhaseTapChangerTabular -> PSRType: PSRType


PhaseTapChangerTabular -> ConfigurationEvent: ConfigurationEvent


PhaseTapChangerTabular -> ReportingGroup: ReportingGroup


PhaseTapChangerTabular -> OperatingShare: OperatingShare


PhaseTapChangerTabular -> AssetInfo: AssetDatasheet


PhaseTapChangerTabular -> VerificationAction: VerificationAction


PhaseTapChangerTabular -> ClearanceDocument: Clearances


PhaseTapChangerTabular -> GenericAction: GenericAction


PhaseTapChangerTabular -> PSREvent: PSREvents


PhaseTapChangerTabular -> Asset: Assets


PhaseTapChangerTabular -> Location: Location


PhaseTapChangerTabular -> OperationalTag: OperationalTags


PhaseTapChangerTabular -> DiagramObject: DiagramObjects


PhaseTapChangerTabular -> InstanceSet: InstanceSet


PhaseTapChangerTabular -> Name: Names


PhaseTapChangerTabular -> ChangeSetMember: PropertiesCIMDataObject


PhaseTapChangerTabular -> ChangeSetMember: TargetingCIMDataObject
