...
Discrete -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Discrete -> CalculationMethodHierarchy: CalculationMethodHierarchy


Discrete -> PowerSystemResource: PowerSystemResource


Discrete -> PinMeasurement: PinMeasurement


Discrete -> MeasurementCalculatorInput: MeasurementCalculatorInput


Discrete -> Asset: Asset


Discrete -> MeasurementAction: MeasurementAction


Discrete -> Location: Locations


Discrete -> Procedure: Procedures


Discrete -> DiagramObject: DiagramObjects


Discrete -> InstanceSet: InstanceSet


Discrete -> Name: Names


Discrete -> ChangeSetMember: PropertiesCIMDataObject


Discrete -> ChangeSetMember: TargetingCIMDataObject
