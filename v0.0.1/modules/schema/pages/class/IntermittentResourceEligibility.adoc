...
IntermittentResourceEligibility -> RegisteredResource: RegisteredResource


IntermittentResourceEligibility -> MktActivityRecord: MktActivityRecord


IntermittentResourceEligibility -> Market: Market


IntermittentResourceEligibility -> Status: docStatus


IntermittentResourceEligibility -> ElectronicAddress: electronicAddress


IntermittentResourceEligibility -> Status: status


IntermittentResourceEligibility -> ActivityRecord: ActivityRecord


IntermittentResourceEligibility -> ConfigurationEvent: ConfigurationEvents


IntermittentResourceEligibility -> Author: Author


IntermittentResourceEligibility -> Editor: Editor


IntermittentResourceEligibility -> Approver: Approver


IntermittentResourceEligibility -> Issuer: Issuer


IntermittentResourceEligibility -> DiagramObject: DiagramObjects


IntermittentResourceEligibility -> InstanceSet: InstanceSet


IntermittentResourceEligibility -> Name: Names


IntermittentResourceEligibility -> ChangeSetMember: PropertiesCIMDataObject


IntermittentResourceEligibility -> ChangeSetMember: TargetingCIMDataObject
