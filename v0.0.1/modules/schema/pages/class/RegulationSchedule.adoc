...
RegulationSchedule -> VoltageControlZone: VoltageControlZones


RegulationSchedule -> DayType: DayType


RegulationSchedule -> Season: Season



RegulationSchedule -> RegularTimePoint: TimePoints


RegulationSchedule -> DiagramObject: DiagramObjects


RegulationSchedule -> InstanceSet: InstanceSet


RegulationSchedule -> Name: Names


RegulationSchedule -> ChangeSetMember: PropertiesCIMDataObject


RegulationSchedule -> ChangeSetMember: TargetingCIMDataObject
