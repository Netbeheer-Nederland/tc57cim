...
MeasurementValueSource -> DiagramObject: DiagramObjects


MeasurementValueSource -> InstanceSet: InstanceSet


MeasurementValueSource -> Name: Names


MeasurementValueSource -> ChangeSetMember: PropertiesCIMDataObject


MeasurementValueSource -> ChangeSetMember: TargetingCIMDataObject
