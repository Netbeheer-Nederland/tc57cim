...
PointOfSale -> CashierShift: CashierShifts


PointOfSale -> DiagramObject: DiagramObjects


PointOfSale -> InstanceSet: InstanceSet


PointOfSale -> Name: Names


PointOfSale -> ChangeSetMember: PropertiesCIMDataObject


PointOfSale -> ChangeSetMember: TargetingCIMDataObject
