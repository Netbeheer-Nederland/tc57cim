...
EnergyConsumerPhase -> EnergyConsumer: EnergyConsumer
...
EnergyConsumerPhase -> ConfigurationEvent: ConfigurationEvent


EnergyConsumerPhase -> ReportingGroup: ReportingGroup


EnergyConsumerPhase -> OperatingShare: OperatingShare


EnergyConsumerPhase -> AssetInfo: AssetDatasheet


EnergyConsumerPhase -> VerificationAction: VerificationAction


EnergyConsumerPhase -> ClearanceDocument: Clearances


EnergyConsumerPhase -> GenericAction: GenericAction
...
EnergyConsumerPhase -> OperationalTag: OperationalTags


EnergyConsumerPhase -> DiagramObject: DiagramObjects


EnergyConsumerPhase -> InstanceSet: InstanceSet


EnergyConsumerPhase -> Name: Names


EnergyConsumerPhase -> ChangeSetMember: PropertiesCIMDataObject


EnergyConsumerPhase -> ChangeSetMember: TargetingCIMDataObject
