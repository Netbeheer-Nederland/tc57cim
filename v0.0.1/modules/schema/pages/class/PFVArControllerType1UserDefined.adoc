...
PFVArControllerType1UserDefined -> ExcitationSystemDynamics: ExcitationSystemDynamics


PFVArControllerType1UserDefined -> RemoteInputSignal: RemoteInputSignal


PFVArControllerType1UserDefined -> VoltageAdjusterDynamics: VoltageAdjusterDynamics


PFVArControllerType1UserDefined -> DiagramObject: DiagramObjects


PFVArControllerType1UserDefined -> InstanceSet: InstanceSet


PFVArControllerType1UserDefined -> Name: Names


PFVArControllerType1UserDefined -> ChangeSetMember: PropertiesCIMDataObject


PFVArControllerType1UserDefined -> ChangeSetMember: TargetingCIMDataObject
