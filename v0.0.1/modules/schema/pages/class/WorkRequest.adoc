...
WorkRequest -> Status: docStatus


WorkRequest -> ElectronicAddress: electronicAddress


WorkRequest -> Status: status


WorkRequest -> ActivityRecord: ActivityRecord


WorkRequest -> ConfigurationEvent: ConfigurationEvents


WorkRequest -> Author: Author


WorkRequest -> Editor: Editor


WorkRequest -> Approver: Approver


WorkRequest -> Issuer: Issuer


WorkRequest -> DiagramObject: DiagramObjects


WorkRequest -> InstanceSet: InstanceSet


WorkRequest -> Name: Names


WorkRequest -> ChangeSetMember: PropertiesCIMDataObject


WorkRequest -> ChangeSetMember: TargetingCIMDataObject
