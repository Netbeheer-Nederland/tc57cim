...
RaiseLowerCommand -> AnalogValue: AnalogValue


RaiseLowerCommand -> RemoteControl: RemoteControl


RaiseLowerCommand -> PowerSystemResource: PowerSystemResource


RaiseLowerCommand -> ControlAction: ControlAction


RaiseLowerCommand -> ProvidedBilateralPoint: BilateralToIOPoint


RaiseLowerCommand -> IOPointSource: IOPointSource


RaiseLowerCommand -> DiagramObject: DiagramObjects


RaiseLowerCommand -> InstanceSet: InstanceSet


RaiseLowerCommand -> Name: Names


RaiseLowerCommand -> ChangeSetMember: PropertiesCIMDataObject


RaiseLowerCommand -> ChangeSetMember: TargetingCIMDataObject
