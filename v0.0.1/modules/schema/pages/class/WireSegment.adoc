...
WireSegment -> WireSegmentPhase: WireSegmentPhases



WireSegment -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


WireSegment -> SvStatus: SvStatus


WireSegment -> ProtectionEquipment: ProtectionEquipments


WireSegment -> BaseVoltage: BaseVoltage


WireSegment -> Terminal: Terminals


WireSegment -> JumperAction: JumpingAction


WireSegment -> GroundAction: GroundingAction


WireSegment -> Outage: Outage


WireSegment -> WeatherStation: WeatherStation


WireSegment -> OperationalLimitSet: OperationalLimitSet


WireSegment -> ContingencyEquipment: ContingencyEquipment


WireSegment -> EquipmentContainer: EquipmentContainer


WireSegment -> Fault: Faults


WireSegment -> LimitDependency: LimitDependencyModel


WireSegment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


WireSegment -> ProtectiveActionEquipment: ProtectiveActionEquipment


WireSegment -> PinEquipment: PinEquipment


WireSegment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


WireSegment -> EquipmentContainer: AdditionalEquipmentContainer


WireSegment -> UsagePoint: UsagePoints


WireSegment -> Outage: Outages


WireSegment -> OperationalRestriction: OperationalRestrictions


WireSegment -> Control: Controls


WireSegment -> Measurement: Measurements


WireSegment -> PSRType: PSRType


WireSegment -> ConfigurationEvent: ConfigurationEvent


WireSegment -> ReportingGroup: ReportingGroup


WireSegment -> OperatingShare: OperatingShare


WireSegment -> AssetInfo: AssetDatasheet


WireSegment -> VerificationAction: VerificationAction


WireSegment -> ClearanceDocument: Clearances


WireSegment -> GenericAction: GenericAction


WireSegment -> PSREvent: PSREvents


WireSegment -> Asset: Assets


WireSegment -> Location: Location


WireSegment -> OperationalTag: OperationalTags


WireSegment -> DiagramObject: DiagramObjects


WireSegment -> InstanceSet: InstanceSet


WireSegment -> Name: Names


WireSegment -> ChangeSetMember: PropertiesCIMDataObject


WireSegment -> ChangeSetMember: TargetingCIMDataObject
