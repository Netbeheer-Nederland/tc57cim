...
ReserveReqCurve -> ReserveReq: ReserveReq


ReserveReqCurve -> CurveData: CurveDatas


ReserveReqCurve -> DiagramObject: DiagramObjects


ReserveReqCurve -> InstanceSet: InstanceSet


ReserveReqCurve -> Name: Names


ReserveReqCurve -> ChangeSetMember: PropertiesCIMDataObject


ReserveReqCurve -> ChangeSetMember: TargetingCIMDataObject
