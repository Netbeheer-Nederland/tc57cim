...
WindGenType3aIEC -> WindTurbineType3IEC: WindTurbineType3IEC


WindGenType3aIEC -> DiagramObject: DiagramObjects


WindGenType3aIEC -> InstanceSet: InstanceSet


WindGenType3aIEC -> Name: Names


WindGenType3aIEC -> ChangeSetMember: PropertiesCIMDataObject


WindGenType3aIEC -> ChangeSetMember: TargetingCIMDataObject
