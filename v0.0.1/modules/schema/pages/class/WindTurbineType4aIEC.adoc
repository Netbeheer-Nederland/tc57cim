...
WindTurbineType4aIEC -> WindGenType3aIEC: WindGenType3aIEC


WindTurbineType4aIEC -> WindContQPQULimIEC: WindContQPQULimIEC


WindTurbineType4aIEC -> WindContCurrLimIEC: WindContCurrLimIEC


WindTurbineType4aIEC -> WindProtectionIEC: WindProtectionIEC


WindTurbineType4aIEC -> WindContQIEC: WIndContQIEC


WindTurbineType4aIEC -> WindRefFrameRotIEC: WindRefFrameRotIEC


WindTurbineType4aIEC -> WindContQLimIEC: WindContQLimIEC


WindTurbineType4aIEC -> PowerElectronicsConnection: PowerElectronicsConnection


WindTurbineType4aIEC -> RemoteInputSignal: RemoteInputSignal


WindTurbineType4aIEC -> WindPlantDynamics: WindPlantDynamics


WindTurbineType4aIEC -> DiagramObject: DiagramObjects


WindTurbineType4aIEC -> InstanceSet: InstanceSet


WindTurbineType4aIEC -> Name: Names


WindTurbineType4aIEC -> ChangeSetMember: PropertiesCIMDataObject


WindTurbineType4aIEC -> ChangeSetMember: TargetingCIMDataObject
