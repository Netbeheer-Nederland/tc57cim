...
EquivalentBranch -> EquivalentNetwork: EquivalentNetwork


EquivalentBranch -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EquivalentBranch -> SvStatus: SvStatus


EquivalentBranch -> ProtectionEquipment: ProtectionEquipments


EquivalentBranch -> BaseVoltage: BaseVoltage


EquivalentBranch -> Terminal: Terminals


EquivalentBranch -> JumperAction: JumpingAction


EquivalentBranch -> GroundAction: GroundingAction


EquivalentBranch -> Outage: Outage


EquivalentBranch -> WeatherStation: WeatherStation


EquivalentBranch -> OperationalLimitSet: OperationalLimitSet


EquivalentBranch -> ContingencyEquipment: ContingencyEquipment


EquivalentBranch -> EquipmentContainer: EquipmentContainer


EquivalentBranch -> Fault: Faults


EquivalentBranch -> LimitDependency: LimitDependencyModel


EquivalentBranch -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


EquivalentBranch -> ProtectiveActionEquipment: ProtectiveActionEquipment


EquivalentBranch -> PinEquipment: PinEquipment


EquivalentBranch -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


EquivalentBranch -> EquipmentContainer: AdditionalEquipmentContainer


EquivalentBranch -> UsagePoint: UsagePoints


EquivalentBranch -> Outage: Outages


EquivalentBranch -> OperationalRestriction: OperationalRestrictions


EquivalentBranch -> Control: Controls


EquivalentBranch -> Measurement: Measurements


EquivalentBranch -> PSRType: PSRType


EquivalentBranch -> ConfigurationEvent: ConfigurationEvent


EquivalentBranch -> ReportingGroup: ReportingGroup


EquivalentBranch -> OperatingShare: OperatingShare


EquivalentBranch -> AssetInfo: AssetDatasheet


EquivalentBranch -> VerificationAction: VerificationAction


EquivalentBranch -> ClearanceDocument: Clearances


EquivalentBranch -> GenericAction: GenericAction


EquivalentBranch -> PSREvent: PSREvents


EquivalentBranch -> Asset: Assets


EquivalentBranch -> Location: Location


EquivalentBranch -> OperationalTag: OperationalTags


EquivalentBranch -> DiagramObject: DiagramObjects


EquivalentBranch -> InstanceSet: InstanceSet


EquivalentBranch -> Name: Names


EquivalentBranch -> ChangeSetMember: PropertiesCIMDataObject


EquivalentBranch -> ChangeSetMember: TargetingCIMDataObject
