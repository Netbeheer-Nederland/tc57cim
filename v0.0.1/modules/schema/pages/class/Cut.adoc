...
Cut -> CutAction: CutAction



Cut -> SwitchPhase: SwitchPhase


Cut -> SwitchSchedule: SwitchSchedules


Cut -> CompositeSwitch: CompositeSwitch


Cut -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


Cut -> SvSwitch: SvSwitch


Cut -> ConnectDisconnectFunction: ConnectDisconnectFunctions


Cut -> SwitchAction: SwitchAction


Cut -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Cut -> SvStatus: SvStatus


Cut -> ProtectionEquipment: ProtectionEquipments


Cut -> BaseVoltage: BaseVoltage


Cut -> Terminal: Terminals


Cut -> JumperAction: JumpingAction


Cut -> GroundAction: GroundingAction


Cut -> Outage: Outage


Cut -> WeatherStation: WeatherStation


Cut -> OperationalLimitSet: OperationalLimitSet


Cut -> ContingencyEquipment: ContingencyEquipment


Cut -> EquipmentContainer: EquipmentContainer


Cut -> Fault: Faults


Cut -> LimitDependency: LimitDependencyModel


Cut -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Cut -> ProtectiveActionEquipment: ProtectiveActionEquipment


Cut -> PinEquipment: PinEquipment


Cut -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Cut -> EquipmentContainer: AdditionalEquipmentContainer


Cut -> UsagePoint: UsagePoints


Cut -> Outage: Outages


Cut -> OperationalRestriction: OperationalRestrictions


Cut -> Control: Controls


Cut -> Measurement: Measurements


Cut -> PSRType: PSRType


Cut -> ConfigurationEvent: ConfigurationEvent


Cut -> ReportingGroup: ReportingGroup


Cut -> OperatingShare: OperatingShare


Cut -> AssetInfo: AssetDatasheet


Cut -> VerificationAction: VerificationAction


Cut -> ClearanceDocument: Clearances


Cut -> GenericAction: GenericAction


Cut -> PSREvent: PSREvents
...
Cut -> OperationalTag: OperationalTags


Cut -> DiagramObject: DiagramObjects


Cut -> InstanceSet: InstanceSet


Cut -> Name: Names


Cut -> ChangeSetMember: PropertiesCIMDataObject


Cut -> ChangeSetMember: TargetingCIMDataObject
