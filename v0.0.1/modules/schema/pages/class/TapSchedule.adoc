...
TapSchedule -> DayType: DayType


TapSchedule -> Season: Season



TapSchedule -> RegularTimePoint: TimePoints


TapSchedule -> DiagramObject: DiagramObjects


TapSchedule -> InstanceSet: InstanceSet


TapSchedule -> Name: Names


TapSchedule -> ChangeSetMember: PropertiesCIMDataObject


TapSchedule -> ChangeSetMember: TargetingCIMDataObject
