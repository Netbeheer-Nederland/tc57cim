...
DiscontinuousExcitationControlUserDefined -> ExcitationSystemDynamics: ExcitationSystemDynamics


DiscontinuousExcitationControlUserDefined -> RemoteInputSignal: RemoteInputSignal


DiscontinuousExcitationControlUserDefined -> DiagramObject: DiagramObjects


DiscontinuousExcitationControlUserDefined -> InstanceSet: InstanceSet


DiscontinuousExcitationControlUserDefined -> Name: Names


DiscontinuousExcitationControlUserDefined -> ChangeSetMember: PropertiesCIMDataObject


DiscontinuousExcitationControlUserDefined -> ChangeSetMember: TargetingCIMDataObject
