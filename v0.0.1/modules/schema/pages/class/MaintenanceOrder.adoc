...
MaintenanceOrder -> Status: docStatus


MaintenanceOrder -> ElectronicAddress: electronicAddress


MaintenanceOrder -> Status: status


MaintenanceOrder -> ActivityRecord: ActivityRecord


MaintenanceOrder -> ConfigurationEvent: ConfigurationEvents


MaintenanceOrder -> Author: Author


MaintenanceOrder -> Editor: Editor


MaintenanceOrder -> Approver: Approver


MaintenanceOrder -> Issuer: Issuer


MaintenanceOrder -> DiagramObject: DiagramObjects


MaintenanceOrder -> InstanceSet: InstanceSet


MaintenanceOrder -> Name: Names


MaintenanceOrder -> ChangeSetMember: PropertiesCIMDataObject


MaintenanceOrder -> ChangeSetMember: TargetingCIMDataObject
