...
OrgOrgRole -> Organisation: Organisation


OrgOrgRole -> ConfigurationEvent: ConfigurationEvents


OrgOrgRole -> DiagramObject: DiagramObjects


OrgOrgRole -> InstanceSet: InstanceSet


OrgOrgRole -> Name: Names


OrgOrgRole -> ChangeSetMember: PropertiesCIMDataObject


OrgOrgRole -> ChangeSetMember: TargetingCIMDataObject
