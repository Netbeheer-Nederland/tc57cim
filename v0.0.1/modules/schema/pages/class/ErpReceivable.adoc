...
ErpReceivable -> ErpRecLineItem: ErpRecLineItems


ErpReceivable -> Status: docStatus


ErpReceivable -> ElectronicAddress: electronicAddress


ErpReceivable -> Status: status


ErpReceivable -> ActivityRecord: ActivityRecord


ErpReceivable -> ConfigurationEvent: ConfigurationEvents


ErpReceivable -> Author: Author


ErpReceivable -> Editor: Editor


ErpReceivable -> Approver: Approver


ErpReceivable -> Issuer: Issuer


ErpReceivable -> DiagramObject: DiagramObjects


ErpReceivable -> InstanceSet: InstanceSet


ErpReceivable -> Name: Names


ErpReceivable -> ChangeSetMember: PropertiesCIMDataObject


ErpReceivable -> ChangeSetMember: TargetingCIMDataObject
