...
WindAeroOneDimIEC -> DiagramObject: DiagramObjects


WindAeroOneDimIEC -> InstanceSet: InstanceSet


WindAeroOneDimIEC -> Name: Names


WindAeroOneDimIEC -> ChangeSetMember: PropertiesCIMDataObject


WindAeroOneDimIEC -> ChangeSetMember: TargetingCIMDataObject
