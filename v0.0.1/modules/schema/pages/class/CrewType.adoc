...
CrewType -> DiagramObject: DiagramObjects


CrewType -> InstanceSet: InstanceSet


CrewType -> Name: Names


CrewType -> ChangeSetMember: PropertiesCIMDataObject


CrewType -> ChangeSetMember: TargetingCIMDataObject
