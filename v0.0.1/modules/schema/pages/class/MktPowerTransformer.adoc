...
MktPowerTransformer -> BranchEndFlow: EndAFlow


MktPowerTransformer -> BranchEndFlow: EndBFlow


MktPowerTransformer -> Flowgate: Flowgate
...
MktPowerTransformer -> PowerTransformerEnd: PowerTransformerEnd


MktPowerTransformer -> TransformerTank: TransformerTanks


MktPowerTransformer -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


MktPowerTransformer -> SvStatus: SvStatus


MktPowerTransformer -> ProtectionEquipment: ProtectionEquipments


MktPowerTransformer -> BaseVoltage: BaseVoltage


MktPowerTransformer -> Terminal: Terminals


MktPowerTransformer -> JumperAction: JumpingAction


MktPowerTransformer -> GroundAction: GroundingAction


MktPowerTransformer -> Outage: Outage


MktPowerTransformer -> WeatherStation: WeatherStation


MktPowerTransformer -> OperationalLimitSet: OperationalLimitSet


MktPowerTransformer -> ContingencyEquipment: ContingencyEquipment


MktPowerTransformer -> EquipmentContainer: EquipmentContainer


MktPowerTransformer -> Fault: Faults


MktPowerTransformer -> LimitDependency: LimitDependencyModel


MktPowerTransformer -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


MktPowerTransformer -> ProtectiveActionEquipment: ProtectiveActionEquipment


MktPowerTransformer -> PinEquipment: PinEquipment


MktPowerTransformer -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


MktPowerTransformer -> EquipmentContainer: AdditionalEquipmentContainer


MktPowerTransformer -> UsagePoint: UsagePoints


MktPowerTransformer -> Outage: Outages


MktPowerTransformer -> OperationalRestriction: OperationalRestrictions


MktPowerTransformer -> Control: Controls


MktPowerTransformer -> Measurement: Measurements


MktPowerTransformer -> PSRType: PSRType


MktPowerTransformer -> ConfigurationEvent: ConfigurationEvent


MktPowerTransformer -> ReportingGroup: ReportingGroup


MktPowerTransformer -> OperatingShare: OperatingShare


MktPowerTransformer -> AssetInfo: AssetDatasheet


MktPowerTransformer -> VerificationAction: VerificationAction


MktPowerTransformer -> ClearanceDocument: Clearances


MktPowerTransformer -> GenericAction: GenericAction


MktPowerTransformer -> PSREvent: PSREvents


MktPowerTransformer -> Asset: Assets


MktPowerTransformer -> Location: Location


MktPowerTransformer -> OperationalTag: OperationalTags


MktPowerTransformer -> DiagramObject: DiagramObjects


MktPowerTransformer -> InstanceSet: InstanceSet


MktPowerTransformer -> Name: Names


MktPowerTransformer -> ChangeSetMember: PropertiesCIMDataObject


MktPowerTransformer -> ChangeSetMember: TargetingCIMDataObject
