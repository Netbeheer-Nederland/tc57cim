...
CsConverter -> Terminal: PccTerminal


CsConverter -> ACDCConverterDCTerminal: DCTerminals


CsConverter -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


CsConverter -> SvStatus: SvStatus


CsConverter -> ProtectionEquipment: ProtectionEquipments


CsConverter -> BaseVoltage: BaseVoltage


CsConverter -> Terminal: Terminals


CsConverter -> JumperAction: JumpingAction


CsConverter -> GroundAction: GroundingAction


CsConverter -> Outage: Outage


CsConverter -> WeatherStation: WeatherStation


CsConverter -> OperationalLimitSet: OperationalLimitSet


CsConverter -> ContingencyEquipment: ContingencyEquipment


CsConverter -> EquipmentContainer: EquipmentContainer


CsConverter -> Fault: Faults


CsConverter -> LimitDependency: LimitDependencyModel


CsConverter -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


CsConverter -> ProtectiveActionEquipment: ProtectiveActionEquipment


CsConverter -> PinEquipment: PinEquipment


CsConverter -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


CsConverter -> EquipmentContainer: AdditionalEquipmentContainer


CsConverter -> UsagePoint: UsagePoints


CsConverter -> Outage: Outages


CsConverter -> OperationalRestriction: OperationalRestrictions
...
CsConverter -> ConfigurationEvent: ConfigurationEvent


CsConverter -> ReportingGroup: ReportingGroup


CsConverter -> OperatingShare: OperatingShare


CsConverter -> AssetInfo: AssetDatasheet


CsConverter -> VerificationAction: VerificationAction


CsConverter -> ClearanceDocument: Clearances


CsConverter -> GenericAction: GenericAction
...
CsConverter -> OperationalTag: OperationalTags


CsConverter -> DiagramObject: DiagramObjects


CsConverter -> InstanceSet: InstanceSet


CsConverter -> Name: Names


CsConverter -> ChangeSetMember: PropertiesCIMDataObject


CsConverter -> ChangeSetMember: TargetingCIMDataObject
