...
CurrentTransformer -> Terminal: Terminal


CurrentTransformer -> WeatherStation: WeatherStation


CurrentTransformer -> OperationalLimitSet: OperationalLimitSet


CurrentTransformer -> ContingencyEquipment: ContingencyEquipment


CurrentTransformer -> EquipmentContainer: EquipmentContainer


CurrentTransformer -> Fault: Faults


CurrentTransformer -> LimitDependency: LimitDependencyModel


CurrentTransformer -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


CurrentTransformer -> ProtectiveActionEquipment: ProtectiveActionEquipment


CurrentTransformer -> PinEquipment: PinEquipment


CurrentTransformer -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


CurrentTransformer -> EquipmentContainer: AdditionalEquipmentContainer


CurrentTransformer -> UsagePoint: UsagePoints


CurrentTransformer -> Outage: Outages


CurrentTransformer -> OperationalRestriction: OperationalRestrictions


CurrentTransformer -> Control: Controls


CurrentTransformer -> Measurement: Measurements


CurrentTransformer -> PSRType: PSRType


CurrentTransformer -> ConfigurationEvent: ConfigurationEvent


CurrentTransformer -> ReportingGroup: ReportingGroup


CurrentTransformer -> OperatingShare: OperatingShare


CurrentTransformer -> AssetInfo: AssetDatasheet


CurrentTransformer -> VerificationAction: VerificationAction


CurrentTransformer -> ClearanceDocument: Clearances


CurrentTransformer -> GenericAction: GenericAction


CurrentTransformer -> PSREvent: PSREvents


CurrentTransformer -> Asset: Assets


CurrentTransformer -> Location: Location


CurrentTransformer -> OperationalTag: OperationalTags


CurrentTransformer -> DiagramObject: DiagramObjects


CurrentTransformer -> InstanceSet: InstanceSet


CurrentTransformer -> Name: Names


CurrentTransformer -> ChangeSetMember: PropertiesCIMDataObject


CurrentTransformer -> ChangeSetMember: TargetingCIMDataObject
