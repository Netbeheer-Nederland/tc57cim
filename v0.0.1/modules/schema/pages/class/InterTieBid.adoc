...
InterTieBid -> RampRateCurve: RampRateCurve


InterTieBid -> RegisteredInterTie: RegisteredInterTie


InterTieBid -> BidError: BidError


InterTieBid -> MarketParticipant: MarketParticipant


InterTieBid -> EnergyMarket: EnergyMarket


InterTieBid -> ChargeProfile: ChargeProfiles


InterTieBid -> MitigatedBidSegment: MitigatedBidSegment


InterTieBid -> RMRDetermination: RMRDetermination


InterTieBid -> MitigatedBid: MitigatedBid


InterTieBid -> BidHourlySchedule: BidHourlySchedule


InterTieBid -> ProductBid: ProductBids


InterTieBid -> ActionRequest: ActionRequest


InterTieBid -> Status: docStatus


InterTieBid -> ElectronicAddress: electronicAddress


InterTieBid -> Status: status


InterTieBid -> ActivityRecord: ActivityRecord


InterTieBid -> ConfigurationEvent: ConfigurationEvents


InterTieBid -> Author: Author


InterTieBid -> Editor: Editor


InterTieBid -> Approver: Approver


InterTieBid -> Issuer: Issuer


InterTieBid -> DiagramObject: DiagramObjects


InterTieBid -> InstanceSet: InstanceSet


InterTieBid -> Name: Names


InterTieBid -> ChangeSetMember: PropertiesCIMDataObject


InterTieBid -> ChangeSetMember: TargetingCIMDataObject
