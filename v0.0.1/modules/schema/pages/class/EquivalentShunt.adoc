...
EquivalentShunt -> EquivalentNetwork: EquivalentNetwork


EquivalentShunt -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EquivalentShunt -> SvStatus: SvStatus


EquivalentShunt -> ProtectionEquipment: ProtectionEquipments


EquivalentShunt -> BaseVoltage: BaseVoltage


EquivalentShunt -> Terminal: Terminals


EquivalentShunt -> JumperAction: JumpingAction


EquivalentShunt -> GroundAction: GroundingAction


EquivalentShunt -> Outage: Outage


EquivalentShunt -> WeatherStation: WeatherStation


EquivalentShunt -> OperationalLimitSet: OperationalLimitSet


EquivalentShunt -> ContingencyEquipment: ContingencyEquipment


EquivalentShunt -> EquipmentContainer: EquipmentContainer


EquivalentShunt -> Fault: Faults


EquivalentShunt -> LimitDependency: LimitDependencyModel


EquivalentShunt -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


EquivalentShunt -> ProtectiveActionEquipment: ProtectiveActionEquipment


EquivalentShunt -> PinEquipment: PinEquipment


EquivalentShunt -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


EquivalentShunt -> EquipmentContainer: AdditionalEquipmentContainer


EquivalentShunt -> UsagePoint: UsagePoints


EquivalentShunt -> Outage: Outages


EquivalentShunt -> OperationalRestriction: OperationalRestrictions


EquivalentShunt -> Control: Controls


EquivalentShunt -> Measurement: Measurements


EquivalentShunt -> PSRType: PSRType


EquivalentShunt -> ConfigurationEvent: ConfigurationEvent


EquivalentShunt -> ReportingGroup: ReportingGroup


EquivalentShunt -> OperatingShare: OperatingShare


EquivalentShunt -> AssetInfo: AssetDatasheet


EquivalentShunt -> VerificationAction: VerificationAction


EquivalentShunt -> ClearanceDocument: Clearances


EquivalentShunt -> GenericAction: GenericAction


EquivalentShunt -> PSREvent: PSREvents


EquivalentShunt -> Asset: Assets


EquivalentShunt -> Location: Location


EquivalentShunt -> OperationalTag: OperationalTags


EquivalentShunt -> DiagramObject: DiagramObjects


EquivalentShunt -> InstanceSet: InstanceSet


EquivalentShunt -> Name: Names


EquivalentShunt -> ChangeSetMember: PropertiesCIMDataObject


EquivalentShunt -> ChangeSetMember: TargetingCIMDataObject
