...
Analog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Analog -> CalculationMethodHierarchy: CalculationMethodHierarchy


Analog -> PowerSystemResource: PowerSystemResource


Analog -> PinMeasurement: PinMeasurement


Analog -> MeasurementCalculatorInput: MeasurementCalculatorInput


Analog -> Asset: Asset


Analog -> MeasurementAction: MeasurementAction


Analog -> Location: Locations


Analog -> Procedure: Procedures


Analog -> DiagramObject: DiagramObjects


Analog -> InstanceSet: InstanceSet


Analog -> Name: Names


Analog -> ChangeSetMember: PropertiesCIMDataObject


Analog -> ChangeSetMember: TargetingCIMDataObject
