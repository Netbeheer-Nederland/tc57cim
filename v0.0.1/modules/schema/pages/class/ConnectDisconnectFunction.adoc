...
ConnectDisconnectFunction -> RemoteConnectDisconnectInfo: rcdInfo


ConnectDisconnectFunction -> Switch: Switches


ConnectDisconnectFunction -> EndDevice: EndDevice
...
ConnectDisconnectFunction -> DiagramObject: DiagramObjects


ConnectDisconnectFunction -> InstanceSet: InstanceSet


ConnectDisconnectFunction -> Name: Names


ConnectDisconnectFunction -> ChangeSetMember: PropertiesCIMDataObject


ConnectDisconnectFunction -> ChangeSetMember: TargetingCIMDataObject
