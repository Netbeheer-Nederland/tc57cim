...
Agreement -> DateTimeInterval: validityInterval


Agreement -> Status: docStatus


Agreement -> ElectronicAddress: electronicAddress


Agreement -> Status: status


Agreement -> ActivityRecord: ActivityRecord


Agreement -> ConfigurationEvent: ConfigurationEvents


Agreement -> Author: Author


Agreement -> Editor: Editor


Agreement -> Approver: Approver


Agreement -> Issuer: Issuer


Agreement -> DiagramObject: DiagramObjects


Agreement -> InstanceSet: InstanceSet


Agreement -> Name: Names


Agreement -> ChangeSetMember: PropertiesCIMDataObject


Agreement -> ChangeSetMember: TargetingCIMDataObject
