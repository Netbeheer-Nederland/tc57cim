...
BaseFrequency -> DiagramObject: DiagramObjects


BaseFrequency -> InstanceSet: InstanceSet


BaseFrequency -> Name: Names


BaseFrequency -> ChangeSetMember: PropertiesCIMDataObject


BaseFrequency -> ChangeSetMember: TargetingCIMDataObject
