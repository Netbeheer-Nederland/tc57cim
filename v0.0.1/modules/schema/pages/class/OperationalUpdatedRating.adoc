...
OperationalUpdatedRating -> PlannedOutage: PlannedOutage


OperationalUpdatedRating -> DateTimeInterval: activePeriod


OperationalUpdatedRating -> FloatQuantity: restrictedValue


OperationalUpdatedRating -> ProductAssetModel: ProductAssetModel


OperationalUpdatedRating -> Equipment: Equipments


OperationalUpdatedRating -> Status: docStatus


OperationalUpdatedRating -> ElectronicAddress: electronicAddress


OperationalUpdatedRating -> Status: status


OperationalUpdatedRating -> ActivityRecord: ActivityRecord


OperationalUpdatedRating -> ConfigurationEvent: ConfigurationEvents


OperationalUpdatedRating -> Author: Author


OperationalUpdatedRating -> Editor: Editor


OperationalUpdatedRating -> Approver: Approver


OperationalUpdatedRating -> Issuer: Issuer


OperationalUpdatedRating -> DiagramObject: DiagramObjects


OperationalUpdatedRating -> InstanceSet: InstanceSet


OperationalUpdatedRating -> Name: Names


OperationalUpdatedRating -> ChangeSetMember: PropertiesCIMDataObject


OperationalUpdatedRating -> ChangeSetMember: TargetingCIMDataObject
