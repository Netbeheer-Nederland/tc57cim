...
SeriesCompensator -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


SeriesCompensator -> SvStatus: SvStatus


SeriesCompensator -> ProtectionEquipment: ProtectionEquipments
...
SeriesCompensator -> JumperAction: JumpingAction


SeriesCompensator -> GroundAction: GroundingAction


SeriesCompensator -> Outage: Outage


SeriesCompensator -> WeatherStation: WeatherStation


SeriesCompensator -> OperationalLimitSet: OperationalLimitSet


SeriesCompensator -> ContingencyEquipment: ContingencyEquipment


SeriesCompensator -> EquipmentContainer: EquipmentContainer


SeriesCompensator -> Fault: Faults


SeriesCompensator -> LimitDependency: LimitDependencyModel


SeriesCompensator -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


SeriesCompensator -> ProtectiveActionEquipment: ProtectiveActionEquipment


SeriesCompensator -> PinEquipment: PinEquipment


SeriesCompensator -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


SeriesCompensator -> EquipmentContainer: AdditionalEquipmentContainer


SeriesCompensator -> UsagePoint: UsagePoints


SeriesCompensator -> Outage: Outages


SeriesCompensator -> OperationalRestriction: OperationalRestrictions


SeriesCompensator -> Control: Controls


SeriesCompensator -> Measurement: Measurements


SeriesCompensator -> PSRType: PSRType


SeriesCompensator -> ConfigurationEvent: ConfigurationEvent


SeriesCompensator -> ReportingGroup: ReportingGroup


SeriesCompensator -> OperatingShare: OperatingShare


SeriesCompensator -> AssetInfo: AssetDatasheet


SeriesCompensator -> VerificationAction: VerificationAction


SeriesCompensator -> ClearanceDocument: Clearances


SeriesCompensator -> GenericAction: GenericAction


SeriesCompensator -> PSREvent: PSREvents


SeriesCompensator -> Asset: Assets


SeriesCompensator -> Location: Location


SeriesCompensator -> OperationalTag: OperationalTags


SeriesCompensator -> DiagramObject: DiagramObjects


SeriesCompensator -> InstanceSet: InstanceSet


SeriesCompensator -> Name: Names


SeriesCompensator -> ChangeSetMember: PropertiesCIMDataObject


SeriesCompensator -> ChangeSetMember: TargetingCIMDataObject
