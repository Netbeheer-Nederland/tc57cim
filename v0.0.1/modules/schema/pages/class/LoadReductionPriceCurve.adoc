...
LoadReductionPriceCurve -> LoadBid: LoadBid


LoadReductionPriceCurve -> CurveData: CurveDatas


LoadReductionPriceCurve -> DiagramObject: DiagramObjects


LoadReductionPriceCurve -> InstanceSet: InstanceSet


LoadReductionPriceCurve -> Name: Names


LoadReductionPriceCurve -> ChangeSetMember: PropertiesCIMDataObject


LoadReductionPriceCurve -> ChangeSetMember: TargetingCIMDataObject
