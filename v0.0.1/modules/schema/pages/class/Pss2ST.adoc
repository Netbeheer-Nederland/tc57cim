...
Pss2ST -> ExcitationSystemDynamics: ExcitationSystemDynamics


Pss2ST -> RemoteInputSignal: RemoteInputSignal


Pss2ST -> DiagramObject: DiagramObjects


Pss2ST -> InstanceSet: InstanceSet


Pss2ST -> Name: Names


Pss2ST -> ChangeSetMember: PropertiesCIMDataObject


Pss2ST -> ChangeSetMember: TargetingCIMDataObject
