...
AssetPropertyCurve -> Specification: Specification


AssetPropertyCurve -> Asset: Assets


AssetPropertyCurve -> CurveData: CurveDatas


AssetPropertyCurve -> DiagramObject: DiagramObjects


AssetPropertyCurve -> InstanceSet: InstanceSet


AssetPropertyCurve -> Name: Names


AssetPropertyCurve -> ChangeSetMember: PropertiesCIMDataObject


AssetPropertyCurve -> ChangeSetMember: TargetingCIMDataObject
