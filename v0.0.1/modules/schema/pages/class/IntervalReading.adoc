...
IntervalReading -> IntervalBlock: IntervalBlocks


IntervalReading -> DateTimeInterval: timePeriod


IntervalReading -> ReadingQuality: ReadingQualities



IntervalReading -> RemoteSource: RemoteSource


IntervalReading -> MeasurementValueQuality: MeasurementValueQuality


IntervalReading -> MeasurementValueSource: MeasurementValueSource


IntervalReading -> CalculationMethodHierarchy: CalculationMethodHierarchy


IntervalReading -> ProcedureDataSet: ProcedureDataSet


IntervalReading -> OldPerson: ErpPerson


IntervalReading -> ProvidedBilateralPoint: BilateralToIOPoint


IntervalReading -> IOPointSource: IOPointSource


IntervalReading -> DiagramObject: DiagramObjects


IntervalReading -> InstanceSet: InstanceSet


IntervalReading -> Name: Names


IntervalReading -> ChangeSetMember: PropertiesCIMDataObject


IntervalReading -> ChangeSetMember: TargetingCIMDataObject
