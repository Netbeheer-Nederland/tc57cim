...
MaintenanceDataSet -> WorkTask: WorkTask


MaintenanceDataSet -> TransformerObservation: TransformerObservations


MaintenanceDataSet -> MeasurementValue: MeasurementValue


MaintenanceDataSet -> Asset: Asset


MaintenanceDataSet -> UserAttribute: Properties


MaintenanceDataSet -> Procedure: Procedure


MaintenanceDataSet -> Status: docStatus


MaintenanceDataSet -> ElectronicAddress: electronicAddress


MaintenanceDataSet -> Status: status


MaintenanceDataSet -> ActivityRecord: ActivityRecord


MaintenanceDataSet -> ConfigurationEvent: ConfigurationEvents


MaintenanceDataSet -> Author: Author


MaintenanceDataSet -> Editor: Editor


MaintenanceDataSet -> Approver: Approver


MaintenanceDataSet -> Issuer: Issuer


MaintenanceDataSet -> DiagramObject: DiagramObjects


MaintenanceDataSet -> InstanceSet: InstanceSet


MaintenanceDataSet -> Name: Names


MaintenanceDataSet -> ChangeSetMember: PropertiesCIMDataObject


MaintenanceDataSet -> ChangeSetMember: TargetingCIMDataObject
