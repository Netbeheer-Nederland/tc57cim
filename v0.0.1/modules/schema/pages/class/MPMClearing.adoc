...
MPMClearing -> MPMTestResults: MPMTestResults


MPMClearing -> MktActivityRecord: MktActivityRecord


MPMClearing -> Market: Market


MPMClearing -> Status: docStatus


MPMClearing -> ElectronicAddress: electronicAddress


MPMClearing -> Status: status


MPMClearing -> ActivityRecord: ActivityRecord


MPMClearing -> ConfigurationEvent: ConfigurationEvents


MPMClearing -> Author: Author


MPMClearing -> Editor: Editor


MPMClearing -> Approver: Approver


MPMClearing -> Issuer: Issuer


MPMClearing -> DiagramObject: DiagramObjects


MPMClearing -> InstanceSet: InstanceSet


MPMClearing -> Name: Names


MPMClearing -> ChangeSetMember: PropertiesCIMDataObject


MPMClearing -> ChangeSetMember: TargetingCIMDataObject
