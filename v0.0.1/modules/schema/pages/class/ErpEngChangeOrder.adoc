...
ErpEngChangeOrder -> Status: docStatus


ErpEngChangeOrder -> ElectronicAddress: electronicAddress


ErpEngChangeOrder -> Status: status


ErpEngChangeOrder -> ActivityRecord: ActivityRecord


ErpEngChangeOrder -> ConfigurationEvent: ConfigurationEvents


ErpEngChangeOrder -> Author: Author


ErpEngChangeOrder -> Editor: Editor


ErpEngChangeOrder -> Approver: Approver


ErpEngChangeOrder -> Issuer: Issuer


ErpEngChangeOrder -> DiagramObject: DiagramObjects


ErpEngChangeOrder -> InstanceSet: InstanceSet


ErpEngChangeOrder -> Name: Names


ErpEngChangeOrder -> ChangeSetMember: PropertiesCIMDataObject


ErpEngChangeOrder -> ChangeSetMember: TargetingCIMDataObject
