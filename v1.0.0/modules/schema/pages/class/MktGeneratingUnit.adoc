...
MktGeneratingUnit -> GeneratingUnitDynamicValues: GeneratingUnitDynamicValues
...
MktGeneratingUnit -> RotatingMachine: RotatingMachine


MktGeneratingUnit -> GenUnitOpSchedule: GenUnitOpSchedule


MktGeneratingUnit -> ControlAreaGeneratingUnit: ControlAreaGeneratingUnit


MktGeneratingUnit -> GrossToNetActivePowerCurve: GrossToNetActivePowerCurves


MktGeneratingUnit -> GenUnitOpCostCurve: GenUnitOpCostCurves


MktGeneratingUnit -> WeatherStation: WeatherStation


MktGeneratingUnit -> OperationalLimitSet: OperationalLimitSet


MktGeneratingUnit -> ContingencyEquipment: ContingencyEquipment


MktGeneratingUnit -> EquipmentContainer: EquipmentContainer


MktGeneratingUnit -> Fault: Faults


MktGeneratingUnit -> LimitDependency: LimitDependencyModel


MktGeneratingUnit -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


MktGeneratingUnit -> ProtectiveActionEquipment: ProtectiveActionEquipment


MktGeneratingUnit -> PinEquipment: PinEquipment


MktGeneratingUnit -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


MktGeneratingUnit -> EquipmentContainer: AdditionalEquipmentContainer


MktGeneratingUnit -> UsagePoint: UsagePoints


MktGeneratingUnit -> Outage: Outages


MktGeneratingUnit -> OperationalRestriction: OperationalRestrictions


MktGeneratingUnit -> Control: Controls


MktGeneratingUnit -> Measurement: Measurements


MktGeneratingUnit -> PSRType: PSRType


MktGeneratingUnit -> ConfigurationEvent: ConfigurationEvent


MktGeneratingUnit -> ReportingGroup: ReportingGroup


MktGeneratingUnit -> OperatingShare: OperatingShare


MktGeneratingUnit -> AssetInfo: AssetDatasheet


MktGeneratingUnit -> VerificationAction: VerificationAction


MktGeneratingUnit -> ClearanceDocument: Clearances


MktGeneratingUnit -> GenericAction: GenericAction


MktGeneratingUnit -> PSREvent: PSREvents


MktGeneratingUnit -> Asset: Assets


MktGeneratingUnit -> Location: Location


MktGeneratingUnit -> OperationalTag: OperationalTags


MktGeneratingUnit -> DiagramObject: DiagramObjects


MktGeneratingUnit -> InstanceSet: InstanceSet


MktGeneratingUnit -> Name: Names


MktGeneratingUnit -> ChangeSetMember: PropertiesCIMDataObject


MktGeneratingUnit -> ChangeSetMember: TargetingCIMDataObject
