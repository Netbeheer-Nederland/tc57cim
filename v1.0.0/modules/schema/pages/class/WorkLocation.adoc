...
WorkLocation -> OneCallRequest: OneCallRequest


WorkLocation -> BaseWork: BaseWorks


WorkLocation -> DesignLocation: DesignLocations


WorkLocation -> ElectronicAddress: electronicAddress


WorkLocation -> StreetAddress: mainAddress


WorkLocation -> TelephoneNumber: phone1


WorkLocation -> TelephoneNumber: phone2


WorkLocation -> StreetAddress: secondaryAddress


WorkLocation -> Status: status


WorkLocation -> ConfigurationEvent: ConfigurationEvents


WorkLocation -> SwitchingOrder: SwitchingOrder


WorkLocation -> Crew: Crew


WorkLocation -> PowerSystemResource: PowerSystemResources


WorkLocation -> CoordinateSystem: CoordinateSystem


WorkLocation -> PositionPoint: PositionPoints
...
WorkLocation -> TroubleOrder: TroubleOrder


WorkLocation -> OutageOrder: OutageOrder
...
WorkLocation -> LandProperty: LandProperties


WorkLocation -> Route: Routes


WorkLocation -> TroubleTicket: TroubleTicket


WorkLocation -> EnvironmentalLocationType: EnvironmentalLocationKind


WorkLocation -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


WorkLocation -> DiagramObject: DiagramObjects


WorkLocation -> InstanceSet: InstanceSet


WorkLocation -> Name: Names


WorkLocation -> ChangeSetMember: PropertiesCIMDataObject


WorkLocation -> ChangeSetMember: TargetingCIMDataObject
