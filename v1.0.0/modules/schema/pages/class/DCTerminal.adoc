...
DCTerminal -> DCTopologicalNode: DCTopologicalNode


DCTerminal -> DCNode: DCNode


DCTerminal -> BusNameMarker: BusNameMarker


DCTerminal -> OperationalLimitSet: OperationalLimitSet


DCTerminal -> Measurement: Measurements


DCTerminal -> DiagramObject: DiagramObjects


DCTerminal -> InstanceSet: InstanceSet


DCTerminal -> Name: Names


DCTerminal -> ChangeSetMember: PropertiesCIMDataObject


DCTerminal -> ChangeSetMember: TargetingCIMDataObject
