...
HeatRecoveryBoiler -> CombustionTurbine: CombustionTurbines
...
HeatRecoveryBoiler -> SteamTurbine: SteamTurbines
...
HeatRecoveryBoiler -> ConfigurationEvent: ConfigurationEvent


HeatRecoveryBoiler -> ReportingGroup: ReportingGroup


HeatRecoveryBoiler -> OperatingShare: OperatingShare


HeatRecoveryBoiler -> AssetInfo: AssetDatasheet


HeatRecoveryBoiler -> VerificationAction: VerificationAction


HeatRecoveryBoiler -> ClearanceDocument: Clearances


HeatRecoveryBoiler -> GenericAction: GenericAction
...
HeatRecoveryBoiler -> OperationalTag: OperationalTags


HeatRecoveryBoiler -> DiagramObject: DiagramObjects


HeatRecoveryBoiler -> InstanceSet: InstanceSet


HeatRecoveryBoiler -> Name: Names


HeatRecoveryBoiler -> ChangeSetMember: PropertiesCIMDataObject


HeatRecoveryBoiler -> ChangeSetMember: TargetingCIMDataObject
