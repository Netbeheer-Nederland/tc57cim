...
OilAnalysisParticleDiscrete -> TestStandard: TestStandard


OilAnalysisParticleDiscrete -> DiscreteValue: DiscreteValues


OilAnalysisParticleDiscrete -> ValueAliasSet: ValueAliasSet


OilAnalysisParticleDiscrete -> ACDCTerminal: Terminal


OilAnalysisParticleDiscrete -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


OilAnalysisParticleDiscrete -> CalculationMethodHierarchy: CalculationMethodHierarchy


OilAnalysisParticleDiscrete -> PowerSystemResource: PowerSystemResource


OilAnalysisParticleDiscrete -> PinMeasurement: PinMeasurement


OilAnalysisParticleDiscrete -> MeasurementCalculatorInput: MeasurementCalculatorInput


OilAnalysisParticleDiscrete -> Asset: Asset


OilAnalysisParticleDiscrete -> MeasurementAction: MeasurementAction


OilAnalysisParticleDiscrete -> Location: Locations


OilAnalysisParticleDiscrete -> Procedure: Procedures


OilAnalysisParticleDiscrete -> DiagramObject: DiagramObjects


OilAnalysisParticleDiscrete -> InstanceSet: InstanceSet


OilAnalysisParticleDiscrete -> Name: Names


OilAnalysisParticleDiscrete -> ChangeSetMember: PropertiesCIMDataObject


OilAnalysisParticleDiscrete -> ChangeSetMember: TargetingCIMDataObject
