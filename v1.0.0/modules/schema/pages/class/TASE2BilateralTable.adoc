...
TASE2BilateralTable -> ICCPInformationMessage: ICCPInformationMessage
...
TASE2BilateralTable -> DiagramObject: DiagramObjects


TASE2BilateralTable -> InstanceSet: InstanceSet


TASE2BilateralTable -> Name: Names


TASE2BilateralTable -> ChangeSetMember: PropertiesCIMDataObject


TASE2BilateralTable -> ChangeSetMember: TargetingCIMDataObject
