...
HeatInputCurve -> ThermalGeneratingUnit: ThermalGeneratingUnit


HeatInputCurve -> CurveData: CurveDatas


HeatInputCurve -> DiagramObject: DiagramObjects


HeatInputCurve -> InstanceSet: InstanceSet


HeatInputCurve -> Name: Names


HeatInputCurve -> ChangeSetMember: PropertiesCIMDataObject


HeatInputCurve -> ChangeSetMember: TargetingCIMDataObject
