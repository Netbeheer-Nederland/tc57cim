...
WaveTrap -> Terminal: Terminal


WaveTrap -> WeatherStation: WeatherStation


WaveTrap -> OperationalLimitSet: OperationalLimitSet


WaveTrap -> ContingencyEquipment: ContingencyEquipment


WaveTrap -> EquipmentContainer: EquipmentContainer


WaveTrap -> Fault: Faults


WaveTrap -> LimitDependency: LimitDependencyModel


WaveTrap -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


WaveTrap -> ProtectiveActionEquipment: ProtectiveActionEquipment


WaveTrap -> PinEquipment: PinEquipment


WaveTrap -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


WaveTrap -> EquipmentContainer: AdditionalEquipmentContainer


WaveTrap -> UsagePoint: UsagePoints


WaveTrap -> Outage: Outages


WaveTrap -> OperationalRestriction: OperationalRestrictions


WaveTrap -> Control: Controls


WaveTrap -> Measurement: Measurements


WaveTrap -> PSRType: PSRType


WaveTrap -> ConfigurationEvent: ConfigurationEvent


WaveTrap -> ReportingGroup: ReportingGroup


WaveTrap -> OperatingShare: OperatingShare


WaveTrap -> AssetInfo: AssetDatasheet


WaveTrap -> VerificationAction: VerificationAction


WaveTrap -> ClearanceDocument: Clearances


WaveTrap -> GenericAction: GenericAction


WaveTrap -> PSREvent: PSREvents


WaveTrap -> Asset: Assets


WaveTrap -> Location: Location


WaveTrap -> OperationalTag: OperationalTags


WaveTrap -> DiagramObject: DiagramObjects


WaveTrap -> InstanceSet: InstanceSet


WaveTrap -> Name: Names


WaveTrap -> ChangeSetMember: PropertiesCIMDataObject


WaveTrap -> ChangeSetMember: TargetingCIMDataObject
