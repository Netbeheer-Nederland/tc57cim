...
ResourcePerformanceRating -> RegisteredDistributedResource: RegisteredResource


ResourcePerformanceRating -> DiagramObject: DiagramObjects


ResourcePerformanceRating -> InstanceSet: InstanceSet


ResourcePerformanceRating -> Name: Names


ResourcePerformanceRating -> ChangeSetMember: PropertiesCIMDataObject


ResourcePerformanceRating -> ChangeSetMember: TargetingCIMDataObject
