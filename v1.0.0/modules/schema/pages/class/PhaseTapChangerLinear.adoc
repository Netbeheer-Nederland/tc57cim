...
PhaseTapChangerLinear -> TransformerEnd: TransformerEnd





PhaseTapChangerLinear -> TapChangerControl: TapChangerControl


PhaseTapChangerLinear -> SvTapStep: SvTapStep


PhaseTapChangerLinear -> TapSchedule: TapSchedules
...
PhaseTapChangerLinear -> ConfigurationEvent: ConfigurationEvent


PhaseTapChangerLinear -> ReportingGroup: ReportingGroup


PhaseTapChangerLinear -> OperatingShare: OperatingShare


PhaseTapChangerLinear -> AssetInfo: AssetDatasheet


PhaseTapChangerLinear -> VerificationAction: VerificationAction


PhaseTapChangerLinear -> ClearanceDocument: Clearances


PhaseTapChangerLinear -> GenericAction: GenericAction
...
PhaseTapChangerLinear -> OperationalTag: OperationalTags


PhaseTapChangerLinear -> DiagramObject: DiagramObjects


PhaseTapChangerLinear -> InstanceSet: InstanceSet


PhaseTapChangerLinear -> Name: Names


PhaseTapChangerLinear -> ChangeSetMember: PropertiesCIMDataObject


PhaseTapChangerLinear -> ChangeSetMember: TargetingCIMDataObject
