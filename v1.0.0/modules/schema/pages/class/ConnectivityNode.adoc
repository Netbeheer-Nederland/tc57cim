...
ConnectivityNode -> DiagramObject: DiagramObjects


ConnectivityNode -> InstanceSet: InstanceSet


ConnectivityNode -> Name: Names


ConnectivityNode -> ChangeSetMember: PropertiesCIMDataObject


ConnectivityNode -> ChangeSetMember: TargetingCIMDataObject
