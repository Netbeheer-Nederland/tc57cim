...
RecloserInfo -> PowerSystemResource: PowerSystemResources


RecloserInfo -> CatalogAssetType: CatalogAssetType


RecloserInfo -> Asset: Assets


RecloserInfo -> ProductAssetModel: ProductAssetModel


RecloserInfo -> DiagramObject: DiagramObjects


RecloserInfo -> InstanceSet: InstanceSet


RecloserInfo -> Name: Names


RecloserInfo -> ChangeSetMember: PropertiesCIMDataObject


RecloserInfo -> ChangeSetMember: TargetingCIMDataObject
