...
Bank -> Organisation: Organisation


Bank -> ConfigurationEvent: ConfigurationEvents


Bank -> DiagramObject: DiagramObjects


Bank -> InstanceSet: InstanceSet


Bank -> Name: Names


Bank -> ChangeSetMember: PropertiesCIMDataObject


Bank -> ChangeSetMember: TargetingCIMDataObject
