...
ErpJournal -> ErpJournalEntry: ErpJournalEntries


ErpJournal -> Status: docStatus


ErpJournal -> ElectronicAddress: electronicAddress


ErpJournal -> Status: status


ErpJournal -> ActivityRecord: ActivityRecord


ErpJournal -> ConfigurationEvent: ConfigurationEvents


ErpJournal -> Author: Author


ErpJournal -> Editor: Editor


ErpJournal -> Approver: Approver


ErpJournal -> Issuer: Issuer


ErpJournal -> DiagramObject: DiagramObjects


ErpJournal -> InstanceSet: InstanceSet


ErpJournal -> Name: Names


ErpJournal -> ChangeSetMember: PropertiesCIMDataObject


ErpJournal -> ChangeSetMember: TargetingCIMDataObject
