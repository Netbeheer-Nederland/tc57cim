...
BusinessCase -> Project: Projects


BusinessCase -> Work: Works


BusinessCase -> Status: docStatus


BusinessCase -> ElectronicAddress: electronicAddress


BusinessCase -> Status: status


BusinessCase -> ActivityRecord: ActivityRecord


BusinessCase -> ConfigurationEvent: ConfigurationEvents


BusinessCase -> Author: Author


BusinessCase -> Editor: Editor


BusinessCase -> Approver: Approver


BusinessCase -> Issuer: Issuer


BusinessCase -> DiagramObject: DiagramObjects


BusinessCase -> InstanceSet: InstanceSet


BusinessCase -> Name: Names


BusinessCase -> ChangeSetMember: PropertiesCIMDataObject


BusinessCase -> ChangeSetMember: TargetingCIMDataObject
