...
FossilFuel -> FuelAllocationSchedule: FuelAllocationSchedules


FossilFuel -> ThermalGeneratingUnit: ThermalGeneratingUnit


FossilFuel -> DiagramObject: DiagramObjects


FossilFuel -> InstanceSet: InstanceSet


FossilFuel -> Name: Names


FossilFuel -> ChangeSetMember: PropertiesCIMDataObject


FossilFuel -> ChangeSetMember: TargetingCIMDataObject
