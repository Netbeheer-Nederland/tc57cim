...
ComplianceEvent -> Document: Document


ComplianceEvent -> Author: Author


ComplianceEvent -> Asset: Assets


ComplianceEvent -> DiagramObject: DiagramObjects


ComplianceEvent -> InstanceSet: InstanceSet


ComplianceEvent -> Name: Names


ComplianceEvent -> ChangeSetMember: PropertiesCIMDataObject


ComplianceEvent -> ChangeSetMember: TargetingCIMDataObject
