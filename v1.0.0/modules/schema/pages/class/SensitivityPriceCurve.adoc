...
SensitivityPriceCurve -> ReserveReq: ReserveReq


SensitivityPriceCurve -> CurveData: CurveDatas


SensitivityPriceCurve -> DiagramObject: DiagramObjects


SensitivityPriceCurve -> InstanceSet: InstanceSet


SensitivityPriceCurve -> Name: Names


SensitivityPriceCurve -> ChangeSetMember: PropertiesCIMDataObject


SensitivityPriceCurve -> ChangeSetMember: TargetingCIMDataObject
