...
EnergyConsumerAction -> EnergyConsumer: EnergyConsumer


EnergyConsumerAction -> SwitchingPlan: SwitchingPlan
...
EnergyConsumerAction -> SwitchingEvent: SwitchingEvent


EnergyConsumerAction -> SwitchingStep: SwitchingStep


EnergyConsumerAction -> DiagramObject: DiagramObjects


EnergyConsumerAction -> InstanceSet: InstanceSet


EnergyConsumerAction -> Name: Names


EnergyConsumerAction -> ChangeSetMember: PropertiesCIMDataObject


EnergyConsumerAction -> ChangeSetMember: TargetingCIMDataObject
