...
RedLine -> DiagramObject: DiagramObjects


RedLine -> InstanceSet: InstanceSet


RedLine -> Name: Names


RedLine -> ChangeSetMember: PropertiesCIMDataObject


RedLine -> ChangeSetMember: TargetingCIMDataObject
