...
Assignment -> DateTimeInterval: effectivePeriod


Assignment -> OldCrew: Crews


Assignment -> Status: docStatus


Assignment -> ElectronicAddress: electronicAddress


Assignment -> Status: status


Assignment -> ActivityRecord: ActivityRecord


Assignment -> ConfigurationEvent: ConfigurationEvents
...
Assignment -> DiagramObject: DiagramObjects


Assignment -> InstanceSet: InstanceSet


Assignment -> Name: Names


Assignment -> ChangeSetMember: PropertiesCIMDataObject


Assignment -> ChangeSetMember: TargetingCIMDataObject
