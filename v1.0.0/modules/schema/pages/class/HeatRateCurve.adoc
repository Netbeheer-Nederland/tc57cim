...
HeatRateCurve -> ThermalGeneratingUnit: ThermalGeneratingUnit


HeatRateCurve -> CurveData: CurveDatas


HeatRateCurve -> DiagramObject: DiagramObjects


HeatRateCurve -> InstanceSet: InstanceSet


HeatRateCurve -> Name: Names


HeatRateCurve -> ChangeSetMember: PropertiesCIMDataObject


HeatRateCurve -> ChangeSetMember: TargetingCIMDataObject
