...
TagAction -> OperationalTag: OperationalTag


TagAction -> SwitchingPlan: SwitchingPlan
...
TagAction -> SwitchingEvent: SwitchingEvent


TagAction -> SwitchingStep: SwitchingStep


TagAction -> DiagramObject: DiagramObjects


TagAction -> InstanceSet: InstanceSet


TagAction -> Name: Names


TagAction -> ChangeSetMember: PropertiesCIMDataObject


TagAction -> ChangeSetMember: TargetingCIMDataObject
