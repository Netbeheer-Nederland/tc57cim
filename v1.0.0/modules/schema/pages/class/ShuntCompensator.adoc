...
ShuntCompensator -> ShuntCompensatorPhase: ShuntCompensatorPhase


ShuntCompensator -> ShuntCompensatorAction: ShuntCompensatorAction


ShuntCompensator -> SvShuntCompensatorSections: SvShuntCompensatorSections


ShuntCompensator -> RegulatingControl: RegulatingControl


ShuntCompensator -> EnergyComponent: EnergyComponent


ShuntCompensator -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


ShuntCompensator -> SvStatus: SvStatus


ShuntCompensator -> ProtectionEquipment: ProtectionEquipments


ShuntCompensator -> BaseVoltage: BaseVoltage


ShuntCompensator -> Terminal: Terminals


ShuntCompensator -> JumperAction: JumpingAction


ShuntCompensator -> GroundAction: GroundingAction


ShuntCompensator -> Outage: Outage


ShuntCompensator -> WeatherStation: WeatherStation


ShuntCompensator -> OperationalLimitSet: OperationalLimitSet


ShuntCompensator -> ContingencyEquipment: ContingencyEquipment


ShuntCompensator -> EquipmentContainer: EquipmentContainer


ShuntCompensator -> Fault: Faults


ShuntCompensator -> LimitDependency: LimitDependencyModel


ShuntCompensator -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ShuntCompensator -> ProtectiveActionEquipment: ProtectiveActionEquipment


ShuntCompensator -> PinEquipment: PinEquipment


ShuntCompensator -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ShuntCompensator -> EquipmentContainer: AdditionalEquipmentContainer


ShuntCompensator -> UsagePoint: UsagePoints


ShuntCompensator -> Outage: Outages


ShuntCompensator -> OperationalRestriction: OperationalRestrictions


ShuntCompensator -> Control: Controls


ShuntCompensator -> Measurement: Measurements


ShuntCompensator -> PSRType: PSRType


ShuntCompensator -> ConfigurationEvent: ConfigurationEvent


ShuntCompensator -> ReportingGroup: ReportingGroup


ShuntCompensator -> OperatingShare: OperatingShare


ShuntCompensator -> AssetInfo: AssetDatasheet


ShuntCompensator -> VerificationAction: VerificationAction


ShuntCompensator -> ClearanceDocument: Clearances


ShuntCompensator -> GenericAction: GenericAction


ShuntCompensator -> PSREvent: PSREvents


ShuntCompensator -> Asset: Assets


ShuntCompensator -> Location: Location


ShuntCompensator -> OperationalTag: OperationalTags


ShuntCompensator -> DiagramObject: DiagramObjects


ShuntCompensator -> InstanceSet: InstanceSet


ShuntCompensator -> Name: Names


ShuntCompensator -> ChangeSetMember: PropertiesCIMDataObject


ShuntCompensator -> ChangeSetMember: TargetingCIMDataObject
