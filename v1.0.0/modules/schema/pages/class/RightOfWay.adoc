...
RightOfWay -> LandProperty: LandProperties


RightOfWay -> DateTimeInterval: validityInterval


RightOfWay -> Status: docStatus


RightOfWay -> ElectronicAddress: electronicAddress


RightOfWay -> Status: status


RightOfWay -> ActivityRecord: ActivityRecord


RightOfWay -> ConfigurationEvent: ConfigurationEvents


RightOfWay -> Author: Author


RightOfWay -> Editor: Editor


RightOfWay -> Approver: Approver


RightOfWay -> Issuer: Issuer


RightOfWay -> DiagramObject: DiagramObjects


RightOfWay -> InstanceSet: InstanceSet


RightOfWay -> Name: Names


RightOfWay -> ChangeSetMember: PropertiesCIMDataObject


RightOfWay -> ChangeSetMember: TargetingCIMDataObject
