...
VSCUserDefined -> VsConverter: VsConverter


VSCUserDefined -> DiagramObject: DiagramObjects


VSCUserDefined -> InstanceSet: InstanceSet


VSCUserDefined -> Name: Names


VSCUserDefined -> ChangeSetMember: PropertiesCIMDataObject


VSCUserDefined -> ChangeSetMember: TargetingCIMDataObject
