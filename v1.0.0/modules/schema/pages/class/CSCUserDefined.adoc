...
CSCUserDefined -> CsConverter: CSConverter


CSCUserDefined -> DiagramObject: DiagramObjects


CSCUserDefined -> InstanceSet: InstanceSet


CSCUserDefined -> Name: Names


CSCUserDefined -> ChangeSetMember: PropertiesCIMDataObject


CSCUserDefined -> ChangeSetMember: TargetingCIMDataObject
