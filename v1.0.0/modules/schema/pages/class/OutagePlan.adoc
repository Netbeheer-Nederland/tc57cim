...
OutagePlan -> DateTimeInterval: plannedPeriod


OutagePlan -> OutageOrder: OutageOrder


OutagePlan -> PlannedOutage: PlannedOutage


OutagePlan -> SwitchingPlan: SwitchingPlan


OutagePlan -> Customer: Customer


OutagePlan -> Status: docStatus


OutagePlan -> ElectronicAddress: electronicAddress


OutagePlan -> Status: status


OutagePlan -> ActivityRecord: ActivityRecord


OutagePlan -> ConfigurationEvent: ConfigurationEvents


OutagePlan -> Author: Author


OutagePlan -> Editor: Editor


OutagePlan -> Approver: Approver


OutagePlan -> Issuer: Issuer


OutagePlan -> DiagramObject: DiagramObjects


OutagePlan -> InstanceSet: InstanceSet


OutagePlan -> Name: Names


OutagePlan -> ChangeSetMember: PropertiesCIMDataObject


OutagePlan -> ChangeSetMember: TargetingCIMDataObject
