...
InternalLocation -> OneCallRequest: OneCallRequest


InternalLocation -> BaseWork: BaseWorks


InternalLocation -> DesignLocation: DesignLocations


InternalLocation -> ElectronicAddress: electronicAddress


InternalLocation -> StreetAddress: mainAddress


InternalLocation -> TelephoneNumber: phone1


InternalLocation -> TelephoneNumber: phone2


InternalLocation -> StreetAddress: secondaryAddress


InternalLocation -> Status: status


InternalLocation -> ConfigurationEvent: ConfigurationEvents


InternalLocation -> SwitchingOrder: SwitchingOrder


InternalLocation -> Crew: Crew


InternalLocation -> PowerSystemResource: PowerSystemResources


InternalLocation -> CoordinateSystem: CoordinateSystem


InternalLocation -> PositionPoint: PositionPoints
...
InternalLocation -> TroubleOrder: TroubleOrder


InternalLocation -> OutageOrder: OutageOrder
...
InternalLocation -> LandProperty: LandProperties


InternalLocation -> Route: Routes


InternalLocation -> TroubleTicket: TroubleTicket


InternalLocation -> EnvironmentalLocationType: EnvironmentalLocationKind


InternalLocation -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


InternalLocation -> DiagramObject: DiagramObjects


InternalLocation -> InstanceSet: InstanceSet


InternalLocation -> Name: Names


InternalLocation -> ChangeSetMember: PropertiesCIMDataObject


InternalLocation -> ChangeSetMember: TargetingCIMDataObject
