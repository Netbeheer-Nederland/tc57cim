...
TieFlow -> AltTieMeas: AltTieMeas


TieFlow -> DiagramObject: DiagramObjects


TieFlow -> InstanceSet: InstanceSet


TieFlow -> Name: Names


TieFlow -> ChangeSetMember: PropertiesCIMDataObject


TieFlow -> ChangeSetMember: TargetingCIMDataObject
