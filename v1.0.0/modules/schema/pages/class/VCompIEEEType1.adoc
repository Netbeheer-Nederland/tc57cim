...
VCompIEEEType1 -> ExcitationSystemDynamics: ExcitationSystemDynamics


VCompIEEEType1 -> RemoteInputSignal: RemoteInputSignal


VCompIEEEType1 -> DiagramObject: DiagramObjects


VCompIEEEType1 -> InstanceSet: InstanceSet


VCompIEEEType1 -> Name: Names


VCompIEEEType1 -> ChangeSetMember: PropertiesCIMDataObject


VCompIEEEType1 -> ChangeSetMember: TargetingCIMDataObject
