...
RemoteUnit -> CommunicationLink: CommunicationLinks


RemoteUnit -> RemotePoint: RemotePoints


RemoteUnit -> Control: Controls


RemoteUnit -> Measurement: Measurements


RemoteUnit -> PSRType: PSRType


RemoteUnit -> ConfigurationEvent: ConfigurationEvent


RemoteUnit -> ReportingGroup: ReportingGroup


RemoteUnit -> OperatingShare: OperatingShare


RemoteUnit -> AssetInfo: AssetDatasheet


RemoteUnit -> VerificationAction: VerificationAction


RemoteUnit -> ClearanceDocument: Clearances


RemoteUnit -> GenericAction: GenericAction


RemoteUnit -> PSREvent: PSREvents


RemoteUnit -> Asset: Assets


RemoteUnit -> Location: Location


RemoteUnit -> OperationalTag: OperationalTags


RemoteUnit -> DiagramObject: DiagramObjects


RemoteUnit -> InstanceSet: InstanceSet


RemoteUnit -> Name: Names


RemoteUnit -> ChangeSetMember: PropertiesCIMDataObject


RemoteUnit -> ChangeSetMember: TargetingCIMDataObject
