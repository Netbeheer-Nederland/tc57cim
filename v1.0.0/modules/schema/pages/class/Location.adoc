...
Location -> ElectronicAddress: electronicAddress


Location -> StreetAddress: mainAddress


Location -> TelephoneNumber: phone1


Location -> TelephoneNumber: phone2
...
Location -> ConfigurationEvent: ConfigurationEvents


Location -> SwitchingOrder: SwitchingOrder
...
Location -> TroubleOrder: TroubleOrder


Location -> OutageOrder: OutageOrder
...
Location -> LandProperty: LandProperties


Location -> Route: Routes


Location -> TroubleTicket: TroubleTicket


Location -> EnvironmentalLocationType: EnvironmentalLocationKind


Location -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


Location -> DiagramObject: DiagramObjects


Location -> InstanceSet: InstanceSet


Location -> Name: Names


Location -> ChangeSetMember: PropertiesCIMDataObject


Location -> ChangeSetMember: TargetingCIMDataObject
