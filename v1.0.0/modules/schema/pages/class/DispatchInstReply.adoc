...
DispatchInstReply -> RegisteredResource: RegisteredResource


DispatchInstReply -> DiagramObject: DiagramObjects


DispatchInstReply -> InstanceSet: InstanceSet


DispatchInstReply -> Name: Names


DispatchInstReply -> ChangeSetMember: PropertiesCIMDataObject


DispatchInstReply -> ChangeSetMember: TargetingCIMDataObject
