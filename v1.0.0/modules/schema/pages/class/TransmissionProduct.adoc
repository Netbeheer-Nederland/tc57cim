...
TransmissionProduct -> TransmissionPath: LocationFor


TransmissionProduct -> TransmissionProvider: TransmissionProvider


TransmissionProduct -> DiagramObject: DiagramObjects


TransmissionProduct -> InstanceSet: InstanceSet


TransmissionProduct -> Name: Names


TransmissionProduct -> ChangeSetMember: PropertiesCIMDataObject


TransmissionProduct -> ChangeSetMember: TargetingCIMDataObject
