...
VerificationAction -> PowerSystemResource: PowerSystemResource


VerificationAction -> SwitchingPlan: SwitchingPlan


VerificationAction -> Operator: Operator


VerificationAction -> Crew: Crew


VerificationAction -> SwitchingEvent: SwitchingEvent


VerificationAction -> SwitchingStep: SwitchingStep


VerificationAction -> DiagramObject: DiagramObjects


VerificationAction -> InstanceSet: InstanceSet


VerificationAction -> Name: Names


VerificationAction -> ChangeSetMember: PropertiesCIMDataObject


VerificationAction -> ChangeSetMember: TargetingCIMDataObject
