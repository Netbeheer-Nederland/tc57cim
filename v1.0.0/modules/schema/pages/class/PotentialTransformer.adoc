...
PotentialTransformer -> Terminal: Terminal


PotentialTransformer -> WeatherStation: WeatherStation


PotentialTransformer -> OperationalLimitSet: OperationalLimitSet


PotentialTransformer -> ContingencyEquipment: ContingencyEquipment


PotentialTransformer -> EquipmentContainer: EquipmentContainer


PotentialTransformer -> Fault: Faults


PotentialTransformer -> LimitDependency: LimitDependencyModel


PotentialTransformer -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


PotentialTransformer -> ProtectiveActionEquipment: ProtectiveActionEquipment


PotentialTransformer -> PinEquipment: PinEquipment


PotentialTransformer -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


PotentialTransformer -> EquipmentContainer: AdditionalEquipmentContainer


PotentialTransformer -> UsagePoint: UsagePoints


PotentialTransformer -> Outage: Outages


PotentialTransformer -> OperationalRestriction: OperationalRestrictions


PotentialTransformer -> Control: Controls


PotentialTransformer -> Measurement: Measurements


PotentialTransformer -> PSRType: PSRType


PotentialTransformer -> ConfigurationEvent: ConfigurationEvent


PotentialTransformer -> ReportingGroup: ReportingGroup


PotentialTransformer -> OperatingShare: OperatingShare


PotentialTransformer -> AssetInfo: AssetDatasheet


PotentialTransformer -> VerificationAction: VerificationAction


PotentialTransformer -> ClearanceDocument: Clearances


PotentialTransformer -> GenericAction: GenericAction


PotentialTransformer -> PSREvent: PSREvents


PotentialTransformer -> Asset: Assets


PotentialTransformer -> Location: Location


PotentialTransformer -> OperationalTag: OperationalTags


PotentialTransformer -> DiagramObject: DiagramObjects


PotentialTransformer -> InstanceSet: InstanceSet


PotentialTransformer -> Name: Names


PotentialTransformer -> ChangeSetMember: PropertiesCIMDataObject


PotentialTransformer -> ChangeSetMember: TargetingCIMDataObject
