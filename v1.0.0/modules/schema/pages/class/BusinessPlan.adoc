...
BusinessPlan -> Status: docStatus


BusinessPlan -> ElectronicAddress: electronicAddress


BusinessPlan -> Status: status


BusinessPlan -> ActivityRecord: ActivityRecord


BusinessPlan -> ConfigurationEvent: ConfigurationEvents


BusinessPlan -> Author: Author


BusinessPlan -> Editor: Editor


BusinessPlan -> Approver: Approver


BusinessPlan -> Issuer: Issuer


BusinessPlan -> DiagramObject: DiagramObjects


BusinessPlan -> InstanceSet: InstanceSet


BusinessPlan -> Name: Names


BusinessPlan -> ChangeSetMember: PropertiesCIMDataObject


BusinessPlan -> ChangeSetMember: TargetingCIMDataObject
