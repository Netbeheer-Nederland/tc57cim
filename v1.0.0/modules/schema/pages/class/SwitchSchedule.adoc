...
SwitchSchedule -> DayType: DayType


SwitchSchedule -> Season: Season



SwitchSchedule -> RegularTimePoint: TimePoints


SwitchSchedule -> DiagramObject: DiagramObjects


SwitchSchedule -> InstanceSet: InstanceSet


SwitchSchedule -> Name: Names


SwitchSchedule -> ChangeSetMember: PropertiesCIMDataObject


SwitchSchedule -> ChangeSetMember: TargetingCIMDataObject
