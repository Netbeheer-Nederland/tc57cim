...
MerchantAgreement -> MerchantAccount: MerchantAccounts


MerchantAgreement -> DateTimeInterval: validityInterval


MerchantAgreement -> Status: docStatus


MerchantAgreement -> ElectronicAddress: electronicAddress


MerchantAgreement -> Status: status


MerchantAgreement -> ActivityRecord: ActivityRecord


MerchantAgreement -> ConfigurationEvent: ConfigurationEvents


MerchantAgreement -> Author: Author


MerchantAgreement -> Editor: Editor


MerchantAgreement -> Approver: Approver


MerchantAgreement -> Issuer: Issuer


MerchantAgreement -> DiagramObject: DiagramObjects


MerchantAgreement -> InstanceSet: InstanceSet


MerchantAgreement -> Name: Names


MerchantAgreement -> ChangeSetMember: PropertiesCIMDataObject


MerchantAgreement -> ChangeSetMember: TargetingCIMDataObject
