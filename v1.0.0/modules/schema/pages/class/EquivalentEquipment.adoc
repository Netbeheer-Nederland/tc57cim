...
EquivalentEquipment -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EquivalentEquipment -> SvStatus: SvStatus


EquivalentEquipment -> ProtectionEquipment: ProtectionEquipments
...
EquivalentEquipment -> JumperAction: JumpingAction


EquivalentEquipment -> GroundAction: GroundingAction


EquivalentEquipment -> Outage: Outage


EquivalentEquipment -> WeatherStation: WeatherStation


EquivalentEquipment -> OperationalLimitSet: OperationalLimitSet


EquivalentEquipment -> ContingencyEquipment: ContingencyEquipment


EquivalentEquipment -> EquipmentContainer: EquipmentContainer


EquivalentEquipment -> Fault: Faults


EquivalentEquipment -> LimitDependency: LimitDependencyModel


EquivalentEquipment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


EquivalentEquipment -> ProtectiveActionEquipment: ProtectiveActionEquipment


EquivalentEquipment -> PinEquipment: PinEquipment


EquivalentEquipment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


EquivalentEquipment -> EquipmentContainer: AdditionalEquipmentContainer


EquivalentEquipment -> UsagePoint: UsagePoints


EquivalentEquipment -> Outage: Outages


EquivalentEquipment -> OperationalRestriction: OperationalRestrictions


EquivalentEquipment -> Control: Controls


EquivalentEquipment -> Measurement: Measurements


EquivalentEquipment -> PSRType: PSRType


EquivalentEquipment -> ConfigurationEvent: ConfigurationEvent


EquivalentEquipment -> ReportingGroup: ReportingGroup


EquivalentEquipment -> OperatingShare: OperatingShare


EquivalentEquipment -> AssetInfo: AssetDatasheet


EquivalentEquipment -> VerificationAction: VerificationAction


EquivalentEquipment -> ClearanceDocument: Clearances


EquivalentEquipment -> GenericAction: GenericAction


EquivalentEquipment -> PSREvent: PSREvents


EquivalentEquipment -> Asset: Assets


EquivalentEquipment -> Location: Location


EquivalentEquipment -> OperationalTag: OperationalTags


EquivalentEquipment -> DiagramObject: DiagramObjects


EquivalentEquipment -> InstanceSet: InstanceSet


EquivalentEquipment -> Name: Names


EquivalentEquipment -> ChangeSetMember: PropertiesCIMDataObject


EquivalentEquipment -> ChangeSetMember: TargetingCIMDataObject
