...
Channel -> ReadingType: ReadingType


Channel -> DiagramObject: DiagramObjects


Channel -> InstanceSet: InstanceSet


Channel -> Name: Names


Channel -> ChangeSetMember: PropertiesCIMDataObject


Channel -> ChangeSetMember: TargetingCIMDataObject
