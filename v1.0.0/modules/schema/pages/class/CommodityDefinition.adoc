...
CommodityDefinition -> MarketProduct: MarketProduct


CommodityDefinition -> Pnode: Pnode


CommodityDefinition -> RTO: RTO


CommodityDefinition -> CommodityPrice: CommodityPrice


CommodityDefinition -> DiagramObject: DiagramObjects


CommodityDefinition -> InstanceSet: InstanceSet


CommodityDefinition -> Name: Names


CommodityDefinition -> ChangeSetMember: PropertiesCIMDataObject


CommodityDefinition -> ChangeSetMember: TargetingCIMDataObject
