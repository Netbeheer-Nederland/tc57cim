...
Ground -> GroundAction: GroundAction


Ground -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Ground -> SvStatus: SvStatus


Ground -> ProtectionEquipment: ProtectionEquipments


Ground -> BaseVoltage: BaseVoltage


Ground -> Terminal: Terminals


Ground -> JumperAction: JumpingAction


Ground -> GroundAction: GroundingAction


Ground -> Outage: Outage


Ground -> WeatherStation: WeatherStation


Ground -> OperationalLimitSet: OperationalLimitSet


Ground -> ContingencyEquipment: ContingencyEquipment


Ground -> EquipmentContainer: EquipmentContainer


Ground -> Fault: Faults


Ground -> LimitDependency: LimitDependencyModel


Ground -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Ground -> ProtectiveActionEquipment: ProtectiveActionEquipment


Ground -> PinEquipment: PinEquipment


Ground -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Ground -> EquipmentContainer: AdditionalEquipmentContainer


Ground -> UsagePoint: UsagePoints


Ground -> Outage: Outages


Ground -> OperationalRestriction: OperationalRestrictions


Ground -> Control: Controls


Ground -> Measurement: Measurements


Ground -> PSRType: PSRType


Ground -> ConfigurationEvent: ConfigurationEvent


Ground -> ReportingGroup: ReportingGroup


Ground -> OperatingShare: OperatingShare


Ground -> AssetInfo: AssetDatasheet


Ground -> VerificationAction: VerificationAction


Ground -> ClearanceDocument: Clearances


Ground -> GenericAction: GenericAction


Ground -> PSREvent: PSREvents
...
Ground -> OperationalTag: OperationalTags


Ground -> DiagramObject: DiagramObjects


Ground -> InstanceSet: InstanceSet


Ground -> Name: Names


Ground -> ChangeSetMember: PropertiesCIMDataObject


Ground -> ChangeSetMember: TargetingCIMDataObject
