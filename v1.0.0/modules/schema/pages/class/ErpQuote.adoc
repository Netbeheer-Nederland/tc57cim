...
ErpQuote -> ErpQuoteLineItem: ErpQuoteLineItems


ErpQuote -> Status: docStatus


ErpQuote -> ElectronicAddress: electronicAddress


ErpQuote -> Status: status


ErpQuote -> ActivityRecord: ActivityRecord


ErpQuote -> ConfigurationEvent: ConfigurationEvents


ErpQuote -> Author: Author


ErpQuote -> Editor: Editor


ErpQuote -> Approver: Approver


ErpQuote -> Issuer: Issuer


ErpQuote -> DiagramObject: DiagramObjects


ErpQuote -> InstanceSet: InstanceSet


ErpQuote -> Name: Names


ErpQuote -> ChangeSetMember: PropertiesCIMDataObject


ErpQuote -> ChangeSetMember: TargetingCIMDataObject
