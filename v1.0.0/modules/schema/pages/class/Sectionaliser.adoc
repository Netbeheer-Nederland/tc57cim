...
Sectionaliser -> SwitchPhase: SwitchPhase


Sectionaliser -> SwitchSchedule: SwitchSchedules


Sectionaliser -> CompositeSwitch: CompositeSwitch


Sectionaliser -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


Sectionaliser -> SvSwitch: SvSwitch


Sectionaliser -> ConnectDisconnectFunction: ConnectDisconnectFunctions


Sectionaliser -> SwitchAction: SwitchAction


Sectionaliser -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Sectionaliser -> SvStatus: SvStatus


Sectionaliser -> ProtectionEquipment: ProtectionEquipments


Sectionaliser -> BaseVoltage: BaseVoltage


Sectionaliser -> Terminal: Terminals


Sectionaliser -> JumperAction: JumpingAction


Sectionaliser -> GroundAction: GroundingAction


Sectionaliser -> Outage: Outage


Sectionaliser -> WeatherStation: WeatherStation


Sectionaliser -> OperationalLimitSet: OperationalLimitSet


Sectionaliser -> ContingencyEquipment: ContingencyEquipment


Sectionaliser -> EquipmentContainer: EquipmentContainer


Sectionaliser -> Fault: Faults


Sectionaliser -> LimitDependency: LimitDependencyModel


Sectionaliser -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Sectionaliser -> ProtectiveActionEquipment: ProtectiveActionEquipment


Sectionaliser -> PinEquipment: PinEquipment


Sectionaliser -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Sectionaliser -> EquipmentContainer: AdditionalEquipmentContainer


Sectionaliser -> UsagePoint: UsagePoints


Sectionaliser -> Outage: Outages


Sectionaliser -> OperationalRestriction: OperationalRestrictions


Sectionaliser -> Control: Controls


Sectionaliser -> Measurement: Measurements


Sectionaliser -> PSRType: PSRType


Sectionaliser -> ConfigurationEvent: ConfigurationEvent


Sectionaliser -> ReportingGroup: ReportingGroup


Sectionaliser -> OperatingShare: OperatingShare


Sectionaliser -> AssetInfo: AssetDatasheet


Sectionaliser -> VerificationAction: VerificationAction


Sectionaliser -> ClearanceDocument: Clearances


Sectionaliser -> GenericAction: GenericAction


Sectionaliser -> PSREvent: PSREvents


Sectionaliser -> Asset: Assets


Sectionaliser -> Location: Location


Sectionaliser -> OperationalTag: OperationalTags


Sectionaliser -> DiagramObject: DiagramObjects


Sectionaliser -> InstanceSet: InstanceSet


Sectionaliser -> Name: Names


Sectionaliser -> ChangeSetMember: PropertiesCIMDataObject


Sectionaliser -> ChangeSetMember: TargetingCIMDataObject
