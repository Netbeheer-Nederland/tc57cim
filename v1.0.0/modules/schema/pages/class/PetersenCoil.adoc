...
PetersenCoil -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


PetersenCoil -> SvStatus: SvStatus


PetersenCoil -> ProtectionEquipment: ProtectionEquipments


PetersenCoil -> BaseVoltage: BaseVoltage


PetersenCoil -> Terminal: Terminals


PetersenCoil -> JumperAction: JumpingAction


PetersenCoil -> GroundAction: GroundingAction


PetersenCoil -> Outage: Outage


PetersenCoil -> WeatherStation: WeatherStation


PetersenCoil -> OperationalLimitSet: OperationalLimitSet


PetersenCoil -> ContingencyEquipment: ContingencyEquipment


PetersenCoil -> EquipmentContainer: EquipmentContainer


PetersenCoil -> Fault: Faults


PetersenCoil -> LimitDependency: LimitDependencyModel


PetersenCoil -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


PetersenCoil -> ProtectiveActionEquipment: ProtectiveActionEquipment


PetersenCoil -> PinEquipment: PinEquipment


PetersenCoil -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


PetersenCoil -> EquipmentContainer: AdditionalEquipmentContainer


PetersenCoil -> UsagePoint: UsagePoints


PetersenCoil -> Outage: Outages


PetersenCoil -> OperationalRestriction: OperationalRestrictions


PetersenCoil -> Control: Controls


PetersenCoil -> Measurement: Measurements


PetersenCoil -> PSRType: PSRType


PetersenCoil -> ConfigurationEvent: ConfigurationEvent


PetersenCoil -> ReportingGroup: ReportingGroup


PetersenCoil -> OperatingShare: OperatingShare


PetersenCoil -> AssetInfo: AssetDatasheet


PetersenCoil -> VerificationAction: VerificationAction


PetersenCoil -> ClearanceDocument: Clearances


PetersenCoil -> GenericAction: GenericAction


PetersenCoil -> PSREvent: PSREvents


PetersenCoil -> Asset: Assets


PetersenCoil -> Location: Location


PetersenCoil -> OperationalTag: OperationalTags


PetersenCoil -> DiagramObject: DiagramObjects


PetersenCoil -> InstanceSet: InstanceSet


PetersenCoil -> Name: Names


PetersenCoil -> ChangeSetMember: PropertiesCIMDataObject


PetersenCoil -> ChangeSetMember: TargetingCIMDataObject
