...
EnergyConnection -> EnergyComponent: EnergyComponent


EnergyConnection -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EnergyConnection -> SvStatus: SvStatus


EnergyConnection -> ProtectionEquipment: ProtectionEquipments
...
EnergyConnection -> JumperAction: JumpingAction


EnergyConnection -> GroundAction: GroundingAction


EnergyConnection -> Outage: Outage


EnergyConnection -> WeatherStation: WeatherStation


EnergyConnection -> OperationalLimitSet: OperationalLimitSet


EnergyConnection -> ContingencyEquipment: ContingencyEquipment


EnergyConnection -> EquipmentContainer: EquipmentContainer


EnergyConnection -> Fault: Faults


EnergyConnection -> LimitDependency: LimitDependencyModel


EnergyConnection -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


EnergyConnection -> ProtectiveActionEquipment: ProtectiveActionEquipment


EnergyConnection -> PinEquipment: PinEquipment


EnergyConnection -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


EnergyConnection -> EquipmentContainer: AdditionalEquipmentContainer


EnergyConnection -> UsagePoint: UsagePoints


EnergyConnection -> Outage: Outages


EnergyConnection -> OperationalRestriction: OperationalRestrictions


EnergyConnection -> Control: Controls


EnergyConnection -> Measurement: Measurements


EnergyConnection -> PSRType: PSRType


EnergyConnection -> ConfigurationEvent: ConfigurationEvent


EnergyConnection -> ReportingGroup: ReportingGroup


EnergyConnection -> OperatingShare: OperatingShare


EnergyConnection -> AssetInfo: AssetDatasheet


EnergyConnection -> VerificationAction: VerificationAction


EnergyConnection -> ClearanceDocument: Clearances


EnergyConnection -> GenericAction: GenericAction


EnergyConnection -> PSREvent: PSREvents
...
EnergyConnection -> OperationalTag: OperationalTags


EnergyConnection -> DiagramObject: DiagramObjects


EnergyConnection -> InstanceSet: InstanceSet


EnergyConnection -> Name: Names


EnergyConnection -> ChangeSetMember: PropertiesCIMDataObject


EnergyConnection -> ChangeSetMember: TargetingCIMDataObject
