...
Subcritical -> SteamTurbine: SteamTurbines


Subcritical -> Control: Controls


Subcritical -> Measurement: Measurements


Subcritical -> PSRType: PSRType


Subcritical -> ConfigurationEvent: ConfigurationEvent


Subcritical -> ReportingGroup: ReportingGroup


Subcritical -> OperatingShare: OperatingShare


Subcritical -> AssetInfo: AssetDatasheet


Subcritical -> VerificationAction: VerificationAction


Subcritical -> ClearanceDocument: Clearances


Subcritical -> GenericAction: GenericAction


Subcritical -> PSREvent: PSREvents


Subcritical -> Asset: Assets


Subcritical -> Location: Location


Subcritical -> OperationalTag: OperationalTags


Subcritical -> DiagramObject: DiagramObjects


Subcritical -> InstanceSet: InstanceSet


Subcritical -> Name: Names


Subcritical -> ChangeSetMember: PropertiesCIMDataObject


Subcritical -> ChangeSetMember: TargetingCIMDataObject
