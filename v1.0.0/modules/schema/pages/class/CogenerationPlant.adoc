...
CogenerationPlant -> SteamSendoutSchedule: SteamSendoutSchedule
...
CogenerationPlant -> ConfigurationEvent: ConfigurationEvent


CogenerationPlant -> ReportingGroup: ReportingGroup


CogenerationPlant -> OperatingShare: OperatingShare


CogenerationPlant -> AssetInfo: AssetDatasheet


CogenerationPlant -> VerificationAction: VerificationAction


CogenerationPlant -> ClearanceDocument: Clearances


CogenerationPlant -> GenericAction: GenericAction
...
CogenerationPlant -> OperationalTag: OperationalTags


CogenerationPlant -> DiagramObject: DiagramObjects


CogenerationPlant -> InstanceSet: InstanceSet


CogenerationPlant -> Name: Names


CogenerationPlant -> ChangeSetMember: PropertiesCIMDataObject


CogenerationPlant -> ChangeSetMember: TargetingCIMDataObject
