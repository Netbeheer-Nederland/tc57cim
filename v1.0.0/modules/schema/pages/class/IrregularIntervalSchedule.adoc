...
IrregularIntervalSchedule -> IrregularTimePoint: TimePoints


IrregularIntervalSchedule -> DiagramObject: DiagramObjects


IrregularIntervalSchedule -> InstanceSet: InstanceSet


IrregularIntervalSchedule -> Name: Names


IrregularIntervalSchedule -> ChangeSetMember: PropertiesCIMDataObject


IrregularIntervalSchedule -> ChangeSetMember: TargetingCIMDataObject
