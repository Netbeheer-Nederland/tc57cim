...
HydroTurbine -> SynchronousMachine: SynchronousMachines


HydroTurbine -> Control: Controls


HydroTurbine -> Measurement: Measurements


HydroTurbine -> PSRType: PSRType


HydroTurbine -> ConfigurationEvent: ConfigurationEvent


HydroTurbine -> ReportingGroup: ReportingGroup


HydroTurbine -> OperatingShare: OperatingShare


HydroTurbine -> AssetInfo: AssetDatasheet


HydroTurbine -> VerificationAction: VerificationAction


HydroTurbine -> ClearanceDocument: Clearances


HydroTurbine -> GenericAction: GenericAction


HydroTurbine -> PSREvent: PSREvents


HydroTurbine -> Asset: Assets


HydroTurbine -> Location: Location


HydroTurbine -> OperationalTag: OperationalTags


HydroTurbine -> DiagramObject: DiagramObjects


HydroTurbine -> InstanceSet: InstanceSet


HydroTurbine -> Name: Names


HydroTurbine -> ChangeSetMember: PropertiesCIMDataObject


HydroTurbine -> ChangeSetMember: TargetingCIMDataObject
