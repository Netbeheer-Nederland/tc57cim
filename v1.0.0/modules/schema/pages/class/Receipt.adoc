...
Receipt -> CashierShift: CashierShift


Receipt -> Tender: Tenders


Receipt -> VendorShift: VendorShift


Receipt -> DiagramObject: DiagramObjects


Receipt -> InstanceSet: InstanceSet


Receipt -> Name: Names


Receipt -> ChangeSetMember: PropertiesCIMDataObject


Receipt -> ChangeSetMember: TargetingCIMDataObject
