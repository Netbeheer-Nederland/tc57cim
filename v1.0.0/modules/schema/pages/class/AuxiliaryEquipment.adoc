...
AuxiliaryEquipment -> WeatherStation: WeatherStation


AuxiliaryEquipment -> OperationalLimitSet: OperationalLimitSet


AuxiliaryEquipment -> ContingencyEquipment: ContingencyEquipment


AuxiliaryEquipment -> EquipmentContainer: EquipmentContainer


AuxiliaryEquipment -> Fault: Faults


AuxiliaryEquipment -> LimitDependency: LimitDependencyModel


AuxiliaryEquipment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


AuxiliaryEquipment -> ProtectiveActionEquipment: ProtectiveActionEquipment


AuxiliaryEquipment -> PinEquipment: PinEquipment


AuxiliaryEquipment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


AuxiliaryEquipment -> EquipmentContainer: AdditionalEquipmentContainer


AuxiliaryEquipment -> UsagePoint: UsagePoints


AuxiliaryEquipment -> Outage: Outages


AuxiliaryEquipment -> OperationalRestriction: OperationalRestrictions


AuxiliaryEquipment -> Control: Controls


AuxiliaryEquipment -> Measurement: Measurements


AuxiliaryEquipment -> PSRType: PSRType


AuxiliaryEquipment -> ConfigurationEvent: ConfigurationEvent


AuxiliaryEquipment -> ReportingGroup: ReportingGroup


AuxiliaryEquipment -> OperatingShare: OperatingShare


AuxiliaryEquipment -> AssetInfo: AssetDatasheet


AuxiliaryEquipment -> VerificationAction: VerificationAction


AuxiliaryEquipment -> ClearanceDocument: Clearances


AuxiliaryEquipment -> GenericAction: GenericAction


AuxiliaryEquipment -> PSREvent: PSREvents


AuxiliaryEquipment -> Asset: Assets


AuxiliaryEquipment -> Location: Location


AuxiliaryEquipment -> OperationalTag: OperationalTags


AuxiliaryEquipment -> DiagramObject: DiagramObjects


AuxiliaryEquipment -> InstanceSet: InstanceSet


AuxiliaryEquipment -> Name: Names


AuxiliaryEquipment -> ChangeSetMember: PropertiesCIMDataObject


AuxiliaryEquipment -> ChangeSetMember: TargetingCIMDataObject
