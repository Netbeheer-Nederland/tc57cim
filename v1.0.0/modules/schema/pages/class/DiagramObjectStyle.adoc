...
DiagramObjectStyle -> DiagramObject: DiagramObjects


DiagramObjectStyle -> InstanceSet: InstanceSet


DiagramObjectStyle -> Name: Names


DiagramObjectStyle -> ChangeSetMember: PropertiesCIMDataObject


DiagramObjectStyle -> ChangeSetMember: TargetingCIMDataObject
