...
ConformLoadSchedule -> DayType: DayType


ConformLoadSchedule -> Season: Season



ConformLoadSchedule -> RegularTimePoint: TimePoints


ConformLoadSchedule -> DiagramObject: DiagramObjects


ConformLoadSchedule -> InstanceSet: InstanceSet


ConformLoadSchedule -> Name: Names


ConformLoadSchedule -> ChangeSetMember: PropertiesCIMDataObject


ConformLoadSchedule -> ChangeSetMember: TargetingCIMDataObject
