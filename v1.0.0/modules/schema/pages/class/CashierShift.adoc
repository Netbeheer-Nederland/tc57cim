...
CashierShift -> Transaction: Transactions


CashierShift -> Receipt: Receipts


CashierShift -> PointOfSale: PointOfSale


CashierShift -> Cashier: Cashier


CashierShift -> DateTimeInterval: activityInterval
...
CashierShift -> DiagramObject: DiagramObjects


CashierShift -> InstanceSet: InstanceSet


CashierShift -> Name: Names


CashierShift -> ChangeSetMember: PropertiesCIMDataObject


CashierShift -> ChangeSetMember: TargetingCIMDataObject
