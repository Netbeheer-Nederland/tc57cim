...
IntSchedAgreement -> DateTimeInterval: validityInterval


IntSchedAgreement -> Status: docStatus


IntSchedAgreement -> ElectronicAddress: electronicAddress


IntSchedAgreement -> Status: status


IntSchedAgreement -> ActivityRecord: ActivityRecord


IntSchedAgreement -> ConfigurationEvent: ConfigurationEvents


IntSchedAgreement -> Author: Author


IntSchedAgreement -> Editor: Editor


IntSchedAgreement -> Approver: Approver


IntSchedAgreement -> Issuer: Issuer


IntSchedAgreement -> DiagramObject: DiagramObjects


IntSchedAgreement -> InstanceSet: InstanceSet


IntSchedAgreement -> Name: Names


IntSchedAgreement -> ChangeSetMember: PropertiesCIMDataObject


IntSchedAgreement -> ChangeSetMember: TargetingCIMDataObject
