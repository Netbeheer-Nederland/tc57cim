...
Transactor -> MerchantAccount: MerchantAccounts


Transactor -> DiagramObject: DiagramObjects


Transactor -> InstanceSet: InstanceSet


Transactor -> Name: Names


Transactor -> ChangeSetMember: PropertiesCIMDataObject


Transactor -> ChangeSetMember: TargetingCIMDataObject
