...
AtmosphericAnalog -> ReportingCapability: ReportingCapability


AtmosphericAnalog -> EnvironmentalInformation: EnvironmentalInformation


AtmosphericAnalog -> ClassificationCondition: ClassificationCondition


AtmosphericAnalog -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


AtmosphericAnalog -> AnalogValue: AnalogValues


AtmosphericAnalog -> AnalogLimitSet: LimitSets


AtmosphericAnalog -> ACDCTerminal: Terminal


AtmosphericAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


AtmosphericAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


AtmosphericAnalog -> PowerSystemResource: PowerSystemResource


AtmosphericAnalog -> PinMeasurement: PinMeasurement


AtmosphericAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


AtmosphericAnalog -> Asset: Asset


AtmosphericAnalog -> MeasurementAction: MeasurementAction


AtmosphericAnalog -> Location: Locations


AtmosphericAnalog -> Procedure: Procedures


AtmosphericAnalog -> DiagramObject: DiagramObjects


AtmosphericAnalog -> InstanceSet: InstanceSet


AtmosphericAnalog -> Name: Names


AtmosphericAnalog -> ChangeSetMember: PropertiesCIMDataObject


AtmosphericAnalog -> ChangeSetMember: TargetingCIMDataObject
