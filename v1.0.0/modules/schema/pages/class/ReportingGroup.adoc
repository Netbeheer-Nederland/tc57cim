...
ReportingGroup -> ReportingSuperGroup: ReportingSuperGroup


ReportingGroup -> PowerSystemResource: PowerSystemResource
...
ReportingGroup -> DiagramObject: DiagramObjects


ReportingGroup -> InstanceSet: InstanceSet


ReportingGroup -> Name: Names


ReportingGroup -> ChangeSetMember: PropertiesCIMDataObject


ReportingGroup -> ChangeSetMember: TargetingCIMDataObject
