...
AccessPermit -> Status: docStatus


AccessPermit -> ElectronicAddress: electronicAddress


AccessPermit -> Status: status


AccessPermit -> ActivityRecord: ActivityRecord


AccessPermit -> ConfigurationEvent: ConfigurationEvents


AccessPermit -> Author: Author


AccessPermit -> Editor: Editor


AccessPermit -> Approver: Approver


AccessPermit -> Issuer: Issuer


AccessPermit -> DiagramObject: DiagramObjects


AccessPermit -> InstanceSet: InstanceSet


AccessPermit -> Name: Names


AccessPermit -> ChangeSetMember: PropertiesCIMDataObject


AccessPermit -> ChangeSetMember: TargetingCIMDataObject
