...
RMROperatorInput -> RegisteredResource: RegisteredResource


RMROperatorInput -> MktActivityRecord: MktActivityRecord


RMROperatorInput -> Market: Market


RMROperatorInput -> Status: docStatus


RMROperatorInput -> ElectronicAddress: electronicAddress


RMROperatorInput -> Status: status


RMROperatorInput -> ActivityRecord: ActivityRecord


RMROperatorInput -> ConfigurationEvent: ConfigurationEvents


RMROperatorInput -> Author: Author


RMROperatorInput -> Editor: Editor


RMROperatorInput -> Approver: Approver


RMROperatorInput -> Issuer: Issuer


RMROperatorInput -> DiagramObject: DiagramObjects


RMROperatorInput -> InstanceSet: InstanceSet


RMROperatorInput -> Name: Names


RMROperatorInput -> ChangeSetMember: PropertiesCIMDataObject


RMROperatorInput -> ChangeSetMember: TargetingCIMDataObject
