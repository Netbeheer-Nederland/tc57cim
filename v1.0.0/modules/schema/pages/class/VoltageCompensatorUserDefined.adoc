...
VoltageCompensatorUserDefined -> ExcitationSystemDynamics: ExcitationSystemDynamics


VoltageCompensatorUserDefined -> RemoteInputSignal: RemoteInputSignal


VoltageCompensatorUserDefined -> DiagramObject: DiagramObjects


VoltageCompensatorUserDefined -> InstanceSet: InstanceSet


VoltageCompensatorUserDefined -> Name: Names


VoltageCompensatorUserDefined -> ChangeSetMember: PropertiesCIMDataObject


VoltageCompensatorUserDefined -> ChangeSetMember: TargetingCIMDataObject
