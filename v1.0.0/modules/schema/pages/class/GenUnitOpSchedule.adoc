...
GenUnitOpSchedule -> GeneratingUnit: GeneratingUnit



GenUnitOpSchedule -> RegularTimePoint: TimePoints


GenUnitOpSchedule -> DiagramObject: DiagramObjects


GenUnitOpSchedule -> InstanceSet: InstanceSet


GenUnitOpSchedule -> Name: Names


GenUnitOpSchedule -> ChangeSetMember: PropertiesCIMDataObject


GenUnitOpSchedule -> ChangeSetMember: TargetingCIMDataObject
