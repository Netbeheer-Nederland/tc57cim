...
TransformerStarImpedance -> TransformerEnd: TransformerEnd


TransformerStarImpedance -> TransformerEndInfo: TransformerEndInfo


TransformerStarImpedance -> DiagramObject: DiagramObjects


TransformerStarImpedance -> InstanceSet: InstanceSet


TransformerStarImpedance -> Name: Names


TransformerStarImpedance -> ChangeSetMember: PropertiesCIMDataObject


TransformerStarImpedance -> ChangeSetMember: TargetingCIMDataObject
