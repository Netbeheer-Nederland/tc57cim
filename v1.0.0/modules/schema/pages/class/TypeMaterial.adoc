...
TypeMaterial -> MaterialItem: MaterialItems


TypeMaterial -> ErpReqLineItem: ErpReqLineItems


TypeMaterial -> ErpIssueInventory: ErpIssueInventories


TypeMaterial -> CUMaterialItem: CUMaterialItems


TypeMaterial -> Status: docStatus


TypeMaterial -> ElectronicAddress: electronicAddress


TypeMaterial -> Status: status


TypeMaterial -> ActivityRecord: ActivityRecord


TypeMaterial -> ConfigurationEvent: ConfigurationEvents


TypeMaterial -> Author: Author


TypeMaterial -> Editor: Editor


TypeMaterial -> Approver: Approver


TypeMaterial -> Issuer: Issuer


TypeMaterial -> DiagramObject: DiagramObjects


TypeMaterial -> InstanceSet: InstanceSet


TypeMaterial -> Name: Names


TypeMaterial -> ChangeSetMember: PropertiesCIMDataObject


TypeMaterial -> ChangeSetMember: TargetingCIMDataObject
