...
ErpPayment -> ErpInvoiceLineItem: ErpInvoiceLineItems


ErpPayment -> ErpPayableLineItem: ErpPayableLineItems


ErpPayment -> ErpRecLineItem: ErpRecLineItems


ErpPayment -> Status: docStatus


ErpPayment -> ElectronicAddress: electronicAddress


ErpPayment -> Status: status


ErpPayment -> ActivityRecord: ActivityRecord


ErpPayment -> ConfigurationEvent: ConfigurationEvents


ErpPayment -> Author: Author


ErpPayment -> Editor: Editor


ErpPayment -> Approver: Approver


ErpPayment -> Issuer: Issuer


ErpPayment -> DiagramObject: DiagramObjects


ErpPayment -> InstanceSet: InstanceSet


ErpPayment -> Name: Names


ErpPayment -> ChangeSetMember: PropertiesCIMDataObject


ErpPayment -> ChangeSetMember: TargetingCIMDataObject
