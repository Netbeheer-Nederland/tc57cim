...
MaintenanceWorkTask -> TroubleOrder: TroubleOrder


MaintenanceWorkTask -> Asset: Assets


MaintenanceWorkTask -> MaterialItem: MaterialItems


MaintenanceWorkTask -> Crew: Crews


MaintenanceWorkTask -> Asset: OldAsset


MaintenanceWorkTask -> SwitchingPlan: SwitchingPlan


MaintenanceWorkTask -> ProcedureDataSet: ProcedureDataSet


MaintenanceWorkTask -> Work: Work


MaintenanceWorkTask -> Priority: priority


MaintenanceWorkTask -> WorkTimeSchedule: TimeSchedules


MaintenanceWorkTask -> WorkLocation: WorkLocation


MaintenanceWorkTask -> WorkActivityRecord: WorkActivityRecords


MaintenanceWorkTask -> Status: docStatus


MaintenanceWorkTask -> ElectronicAddress: electronicAddress


MaintenanceWorkTask -> Status: status


MaintenanceWorkTask -> ActivityRecord: ActivityRecord


MaintenanceWorkTask -> ConfigurationEvent: ConfigurationEvents


MaintenanceWorkTask -> Author: Author


MaintenanceWorkTask -> Editor: Editor


MaintenanceWorkTask -> Approver: Approver


MaintenanceWorkTask -> Issuer: Issuer


MaintenanceWorkTask -> DiagramObject: DiagramObjects


MaintenanceWorkTask -> InstanceSet: InstanceSet


MaintenanceWorkTask -> Name: Names


MaintenanceWorkTask -> ChangeSetMember: PropertiesCIMDataObject


MaintenanceWorkTask -> ChangeSetMember: TargetingCIMDataObject
