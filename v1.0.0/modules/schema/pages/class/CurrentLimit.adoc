...
CurrentLimit -> LimitDependency: LimitDependencyModel


CurrentLimit -> LimitScalingLimit: LimitScalingLimit


CurrentLimit -> DiagramObject: DiagramObjects


CurrentLimit -> InstanceSet: InstanceSet


CurrentLimit -> Name: Names


CurrentLimit -> ChangeSetMember: PropertiesCIMDataObject


CurrentLimit -> ChangeSetMember: TargetingCIMDataObject
