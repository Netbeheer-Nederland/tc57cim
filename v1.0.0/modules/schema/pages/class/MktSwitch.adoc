...
MktSwitch -> SwitchStatus: SwitchStatus



MktSwitch -> SwitchPhase: SwitchPhase


MktSwitch -> SwitchSchedule: SwitchSchedules


MktSwitch -> CompositeSwitch: CompositeSwitch


MktSwitch -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


MktSwitch -> SvSwitch: SvSwitch


MktSwitch -> ConnectDisconnectFunction: ConnectDisconnectFunctions


MktSwitch -> SwitchAction: SwitchAction


MktSwitch -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


MktSwitch -> SvStatus: SvStatus


MktSwitch -> ProtectionEquipment: ProtectionEquipments


MktSwitch -> BaseVoltage: BaseVoltage


MktSwitch -> Terminal: Terminals


MktSwitch -> JumperAction: JumpingAction


MktSwitch -> GroundAction: GroundingAction


MktSwitch -> Outage: Outage


MktSwitch -> WeatherStation: WeatherStation


MktSwitch -> OperationalLimitSet: OperationalLimitSet


MktSwitch -> ContingencyEquipment: ContingencyEquipment


MktSwitch -> EquipmentContainer: EquipmentContainer


MktSwitch -> Fault: Faults


MktSwitch -> LimitDependency: LimitDependencyModel


MktSwitch -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


MktSwitch -> ProtectiveActionEquipment: ProtectiveActionEquipment


MktSwitch -> PinEquipment: PinEquipment


MktSwitch -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


MktSwitch -> EquipmentContainer: AdditionalEquipmentContainer


MktSwitch -> UsagePoint: UsagePoints


MktSwitch -> Outage: Outages


MktSwitch -> OperationalRestriction: OperationalRestrictions


MktSwitch -> Control: Controls


MktSwitch -> Measurement: Measurements


MktSwitch -> PSRType: PSRType


MktSwitch -> ConfigurationEvent: ConfigurationEvent


MktSwitch -> ReportingGroup: ReportingGroup


MktSwitch -> OperatingShare: OperatingShare


MktSwitch -> AssetInfo: AssetDatasheet


MktSwitch -> VerificationAction: VerificationAction


MktSwitch -> ClearanceDocument: Clearances


MktSwitch -> GenericAction: GenericAction


MktSwitch -> PSREvent: PSREvents


MktSwitch -> Asset: Assets


MktSwitch -> Location: Location


MktSwitch -> OperationalTag: OperationalTags


MktSwitch -> DiagramObject: DiagramObjects


MktSwitch -> InstanceSet: InstanceSet


MktSwitch -> Name: Names


MktSwitch -> ChangeSetMember: PropertiesCIMDataObject


MktSwitch -> ChangeSetMember: TargetingCIMDataObject
