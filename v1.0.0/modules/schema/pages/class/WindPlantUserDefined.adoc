...
WindPlantUserDefined -> WindTurbineType3or4Dynamics: WindTurbineType3or4Dynamics


WindPlantUserDefined -> RemoteInputSignal: RemoteInputSignal


WindPlantUserDefined -> DiagramObject: DiagramObjects


WindPlantUserDefined -> InstanceSet: InstanceSet


WindPlantUserDefined -> Name: Names


WindPlantUserDefined -> ChangeSetMember: PropertiesCIMDataObject


WindPlantUserDefined -> ChangeSetMember: TargetingCIMDataObject
