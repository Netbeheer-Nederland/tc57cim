...
ErpRequisition -> ErpReqLineItem: ErpReqLineItems


ErpRequisition -> Status: docStatus


ErpRequisition -> ElectronicAddress: electronicAddress


ErpRequisition -> Status: status


ErpRequisition -> ActivityRecord: ActivityRecord


ErpRequisition -> ConfigurationEvent: ConfigurationEvents


ErpRequisition -> Author: Author


ErpRequisition -> Editor: Editor


ErpRequisition -> Approver: Approver


ErpRequisition -> Issuer: Issuer


ErpRequisition -> DiagramObject: DiagramObjects


ErpRequisition -> InstanceSet: InstanceSet


ErpRequisition -> Name: Names


ErpRequisition -> ChangeSetMember: PropertiesCIMDataObject


ErpRequisition -> ChangeSetMember: TargetingCIMDataObject
