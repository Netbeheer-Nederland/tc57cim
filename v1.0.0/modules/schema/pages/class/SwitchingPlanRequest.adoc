...
SwitchingPlanRequest -> DateTimeInterval: forwardSwitchingDateTimeInterval


SwitchingPlanRequest -> DateTimeInterval: outageDateTimeInterval


SwitchingPlanRequest -> DateTimeInterval: reverseSwitchingDateTimeInterval


SwitchingPlanRequest -> SwitchingPlan: SwitchingPlan


SwitchingPlanRequest -> Organisation: RequestingOrganization


SwitchingPlanRequest -> Status: docStatus


SwitchingPlanRequest -> ElectronicAddress: electronicAddress


SwitchingPlanRequest -> Status: status


SwitchingPlanRequest -> ActivityRecord: ActivityRecord


SwitchingPlanRequest -> ConfigurationEvent: ConfigurationEvents


SwitchingPlanRequest -> Author: Author


SwitchingPlanRequest -> Editor: Editor


SwitchingPlanRequest -> Approver: Approver


SwitchingPlanRequest -> Issuer: Issuer


SwitchingPlanRequest -> DiagramObject: DiagramObjects


SwitchingPlanRequest -> InstanceSet: InstanceSet


SwitchingPlanRequest -> Name: Names


SwitchingPlanRequest -> ChangeSetMember: PropertiesCIMDataObject


SwitchingPlanRequest -> ChangeSetMember: TargetingCIMDataObject
