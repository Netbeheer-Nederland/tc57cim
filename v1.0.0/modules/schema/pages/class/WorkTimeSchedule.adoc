...
WorkTimeSchedule -> BaseWork: BaseWork


WorkTimeSchedule -> ServiceRequest: ServiceRequest




WorkTimeSchedule -> DateTimeInterval: scheduleInterval


WorkTimeSchedule -> TimePoint: TimePoints


WorkTimeSchedule -> MeterReadSchedule: MeterReadSchedule


WorkTimeSchedule -> Status: docStatus


WorkTimeSchedule -> ElectronicAddress: electronicAddress


WorkTimeSchedule -> Status: status


WorkTimeSchedule -> ActivityRecord: ActivityRecord


WorkTimeSchedule -> ConfigurationEvent: ConfigurationEvents


WorkTimeSchedule -> Author: Author


WorkTimeSchedule -> Editor: Editor


WorkTimeSchedule -> Approver: Approver


WorkTimeSchedule -> Issuer: Issuer


WorkTimeSchedule -> DiagramObject: DiagramObjects


WorkTimeSchedule -> InstanceSet: InstanceSet


WorkTimeSchedule -> Name: Names


WorkTimeSchedule -> ChangeSetMember: PropertiesCIMDataObject


WorkTimeSchedule -> ChangeSetMember: TargetingCIMDataObject
