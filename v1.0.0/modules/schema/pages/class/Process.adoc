...
Process -> MarketDocument: MarketDocument


Process -> DiagramObject: DiagramObjects


Process -> InstanceSet: InstanceSet


Process -> Name: Names


Process -> ChangeSetMember: PropertiesCIMDataObject


Process -> ChangeSetMember: TargetingCIMDataObject
