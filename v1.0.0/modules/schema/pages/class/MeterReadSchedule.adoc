...
MeterReadSchedule -> UsagePoint: UsagePoint


MeterReadSchedule -> EndDeviceGroup: EndDeviceGroup


MeterReadSchedule -> ReadingType: ReadingType


MeterReadSchedule -> UsagePointGroup: UsagePointGroup


MeterReadSchedule -> TimeSchedule: TimeSchedule


MeterReadSchedule -> CustomerAgreement: CustomerAgreement


MeterReadSchedule -> EndDevice: EndDevice


MeterReadSchedule -> CustomerAccount: CustomerAccount


MeterReadSchedule -> Status: docStatus


MeterReadSchedule -> ElectronicAddress: electronicAddress


MeterReadSchedule -> Status: status


MeterReadSchedule -> ActivityRecord: ActivityRecord


MeterReadSchedule -> ConfigurationEvent: ConfigurationEvents


MeterReadSchedule -> Author: Author


MeterReadSchedule -> Editor: Editor


MeterReadSchedule -> Approver: Approver


MeterReadSchedule -> Issuer: Issuer


MeterReadSchedule -> DiagramObject: DiagramObjects


MeterReadSchedule -> InstanceSet: InstanceSet


MeterReadSchedule -> Name: Names


MeterReadSchedule -> ChangeSetMember: PropertiesCIMDataObject


MeterReadSchedule -> ChangeSetMember: TargetingCIMDataObject
