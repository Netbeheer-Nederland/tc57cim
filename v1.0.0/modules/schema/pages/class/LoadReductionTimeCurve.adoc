...
LoadReductionTimeCurve -> CurveData: CurveDatas


LoadReductionTimeCurve -> DiagramObject: DiagramObjects


LoadReductionTimeCurve -> InstanceSet: InstanceSet


LoadReductionTimeCurve -> Name: Names


LoadReductionTimeCurve -> ChangeSetMember: PropertiesCIMDataObject


LoadReductionTimeCurve -> ChangeSetMember: TargetingCIMDataObject
