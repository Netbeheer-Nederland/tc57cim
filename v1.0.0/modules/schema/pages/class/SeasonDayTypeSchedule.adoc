...
SeasonDayTypeSchedule -> DiagramObject: DiagramObjects


SeasonDayTypeSchedule -> InstanceSet: InstanceSet


SeasonDayTypeSchedule -> Name: Names


SeasonDayTypeSchedule -> ChangeSetMember: PropertiesCIMDataObject


SeasonDayTypeSchedule -> ChangeSetMember: TargetingCIMDataObject
