...
ServiceOrder -> Status: docStatus


ServiceOrder -> ElectronicAddress: electronicAddress


ServiceOrder -> Status: status


ServiceOrder -> ActivityRecord: ActivityRecord


ServiceOrder -> ConfigurationEvent: ConfigurationEvents


ServiceOrder -> Author: Author


ServiceOrder -> Editor: Editor


ServiceOrder -> Approver: Approver


ServiceOrder -> Issuer: Issuer


ServiceOrder -> DiagramObject: DiagramObjects


ServiceOrder -> InstanceSet: InstanceSet


ServiceOrder -> Name: Names


ServiceOrder -> ChangeSetMember: PropertiesCIMDataObject


ServiceOrder -> ChangeSetMember: TargetingCIMDataObject
