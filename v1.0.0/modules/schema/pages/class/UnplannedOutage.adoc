...
UnplannedOutage -> TroubleTicket: TroubleTicket


UnplannedOutage -> TroubleOrder: TroubleOrder


UnplannedOutage -> FieldDispatchHistory: FieldDispatchHistory


UnplannedOutage -> Incident: Incident


UnplannedOutage -> DateTimeInterval: actualPeriod


UnplannedOutage -> DateTimeInterval: estimatedPeriod


UnplannedOutage -> ServicePointOutageSummary: summary


UnplannedOutage -> UsagePoint: EnergizedUsagePoint


UnplannedOutage -> Equipment: Equipments


UnplannedOutage -> SwitchAction: PlannedSwitchActions


UnplannedOutage -> UsagePoint: DeEnergizedUsagePoint
...
UnplannedOutage -> ConductingEquipment: OutageIsolationEquipment


UnplannedOutage -> Incident: Incident


UnplannedOutage -> EstimatedRestorationTime: EstimatedRestorationTime


UnplannedOutage -> SwitchingPlan: SwitchingPlans


UnplannedOutage -> OutageArea: OutageArea


UnplannedOutage -> Status: docStatus


UnplannedOutage -> ElectronicAddress: electronicAddress


UnplannedOutage -> Status: status


UnplannedOutage -> ActivityRecord: ActivityRecord


UnplannedOutage -> ConfigurationEvent: ConfigurationEvents
...
UnplannedOutage -> DiagramObject: DiagramObjects


UnplannedOutage -> InstanceSet: InstanceSet


UnplannedOutage -> Name: Names


UnplannedOutage -> ChangeSetMember: PropertiesCIMDataObject


UnplannedOutage -> ChangeSetMember: TargetingCIMDataObject
