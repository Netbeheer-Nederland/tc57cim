...
InspectionDiscrete -> TestStandard: TestStandard


InspectionDiscrete -> DiscreteValue: DiscreteValues


InspectionDiscrete -> ValueAliasSet: ValueAliasSet


InspectionDiscrete -> ACDCTerminal: Terminal


InspectionDiscrete -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


InspectionDiscrete -> CalculationMethodHierarchy: CalculationMethodHierarchy


InspectionDiscrete -> PowerSystemResource: PowerSystemResource


InspectionDiscrete -> PinMeasurement: PinMeasurement


InspectionDiscrete -> MeasurementCalculatorInput: MeasurementCalculatorInput


InspectionDiscrete -> Asset: Asset


InspectionDiscrete -> MeasurementAction: MeasurementAction


InspectionDiscrete -> Location: Locations


InspectionDiscrete -> Procedure: Procedures


InspectionDiscrete -> DiagramObject: DiagramObjects


InspectionDiscrete -> InstanceSet: InstanceSet


InspectionDiscrete -> Name: Names


InspectionDiscrete -> ChangeSetMember: PropertiesCIMDataObject


InspectionDiscrete -> ChangeSetMember: TargetingCIMDataObject
