...
ConnectivityNodeContainer -> Control: Controls
...
ConnectivityNodeContainer -> ConfigurationEvent: ConfigurationEvent


ConnectivityNodeContainer -> ReportingGroup: ReportingGroup


ConnectivityNodeContainer -> OperatingShare: OperatingShare


ConnectivityNodeContainer -> AssetInfo: AssetDatasheet


ConnectivityNodeContainer -> VerificationAction: VerificationAction


ConnectivityNodeContainer -> ClearanceDocument: Clearances


ConnectivityNodeContainer -> GenericAction: GenericAction


ConnectivityNodeContainer -> PSREvent: PSREvents
...
ConnectivityNodeContainer -> OperationalTag: OperationalTags


ConnectivityNodeContainer -> DiagramObject: DiagramObjects


ConnectivityNodeContainer -> InstanceSet: InstanceSet


ConnectivityNodeContainer -> Name: Names


ConnectivityNodeContainer -> ChangeSetMember: PropertiesCIMDataObject


ConnectivityNodeContainer -> ChangeSetMember: TargetingCIMDataObject
