...
Control -> ProvidedBilateralPoint: BilateralToIOPoint


Control -> IOPointSource: IOPointSource


Control -> DiagramObject: DiagramObjects


Control -> InstanceSet: InstanceSet


Control -> Name: Names


Control -> ChangeSetMember: PropertiesCIMDataObject


Control -> ChangeSetMember: TargetingCIMDataObject
