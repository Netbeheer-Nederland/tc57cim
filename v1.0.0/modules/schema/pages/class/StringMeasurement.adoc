...
StringMeasurement -> ACDCTerminal: Terminal


StringMeasurement -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


StringMeasurement -> CalculationMethodHierarchy: CalculationMethodHierarchy


StringMeasurement -> PowerSystemResource: PowerSystemResource


StringMeasurement -> PinMeasurement: PinMeasurement


StringMeasurement -> MeasurementCalculatorInput: MeasurementCalculatorInput


StringMeasurement -> Asset: Asset


StringMeasurement -> MeasurementAction: MeasurementAction


StringMeasurement -> Location: Locations


StringMeasurement -> Procedure: Procedures


StringMeasurement -> DiagramObject: DiagramObjects


StringMeasurement -> InstanceSet: InstanceSet


StringMeasurement -> Name: Names


StringMeasurement -> ChangeSetMember: PropertiesCIMDataObject


StringMeasurement -> ChangeSetMember: TargetingCIMDataObject
