...
AssetModelCatalogueItem -> AssetModelCatalogue: AssetModelCatalogue


AssetModelCatalogueItem -> ErpPOLineItem: ErpPOLineItems


AssetModelCatalogueItem -> ErpQuoteLineItem: ErpQuoteLineItems


AssetModelCatalogueItem -> ProductAssetModel: AssetModel


AssetModelCatalogueItem -> Status: docStatus


AssetModelCatalogueItem -> ElectronicAddress: electronicAddress


AssetModelCatalogueItem -> Status: status


AssetModelCatalogueItem -> ActivityRecord: ActivityRecord


AssetModelCatalogueItem -> ConfigurationEvent: ConfigurationEvents


AssetModelCatalogueItem -> Author: Author


AssetModelCatalogueItem -> Editor: Editor


AssetModelCatalogueItem -> Approver: Approver


AssetModelCatalogueItem -> Issuer: Issuer


AssetModelCatalogueItem -> DiagramObject: DiagramObjects


AssetModelCatalogueItem -> InstanceSet: InstanceSet


AssetModelCatalogueItem -> Name: Names


AssetModelCatalogueItem -> ChangeSetMember: PropertiesCIMDataObject


AssetModelCatalogueItem -> ChangeSetMember: TargetingCIMDataObject
