...
StartUpTimeCurve -> GeneratingBid: GeneratingBid


StartUpTimeCurve -> RegisteredGenerator: RegisteredGenerator


StartUpTimeCurve -> CurveData: CurveDatas


StartUpTimeCurve -> DiagramObject: DiagramObjects


StartUpTimeCurve -> InstanceSet: InstanceSet


StartUpTimeCurve -> Name: Names


StartUpTimeCurve -> ChangeSetMember: PropertiesCIMDataObject


StartUpTimeCurve -> ChangeSetMember: TargetingCIMDataObject
