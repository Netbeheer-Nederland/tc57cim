...
SwitchingOrder -> DateTimeInterval: plannedExecutionInterval


SwitchingOrder -> SwitchingPlan: SwitchingPlan


SwitchingOrder -> Location: Location


SwitchingOrder -> Status: docStatus


SwitchingOrder -> ElectronicAddress: electronicAddress


SwitchingOrder -> Status: status


SwitchingOrder -> ActivityRecord: ActivityRecord


SwitchingOrder -> ConfigurationEvent: ConfigurationEvents


SwitchingOrder -> Author: Author


SwitchingOrder -> Editor: Editor


SwitchingOrder -> Approver: Approver


SwitchingOrder -> Issuer: Issuer


SwitchingOrder -> DiagramObject: DiagramObjects


SwitchingOrder -> InstanceSet: InstanceSet


SwitchingOrder -> Name: Names


SwitchingOrder -> ChangeSetMember: PropertiesCIMDataObject


SwitchingOrder -> ChangeSetMember: TargetingCIMDataObject
