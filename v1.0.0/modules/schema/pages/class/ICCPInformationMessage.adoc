...
ICCPInformationMessage -> TASE2BilateralTable: TASE2BilateralTable


ICCPInformationMessage -> DiagramObject: DiagramObjects


ICCPInformationMessage -> InstanceSet: InstanceSet


ICCPInformationMessage -> Name: Names


ICCPInformationMessage -> ChangeSetMember: PropertiesCIMDataObject


ICCPInformationMessage -> ChangeSetMember: TargetingCIMDataObject
