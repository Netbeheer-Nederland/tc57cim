...
LoadUserDefined -> EnergyConsumer: EnergyConsumer


LoadUserDefined -> DiagramObject: DiagramObjects


LoadUserDefined -> InstanceSet: InstanceSet


LoadUserDefined -> Name: Names


LoadUserDefined -> ChangeSetMember: PropertiesCIMDataObject


LoadUserDefined -> ChangeSetMember: TargetingCIMDataObject
