...
AuxiliaryAccount -> Due: due


AuxiliaryAccount -> AccountMovement: lastCredit


AuxiliaryAccount -> AccountMovement: lastDebit



AuxiliaryAccount -> Charge: Charges


AuxiliaryAccount -> Transaction: PaymentTransactions


AuxiliaryAccount -> AuxiliaryAgreement: AuxiliaryAgreement


AuxiliaryAccount -> Status: docStatus


AuxiliaryAccount -> ElectronicAddress: electronicAddress


AuxiliaryAccount -> Status: status


AuxiliaryAccount -> ActivityRecord: ActivityRecord


AuxiliaryAccount -> ConfigurationEvent: ConfigurationEvents


AuxiliaryAccount -> Author: Author


AuxiliaryAccount -> Editor: Editor


AuxiliaryAccount -> Approver: Approver


AuxiliaryAccount -> Issuer: Issuer


AuxiliaryAccount -> DiagramObject: DiagramObjects


AuxiliaryAccount -> InstanceSet: InstanceSet


AuxiliaryAccount -> Name: Names


AuxiliaryAccount -> ChangeSetMember: PropertiesCIMDataObject


AuxiliaryAccount -> ChangeSetMember: TargetingCIMDataObject
