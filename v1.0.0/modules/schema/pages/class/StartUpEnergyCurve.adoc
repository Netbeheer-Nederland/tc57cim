...
StartUpEnergyCurve -> RegisteredGenerator: RegisteredGenerator


StartUpEnergyCurve -> CurveData: CurveDatas


StartUpEnergyCurve -> DiagramObject: DiagramObjects


StartUpEnergyCurve -> InstanceSet: InstanceSet


StartUpEnergyCurve -> Name: Names


StartUpEnergyCurve -> ChangeSetMember: PropertiesCIMDataObject


StartUpEnergyCurve -> ChangeSetMember: TargetingCIMDataObject
