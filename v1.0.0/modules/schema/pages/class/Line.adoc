...
Line -> Equipment: AdditionalGroupedEquipment


Line -> TopologicalNode: TopologicalNode


Line -> ConnectivityNode: ConnectivityNodes


Line -> Control: Controls


Line -> Measurement: Measurements


Line -> PSRType: PSRType


Line -> ConfigurationEvent: ConfigurationEvent


Line -> ReportingGroup: ReportingGroup


Line -> OperatingShare: OperatingShare


Line -> AssetInfo: AssetDatasheet


Line -> VerificationAction: VerificationAction


Line -> ClearanceDocument: Clearances


Line -> GenericAction: GenericAction


Line -> PSREvent: PSREvents
...
Line -> OperationalTag: OperationalTags


Line -> DiagramObject: DiagramObjects


Line -> InstanceSet: InstanceSet


Line -> Name: Names


Line -> ChangeSetMember: PropertiesCIMDataObject


Line -> ChangeSetMember: TargetingCIMDataObject
