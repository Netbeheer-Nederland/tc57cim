...
ICCPProvidedPoint -> BilateralExchangeActor: BilateralExchangeActor


ICCPProvidedPoint -> IOPoint: IOPoint


ICCPProvidedPoint -> DiagramObject: DiagramObjects


ICCPProvidedPoint -> InstanceSet: InstanceSet


ICCPProvidedPoint -> Name: Names


ICCPProvidedPoint -> ChangeSetMember: PropertiesCIMDataObject


ICCPProvidedPoint -> ChangeSetMember: TargetingCIMDataObject
