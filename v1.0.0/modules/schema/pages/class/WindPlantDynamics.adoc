...
WindPlantDynamics -> RemoteInputSignal: RemoteInputSignal


WindPlantDynamics -> DiagramObject: DiagramObjects


WindPlantDynamics -> InstanceSet: InstanceSet


WindPlantDynamics -> Name: Names


WindPlantDynamics -> ChangeSetMember: PropertiesCIMDataObject


WindPlantDynamics -> ChangeSetMember: TargetingCIMDataObject
