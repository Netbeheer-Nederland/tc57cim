...
EnvironmentalStringMeasurement -> EnvironmentalInformation: EnvironmentalInformation


EnvironmentalStringMeasurement -> ClassificationCondition: ClassificationCondition


EnvironmentalStringMeasurement -> StringMeasurementValue: StringMeasurementValues


EnvironmentalStringMeasurement -> ACDCTerminal: Terminal


EnvironmentalStringMeasurement -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EnvironmentalStringMeasurement -> CalculationMethodHierarchy: CalculationMethodHierarchy


EnvironmentalStringMeasurement -> PowerSystemResource: PowerSystemResource


EnvironmentalStringMeasurement -> PinMeasurement: PinMeasurement


EnvironmentalStringMeasurement -> MeasurementCalculatorInput: MeasurementCalculatorInput


EnvironmentalStringMeasurement -> Asset: Asset


EnvironmentalStringMeasurement -> MeasurementAction: MeasurementAction


EnvironmentalStringMeasurement -> Location: Locations


EnvironmentalStringMeasurement -> Procedure: Procedures


EnvironmentalStringMeasurement -> DiagramObject: DiagramObjects


EnvironmentalStringMeasurement -> InstanceSet: InstanceSet


EnvironmentalStringMeasurement -> Name: Names


EnvironmentalStringMeasurement -> ChangeSetMember: PropertiesCIMDataObject


EnvironmentalStringMeasurement -> ChangeSetMember: TargetingCIMDataObject
