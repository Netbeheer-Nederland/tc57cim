...
WindContQLimIEC -> DiagramObject: DiagramObjects


WindContQLimIEC -> InstanceSet: InstanceSet


WindContQLimIEC -> Name: Names


WindContQLimIEC -> ChangeSetMember: PropertiesCIMDataObject


WindContQLimIEC -> ChangeSetMember: TargetingCIMDataObject
