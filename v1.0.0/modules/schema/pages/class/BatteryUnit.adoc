...
BatteryUnit -> PowerElectronicsConnection: PowerElectronicsConnection


BatteryUnit -> WeatherStation: WeatherStation


BatteryUnit -> OperationalLimitSet: OperationalLimitSet


BatteryUnit -> ContingencyEquipment: ContingencyEquipment


BatteryUnit -> EquipmentContainer: EquipmentContainer


BatteryUnit -> Fault: Faults


BatteryUnit -> LimitDependency: LimitDependencyModel


BatteryUnit -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


BatteryUnit -> ProtectiveActionEquipment: ProtectiveActionEquipment


BatteryUnit -> PinEquipment: PinEquipment


BatteryUnit -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


BatteryUnit -> EquipmentContainer: AdditionalEquipmentContainer


BatteryUnit -> UsagePoint: UsagePoints


BatteryUnit -> Outage: Outages


BatteryUnit -> OperationalRestriction: OperationalRestrictions


BatteryUnit -> Control: Controls


BatteryUnit -> Measurement: Measurements


BatteryUnit -> PSRType: PSRType


BatteryUnit -> ConfigurationEvent: ConfigurationEvent


BatteryUnit -> ReportingGroup: ReportingGroup


BatteryUnit -> OperatingShare: OperatingShare


BatteryUnit -> AssetInfo: AssetDatasheet


BatteryUnit -> VerificationAction: VerificationAction


BatteryUnit -> ClearanceDocument: Clearances


BatteryUnit -> GenericAction: GenericAction


BatteryUnit -> PSREvent: PSREvents


BatteryUnit -> Asset: Assets


BatteryUnit -> Location: Location


BatteryUnit -> OperationalTag: OperationalTags


BatteryUnit -> DiagramObject: DiagramObjects


BatteryUnit -> InstanceSet: InstanceSet


BatteryUnit -> Name: Names


BatteryUnit -> ChangeSetMember: PropertiesCIMDataObject


BatteryUnit -> ChangeSetMember: TargetingCIMDataObject
