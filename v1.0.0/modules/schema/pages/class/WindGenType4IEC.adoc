...
WindGenType4IEC -> DiagramObject: DiagramObjects


WindGenType4IEC -> InstanceSet: InstanceSet


WindGenType4IEC -> Name: Names


WindGenType4IEC -> ChangeSetMember: PropertiesCIMDataObject


WindGenType4IEC -> ChangeSetMember: TargetingCIMDataObject
