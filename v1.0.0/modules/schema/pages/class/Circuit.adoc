...
Circuit -> Terminal: EndTerminal


Circuit -> SubGeographicalRegion: Region


Circuit -> Equipment: Equipments


Circuit -> Equipment: AdditionalGroupedEquipment


Circuit -> TopologicalNode: TopologicalNode


Circuit -> ConnectivityNode: ConnectivityNodes


Circuit -> Control: Controls


Circuit -> Measurement: Measurements


Circuit -> PSRType: PSRType


Circuit -> ConfigurationEvent: ConfigurationEvent


Circuit -> ReportingGroup: ReportingGroup


Circuit -> OperatingShare: OperatingShare


Circuit -> AssetInfo: AssetDatasheet


Circuit -> VerificationAction: VerificationAction


Circuit -> ClearanceDocument: Clearances


Circuit -> GenericAction: GenericAction


Circuit -> PSREvent: PSREvents


Circuit -> Asset: Assets


Circuit -> Location: Location


Circuit -> OperationalTag: OperationalTags


Circuit -> DiagramObject: DiagramObjects


Circuit -> InstanceSet: InstanceSet


Circuit -> Name: Names


Circuit -> ChangeSetMember: PropertiesCIMDataObject


Circuit -> ChangeSetMember: TargetingCIMDataObject
