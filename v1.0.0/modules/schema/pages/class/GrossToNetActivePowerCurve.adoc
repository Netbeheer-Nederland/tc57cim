...
GrossToNetActivePowerCurve -> CurveData: CurveDatas


GrossToNetActivePowerCurve -> DiagramObject: DiagramObjects


GrossToNetActivePowerCurve -> InstanceSet: InstanceSet


GrossToNetActivePowerCurve -> Name: Names


GrossToNetActivePowerCurve -> ChangeSetMember: PropertiesCIMDataObject


GrossToNetActivePowerCurve -> ChangeSetMember: TargetingCIMDataObject
