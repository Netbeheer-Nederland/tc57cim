...
EndDeviceControlType -> EndDeviceControl: EndDeviceControls


EndDeviceControlType -> DiagramObject: DiagramObjects


EndDeviceControlType -> InstanceSet: InstanceSet


EndDeviceControlType -> Name: Names


EndDeviceControlType -> ChangeSetMember: PropertiesCIMDataObject


EndDeviceControlType -> ChangeSetMember: TargetingCIMDataObject
