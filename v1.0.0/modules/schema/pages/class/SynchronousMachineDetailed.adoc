...
SynchronousMachineDetailed -> SynchronousMachine: SynchronousMachine


SynchronousMachineDetailed -> TurbineGovernorDynamics: TurbineGovernorDynamics


SynchronousMachineDetailed -> GenICompensationForGenJ: GenICompensationForGenJ


SynchronousMachineDetailed -> ExcitationSystemDynamics: ExcitationSystemDynamics


SynchronousMachineDetailed -> CrossCompoundTurbineGovernorDynamics: CrossCompoundTurbineGovernorDynamics


SynchronousMachineDetailed -> CrossCompoundTurbineGovernorDynamics: CrossCompoundTurbineGovernorDyanmics


SynchronousMachineDetailed -> MechanicalLoadDynamics: MechanicalLoadDynamics





SynchronousMachineDetailed -> DiagramObject: DiagramObjects


SynchronousMachineDetailed -> InstanceSet: InstanceSet


SynchronousMachineDetailed -> Name: Names


SynchronousMachineDetailed -> ChangeSetMember: PropertiesCIMDataObject


SynchronousMachineDetailed -> ChangeSetMember: TargetingCIMDataObject
