...
TopologicalIsland -> DiagramObject: DiagramObjects


TopologicalIsland -> InstanceSet: InstanceSet


TopologicalIsland -> Name: Names


TopologicalIsland -> ChangeSetMember: PropertiesCIMDataObject


TopologicalIsland -> ChangeSetMember: TargetingCIMDataObject
