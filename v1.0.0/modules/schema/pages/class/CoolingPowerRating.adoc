...
CoolingPowerRating -> Reconditioning: Reconditionings


CoolingPowerRating -> DiagramObject: DiagramObjects


CoolingPowerRating -> InstanceSet: InstanceSet


CoolingPowerRating -> Name: Names


CoolingPowerRating -> ChangeSetMember: PropertiesCIMDataObject


CoolingPowerRating -> ChangeSetMember: TargetingCIMDataObject
