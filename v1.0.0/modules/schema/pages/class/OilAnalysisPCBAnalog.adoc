...
OilAnalysisPCBAnalog -> TestStandard: TestStandard


OilAnalysisPCBAnalog -> AnalogValue: AnalogValues


OilAnalysisPCBAnalog -> AnalogLimitSet: LimitSets


OilAnalysisPCBAnalog -> ACDCTerminal: Terminal


OilAnalysisPCBAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


OilAnalysisPCBAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


OilAnalysisPCBAnalog -> PowerSystemResource: PowerSystemResource


OilAnalysisPCBAnalog -> PinMeasurement: PinMeasurement


OilAnalysisPCBAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


OilAnalysisPCBAnalog -> Asset: Asset


OilAnalysisPCBAnalog -> MeasurementAction: MeasurementAction


OilAnalysisPCBAnalog -> Location: Locations


OilAnalysisPCBAnalog -> Procedure: Procedures


OilAnalysisPCBAnalog -> DiagramObject: DiagramObjects


OilAnalysisPCBAnalog -> InstanceSet: InstanceSet


OilAnalysisPCBAnalog -> Name: Names


OilAnalysisPCBAnalog -> ChangeSetMember: PropertiesCIMDataObject


OilAnalysisPCBAnalog -> ChangeSetMember: TargetingCIMDataObject
