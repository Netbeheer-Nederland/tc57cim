...
PumpingLevelSchedule -> ProductBid: ProductBid



PumpingLevelSchedule -> RegularTimePoint: TimePoints


PumpingLevelSchedule -> DiagramObject: DiagramObjects


PumpingLevelSchedule -> InstanceSet: InstanceSet


PumpingLevelSchedule -> Name: Names


PumpingLevelSchedule -> ChangeSetMember: PropertiesCIMDataObject


PumpingLevelSchedule -> ChangeSetMember: TargetingCIMDataObject
