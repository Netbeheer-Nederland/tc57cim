...
MerchantAccount -> VendorShift: VendorShifts


MerchantAccount -> Transactor: Transactors


MerchantAccount -> MerchantAgreement: MerchantAgreement


MerchantAccount -> Status: docStatus


MerchantAccount -> ElectronicAddress: electronicAddress


MerchantAccount -> Status: status


MerchantAccount -> ActivityRecord: ActivityRecord


MerchantAccount -> ConfigurationEvent: ConfigurationEvents


MerchantAccount -> Author: Author


MerchantAccount -> Editor: Editor


MerchantAccount -> Approver: Approver


MerchantAccount -> Issuer: Issuer


MerchantAccount -> DiagramObject: DiagramObjects


MerchantAccount -> InstanceSet: InstanceSet


MerchantAccount -> Name: Names


MerchantAccount -> ChangeSetMember: PropertiesCIMDataObject


MerchantAccount -> ChangeSetMember: TargetingCIMDataObject
