...
EquipmentLimitSeriesComponent -> SeriesEquipmentDependentLimit: SeriesEquipmentDependentLimit


EquipmentLimitSeriesComponent -> Equipment: Equipment


EquipmentLimitSeriesComponent -> DiagramObject: DiagramObjects


EquipmentLimitSeriesComponent -> InstanceSet: InstanceSet


EquipmentLimitSeriesComponent -> Name: Names


EquipmentLimitSeriesComponent -> ChangeSetMember: PropertiesCIMDataObject


EquipmentLimitSeriesComponent -> ChangeSetMember: TargetingCIMDataObject
