...
Switch -> SwitchPhase: SwitchPhase


Switch -> SwitchSchedule: SwitchSchedules


Switch -> CompositeSwitch: CompositeSwitch


Switch -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


Switch -> SvSwitch: SvSwitch


Switch -> ConnectDisconnectFunction: ConnectDisconnectFunctions


Switch -> SwitchAction: SwitchAction


Switch -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Switch -> SvStatus: SvStatus


Switch -> ProtectionEquipment: ProtectionEquipments
...
Switch -> JumperAction: JumpingAction


Switch -> GroundAction: GroundingAction


Switch -> Outage: Outage


Switch -> WeatherStation: WeatherStation


Switch -> OperationalLimitSet: OperationalLimitSet


Switch -> ContingencyEquipment: ContingencyEquipment
...
Switch -> LimitDependency: LimitDependencyModel


Switch -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Switch -> ProtectiveActionEquipment: ProtectiveActionEquipment


Switch -> PinEquipment: PinEquipment


Switch -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Switch -> EquipmentContainer: AdditionalEquipmentContainer


Switch -> UsagePoint: UsagePoints


Switch -> Outage: Outages


Switch -> OperationalRestriction: OperationalRestrictions


Switch -> Control: Controls


Switch -> Measurement: Measurements


Switch -> PSRType: PSRType


Switch -> ConfigurationEvent: ConfigurationEvent


Switch -> ReportingGroup: ReportingGroup


Switch -> OperatingShare: OperatingShare


Switch -> AssetInfo: AssetDatasheet


Switch -> VerificationAction: VerificationAction


Switch -> ClearanceDocument: Clearances


Switch -> GenericAction: GenericAction


Switch -> PSREvent: PSREvents
...
Switch -> OperationalTag: OperationalTags


Switch -> DiagramObject: DiagramObjects


Switch -> InstanceSet: InstanceSet


Switch -> Name: Names


Switch -> ChangeSetMember: PropertiesCIMDataObject


Switch -> ChangeSetMember: TargetingCIMDataObject
