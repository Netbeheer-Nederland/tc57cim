...
GroundDisconnector -> SwitchPhase: SwitchPhase


GroundDisconnector -> SwitchSchedule: SwitchSchedules


GroundDisconnector -> CompositeSwitch: CompositeSwitch


GroundDisconnector -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


GroundDisconnector -> SvSwitch: SvSwitch


GroundDisconnector -> ConnectDisconnectFunction: ConnectDisconnectFunctions


GroundDisconnector -> SwitchAction: SwitchAction


GroundDisconnector -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


GroundDisconnector -> SvStatus: SvStatus


GroundDisconnector -> ProtectionEquipment: ProtectionEquipments


GroundDisconnector -> BaseVoltage: BaseVoltage


GroundDisconnector -> Terminal: Terminals


GroundDisconnector -> JumperAction: JumpingAction


GroundDisconnector -> GroundAction: GroundingAction


GroundDisconnector -> Outage: Outage


GroundDisconnector -> WeatherStation: WeatherStation


GroundDisconnector -> OperationalLimitSet: OperationalLimitSet


GroundDisconnector -> ContingencyEquipment: ContingencyEquipment


GroundDisconnector -> EquipmentContainer: EquipmentContainer


GroundDisconnector -> Fault: Faults


GroundDisconnector -> LimitDependency: LimitDependencyModel


GroundDisconnector -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


GroundDisconnector -> ProtectiveActionEquipment: ProtectiveActionEquipment


GroundDisconnector -> PinEquipment: PinEquipment


GroundDisconnector -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


GroundDisconnector -> EquipmentContainer: AdditionalEquipmentContainer


GroundDisconnector -> UsagePoint: UsagePoints


GroundDisconnector -> Outage: Outages


GroundDisconnector -> OperationalRestriction: OperationalRestrictions


GroundDisconnector -> Control: Controls


GroundDisconnector -> Measurement: Measurements


GroundDisconnector -> PSRType: PSRType


GroundDisconnector -> ConfigurationEvent: ConfigurationEvent


GroundDisconnector -> ReportingGroup: ReportingGroup


GroundDisconnector -> OperatingShare: OperatingShare


GroundDisconnector -> AssetInfo: AssetDatasheet


GroundDisconnector -> VerificationAction: VerificationAction


GroundDisconnector -> ClearanceDocument: Clearances


GroundDisconnector -> GenericAction: GenericAction


GroundDisconnector -> PSREvent: PSREvents


GroundDisconnector -> Asset: Assets


GroundDisconnector -> Location: Location


GroundDisconnector -> OperationalTag: OperationalTags


GroundDisconnector -> DiagramObject: DiagramObjects


GroundDisconnector -> InstanceSet: InstanceSet


GroundDisconnector -> Name: Names


GroundDisconnector -> ChangeSetMember: PropertiesCIMDataObject


GroundDisconnector -> ChangeSetMember: TargetingCIMDataObject
