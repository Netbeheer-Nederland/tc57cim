...
GroundAction -> ACLineSegment: AlongACLineSegment


GroundAction -> Ground: Ground


GroundAction -> ConductingEquipment: GroundedEquipment


GroundAction -> SwitchingPlan: SwitchingPlan


GroundAction -> Operator: Operator


GroundAction -> Crew: Crew


GroundAction -> SwitchingEvent: SwitchingEvent


GroundAction -> SwitchingStep: SwitchingStep


GroundAction -> DiagramObject: DiagramObjects


GroundAction -> InstanceSet: InstanceSet


GroundAction -> Name: Names


GroundAction -> ChangeSetMember: PropertiesCIMDataObject


GroundAction -> ChangeSetMember: TargetingCIMDataObject
