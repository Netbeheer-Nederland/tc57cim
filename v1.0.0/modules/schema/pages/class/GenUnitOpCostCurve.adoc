...
GenUnitOpCostCurve -> GeneratingUnit: GeneratingUnit


GenUnitOpCostCurve -> CurveData: CurveDatas


GenUnitOpCostCurve -> DiagramObject: DiagramObjects


GenUnitOpCostCurve -> InstanceSet: InstanceSet


GenUnitOpCostCurve -> Name: Names


GenUnitOpCostCurve -> ChangeSetMember: PropertiesCIMDataObject


GenUnitOpCostCurve -> ChangeSetMember: TargetingCIMDataObject
