...
RepairWorkTask -> RepairItem: BreakerRepairItem
...
RepairWorkTask -> TroubleOrder: TroubleOrder


RepairWorkTask -> Asset: Assets


RepairWorkTask -> MaterialItem: MaterialItems


RepairWorkTask -> Crew: Crews


RepairWorkTask -> Asset: OldAsset


RepairWorkTask -> SwitchingPlan: SwitchingPlan


RepairWorkTask -> ProcedureDataSet: ProcedureDataSet
...
RepairWorkTask -> WorkTimeSchedule: TimeSchedules


RepairWorkTask -> WorkLocation: WorkLocation


RepairWorkTask -> WorkActivityRecord: WorkActivityRecords


RepairWorkTask -> Status: docStatus


RepairWorkTask -> ElectronicAddress: electronicAddress


RepairWorkTask -> Status: status


RepairWorkTask -> ActivityRecord: ActivityRecord


RepairWorkTask -> ConfigurationEvent: ConfigurationEvents
...
RepairWorkTask -> DiagramObject: DiagramObjects


RepairWorkTask -> InstanceSet: InstanceSet


RepairWorkTask -> Name: Names


RepairWorkTask -> ChangeSetMember: PropertiesCIMDataObject


RepairWorkTask -> ChangeSetMember: TargetingCIMDataObject
