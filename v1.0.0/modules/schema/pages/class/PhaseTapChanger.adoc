...
PhaseTapChanger -> SvTapStep: SvTapStep


PhaseTapChanger -> TapSchedule: TapSchedules


PhaseTapChanger -> Control: Controls


PhaseTapChanger -> Measurement: Measurements


PhaseTapChanger -> PSRType: PSRType


PhaseTapChanger -> ConfigurationEvent: ConfigurationEvent


PhaseTapChanger -> ReportingGroup: ReportingGroup


PhaseTapChanger -> OperatingShare: OperatingShare


PhaseTapChanger -> AssetInfo: AssetDatasheet


PhaseTapChanger -> VerificationAction: VerificationAction


PhaseTapChanger -> ClearanceDocument: Clearances


PhaseTapChanger -> GenericAction: GenericAction


PhaseTapChanger -> PSREvent: PSREvents


PhaseTapChanger -> Asset: Assets


PhaseTapChanger -> Location: Location


PhaseTapChanger -> OperationalTag: OperationalTags


PhaseTapChanger -> DiagramObject: DiagramObjects


PhaseTapChanger -> InstanceSet: InstanceSet


PhaseTapChanger -> Name: Names


PhaseTapChanger -> ChangeSetMember: PropertiesCIMDataObject


PhaseTapChanger -> ChangeSetMember: TargetingCIMDataObject
