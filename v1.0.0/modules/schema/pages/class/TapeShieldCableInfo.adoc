...
TapeShieldCableInfo -> WirePhaseInfo: WirePhaseInfo


TapeShieldCableInfo -> ACLineSegmentPhase: ACLineSegmentPhase


TapeShieldCableInfo -> PowerSystemResource: PowerSystemResources


TapeShieldCableInfo -> CatalogAssetType: CatalogAssetType


TapeShieldCableInfo -> Asset: Assets


TapeShieldCableInfo -> ProductAssetModel: ProductAssetModel


TapeShieldCableInfo -> DiagramObject: DiagramObjects


TapeShieldCableInfo -> InstanceSet: InstanceSet


TapeShieldCableInfo -> Name: Names


TapeShieldCableInfo -> ChangeSetMember: PropertiesCIMDataObject


TapeShieldCableInfo -> ChangeSetMember: TargetingCIMDataObject
