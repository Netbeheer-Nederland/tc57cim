...
GovGASTWD -> AsynchronousMachineDynamics: AsynchronousMachineDynamics


GovGASTWD -> TurbineLoadControllerDynamics: TurbineLoadControllerDynamics


GovGASTWD -> SynchronousMachineDynamics: SynchronousMachineDynamics


GovGASTWD -> DiagramObject: DiagramObjects


GovGASTWD -> InstanceSet: InstanceSet


GovGASTWD -> Name: Names


GovGASTWD -> ChangeSetMember: PropertiesCIMDataObject


GovGASTWD -> ChangeSetMember: TargetingCIMDataObject
