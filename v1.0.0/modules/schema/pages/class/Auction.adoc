...
Auction -> TimeSeries: TimeSeries


Auction -> DiagramObject: DiagramObjects


Auction -> InstanceSet: InstanceSet


Auction -> Name: Names


Auction -> ChangeSetMember: PropertiesCIMDataObject


Auction -> ChangeSetMember: TargetingCIMDataObject
