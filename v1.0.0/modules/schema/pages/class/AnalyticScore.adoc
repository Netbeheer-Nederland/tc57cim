...
AnalyticScore -> AggregateScore: AssetAggregateScore


AnalyticScore -> Analytic: Analytic


AnalyticScore -> AssetGroup: AssetGroup


AnalyticScore -> DiagramObject: DiagramObjects


AnalyticScore -> InstanceSet: InstanceSet


AnalyticScore -> Name: Names


AnalyticScore -> ChangeSetMember: PropertiesCIMDataObject


AnalyticScore -> ChangeSetMember: TargetingCIMDataObject
