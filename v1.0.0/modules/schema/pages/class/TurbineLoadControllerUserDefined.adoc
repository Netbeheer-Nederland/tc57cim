...
TurbineLoadControllerUserDefined -> TurbineGovernorDynamics: TurbineGovernorDynamics


TurbineLoadControllerUserDefined -> DiagramObject: DiagramObjects


TurbineLoadControllerUserDefined -> InstanceSet: InstanceSet


TurbineLoadControllerUserDefined -> Name: Names


TurbineLoadControllerUserDefined -> ChangeSetMember: PropertiesCIMDataObject


TurbineLoadControllerUserDefined -> ChangeSetMember: TargetingCIMDataObject
