...
ForbiddenRegion -> RegisteredResource: RegisteredResource


ForbiddenRegion -> DiagramObject: DiagramObjects


ForbiddenRegion -> InstanceSet: InstanceSet


ForbiddenRegion -> Name: Names


ForbiddenRegion -> ChangeSetMember: PropertiesCIMDataObject


ForbiddenRegion -> ChangeSetMember: TargetingCIMDataObject
