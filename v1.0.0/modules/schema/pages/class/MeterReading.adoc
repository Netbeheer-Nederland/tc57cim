...
MeterReading -> DateTimeInterval: valuesInterval


MeterReading -> CustomerAgreement: CustomerAgreement


MeterReading -> EndDeviceEvent: EndDeviceEvents


MeterReading -> UsagePoint: UsagePoint


MeterReading -> IntervalBlock: IntervalBlocks
...
MeterReading -> DiagramObject: DiagramObjects


MeterReading -> InstanceSet: InstanceSet


MeterReading -> Name: Names


MeterReading -> ChangeSetMember: PropertiesCIMDataObject


MeterReading -> ChangeSetMember: TargetingCIMDataObject
