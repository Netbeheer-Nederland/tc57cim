...
ErpReceiveDelivery -> ErpRecDelvLineItem: ErpRecDelvLineItems


ErpReceiveDelivery -> Status: docStatus


ErpReceiveDelivery -> ElectronicAddress: electronicAddress


ErpReceiveDelivery -> Status: status


ErpReceiveDelivery -> ActivityRecord: ActivityRecord


ErpReceiveDelivery -> ConfigurationEvent: ConfigurationEvents


ErpReceiveDelivery -> Author: Author


ErpReceiveDelivery -> Editor: Editor


ErpReceiveDelivery -> Approver: Approver


ErpReceiveDelivery -> Issuer: Issuer


ErpReceiveDelivery -> DiagramObject: DiagramObjects


ErpReceiveDelivery -> InstanceSet: InstanceSet


ErpReceiveDelivery -> Name: Names


ErpReceiveDelivery -> ChangeSetMember: PropertiesCIMDataObject


ErpReceiveDelivery -> ChangeSetMember: TargetingCIMDataObject
