...
WindPitchContPowerIEC -> DiagramObject: DiagramObjects


WindPitchContPowerIEC -> InstanceSet: InstanceSet


WindPitchContPowerIEC -> Name: Names


WindPitchContPowerIEC -> ChangeSetMember: PropertiesCIMDataObject


WindPitchContPowerIEC -> ChangeSetMember: TargetingCIMDataObject
