...
HydroPowerPlant -> Reservoir: GenSourcePumpDischargeReservoir
...
HydroPowerPlant -> ConfigurationEvent: ConfigurationEvent


HydroPowerPlant -> ReportingGroup: ReportingGroup


HydroPowerPlant -> OperatingShare: OperatingShare


HydroPowerPlant -> AssetInfo: AssetDatasheet


HydroPowerPlant -> VerificationAction: VerificationAction


HydroPowerPlant -> ClearanceDocument: Clearances


HydroPowerPlant -> GenericAction: GenericAction
...
HydroPowerPlant -> OperationalTag: OperationalTags


HydroPowerPlant -> DiagramObject: DiagramObjects


HydroPowerPlant -> InstanceSet: InstanceSet


HydroPowerPlant -> Name: Names


HydroPowerPlant -> ChangeSetMember: PropertiesCIMDataObject


HydroPowerPlant -> ChangeSetMember: TargetingCIMDataObject
