...
ErpProjectAccounting -> Project: Projects


ErpProjectAccounting -> Work: Works


ErpProjectAccounting -> WorkCostDetail: WorkCostDetails


ErpProjectAccounting -> ErpTimeEntry: ErpTimeEntries


ErpProjectAccounting -> Status: docStatus


ErpProjectAccounting -> ElectronicAddress: electronicAddress


ErpProjectAccounting -> Status: status


ErpProjectAccounting -> ActivityRecord: ActivityRecord


ErpProjectAccounting -> ConfigurationEvent: ConfigurationEvents


ErpProjectAccounting -> Author: Author


ErpProjectAccounting -> Editor: Editor


ErpProjectAccounting -> Approver: Approver


ErpProjectAccounting -> Issuer: Issuer


ErpProjectAccounting -> DiagramObject: DiagramObjects


ErpProjectAccounting -> InstanceSet: InstanceSet


ErpProjectAccounting -> Name: Names


ErpProjectAccounting -> ChangeSetMember: PropertiesCIMDataObject


ErpProjectAccounting -> ChangeSetMember: TargetingCIMDataObject
