...
PssPTIST1 -> ExcitationSystemDynamics: ExcitationSystemDynamics


PssPTIST1 -> RemoteInputSignal: RemoteInputSignal


PssPTIST1 -> DiagramObject: DiagramObjects


PssPTIST1 -> InstanceSet: InstanceSet


PssPTIST1 -> Name: Names


PssPTIST1 -> ChangeSetMember: PropertiesCIMDataObject


PssPTIST1 -> ChangeSetMember: TargetingCIMDataObject
