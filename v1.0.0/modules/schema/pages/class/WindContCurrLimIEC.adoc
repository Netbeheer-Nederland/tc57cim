...
WindContCurrLimIEC -> DiagramObject: DiagramObjects


WindContCurrLimIEC -> InstanceSet: InstanceSet


WindContCurrLimIEC -> Name: Names


WindContCurrLimIEC -> ChangeSetMember: PropertiesCIMDataObject


WindContCurrLimIEC -> ChangeSetMember: TargetingCIMDataObject
