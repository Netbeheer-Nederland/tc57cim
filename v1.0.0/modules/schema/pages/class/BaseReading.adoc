...
BaseReading -> DateTimeInterval: timePeriod


BaseReading -> ReadingQuality: ReadingQualities



BaseReading -> RemoteSource: RemoteSource


BaseReading -> MeasurementValueQuality: MeasurementValueQuality


BaseReading -> MeasurementValueSource: MeasurementValueSource


BaseReading -> CalculationMethodHierarchy: CalculationMethodHierarchy


BaseReading -> ProcedureDataSet: ProcedureDataSet


BaseReading -> OldPerson: ErpPerson


BaseReading -> ProvidedBilateralPoint: BilateralToIOPoint


BaseReading -> IOPointSource: IOPointSource


BaseReading -> DiagramObject: DiagramObjects


BaseReading -> InstanceSet: InstanceSet


BaseReading -> Name: Names


BaseReading -> ChangeSetMember: PropertiesCIMDataObject


BaseReading -> ChangeSetMember: TargetingCIMDataObject
