...
Fuse -> SwitchPhase: SwitchPhase


Fuse -> SwitchSchedule: SwitchSchedules


Fuse -> CompositeSwitch: CompositeSwitch


Fuse -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


Fuse -> SvSwitch: SvSwitch


Fuse -> ConnectDisconnectFunction: ConnectDisconnectFunctions


Fuse -> SwitchAction: SwitchAction


Fuse -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Fuse -> SvStatus: SvStatus


Fuse -> ProtectionEquipment: ProtectionEquipments
...
Fuse -> JumperAction: JumpingAction


Fuse -> GroundAction: GroundingAction


Fuse -> Outage: Outage


Fuse -> WeatherStation: WeatherStation


Fuse -> OperationalLimitSet: OperationalLimitSet


Fuse -> ContingencyEquipment: ContingencyEquipment
...
Fuse -> LimitDependency: LimitDependencyModel


Fuse -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Fuse -> ProtectiveActionEquipment: ProtectiveActionEquipment


Fuse -> PinEquipment: PinEquipment


Fuse -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Fuse -> EquipmentContainer: AdditionalEquipmentContainer


Fuse -> UsagePoint: UsagePoints


Fuse -> Outage: Outages


Fuse -> OperationalRestriction: OperationalRestrictions


Fuse -> Control: Controls


Fuse -> Measurement: Measurements


Fuse -> PSRType: PSRType


Fuse -> ConfigurationEvent: ConfigurationEvent


Fuse -> ReportingGroup: ReportingGroup


Fuse -> OperatingShare: OperatingShare


Fuse -> AssetInfo: AssetDatasheet


Fuse -> VerificationAction: VerificationAction


Fuse -> ClearanceDocument: Clearances


Fuse -> GenericAction: GenericAction


Fuse -> PSREvent: PSREvents
...
Fuse -> OperationalTag: OperationalTags


Fuse -> DiagramObject: DiagramObjects


Fuse -> InstanceSet: InstanceSet


Fuse -> Name: Names


Fuse -> ChangeSetMember: PropertiesCIMDataObject


Fuse -> ChangeSetMember: TargetingCIMDataObject
