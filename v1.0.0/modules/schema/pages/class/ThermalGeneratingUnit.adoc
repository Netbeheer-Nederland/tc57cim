...
ThermalGeneratingUnit -> HeatRateCurve: HeatRateCurve


ThermalGeneratingUnit -> CogenerationPlant: CogenerationPlant


ThermalGeneratingUnit -> FuelAllocationSchedule: FuelAllocationSchedules


ThermalGeneratingUnit -> StartupModel: StartupModel


ThermalGeneratingUnit -> EmissionCurve: EmissionCurves


ThermalGeneratingUnit -> ShutdownCurve: ShutdownCurve


ThermalGeneratingUnit -> IncrementalHeatRateCurve: IncrementalHeatRateCurve
...
ThermalGeneratingUnit -> EmissionAccount: EmmissionAccounts


ThermalGeneratingUnit -> HeatInputCurve: HeatInputCurve
...
ThermalGeneratingUnit -> RotatingMachine: RotatingMachine


ThermalGeneratingUnit -> GenUnitOpSchedule: GenUnitOpSchedule


ThermalGeneratingUnit -> ControlAreaGeneratingUnit: ControlAreaGeneratingUnit


ThermalGeneratingUnit -> GrossToNetActivePowerCurve: GrossToNetActivePowerCurves


ThermalGeneratingUnit -> GenUnitOpCostCurve: GenUnitOpCostCurves


ThermalGeneratingUnit -> WeatherStation: WeatherStation


ThermalGeneratingUnit -> OperationalLimitSet: OperationalLimitSet


ThermalGeneratingUnit -> ContingencyEquipment: ContingencyEquipment


ThermalGeneratingUnit -> EquipmentContainer: EquipmentContainer


ThermalGeneratingUnit -> Fault: Faults


ThermalGeneratingUnit -> LimitDependency: LimitDependencyModel


ThermalGeneratingUnit -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ThermalGeneratingUnit -> ProtectiveActionEquipment: ProtectiveActionEquipment


ThermalGeneratingUnit -> PinEquipment: PinEquipment


ThermalGeneratingUnit -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ThermalGeneratingUnit -> EquipmentContainer: AdditionalEquipmentContainer


ThermalGeneratingUnit -> UsagePoint: UsagePoints


ThermalGeneratingUnit -> Outage: Outages


ThermalGeneratingUnit -> OperationalRestriction: OperationalRestrictions


ThermalGeneratingUnit -> Control: Controls


ThermalGeneratingUnit -> Measurement: Measurements


ThermalGeneratingUnit -> PSRType: PSRType


ThermalGeneratingUnit -> ConfigurationEvent: ConfigurationEvent


ThermalGeneratingUnit -> ReportingGroup: ReportingGroup


ThermalGeneratingUnit -> OperatingShare: OperatingShare


ThermalGeneratingUnit -> AssetInfo: AssetDatasheet


ThermalGeneratingUnit -> VerificationAction: VerificationAction


ThermalGeneratingUnit -> ClearanceDocument: Clearances


ThermalGeneratingUnit -> GenericAction: GenericAction


ThermalGeneratingUnit -> PSREvent: PSREvents


ThermalGeneratingUnit -> Asset: Assets


ThermalGeneratingUnit -> Location: Location


ThermalGeneratingUnit -> OperationalTag: OperationalTags


ThermalGeneratingUnit -> DiagramObject: DiagramObjects


ThermalGeneratingUnit -> InstanceSet: InstanceSet


ThermalGeneratingUnit -> Name: Names


ThermalGeneratingUnit -> ChangeSetMember: PropertiesCIMDataObject


ThermalGeneratingUnit -> ChangeSetMember: TargetingCIMDataObject
