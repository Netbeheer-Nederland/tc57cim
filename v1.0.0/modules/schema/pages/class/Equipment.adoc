...
Equipment -> WeatherStation: WeatherStation


Equipment -> OperationalLimitSet: OperationalLimitSet


Equipment -> ContingencyEquipment: ContingencyEquipment


Equipment -> EquipmentContainer: EquipmentContainer


Equipment -> Fault: Faults


Equipment -> LimitDependency: LimitDependencyModel


Equipment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Equipment -> ProtectiveActionEquipment: ProtectiveActionEquipment


Equipment -> PinEquipment: PinEquipment


Equipment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Equipment -> EquipmentContainer: AdditionalEquipmentContainer


Equipment -> UsagePoint: UsagePoints


Equipment -> Outage: Outages


Equipment -> OperationalRestriction: OperationalRestrictions


Equipment -> Control: Controls
...
Equipment -> ConfigurationEvent: ConfigurationEvent


Equipment -> ReportingGroup: ReportingGroup


Equipment -> OperatingShare: OperatingShare


Equipment -> AssetInfo: AssetDatasheet


Equipment -> VerificationAction: VerificationAction


Equipment -> ClearanceDocument: Clearances


Equipment -> GenericAction: GenericAction


Equipment -> PSREvent: PSREvents
...
Equipment -> OperationalTag: OperationalTags


Equipment -> DiagramObject: DiagramObjects


Equipment -> InstanceSet: InstanceSet


Equipment -> Name: Names


Equipment -> ChangeSetMember: PropertiesCIMDataObject


Equipment -> ChangeSetMember: TargetingCIMDataObject
