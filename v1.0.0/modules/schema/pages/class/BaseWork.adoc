...
BaseWork -> WorkActivityRecord: WorkActivityRecords


BaseWork -> Status: docStatus


BaseWork -> ElectronicAddress: electronicAddress


BaseWork -> Status: status


BaseWork -> ActivityRecord: ActivityRecord


BaseWork -> ConfigurationEvent: ConfigurationEvents


BaseWork -> Author: Author


BaseWork -> Editor: Editor


BaseWork -> Approver: Approver


BaseWork -> Issuer: Issuer


BaseWork -> DiagramObject: DiagramObjects


BaseWork -> InstanceSet: InstanceSet


BaseWork -> Name: Names


BaseWork -> ChangeSetMember: PropertiesCIMDataObject


BaseWork -> ChangeSetMember: TargetingCIMDataObject
