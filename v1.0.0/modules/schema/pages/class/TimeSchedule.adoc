...
TimeSchedule -> DateTimeInterval: scheduleInterval


TimeSchedule -> TimePoint: TimePoints


TimeSchedule -> MeterReadSchedule: MeterReadSchedule


TimeSchedule -> Status: docStatus


TimeSchedule -> ElectronicAddress: electronicAddress


TimeSchedule -> Status: status


TimeSchedule -> ActivityRecord: ActivityRecord


TimeSchedule -> ConfigurationEvent: ConfigurationEvents


TimeSchedule -> Author: Author


TimeSchedule -> Editor: Editor


TimeSchedule -> Approver: Approver


TimeSchedule -> Issuer: Issuer


TimeSchedule -> DiagramObject: DiagramObjects


TimeSchedule -> InstanceSet: InstanceSet


TimeSchedule -> Name: Names


TimeSchedule -> ChangeSetMember: PropertiesCIMDataObject


TimeSchedule -> ChangeSetMember: TargetingCIMDataObject
