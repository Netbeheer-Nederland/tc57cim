...
EnvironmentalDiscrete -> EnvironmentalInformation: EnvironmentalInformation


EnvironmentalDiscrete -> DiscreteValue: DiscreteValues


EnvironmentalDiscrete -> ValueAliasSet: ValueAliasSet


EnvironmentalDiscrete -> ACDCTerminal: Terminal


EnvironmentalDiscrete -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EnvironmentalDiscrete -> CalculationMethodHierarchy: CalculationMethodHierarchy


EnvironmentalDiscrete -> PowerSystemResource: PowerSystemResource


EnvironmentalDiscrete -> PinMeasurement: PinMeasurement


EnvironmentalDiscrete -> MeasurementCalculatorInput: MeasurementCalculatorInput


EnvironmentalDiscrete -> Asset: Asset


EnvironmentalDiscrete -> MeasurementAction: MeasurementAction


EnvironmentalDiscrete -> Location: Locations


EnvironmentalDiscrete -> Procedure: Procedures


EnvironmentalDiscrete -> DiagramObject: DiagramObjects


EnvironmentalDiscrete -> InstanceSet: InstanceSet


EnvironmentalDiscrete -> Name: Names


EnvironmentalDiscrete -> ChangeSetMember: PropertiesCIMDataObject


EnvironmentalDiscrete -> ChangeSetMember: TargetingCIMDataObject
