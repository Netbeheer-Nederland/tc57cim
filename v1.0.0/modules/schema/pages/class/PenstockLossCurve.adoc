...
PenstockLossCurve -> HydroGeneratingUnit: HydroGeneratingUnit


PenstockLossCurve -> CurveData: CurveDatas


PenstockLossCurve -> DiagramObject: DiagramObjects


PenstockLossCurve -> InstanceSet: InstanceSet


PenstockLossCurve -> Name: Names


PenstockLossCurve -> ChangeSetMember: PropertiesCIMDataObject


PenstockLossCurve -> ChangeSetMember: TargetingCIMDataObject
