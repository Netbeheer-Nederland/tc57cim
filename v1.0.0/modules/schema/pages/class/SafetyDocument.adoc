...
SafetyDocument -> OperationsSafetySupervisor: IssuedBySupervisor


SafetyDocument -> FieldSafetySupervisor: IssuedToSupervisor


SafetyDocument -> SwitchingPlan: SwitchingPlan


SafetyDocument -> OperationsSafetySupervisor: ReleasedToSupervisor


SafetyDocument -> FieldSafetySupervisor: ReleasedBySupervisor


SafetyDocument -> Status: docStatus


SafetyDocument -> ElectronicAddress: electronicAddress


SafetyDocument -> Status: status


SafetyDocument -> ActivityRecord: ActivityRecord


SafetyDocument -> ConfigurationEvent: ConfigurationEvents


SafetyDocument -> Author: Author


SafetyDocument -> Editor: Editor


SafetyDocument -> Approver: Approver


SafetyDocument -> Issuer: Issuer


SafetyDocument -> DiagramObject: DiagramObjects


SafetyDocument -> InstanceSet: InstanceSet


SafetyDocument -> Name: Names


SafetyDocument -> ChangeSetMember: PropertiesCIMDataObject


SafetyDocument -> ChangeSetMember: TargetingCIMDataObject
