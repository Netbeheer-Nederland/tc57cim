...
ReserveDemandCurve -> ASRequirements: ASRequirements


ReserveDemandCurve -> MarketRegion: MarketRegion


ReserveDemandCurve -> CurveData: CurveDatas


ReserveDemandCurve -> DiagramObject: DiagramObjects


ReserveDemandCurve -> InstanceSet: InstanceSet


ReserveDemandCurve -> Name: Names


ReserveDemandCurve -> ChangeSetMember: PropertiesCIMDataObject


ReserveDemandCurve -> ChangeSetMember: TargetingCIMDataObject
