...
LabTestDataSet -> AssetTestLab: AssetTestLab


LabTestDataSet -> Specimen: Specimen


LabTestDataSet -> WorkTask: WorkTask


LabTestDataSet -> TransformerObservation: TransformerObservations


LabTestDataSet -> MeasurementValue: MeasurementValue
...
LabTestDataSet -> Status: docStatus


LabTestDataSet -> ElectronicAddress: electronicAddress


LabTestDataSet -> Status: status


LabTestDataSet -> ActivityRecord: ActivityRecord


LabTestDataSet -> ConfigurationEvent: ConfigurationEvents
...
LabTestDataSet -> DiagramObject: DiagramObjects


LabTestDataSet -> InstanceSet: InstanceSet


LabTestDataSet -> Name: Names


LabTestDataSet -> ChangeSetMember: PropertiesCIMDataObject


LabTestDataSet -> ChangeSetMember: TargetingCIMDataObject
