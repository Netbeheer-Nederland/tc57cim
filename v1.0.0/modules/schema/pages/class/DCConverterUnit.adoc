...
DCConverterUnit -> DCTopologicalNode: DCTopologicalNode


DCConverterUnit -> DCNode: DCNodes


DCConverterUnit -> Equipment: Equipments


DCConverterUnit -> Equipment: AdditionalGroupedEquipment


DCConverterUnit -> TopologicalNode: TopologicalNode


DCConverterUnit -> ConnectivityNode: ConnectivityNodes


DCConverterUnit -> Control: Controls


DCConverterUnit -> Measurement: Measurements


DCConverterUnit -> PSRType: PSRType


DCConverterUnit -> ConfigurationEvent: ConfigurationEvent


DCConverterUnit -> ReportingGroup: ReportingGroup


DCConverterUnit -> OperatingShare: OperatingShare


DCConverterUnit -> AssetInfo: AssetDatasheet


DCConverterUnit -> VerificationAction: VerificationAction


DCConverterUnit -> ClearanceDocument: Clearances


DCConverterUnit -> GenericAction: GenericAction


DCConverterUnit -> PSREvent: PSREvents


DCConverterUnit -> Asset: Assets


DCConverterUnit -> Location: Location


DCConverterUnit -> OperationalTag: OperationalTags


DCConverterUnit -> DiagramObject: DiagramObjects


DCConverterUnit -> InstanceSet: InstanceSet


DCConverterUnit -> Name: Names


DCConverterUnit -> ChangeSetMember: PropertiesCIMDataObject


DCConverterUnit -> ChangeSetMember: TargetingCIMDataObject
