...
OperationalLimitSet -> DiagramObject: DiagramObjects


OperationalLimitSet -> InstanceSet: InstanceSet


OperationalLimitSet -> Name: Names


OperationalLimitSet -> ChangeSetMember: PropertiesCIMDataObject


OperationalLimitSet -> ChangeSetMember: TargetingCIMDataObject
