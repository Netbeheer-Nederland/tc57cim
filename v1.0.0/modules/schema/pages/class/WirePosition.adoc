...
WirePosition -> WirePhaseInfo: WirePhaseInfo


WirePosition -> WireSpacingInfo: WireSpacingInfo


WirePosition -> DiagramObject: DiagramObjects


WirePosition -> InstanceSet: InstanceSet


WirePosition -> Name: Names


WirePosition -> ChangeSetMember: PropertiesCIMDataObject


WirePosition -> ChangeSetMember: TargetingCIMDataObject
