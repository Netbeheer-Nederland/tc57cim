...
MarketStatement -> MarketStatementLineItem: MarketStatementLineItem


MarketStatement -> Status: docStatus


MarketStatement -> ElectronicAddress: electronicAddress


MarketStatement -> Status: status


MarketStatement -> ActivityRecord: ActivityRecord


MarketStatement -> ConfigurationEvent: ConfigurationEvents


MarketStatement -> Author: Author


MarketStatement -> Editor: Editor


MarketStatement -> Approver: Approver


MarketStatement -> Issuer: Issuer


MarketStatement -> DiagramObject: DiagramObjects


MarketStatement -> InstanceSet: InstanceSet


MarketStatement -> Name: Names


MarketStatement -> ChangeSetMember: PropertiesCIMDataObject


MarketStatement -> ChangeSetMember: TargetingCIMDataObject
