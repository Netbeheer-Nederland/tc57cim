...
ACLineSegment -> WireSpacingInfo: WireSpacingInfo


ACLineSegment -> PerLengthImpedance: PerLengthImpedance


ACLineSegment -> Cut: Cut


ACLineSegment -> LineFault: LineFaults


ACLineSegment -> ACLineSegmentPhase: ACLineSegmentPhases


ACLineSegment -> GroundAction: LineGroundingAction


ACLineSegment -> JumperAction: LineJumpingAction



ACLineSegment -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


ACLineSegment -> SvStatus: SvStatus


ACLineSegment -> ProtectionEquipment: ProtectionEquipments
...
ACLineSegment -> JumperAction: JumpingAction


ACLineSegment -> GroundAction: GroundingAction


ACLineSegment -> Outage: Outage


ACLineSegment -> WeatherStation: WeatherStation


ACLineSegment -> OperationalLimitSet: OperationalLimitSet


ACLineSegment -> ContingencyEquipment: ContingencyEquipment
...
ACLineSegment -> LimitDependency: LimitDependencyModel


ACLineSegment -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ACLineSegment -> ProtectiveActionEquipment: ProtectiveActionEquipment


ACLineSegment -> PinEquipment: PinEquipment


ACLineSegment -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ACLineSegment -> EquipmentContainer: AdditionalEquipmentContainer


ACLineSegment -> UsagePoint: UsagePoints


ACLineSegment -> Outage: Outages


ACLineSegment -> OperationalRestriction: OperationalRestrictions
...
ACLineSegment -> ConfigurationEvent: ConfigurationEvent


ACLineSegment -> ReportingGroup: ReportingGroup


ACLineSegment -> OperatingShare: OperatingShare


ACLineSegment -> AssetInfo: AssetDatasheet


ACLineSegment -> VerificationAction: VerificationAction


ACLineSegment -> ClearanceDocument: Clearances


ACLineSegment -> GenericAction: GenericAction
...
ACLineSegment -> OperationalTag: OperationalTags


ACLineSegment -> DiagramObject: DiagramObjects


ACLineSegment -> InstanceSet: InstanceSet


ACLineSegment -> Name: Names


ACLineSegment -> ChangeSetMember: PropertiesCIMDataObject


ACLineSegment -> ChangeSetMember: TargetingCIMDataObject
