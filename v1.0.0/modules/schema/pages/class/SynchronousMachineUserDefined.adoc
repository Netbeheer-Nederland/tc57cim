...
SynchronousMachineUserDefined -> SynchronousMachine: SynchronousMachine


SynchronousMachineUserDefined -> TurbineGovernorDynamics: TurbineGovernorDynamics


SynchronousMachineUserDefined -> GenICompensationForGenJ: GenICompensationForGenJ


SynchronousMachineUserDefined -> ExcitationSystemDynamics: ExcitationSystemDynamics


SynchronousMachineUserDefined -> CrossCompoundTurbineGovernorDynamics: CrossCompoundTurbineGovernorDynamics


SynchronousMachineUserDefined -> CrossCompoundTurbineGovernorDynamics: CrossCompoundTurbineGovernorDyanmics


SynchronousMachineUserDefined -> MechanicalLoadDynamics: MechanicalLoadDynamics





SynchronousMachineUserDefined -> DiagramObject: DiagramObjects


SynchronousMachineUserDefined -> InstanceSet: InstanceSet


SynchronousMachineUserDefined -> Name: Names


SynchronousMachineUserDefined -> ChangeSetMember: PropertiesCIMDataObject


SynchronousMachineUserDefined -> ChangeSetMember: TargetingCIMDataObject
