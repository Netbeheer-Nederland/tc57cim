...
ControlArea -> EnergyGroup: EnergyGroup


ControlArea -> Control: Controls


ControlArea -> Measurement: Measurements


ControlArea -> PSRType: PSRType


ControlArea -> ConfigurationEvent: ConfigurationEvent


ControlArea -> ReportingGroup: ReportingGroup


ControlArea -> OperatingShare: OperatingShare


ControlArea -> AssetInfo: AssetDatasheet


ControlArea -> VerificationAction: VerificationAction


ControlArea -> ClearanceDocument: Clearances


ControlArea -> GenericAction: GenericAction


ControlArea -> PSREvent: PSREvents


ControlArea -> Asset: Assets


ControlArea -> Location: Location


ControlArea -> OperationalTag: OperationalTags


ControlArea -> DiagramObject: DiagramObjects


ControlArea -> InstanceSet: InstanceSet


ControlArea -> Name: Names


ControlArea -> ChangeSetMember: PropertiesCIMDataObject


ControlArea -> ChangeSetMember: TargetingCIMDataObject
