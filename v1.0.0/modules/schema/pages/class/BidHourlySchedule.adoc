...
BidHourlySchedule -> Bid: Bid



BidHourlySchedule -> RegularTimePoint: TimePoints


BidHourlySchedule -> DiagramObject: DiagramObjects


BidHourlySchedule -> InstanceSet: InstanceSet


BidHourlySchedule -> Name: Names


BidHourlySchedule -> ChangeSetMember: PropertiesCIMDataObject


BidHourlySchedule -> ChangeSetMember: TargetingCIMDataObject
