...
ReadingQualityType -> ReadingQuality: ReadingQualities


ReadingQualityType -> DiagramObject: DiagramObjects


ReadingQualityType -> InstanceSet: InstanceSet


ReadingQualityType -> Name: Names


ReadingQualityType -> ChangeSetMember: PropertiesCIMDataObject


ReadingQualityType -> ChangeSetMember: TargetingCIMDataObject
