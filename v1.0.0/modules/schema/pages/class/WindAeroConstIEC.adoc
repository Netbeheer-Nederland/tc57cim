...
WindAeroConstIEC -> DiagramObject: DiagramObjects


WindAeroConstIEC -> InstanceSet: InstanceSet


WindAeroConstIEC -> Name: Names


WindAeroConstIEC -> ChangeSetMember: PropertiesCIMDataObject


WindAeroConstIEC -> ChangeSetMember: TargetingCIMDataObject
