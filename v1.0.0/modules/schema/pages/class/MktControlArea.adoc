...
MktControlArea -> ControlAreaSolutionData: ControlAreaSolutionData




MktControlArea -> EnergyArea: EnergyArea


MktControlArea -> ControlAreaGeneratingUnit: ControlAreaGeneratingUnit


MktControlArea -> TieFlow: TieFlow


MktControlArea -> EnergyGroup: EnergyGroup


MktControlArea -> Control: Controls


MktControlArea -> Measurement: Measurements


MktControlArea -> PSRType: PSRType


MktControlArea -> ConfigurationEvent: ConfigurationEvent


MktControlArea -> ReportingGroup: ReportingGroup


MktControlArea -> OperatingShare: OperatingShare


MktControlArea -> AssetInfo: AssetDatasheet


MktControlArea -> VerificationAction: VerificationAction


MktControlArea -> ClearanceDocument: Clearances


MktControlArea -> GenericAction: GenericAction


MktControlArea -> PSREvent: PSREvents


MktControlArea -> Asset: Assets


MktControlArea -> Location: Location


MktControlArea -> OperationalTag: OperationalTags


MktControlArea -> DiagramObject: DiagramObjects


MktControlArea -> InstanceSet: InstanceSet


MktControlArea -> Name: Names


MktControlArea -> ChangeSetMember: PropertiesCIMDataObject


MktControlArea -> ChangeSetMember: TargetingCIMDataObject
