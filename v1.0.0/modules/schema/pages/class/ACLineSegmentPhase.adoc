...
ACLineSegmentPhase -> ACLineSegment: ACLineSegment


ACLineSegmentPhase -> WireInfo: WireInfo


ACLineSegmentPhase -> Control: Controls


ACLineSegmentPhase -> Measurement: Measurements


ACLineSegmentPhase -> PSRType: PSRType


ACLineSegmentPhase -> ConfigurationEvent: ConfigurationEvent


ACLineSegmentPhase -> ReportingGroup: ReportingGroup


ACLineSegmentPhase -> OperatingShare: OperatingShare


ACLineSegmentPhase -> AssetInfo: AssetDatasheet


ACLineSegmentPhase -> VerificationAction: VerificationAction


ACLineSegmentPhase -> ClearanceDocument: Clearances


ACLineSegmentPhase -> GenericAction: GenericAction


ACLineSegmentPhase -> PSREvent: PSREvents


ACLineSegmentPhase -> Asset: Assets


ACLineSegmentPhase -> Location: Location


ACLineSegmentPhase -> OperationalTag: OperationalTags


ACLineSegmentPhase -> DiagramObject: DiagramObjects


ACLineSegmentPhase -> InstanceSet: InstanceSet


ACLineSegmentPhase -> Name: Names


ACLineSegmentPhase -> ChangeSetMember: PropertiesCIMDataObject


ACLineSegmentPhase -> ChangeSetMember: TargetingCIMDataObject
