...
TCPAccessPoint -> PublicX509Certificate: PublicX509Certificate


TCPAccessPoint -> RemoteUnit: RemoteUnits


TCPAccessPoint -> BilateralExchangeActor: BilateralExchangeActor


TCPAccessPoint -> Control: Controls


TCPAccessPoint -> Measurement: Measurements


TCPAccessPoint -> PSRType: PSRType


TCPAccessPoint -> ConfigurationEvent: ConfigurationEvent


TCPAccessPoint -> ReportingGroup: ReportingGroup


TCPAccessPoint -> OperatingShare: OperatingShare


TCPAccessPoint -> AssetInfo: AssetDatasheet


TCPAccessPoint -> VerificationAction: VerificationAction


TCPAccessPoint -> ClearanceDocument: Clearances


TCPAccessPoint -> GenericAction: GenericAction


TCPAccessPoint -> PSREvent: PSREvents


TCPAccessPoint -> Asset: Assets


TCPAccessPoint -> Location: Location


TCPAccessPoint -> OperationalTag: OperationalTags


TCPAccessPoint -> DiagramObject: DiagramObjects


TCPAccessPoint -> InstanceSet: InstanceSet


TCPAccessPoint -> Name: Names


TCPAccessPoint -> ChangeSetMember: PropertiesCIMDataObject


TCPAccessPoint -> ChangeSetMember: TargetingCIMDataObject
