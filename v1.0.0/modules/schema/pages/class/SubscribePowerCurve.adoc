...
SubscribePowerCurve -> CurveData: CurveDatas


SubscribePowerCurve -> DiagramObject: DiagramObjects


SubscribePowerCurve -> InstanceSet: InstanceSet


SubscribePowerCurve -> Name: Names


SubscribePowerCurve -> ChangeSetMember: PropertiesCIMDataObject


SubscribePowerCurve -> ChangeSetMember: TargetingCIMDataObject
