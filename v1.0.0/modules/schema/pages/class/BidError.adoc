...
BidError -> ResourceBid: ResourceBid


BidError -> MarketProduct: MarketProduct


BidError -> DiagramObject: DiagramObjects


BidError -> InstanceSet: InstanceSet


BidError -> Name: Names


BidError -> ChangeSetMember: PropertiesCIMDataObject


BidError -> ChangeSetMember: TargetingCIMDataObject
