...
RegulatingCondEq -> EnergyComponent: EnergyComponent


RegulatingCondEq -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


RegulatingCondEq -> SvStatus: SvStatus


RegulatingCondEq -> ProtectionEquipment: ProtectionEquipments


RegulatingCondEq -> BaseVoltage: BaseVoltage


RegulatingCondEq -> Terminal: Terminals


RegulatingCondEq -> JumperAction: JumpingAction


RegulatingCondEq -> GroundAction: GroundingAction


RegulatingCondEq -> Outage: Outage


RegulatingCondEq -> WeatherStation: WeatherStation


RegulatingCondEq -> OperationalLimitSet: OperationalLimitSet


RegulatingCondEq -> ContingencyEquipment: ContingencyEquipment


RegulatingCondEq -> EquipmentContainer: EquipmentContainer


RegulatingCondEq -> Fault: Faults


RegulatingCondEq -> LimitDependency: LimitDependencyModel


RegulatingCondEq -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


RegulatingCondEq -> ProtectiveActionEquipment: ProtectiveActionEquipment


RegulatingCondEq -> PinEquipment: PinEquipment


RegulatingCondEq -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


RegulatingCondEq -> EquipmentContainer: AdditionalEquipmentContainer


RegulatingCondEq -> UsagePoint: UsagePoints


RegulatingCondEq -> Outage: Outages


RegulatingCondEq -> OperationalRestriction: OperationalRestrictions


RegulatingCondEq -> Control: Controls


RegulatingCondEq -> Measurement: Measurements


RegulatingCondEq -> PSRType: PSRType


RegulatingCondEq -> ConfigurationEvent: ConfigurationEvent


RegulatingCondEq -> ReportingGroup: ReportingGroup


RegulatingCondEq -> OperatingShare: OperatingShare


RegulatingCondEq -> AssetInfo: AssetDatasheet


RegulatingCondEq -> VerificationAction: VerificationAction


RegulatingCondEq -> ClearanceDocument: Clearances


RegulatingCondEq -> GenericAction: GenericAction


RegulatingCondEq -> PSREvent: PSREvents


RegulatingCondEq -> Asset: Assets


RegulatingCondEq -> Location: Location


RegulatingCondEq -> OperationalTag: OperationalTags


RegulatingCondEq -> DiagramObject: DiagramObjects


RegulatingCondEq -> InstanceSet: InstanceSet


RegulatingCondEq -> Name: Names


RegulatingCondEq -> ChangeSetMember: PropertiesCIMDataObject


RegulatingCondEq -> ChangeSetMember: TargetingCIMDataObject
