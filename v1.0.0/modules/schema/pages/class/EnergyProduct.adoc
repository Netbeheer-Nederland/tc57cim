...
EnergyProduct -> Marketer: TitleHeldBy_Marketer


EnergyProduct -> GenerationProvider: GenerationProvider


EnergyProduct -> Marketer: ResoldBy_Marketer


EnergyProduct -> EnergyTransaction: EnergyTransactions


EnergyProduct -> DateTimeInterval: validityInterval


EnergyProduct -> Status: docStatus


EnergyProduct -> ElectronicAddress: electronicAddress


EnergyProduct -> Status: status


EnergyProduct -> ActivityRecord: ActivityRecord


EnergyProduct -> ConfigurationEvent: ConfigurationEvents


EnergyProduct -> Author: Author


EnergyProduct -> Editor: Editor


EnergyProduct -> Approver: Approver


EnergyProduct -> Issuer: Issuer


EnergyProduct -> DiagramObject: DiagramObjects


EnergyProduct -> InstanceSet: InstanceSet


EnergyProduct -> Name: Names


EnergyProduct -> ChangeSetMember: PropertiesCIMDataObject


EnergyProduct -> ChangeSetMember: TargetingCIMDataObject
