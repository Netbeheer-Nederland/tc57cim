...
ReactiveCapabilityCurve -> SynchronousMachine: SynchronousMachines


ReactiveCapabilityCurve -> CurveData: CurveDatas


ReactiveCapabilityCurve -> DiagramObject: DiagramObjects


ReactiveCapabilityCurve -> InstanceSet: InstanceSet


ReactiveCapabilityCurve -> Name: Names


ReactiveCapabilityCurve -> ChangeSetMember: PropertiesCIMDataObject


ReactiveCapabilityCurve -> ChangeSetMember: TargetingCIMDataObject
