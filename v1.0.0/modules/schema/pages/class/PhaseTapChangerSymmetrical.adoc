...
PhaseTapChangerSymmetrical -> TransformerEnd: TransformerEnd





PhaseTapChangerSymmetrical -> TapChangerControl: TapChangerControl


PhaseTapChangerSymmetrical -> SvTapStep: SvTapStep


PhaseTapChangerSymmetrical -> TapSchedule: TapSchedules


PhaseTapChangerSymmetrical -> Control: Controls


PhaseTapChangerSymmetrical -> Measurement: Measurements


PhaseTapChangerSymmetrical -> PSRType: PSRType


PhaseTapChangerSymmetrical -> ConfigurationEvent: ConfigurationEvent


PhaseTapChangerSymmetrical -> ReportingGroup: ReportingGroup


PhaseTapChangerSymmetrical -> OperatingShare: OperatingShare


PhaseTapChangerSymmetrical -> AssetInfo: AssetDatasheet


PhaseTapChangerSymmetrical -> VerificationAction: VerificationAction


PhaseTapChangerSymmetrical -> ClearanceDocument: Clearances


PhaseTapChangerSymmetrical -> GenericAction: GenericAction


PhaseTapChangerSymmetrical -> PSREvent: PSREvents


PhaseTapChangerSymmetrical -> Asset: Assets


PhaseTapChangerSymmetrical -> Location: Location


PhaseTapChangerSymmetrical -> OperationalTag: OperationalTags


PhaseTapChangerSymmetrical -> DiagramObject: DiagramObjects


PhaseTapChangerSymmetrical -> InstanceSet: InstanceSet


PhaseTapChangerSymmetrical -> Name: Names


PhaseTapChangerSymmetrical -> ChangeSetMember: PropertiesCIMDataObject


PhaseTapChangerSymmetrical -> ChangeSetMember: TargetingCIMDataObject
