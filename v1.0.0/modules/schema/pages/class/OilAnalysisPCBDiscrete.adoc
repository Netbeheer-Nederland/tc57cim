...
OilAnalysisPCBDiscrete -> TestStandard: TestStandard


OilAnalysisPCBDiscrete -> DiscreteValue: DiscreteValues


OilAnalysisPCBDiscrete -> ValueAliasSet: ValueAliasSet


OilAnalysisPCBDiscrete -> ACDCTerminal: Terminal


OilAnalysisPCBDiscrete -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


OilAnalysisPCBDiscrete -> CalculationMethodHierarchy: CalculationMethodHierarchy


OilAnalysisPCBDiscrete -> PowerSystemResource: PowerSystemResource


OilAnalysisPCBDiscrete -> PinMeasurement: PinMeasurement


OilAnalysisPCBDiscrete -> MeasurementCalculatorInput: MeasurementCalculatorInput


OilAnalysisPCBDiscrete -> Asset: Asset


OilAnalysisPCBDiscrete -> MeasurementAction: MeasurementAction


OilAnalysisPCBDiscrete -> Location: Locations


OilAnalysisPCBDiscrete -> Procedure: Procedures


OilAnalysisPCBDiscrete -> DiagramObject: DiagramObjects


OilAnalysisPCBDiscrete -> InstanceSet: InstanceSet


OilAnalysisPCBDiscrete -> Name: Names


OilAnalysisPCBDiscrete -> ChangeSetMember: PropertiesCIMDataObject


OilAnalysisPCBDiscrete -> ChangeSetMember: TargetingCIMDataObject
