...
DCBreaker -> DCTerminal: DCTerminals


DCBreaker -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


DCBreaker -> WeatherStation: WeatherStation


DCBreaker -> OperationalLimitSet: OperationalLimitSet


DCBreaker -> ContingencyEquipment: ContingencyEquipment


DCBreaker -> EquipmentContainer: EquipmentContainer


DCBreaker -> Fault: Faults


DCBreaker -> LimitDependency: LimitDependencyModel


DCBreaker -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


DCBreaker -> ProtectiveActionEquipment: ProtectiveActionEquipment


DCBreaker -> PinEquipment: PinEquipment


DCBreaker -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


DCBreaker -> EquipmentContainer: AdditionalEquipmentContainer


DCBreaker -> UsagePoint: UsagePoints


DCBreaker -> Outage: Outages


DCBreaker -> OperationalRestriction: OperationalRestrictions


DCBreaker -> Control: Controls


DCBreaker -> Measurement: Measurements


DCBreaker -> PSRType: PSRType


DCBreaker -> ConfigurationEvent: ConfigurationEvent


DCBreaker -> ReportingGroup: ReportingGroup


DCBreaker -> OperatingShare: OperatingShare


DCBreaker -> AssetInfo: AssetDatasheet


DCBreaker -> VerificationAction: VerificationAction


DCBreaker -> ClearanceDocument: Clearances


DCBreaker -> GenericAction: GenericAction


DCBreaker -> PSREvent: PSREvents


DCBreaker -> Asset: Assets


DCBreaker -> Location: Location


DCBreaker -> OperationalTag: OperationalTags


DCBreaker -> DiagramObject: DiagramObjects


DCBreaker -> InstanceSet: InstanceSet


DCBreaker -> Name: Names


DCBreaker -> ChangeSetMember: PropertiesCIMDataObject


DCBreaker -> ChangeSetMember: TargetingCIMDataObject
