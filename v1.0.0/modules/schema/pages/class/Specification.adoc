...
Specification -> AssetPropertyCurve: AssetPropertyCurves


Specification -> Medium: Mediums


Specification -> DimensionsInfo: DimensionsInfos


Specification -> QualificationRequirement: QualificationRequirements


Specification -> UserAttribute: AssetProperites


Specification -> UserAttribute: Ratings


Specification -> ReliabilityInfo: ReliabilityInfos


Specification -> Status: docStatus


Specification -> ElectronicAddress: electronicAddress


Specification -> Status: status


Specification -> ActivityRecord: ActivityRecord


Specification -> ConfigurationEvent: ConfigurationEvents


Specification -> Author: Author


Specification -> Editor: Editor


Specification -> Approver: Approver


Specification -> Issuer: Issuer


Specification -> DiagramObject: DiagramObjects


Specification -> InstanceSet: InstanceSet


Specification -> Name: Names


Specification -> ChangeSetMember: PropertiesCIMDataObject


Specification -> ChangeSetMember: TargetingCIMDataObject
