...
DCNode -> DiagramObject: DiagramObjects


DCNode -> InstanceSet: InstanceSet


DCNode -> Name: Names


DCNode -> ChangeSetMember: PropertiesCIMDataObject


DCNode -> ChangeSetMember: TargetingCIMDataObject
