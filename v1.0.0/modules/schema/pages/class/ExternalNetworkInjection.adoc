...
ExternalNetworkInjection -> EnergyComponent: EnergyComponent


ExternalNetworkInjection -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


ExternalNetworkInjection -> SvStatus: SvStatus


ExternalNetworkInjection -> ProtectionEquipment: ProtectionEquipments


ExternalNetworkInjection -> BaseVoltage: BaseVoltage


ExternalNetworkInjection -> Terminal: Terminals


ExternalNetworkInjection -> JumperAction: JumpingAction


ExternalNetworkInjection -> GroundAction: GroundingAction


ExternalNetworkInjection -> Outage: Outage


ExternalNetworkInjection -> WeatherStation: WeatherStation


ExternalNetworkInjection -> OperationalLimitSet: OperationalLimitSet


ExternalNetworkInjection -> ContingencyEquipment: ContingencyEquipment


ExternalNetworkInjection -> EquipmentContainer: EquipmentContainer


ExternalNetworkInjection -> Fault: Faults


ExternalNetworkInjection -> LimitDependency: LimitDependencyModel


ExternalNetworkInjection -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ExternalNetworkInjection -> ProtectiveActionEquipment: ProtectiveActionEquipment


ExternalNetworkInjection -> PinEquipment: PinEquipment


ExternalNetworkInjection -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ExternalNetworkInjection -> EquipmentContainer: AdditionalEquipmentContainer


ExternalNetworkInjection -> UsagePoint: UsagePoints


ExternalNetworkInjection -> Outage: Outages


ExternalNetworkInjection -> OperationalRestriction: OperationalRestrictions


ExternalNetworkInjection -> Control: Controls


ExternalNetworkInjection -> Measurement: Measurements


ExternalNetworkInjection -> PSRType: PSRType


ExternalNetworkInjection -> ConfigurationEvent: ConfigurationEvent


ExternalNetworkInjection -> ReportingGroup: ReportingGroup


ExternalNetworkInjection -> OperatingShare: OperatingShare


ExternalNetworkInjection -> AssetInfo: AssetDatasheet


ExternalNetworkInjection -> VerificationAction: VerificationAction


ExternalNetworkInjection -> ClearanceDocument: Clearances


ExternalNetworkInjection -> GenericAction: GenericAction


ExternalNetworkInjection -> PSREvent: PSREvents


ExternalNetworkInjection -> Asset: Assets


ExternalNetworkInjection -> Location: Location


ExternalNetworkInjection -> OperationalTag: OperationalTags


ExternalNetworkInjection -> DiagramObject: DiagramObjects


ExternalNetworkInjection -> InstanceSet: InstanceSet


ExternalNetworkInjection -> Name: Names


ExternalNetworkInjection -> ChangeSetMember: PropertiesCIMDataObject


ExternalNetworkInjection -> ChangeSetMember: TargetingCIMDataObject
