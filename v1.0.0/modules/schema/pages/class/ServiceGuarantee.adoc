...
ServiceGuarantee -> DateTimeInterval: applicationPeriod



ServiceGuarantee -> Status: docStatus


ServiceGuarantee -> ElectronicAddress: electronicAddress


ServiceGuarantee -> Status: status


ServiceGuarantee -> ActivityRecord: ActivityRecord


ServiceGuarantee -> ConfigurationEvent: ConfigurationEvents


ServiceGuarantee -> Author: Author


ServiceGuarantee -> Editor: Editor


ServiceGuarantee -> Approver: Approver


ServiceGuarantee -> Issuer: Issuer


ServiceGuarantee -> DiagramObject: DiagramObjects


ServiceGuarantee -> InstanceSet: InstanceSet


ServiceGuarantee -> Name: Names


ServiceGuarantee -> ChangeSetMember: PropertiesCIMDataObject


ServiceGuarantee -> ChangeSetMember: TargetingCIMDataObject
