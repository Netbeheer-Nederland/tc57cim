...
RotatingMachine -> RegulatingControl: RegulatingControl


RotatingMachine -> EnergyComponent: EnergyComponent


RotatingMachine -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


RotatingMachine -> SvStatus: SvStatus


RotatingMachine -> ProtectionEquipment: ProtectionEquipments


RotatingMachine -> BaseVoltage: BaseVoltage


RotatingMachine -> Terminal: Terminals


RotatingMachine -> JumperAction: JumpingAction


RotatingMachine -> GroundAction: GroundingAction


RotatingMachine -> Outage: Outage


RotatingMachine -> WeatherStation: WeatherStation


RotatingMachine -> OperationalLimitSet: OperationalLimitSet


RotatingMachine -> ContingencyEquipment: ContingencyEquipment


RotatingMachine -> EquipmentContainer: EquipmentContainer


RotatingMachine -> Fault: Faults


RotatingMachine -> LimitDependency: LimitDependencyModel


RotatingMachine -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


RotatingMachine -> ProtectiveActionEquipment: ProtectiveActionEquipment


RotatingMachine -> PinEquipment: PinEquipment


RotatingMachine -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


RotatingMachine -> EquipmentContainer: AdditionalEquipmentContainer


RotatingMachine -> UsagePoint: UsagePoints


RotatingMachine -> Outage: Outages


RotatingMachine -> OperationalRestriction: OperationalRestrictions


RotatingMachine -> Control: Controls


RotatingMachine -> Measurement: Measurements


RotatingMachine -> PSRType: PSRType


RotatingMachine -> ConfigurationEvent: ConfigurationEvent


RotatingMachine -> ReportingGroup: ReportingGroup


RotatingMachine -> OperatingShare: OperatingShare


RotatingMachine -> AssetInfo: AssetDatasheet


RotatingMachine -> VerificationAction: VerificationAction


RotatingMachine -> ClearanceDocument: Clearances


RotatingMachine -> GenericAction: GenericAction


RotatingMachine -> PSREvent: PSREvents


RotatingMachine -> Asset: Assets


RotatingMachine -> Location: Location


RotatingMachine -> OperationalTag: OperationalTags


RotatingMachine -> DiagramObject: DiagramObjects


RotatingMachine -> InstanceSet: InstanceSet


RotatingMachine -> Name: Names


RotatingMachine -> ChangeSetMember: PropertiesCIMDataObject


RotatingMachine -> ChangeSetMember: TargetingCIMDataObject
