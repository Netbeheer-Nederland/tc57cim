...
SVCUserDefined -> StaticVarCompensator: StaticVarCompensator


SVCUserDefined -> DiagramObject: DiagramObjects


SVCUserDefined -> InstanceSet: InstanceSet


SVCUserDefined -> Name: Names


SVCUserDefined -> ChangeSetMember: PropertiesCIMDataObject


SVCUserDefined -> ChangeSetMember: TargetingCIMDataObject
