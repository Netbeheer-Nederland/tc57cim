...
TiePoint -> MktMeasurement: ByMktMeasurement


TiePoint -> MktMeasurement: ForMktMeasurement


TiePoint -> DiagramObject: DiagramObjects


TiePoint -> InstanceSet: InstanceSet


TiePoint -> Name: Names


TiePoint -> ChangeSetMember: PropertiesCIMDataObject


TiePoint -> ChangeSetMember: TargetingCIMDataObject
