...
CombustionTurbine -> AirCompressor: AirCompressor


CombustionTurbine -> HeatRecoveryBoiler: HeatRecoveryBoiler


CombustionTurbine -> CTTempActivePowerCurve: CTTempActivePowerCurve


CombustionTurbine -> SynchronousMachine: SynchronousMachines
...
CombustionTurbine -> ConfigurationEvent: ConfigurationEvent


CombustionTurbine -> ReportingGroup: ReportingGroup


CombustionTurbine -> OperatingShare: OperatingShare


CombustionTurbine -> AssetInfo: AssetDatasheet


CombustionTurbine -> VerificationAction: VerificationAction


CombustionTurbine -> ClearanceDocument: Clearances


CombustionTurbine -> GenericAction: GenericAction
...
CombustionTurbine -> OperationalTag: OperationalTags


CombustionTurbine -> DiagramObject: DiagramObjects


CombustionTurbine -> InstanceSet: InstanceSet


CombustionTurbine -> Name: Names


CombustionTurbine -> ChangeSetMember: PropertiesCIMDataObject


CombustionTurbine -> ChangeSetMember: TargetingCIMDataObject
