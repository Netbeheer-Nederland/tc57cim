...
HydroGeneratingEfficiencyCurve -> HydroGeneratingUnit: HydroGeneratingUnit


HydroGeneratingEfficiencyCurve -> CurveData: CurveDatas


HydroGeneratingEfficiencyCurve -> DiagramObject: DiagramObjects


HydroGeneratingEfficiencyCurve -> InstanceSet: InstanceSet


HydroGeneratingEfficiencyCurve -> Name: Names


HydroGeneratingEfficiencyCurve -> ChangeSetMember: PropertiesCIMDataObject


HydroGeneratingEfficiencyCurve -> ChangeSetMember: TargetingCIMDataObject
