...
TroubleOrder -> DateTimeInterval: plannedExecutionInterval


TroubleOrder -> Location: Location


TroubleOrder -> Incident: Incident


TroubleOrder -> TroubleTicket: TroubleTicket


TroubleOrder -> WorkTask: WorkTask


TroubleOrder -> UnplannedOutage: UnplannedOutage


TroubleOrder -> Status: docStatus


TroubleOrder -> ElectronicAddress: electronicAddress


TroubleOrder -> Status: status


TroubleOrder -> ActivityRecord: ActivityRecord


TroubleOrder -> ConfigurationEvent: ConfigurationEvents


TroubleOrder -> Author: Author


TroubleOrder -> Editor: Editor


TroubleOrder -> Approver: Approver


TroubleOrder -> Issuer: Issuer


TroubleOrder -> DiagramObject: DiagramObjects


TroubleOrder -> InstanceSet: InstanceSet


TroubleOrder -> Name: Names


TroubleOrder -> ChangeSetMember: PropertiesCIMDataObject


TroubleOrder -> ChangeSetMember: TargetingCIMDataObject
