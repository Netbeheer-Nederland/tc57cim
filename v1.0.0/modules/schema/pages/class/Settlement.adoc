...
Settlement -> EnergyMarket: EnergyMarket


Settlement -> MajorChargeGroup: MajorChargeGroup


Settlement -> MarketInvoiceLineItem: MarketInvoiceLineItem


Settlement -> MarketLedgerEntry: MarketLedgerEntry


Settlement -> Status: docStatus


Settlement -> ElectronicAddress: electronicAddress


Settlement -> Status: status


Settlement -> ActivityRecord: ActivityRecord


Settlement -> ConfigurationEvent: ConfigurationEvents


Settlement -> Author: Author


Settlement -> Editor: Editor


Settlement -> Approver: Approver


Settlement -> Issuer: Issuer


Settlement -> DiagramObject: DiagramObjects


Settlement -> InstanceSet: InstanceSet


Settlement -> Name: Names


Settlement -> ChangeSetMember: PropertiesCIMDataObject


Settlement -> ChangeSetMember: TargetingCIMDataObject
