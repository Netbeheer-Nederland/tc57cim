...
ErpInventoryCount -> Status: status


ErpInventoryCount -> DiagramObject: DiagramObjects


ErpInventoryCount -> InstanceSet: InstanceSet


ErpInventoryCount -> Name: Names


ErpInventoryCount -> ChangeSetMember: PropertiesCIMDataObject


ErpInventoryCount -> ChangeSetMember: TargetingCIMDataObject
