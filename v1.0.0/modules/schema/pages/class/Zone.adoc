...
Zone -> ElectronicAddress: electronicAddress


Zone -> StreetAddress: mainAddress


Zone -> TelephoneNumber: phone1


Zone -> TelephoneNumber: phone2


Zone -> StreetAddress: secondaryAddress


Zone -> Status: status


Zone -> ConfigurationEvent: ConfigurationEvents


Zone -> SwitchingOrder: SwitchingOrder


Zone -> Crew: Crew


Zone -> PowerSystemResource: PowerSystemResources


Zone -> CoordinateSystem: CoordinateSystem


Zone -> PositionPoint: PositionPoints


Zone -> Measurement: Measurements


Zone -> Asset: Assets


Zone -> TroubleOrder: TroubleOrder


Zone -> OutageOrder: OutageOrder


Zone -> Fault: Fault


Zone -> Incident: Incident


Zone -> OldCrew: Crews


Zone -> AssetLocationHazard: Hazards


Zone -> LandProperty: LandProperties


Zone -> Route: Routes


Zone -> TroubleTicket: TroubleTicket


Zone -> EnvironmentalLocationType: EnvironmentalLocationKind


Zone -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


Zone -> DiagramObject: DiagramObjects


Zone -> InstanceSet: InstanceSet


Zone -> Name: Names


Zone -> ChangeSetMember: PropertiesCIMDataObject


Zone -> ChangeSetMember: TargetingCIMDataObject
