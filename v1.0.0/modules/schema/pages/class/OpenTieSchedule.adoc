...
OpenTieSchedule -> Bid: Bid



OpenTieSchedule -> RegularTimePoint: TimePoints


OpenTieSchedule -> DiagramObject: DiagramObjects


OpenTieSchedule -> InstanceSet: InstanceSet


OpenTieSchedule -> Name: Names


OpenTieSchedule -> ChangeSetMember: PropertiesCIMDataObject


OpenTieSchedule -> ChangeSetMember: TargetingCIMDataObject
