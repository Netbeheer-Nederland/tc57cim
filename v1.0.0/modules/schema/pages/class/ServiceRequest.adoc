...
ServiceRequest -> WorkTimeSchedule: WorkTimeSchedule
...
ServiceRequest -> Status: docStatus


ServiceRequest -> ElectronicAddress: electronicAddress


ServiceRequest -> Status: status


ServiceRequest -> ActivityRecord: ActivityRecord


ServiceRequest -> ConfigurationEvent: ConfigurationEvents


ServiceRequest -> Author: Author


ServiceRequest -> Editor: Editor


ServiceRequest -> Approver: Approver


ServiceRequest -> Issuer: Issuer


ServiceRequest -> DiagramObject: DiagramObjects


ServiceRequest -> InstanceSet: InstanceSet


ServiceRequest -> Name: Names


ServiceRequest -> ChangeSetMember: PropertiesCIMDataObject


ServiceRequest -> ChangeSetMember: TargetingCIMDataObject
