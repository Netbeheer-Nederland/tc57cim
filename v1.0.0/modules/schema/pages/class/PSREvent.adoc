...
PSREvent -> PowerSystemResource: PowerSystemResource


PSREvent -> Status: status


PSREvent -> Document: Document


PSREvent -> Author: Author


PSREvent -> Asset: Assets


PSREvent -> DiagramObject: DiagramObjects


PSREvent -> InstanceSet: InstanceSet


PSREvent -> Name: Names


PSREvent -> ChangeSetMember: PropertiesCIMDataObject


PSREvent -> ChangeSetMember: TargetingCIMDataObject
