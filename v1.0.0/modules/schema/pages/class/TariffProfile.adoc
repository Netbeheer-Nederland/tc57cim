...
TariffProfile -> TimeTariffInterval: TimeTariffIntervals


TariffProfile -> ConsumptionTariffInterval: ConsumptionTariffIntervals


TariffProfile -> Tariff: Tariffs


TariffProfile -> Status: docStatus


TariffProfile -> ElectronicAddress: electronicAddress


TariffProfile -> Status: status


TariffProfile -> ActivityRecord: ActivityRecord


TariffProfile -> ConfigurationEvent: ConfigurationEvents


TariffProfile -> Author: Author


TariffProfile -> Editor: Editor


TariffProfile -> Approver: Approver


TariffProfile -> Issuer: Issuer


TariffProfile -> DiagramObject: DiagramObjects


TariffProfile -> InstanceSet: InstanceSet


TariffProfile -> Name: Names


TariffProfile -> ChangeSetMember: PropertiesCIMDataObject


TariffProfile -> ChangeSetMember: TargetingCIMDataObject
