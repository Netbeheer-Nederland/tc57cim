...
MarketPerson -> ElectronicAddress: electronicAddressAlternate


MarketPerson -> ElectronicAddress: electronicAddressPrimary


MarketPerson -> TelephoneNumber: landlinePhone


MarketPerson -> TelephoneNumber: mobilePhone


MarketPerson -> Status: status


MarketPerson -> MarketSkill: MarketSkills


MarketPerson -> MarketParticipant: MarketParticipant


MarketPerson -> DiagramObject: DiagramObjects


MarketPerson -> InstanceSet: InstanceSet


MarketPerson -> Name: Names


MarketPerson -> ChangeSetMember: PropertiesCIMDataObject


MarketPerson -> ChangeSetMember: TargetingCIMDataObject
