...
ExPostResource -> ExPostResourceResults: ExPostResourceResults


ExPostResource -> MktActivityRecord: MktActivityRecord


ExPostResource -> Market: Market


ExPostResource -> Status: docStatus


ExPostResource -> ElectronicAddress: electronicAddress


ExPostResource -> Status: status


ExPostResource -> ActivityRecord: ActivityRecord


ExPostResource -> ConfigurationEvent: ConfigurationEvents


ExPostResource -> Author: Author


ExPostResource -> Editor: Editor


ExPostResource -> Approver: Approver


ExPostResource -> Issuer: Issuer


ExPostResource -> DiagramObject: DiagramObjects


ExPostResource -> InstanceSet: InstanceSet


ExPostResource -> Name: Names


ExPostResource -> ChangeSetMember: PropertiesCIMDataObject


ExPostResource -> ChangeSetMember: TargetingCIMDataObject
