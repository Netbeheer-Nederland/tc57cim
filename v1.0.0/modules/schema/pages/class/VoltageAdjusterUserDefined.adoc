...
VoltageAdjusterUserDefined -> PFVArControllerType1Dynamics: PFVArControllerType1Dynamics


VoltageAdjusterUserDefined -> DiagramObject: DiagramObjects


VoltageAdjusterUserDefined -> InstanceSet: InstanceSet


VoltageAdjusterUserDefined -> Name: Names


VoltageAdjusterUserDefined -> ChangeSetMember: PropertiesCIMDataObject


VoltageAdjusterUserDefined -> ChangeSetMember: TargetingCIMDataObject
