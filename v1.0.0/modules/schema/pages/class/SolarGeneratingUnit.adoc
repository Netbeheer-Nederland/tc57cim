...
SolarGeneratingUnit -> RotatingMachine: RotatingMachine


SolarGeneratingUnit -> GenUnitOpSchedule: GenUnitOpSchedule


SolarGeneratingUnit -> ControlAreaGeneratingUnit: ControlAreaGeneratingUnit


SolarGeneratingUnit -> GrossToNetActivePowerCurve: GrossToNetActivePowerCurves


SolarGeneratingUnit -> GenUnitOpCostCurve: GenUnitOpCostCurves


SolarGeneratingUnit -> WeatherStation: WeatherStation


SolarGeneratingUnit -> OperationalLimitSet: OperationalLimitSet


SolarGeneratingUnit -> ContingencyEquipment: ContingencyEquipment


SolarGeneratingUnit -> EquipmentContainer: EquipmentContainer


SolarGeneratingUnit -> Fault: Faults


SolarGeneratingUnit -> LimitDependency: LimitDependencyModel


SolarGeneratingUnit -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


SolarGeneratingUnit -> ProtectiveActionEquipment: ProtectiveActionEquipment


SolarGeneratingUnit -> PinEquipment: PinEquipment


SolarGeneratingUnit -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


SolarGeneratingUnit -> EquipmentContainer: AdditionalEquipmentContainer


SolarGeneratingUnit -> UsagePoint: UsagePoints


SolarGeneratingUnit -> Outage: Outages


SolarGeneratingUnit -> OperationalRestriction: OperationalRestrictions
...
SolarGeneratingUnit -> ConfigurationEvent: ConfigurationEvent


SolarGeneratingUnit -> ReportingGroup: ReportingGroup


SolarGeneratingUnit -> OperatingShare: OperatingShare


SolarGeneratingUnit -> AssetInfo: AssetDatasheet


SolarGeneratingUnit -> VerificationAction: VerificationAction


SolarGeneratingUnit -> ClearanceDocument: Clearances


SolarGeneratingUnit -> GenericAction: GenericAction
...
SolarGeneratingUnit -> OperationalTag: OperationalTags


SolarGeneratingUnit -> DiagramObject: DiagramObjects


SolarGeneratingUnit -> InstanceSet: InstanceSet


SolarGeneratingUnit -> Name: Names


SolarGeneratingUnit -> ChangeSetMember: PropertiesCIMDataObject


SolarGeneratingUnit -> ChangeSetMember: TargetingCIMDataObject
