...
PlannedOutageNotification -> UsagePoint: UsagePoint


PlannedOutageNotification -> Customer: Customer


PlannedOutageNotification -> SwitchingPlan: SwitchingPlan


PlannedOutageNotification -> Status: docStatus


PlannedOutageNotification -> ElectronicAddress: electronicAddress


PlannedOutageNotification -> Status: status


PlannedOutageNotification -> ActivityRecord: ActivityRecord


PlannedOutageNotification -> ConfigurationEvent: ConfigurationEvents


PlannedOutageNotification -> Author: Author


PlannedOutageNotification -> Editor: Editor


PlannedOutageNotification -> Approver: Approver


PlannedOutageNotification -> Issuer: Issuer


PlannedOutageNotification -> DiagramObject: DiagramObjects


PlannedOutageNotification -> InstanceSet: InstanceSet


PlannedOutageNotification -> Name: Names


PlannedOutageNotification -> ChangeSetMember: PropertiesCIMDataObject


PlannedOutageNotification -> ChangeSetMember: TargetingCIMDataObject
