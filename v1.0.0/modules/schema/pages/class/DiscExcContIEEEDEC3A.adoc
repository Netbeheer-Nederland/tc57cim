...
DiscExcContIEEEDEC3A -> ExcitationSystemDynamics: ExcitationSystemDynamics


DiscExcContIEEEDEC3A -> RemoteInputSignal: RemoteInputSignal


DiscExcContIEEEDEC3A -> DiagramObject: DiagramObjects


DiscExcContIEEEDEC3A -> InstanceSet: InstanceSet


DiscExcContIEEEDEC3A -> Name: Names


DiscExcContIEEEDEC3A -> ChangeSetMember: PropertiesCIMDataObject


DiscExcContIEEEDEC3A -> ChangeSetMember: TargetingCIMDataObject
