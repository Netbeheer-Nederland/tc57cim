...
UsagePoint -> DecimalQuantity: physicalConnectionCapacity
...
UsagePoint -> EndDevice: EndDevices


UsagePoint -> ServiceMultiplier: ServiceMultipliers


UsagePoint -> ConfigurationEvent: ConfigurationEvents


UsagePoint -> ServiceCategory: ServiceCategory


UsagePoint -> MeterReadSchedule: MeterReadSchedule


UsagePoint -> CustomerAgreement: CustomerAgreement


UsagePoint -> Outage: Outage


UsagePoint -> PlannedOutageNotification: PlannedOutageNotification


UsagePoint -> MetrologyRequirement: MetrologyRequirements


UsagePoint -> MeterWorkTask: MeterServiceWorkTasks


UsagePoint -> UsagePointGroup: UsagePointGroups


UsagePoint -> ServiceSupplier: ServiceSupplier


UsagePoint -> EndDeviceControl: EndDeviceControls


UsagePoint -> EndDeviceEvent: EndDeviceEvents


UsagePoint -> ServiceLocation: ServiceLocation


UsagePoint -> UsagePointLocation: UsagePointLocation


UsagePoint -> PricingStructure: PricingStructures


UsagePoint -> MeterReading: MeterReadings


UsagePoint -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


UsagePoint -> DiagramObject: DiagramObjects


UsagePoint -> InstanceSet: InstanceSet


UsagePoint -> Name: Names


UsagePoint -> ChangeSetMember: PropertiesCIMDataObject


UsagePoint -> ChangeSetMember: TargetingCIMDataObject
