...
ExcAVR1 -> SynchronousMachineDynamics: SynchronousMachineDynamics


ExcAVR1 -> PowerSystemStabilizerDynamics: PowerSystemStabilizerDynamics


ExcAVR1 -> PFVArControllerType1Dynamics: PFVArControllerType1Dynamics


ExcAVR1 -> OverexcitationLimiterDynamics: OverexcitationLimiterDynamics


ExcAVR1 -> DiscontinuousExcitationControlDynamics: DiscontinuousExcitationControlDynamics


ExcAVR1 -> PFVArControllerType2Dynamics: PFVArControllerType2Dynamics


ExcAVR1 -> UnderexcitationLimiterDynamics: UnderexcitationLimiterDynamics


ExcAVR1 -> VoltageCompensatorDynamics: VoltageCompensatorDynamics


ExcAVR1 -> DiagramObject: DiagramObjects


ExcAVR1 -> InstanceSet: InstanceSet


ExcAVR1 -> Name: Names


ExcAVR1 -> ChangeSetMember: PropertiesCIMDataObject


ExcAVR1 -> ChangeSetMember: TargetingCIMDataObject
