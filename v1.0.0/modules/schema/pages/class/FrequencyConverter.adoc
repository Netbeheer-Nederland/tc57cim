...
FrequencyConverter -> RegulatingControl: RegulatingControl


FrequencyConverter -> EnergyComponent: EnergyComponent


FrequencyConverter -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


FrequencyConverter -> SvStatus: SvStatus


FrequencyConverter -> ProtectionEquipment: ProtectionEquipments


FrequencyConverter -> BaseVoltage: BaseVoltage


FrequencyConverter -> Terminal: Terminals


FrequencyConverter -> JumperAction: JumpingAction


FrequencyConverter -> GroundAction: GroundingAction


FrequencyConverter -> Outage: Outage


FrequencyConverter -> WeatherStation: WeatherStation


FrequencyConverter -> OperationalLimitSet: OperationalLimitSet


FrequencyConverter -> ContingencyEquipment: ContingencyEquipment


FrequencyConverter -> EquipmentContainer: EquipmentContainer


FrequencyConverter -> Fault: Faults


FrequencyConverter -> LimitDependency: LimitDependencyModel


FrequencyConverter -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


FrequencyConverter -> ProtectiveActionEquipment: ProtectiveActionEquipment


FrequencyConverter -> PinEquipment: PinEquipment


FrequencyConverter -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


FrequencyConverter -> EquipmentContainer: AdditionalEquipmentContainer


FrequencyConverter -> UsagePoint: UsagePoints


FrequencyConverter -> Outage: Outages


FrequencyConverter -> OperationalRestriction: OperationalRestrictions


FrequencyConverter -> Control: Controls


FrequencyConverter -> Measurement: Measurements


FrequencyConverter -> PSRType: PSRType


FrequencyConverter -> ConfigurationEvent: ConfigurationEvent


FrequencyConverter -> ReportingGroup: ReportingGroup


FrequencyConverter -> OperatingShare: OperatingShare


FrequencyConverter -> AssetInfo: AssetDatasheet


FrequencyConverter -> VerificationAction: VerificationAction


FrequencyConverter -> ClearanceDocument: Clearances


FrequencyConverter -> GenericAction: GenericAction


FrequencyConverter -> PSREvent: PSREvents


FrequencyConverter -> Asset: Assets


FrequencyConverter -> Location: Location


FrequencyConverter -> OperationalTag: OperationalTags


FrequencyConverter -> DiagramObject: DiagramObjects


FrequencyConverter -> InstanceSet: InstanceSet


FrequencyConverter -> Name: Names


FrequencyConverter -> ChangeSetMember: PropertiesCIMDataObject


FrequencyConverter -> ChangeSetMember: TargetingCIMDataObject
