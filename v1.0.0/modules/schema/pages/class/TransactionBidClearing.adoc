...
TransactionBidClearing -> TransactionBidResults: TransactionBidResults


TransactionBidClearing -> MktActivityRecord: MktActivityRecord


TransactionBidClearing -> Market: Market


TransactionBidClearing -> Status: docStatus


TransactionBidClearing -> ElectronicAddress: electronicAddress


TransactionBidClearing -> Status: status


TransactionBidClearing -> ActivityRecord: ActivityRecord


TransactionBidClearing -> ConfigurationEvent: ConfigurationEvents


TransactionBidClearing -> Author: Author


TransactionBidClearing -> Editor: Editor


TransactionBidClearing -> Approver: Approver


TransactionBidClearing -> Issuer: Issuer


TransactionBidClearing -> DiagramObject: DiagramObjects


TransactionBidClearing -> InstanceSet: InstanceSet


TransactionBidClearing -> Name: Names


TransactionBidClearing -> ChangeSetMember: PropertiesCIMDataObject


TransactionBidClearing -> ChangeSetMember: TargetingCIMDataObject
