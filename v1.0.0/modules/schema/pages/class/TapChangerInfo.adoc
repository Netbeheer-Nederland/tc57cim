...
TapChangerInfo -> PowerSystemResource: PowerSystemResources


TapChangerInfo -> CatalogAssetType: CatalogAssetType


TapChangerInfo -> Asset: Assets


TapChangerInfo -> ProductAssetModel: ProductAssetModel


TapChangerInfo -> DiagramObject: DiagramObjects


TapChangerInfo -> InstanceSet: InstanceSet


TapChangerInfo -> Name: Names


TapChangerInfo -> ChangeSetMember: PropertiesCIMDataObject


TapChangerInfo -> ChangeSetMember: TargetingCIMDataObject
