...
RemoteSource -> MeasurementValue: MeasurementValue


RemoteSource -> RemoteUnit: RemoteUnit


RemoteSource -> DiagramObject: DiagramObjects


RemoteSource -> InstanceSet: InstanceSet


RemoteSource -> Name: Names


RemoteSource -> ChangeSetMember: PropertiesCIMDataObject


RemoteSource -> ChangeSetMember: TargetingCIMDataObject
