...
WindContPType4aIEC -> DiagramObject: DiagramObjects


WindContPType4aIEC -> InstanceSet: InstanceSet


WindContPType4aIEC -> Name: Names


WindContPType4aIEC -> ChangeSetMember: PropertiesCIMDataObject


WindContPType4aIEC -> ChangeSetMember: TargetingCIMDataObject
