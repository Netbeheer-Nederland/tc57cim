...
AreaLoadCurve -> AggregateNode: AggregateNode


AreaLoadCurve -> TACArea: TACArea



AreaLoadCurve -> RegularTimePoint: TimePoints


AreaLoadCurve -> DiagramObject: DiagramObjects


AreaLoadCurve -> InstanceSet: InstanceSet


AreaLoadCurve -> Name: Names


AreaLoadCurve -> ChangeSetMember: PropertiesCIMDataObject


AreaLoadCurve -> ChangeSetMember: TargetingCIMDataObject
