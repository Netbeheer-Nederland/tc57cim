...
GenICompensationForGenJ -> SynchronousMachineDynamics: SynchronousMachineDynamics


GenICompensationForGenJ -> DiagramObject: DiagramObjects


GenICompensationForGenJ -> InstanceSet: InstanceSet


GenICompensationForGenJ -> Name: Names


GenICompensationForGenJ -> ChangeSetMember: PropertiesCIMDataObject


GenICompensationForGenJ -> ChangeSetMember: TargetingCIMDataObject
