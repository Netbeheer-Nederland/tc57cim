...
ACDCConverter -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


ACDCConverter -> SvStatus: SvStatus


ACDCConverter -> ProtectionEquipment: ProtectionEquipments


ACDCConverter -> BaseVoltage: BaseVoltage


ACDCConverter -> Terminal: Terminals


ACDCConverter -> JumperAction: JumpingAction


ACDCConverter -> GroundAction: GroundingAction


ACDCConverter -> Outage: Outage


ACDCConverter -> WeatherStation: WeatherStation


ACDCConverter -> OperationalLimitSet: OperationalLimitSet


ACDCConverter -> ContingencyEquipment: ContingencyEquipment


ACDCConverter -> EquipmentContainer: EquipmentContainer


ACDCConverter -> Fault: Faults


ACDCConverter -> LimitDependency: LimitDependencyModel


ACDCConverter -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ACDCConverter -> ProtectiveActionEquipment: ProtectiveActionEquipment


ACDCConverter -> PinEquipment: PinEquipment


ACDCConverter -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ACDCConverter -> EquipmentContainer: AdditionalEquipmentContainer


ACDCConverter -> UsagePoint: UsagePoints


ACDCConverter -> Outage: Outages


ACDCConverter -> OperationalRestriction: OperationalRestrictions


ACDCConverter -> Control: Controls


ACDCConverter -> Measurement: Measurements


ACDCConverter -> PSRType: PSRType


ACDCConverter -> ConfigurationEvent: ConfigurationEvent


ACDCConverter -> ReportingGroup: ReportingGroup


ACDCConverter -> OperatingShare: OperatingShare


ACDCConverter -> AssetInfo: AssetDatasheet


ACDCConverter -> VerificationAction: VerificationAction


ACDCConverter -> ClearanceDocument: Clearances


ACDCConverter -> GenericAction: GenericAction


ACDCConverter -> PSREvent: PSREvents


ACDCConverter -> Asset: Assets


ACDCConverter -> Location: Location


ACDCConverter -> OperationalTag: OperationalTags


ACDCConverter -> DiagramObject: DiagramObjects


ACDCConverter -> InstanceSet: InstanceSet


ACDCConverter -> Name: Names


ACDCConverter -> ChangeSetMember: PropertiesCIMDataObject


ACDCConverter -> ChangeSetMember: TargetingCIMDataObject
