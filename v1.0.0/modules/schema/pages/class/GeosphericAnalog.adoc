...
GeosphericAnalog -> ReportingCapability: ReportingCapability


GeosphericAnalog -> EnvironmentalInformation: EnvironmentalInformation


GeosphericAnalog -> ClassificationCondition: ClassificationCondition


GeosphericAnalog -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


GeosphericAnalog -> AnalogValue: AnalogValues


GeosphericAnalog -> AnalogLimitSet: LimitSets


GeosphericAnalog -> ACDCTerminal: Terminal


GeosphericAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


GeosphericAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


GeosphericAnalog -> PowerSystemResource: PowerSystemResource


GeosphericAnalog -> PinMeasurement: PinMeasurement


GeosphericAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


GeosphericAnalog -> Asset: Asset


GeosphericAnalog -> MeasurementAction: MeasurementAction


GeosphericAnalog -> Location: Locations


GeosphericAnalog -> Procedure: Procedures


GeosphericAnalog -> DiagramObject: DiagramObjects


GeosphericAnalog -> InstanceSet: InstanceSet


GeosphericAnalog -> Name: Names


GeosphericAnalog -> ChangeSetMember: PropertiesCIMDataObject


GeosphericAnalog -> ChangeSetMember: TargetingCIMDataObject
