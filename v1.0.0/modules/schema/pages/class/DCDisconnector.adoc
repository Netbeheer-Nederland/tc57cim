...
DCDisconnector -> DCTerminal: DCTerminals


DCDisconnector -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


DCDisconnector -> WeatherStation: WeatherStation


DCDisconnector -> OperationalLimitSet: OperationalLimitSet


DCDisconnector -> ContingencyEquipment: ContingencyEquipment


DCDisconnector -> EquipmentContainer: EquipmentContainer


DCDisconnector -> Fault: Faults


DCDisconnector -> LimitDependency: LimitDependencyModel


DCDisconnector -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


DCDisconnector -> ProtectiveActionEquipment: ProtectiveActionEquipment


DCDisconnector -> PinEquipment: PinEquipment


DCDisconnector -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


DCDisconnector -> EquipmentContainer: AdditionalEquipmentContainer


DCDisconnector -> UsagePoint: UsagePoints


DCDisconnector -> Outage: Outages


DCDisconnector -> OperationalRestriction: OperationalRestrictions


DCDisconnector -> Control: Controls


DCDisconnector -> Measurement: Measurements


DCDisconnector -> PSRType: PSRType


DCDisconnector -> ConfigurationEvent: ConfigurationEvent


DCDisconnector -> ReportingGroup: ReportingGroup


DCDisconnector -> OperatingShare: OperatingShare


DCDisconnector -> AssetInfo: AssetDatasheet


DCDisconnector -> VerificationAction: VerificationAction


DCDisconnector -> ClearanceDocument: Clearances


DCDisconnector -> GenericAction: GenericAction


DCDisconnector -> PSREvent: PSREvents


DCDisconnector -> Asset: Assets


DCDisconnector -> Location: Location


DCDisconnector -> OperationalTag: OperationalTags


DCDisconnector -> DiagramObject: DiagramObjects


DCDisconnector -> InstanceSet: InstanceSet


DCDisconnector -> Name: Names


DCDisconnector -> ChangeSetMember: PropertiesCIMDataObject


DCDisconnector -> ChangeSetMember: TargetingCIMDataObject
