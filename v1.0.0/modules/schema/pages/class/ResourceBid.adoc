...
ResourceBid -> BidError: BidError


ResourceBid -> MarketParticipant: MarketParticipant


ResourceBid -> EnergyMarket: EnergyMarket


ResourceBid -> ChargeProfile: ChargeProfiles


ResourceBid -> MitigatedBidSegment: MitigatedBidSegment


ResourceBid -> RMRDetermination: RMRDetermination


ResourceBid -> MitigatedBid: MitigatedBid


ResourceBid -> BidHourlySchedule: BidHourlySchedule


ResourceBid -> ProductBid: ProductBids


ResourceBid -> ActionRequest: ActionRequest


ResourceBid -> Status: docStatus


ResourceBid -> ElectronicAddress: electronicAddress


ResourceBid -> Status: status


ResourceBid -> ActivityRecord: ActivityRecord


ResourceBid -> ConfigurationEvent: ConfigurationEvents


ResourceBid -> Author: Author


ResourceBid -> Editor: Editor


ResourceBid -> Approver: Approver


ResourceBid -> Issuer: Issuer


ResourceBid -> DiagramObject: DiagramObjects


ResourceBid -> InstanceSet: InstanceSet


ResourceBid -> Name: Names


ResourceBid -> ChangeSetMember: PropertiesCIMDataObject


ResourceBid -> ChangeSetMember: TargetingCIMDataObject
