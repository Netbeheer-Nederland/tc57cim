...
WorkActivityRecord -> BaseWork: BaseWork


WorkActivityRecord -> Status: status


WorkActivityRecord -> Document: Document


WorkActivityRecord -> Author: Author


WorkActivityRecord -> Asset: Assets


WorkActivityRecord -> DiagramObject: DiagramObjects


WorkActivityRecord -> InstanceSet: InstanceSet


WorkActivityRecord -> Name: Names


WorkActivityRecord -> ChangeSetMember: PropertiesCIMDataObject


WorkActivityRecord -> ChangeSetMember: TargetingCIMDataObject
