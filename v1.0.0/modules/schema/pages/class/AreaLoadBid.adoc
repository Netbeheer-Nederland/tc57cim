...
AreaLoadBid -> LoadBid: LoadBid


AreaLoadBid -> MarketParticipant: MarketParticipant


AreaLoadBid -> EnergyMarket: EnergyMarket


AreaLoadBid -> ChargeProfile: ChargeProfiles


AreaLoadBid -> MitigatedBidSegment: MitigatedBidSegment


AreaLoadBid -> RMRDetermination: RMRDetermination


AreaLoadBid -> MitigatedBid: MitigatedBid


AreaLoadBid -> BidHourlySchedule: BidHourlySchedule


AreaLoadBid -> ProductBid: ProductBids


AreaLoadBid -> ActionRequest: ActionRequest


AreaLoadBid -> Status: docStatus


AreaLoadBid -> ElectronicAddress: electronicAddress


AreaLoadBid -> Status: status


AreaLoadBid -> ActivityRecord: ActivityRecord


AreaLoadBid -> ConfigurationEvent: ConfigurationEvents


AreaLoadBid -> Author: Author


AreaLoadBid -> Editor: Editor


AreaLoadBid -> Approver: Approver


AreaLoadBid -> Issuer: Issuer


AreaLoadBid -> DiagramObject: DiagramObjects


AreaLoadBid -> InstanceSet: InstanceSet


AreaLoadBid -> Name: Names


AreaLoadBid -> ChangeSetMember: PropertiesCIMDataObject


AreaLoadBid -> ChangeSetMember: TargetingCIMDataObject
