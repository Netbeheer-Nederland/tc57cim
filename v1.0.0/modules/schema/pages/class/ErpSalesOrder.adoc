...
ErpSalesOrder -> Status: docStatus


ErpSalesOrder -> ElectronicAddress: electronicAddress


ErpSalesOrder -> Status: status


ErpSalesOrder -> ActivityRecord: ActivityRecord


ErpSalesOrder -> ConfigurationEvent: ConfigurationEvents


ErpSalesOrder -> Author: Author


ErpSalesOrder -> Editor: Editor


ErpSalesOrder -> Approver: Approver


ErpSalesOrder -> Issuer: Issuer


ErpSalesOrder -> DiagramObject: DiagramObjects


ErpSalesOrder -> InstanceSet: InstanceSet


ErpSalesOrder -> Name: Names


ErpSalesOrder -> ChangeSetMember: PropertiesCIMDataObject


ErpSalesOrder -> ChangeSetMember: TargetingCIMDataObject
