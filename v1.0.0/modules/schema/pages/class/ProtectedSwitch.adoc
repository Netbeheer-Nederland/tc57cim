...
ProtectedSwitch -> ProtectionEquipment: OperatedByProtectionEquipment


ProtectedSwitch -> RecloseSequence: RecloseSequences



ProtectedSwitch -> SwitchPhase: SwitchPhase


ProtectedSwitch -> SwitchSchedule: SwitchSchedules


ProtectedSwitch -> CompositeSwitch: CompositeSwitch


ProtectedSwitch -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


ProtectedSwitch -> SvSwitch: SvSwitch


ProtectedSwitch -> ConnectDisconnectFunction: ConnectDisconnectFunctions


ProtectedSwitch -> SwitchAction: SwitchAction


ProtectedSwitch -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


ProtectedSwitch -> SvStatus: SvStatus


ProtectedSwitch -> ProtectionEquipment: ProtectionEquipments
...
ProtectedSwitch -> JumperAction: JumpingAction


ProtectedSwitch -> GroundAction: GroundingAction


ProtectedSwitch -> Outage: Outage


ProtectedSwitch -> WeatherStation: WeatherStation


ProtectedSwitch -> OperationalLimitSet: OperationalLimitSet


ProtectedSwitch -> ContingencyEquipment: ContingencyEquipment


ProtectedSwitch -> EquipmentContainer: EquipmentContainer


ProtectedSwitch -> Fault: Faults


ProtectedSwitch -> LimitDependency: LimitDependencyModel


ProtectedSwitch -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


ProtectedSwitch -> ProtectiveActionEquipment: ProtectiveActionEquipment


ProtectedSwitch -> PinEquipment: PinEquipment


ProtectedSwitch -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


ProtectedSwitch -> EquipmentContainer: AdditionalEquipmentContainer


ProtectedSwitch -> UsagePoint: UsagePoints


ProtectedSwitch -> Outage: Outages


ProtectedSwitch -> OperationalRestriction: OperationalRestrictions


ProtectedSwitch -> Control: Controls


ProtectedSwitch -> Measurement: Measurements


ProtectedSwitch -> PSRType: PSRType


ProtectedSwitch -> ConfigurationEvent: ConfigurationEvent


ProtectedSwitch -> ReportingGroup: ReportingGroup


ProtectedSwitch -> OperatingShare: OperatingShare


ProtectedSwitch -> AssetInfo: AssetDatasheet


ProtectedSwitch -> VerificationAction: VerificationAction


ProtectedSwitch -> ClearanceDocument: Clearances


ProtectedSwitch -> GenericAction: GenericAction


ProtectedSwitch -> PSREvent: PSREvents


ProtectedSwitch -> Asset: Assets


ProtectedSwitch -> Location: Location


ProtectedSwitch -> OperationalTag: OperationalTags


ProtectedSwitch -> DiagramObject: DiagramObjects


ProtectedSwitch -> InstanceSet: InstanceSet


ProtectedSwitch -> Name: Names


ProtectedSwitch -> ChangeSetMember: PropertiesCIMDataObject


ProtectedSwitch -> ChangeSetMember: TargetingCIMDataObject
