...
SpaceAnalog -> ReportingCapability: ReportingCapability


SpaceAnalog -> EnvironmentalInformation: EnvironmentalInformation


SpaceAnalog -> ClassificationCondition: ClassificationCondition


SpaceAnalog -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


SpaceAnalog -> AnalogValue: AnalogValues


SpaceAnalog -> AnalogLimitSet: LimitSets


SpaceAnalog -> ACDCTerminal: Terminal


SpaceAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


SpaceAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


SpaceAnalog -> PowerSystemResource: PowerSystemResource


SpaceAnalog -> PinMeasurement: PinMeasurement


SpaceAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


SpaceAnalog -> Asset: Asset


SpaceAnalog -> MeasurementAction: MeasurementAction


SpaceAnalog -> Location: Locations


SpaceAnalog -> Procedure: Procedures


SpaceAnalog -> DiagramObject: DiagramObjects


SpaceAnalog -> InstanceSet: InstanceSet


SpaceAnalog -> Name: Names


SpaceAnalog -> ChangeSetMember: PropertiesCIMDataObject


SpaceAnalog -> ChangeSetMember: TargetingCIMDataObject
