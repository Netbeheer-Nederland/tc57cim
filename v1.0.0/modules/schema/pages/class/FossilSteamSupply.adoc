...
FossilSteamSupply -> SteamTurbine: SteamTurbines


FossilSteamSupply -> Control: Controls


FossilSteamSupply -> Measurement: Measurements


FossilSteamSupply -> PSRType: PSRType


FossilSteamSupply -> ConfigurationEvent: ConfigurationEvent


FossilSteamSupply -> ReportingGroup: ReportingGroup


FossilSteamSupply -> OperatingShare: OperatingShare


FossilSteamSupply -> AssetInfo: AssetDatasheet


FossilSteamSupply -> VerificationAction: VerificationAction


FossilSteamSupply -> ClearanceDocument: Clearances


FossilSteamSupply -> GenericAction: GenericAction


FossilSteamSupply -> PSREvent: PSREvents


FossilSteamSupply -> Asset: Assets


FossilSteamSupply -> Location: Location


FossilSteamSupply -> OperationalTag: OperationalTags


FossilSteamSupply -> DiagramObject: DiagramObjects


FossilSteamSupply -> InstanceSet: InstanceSet


FossilSteamSupply -> Name: Names


FossilSteamSupply -> ChangeSetMember: PropertiesCIMDataObject


FossilSteamSupply -> ChangeSetMember: TargetingCIMDataObject
