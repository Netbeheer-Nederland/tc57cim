...
WorkDocument -> Status: docStatus


WorkDocument -> ElectronicAddress: electronicAddress


WorkDocument -> Status: status


WorkDocument -> ActivityRecord: ActivityRecord


WorkDocument -> ConfigurationEvent: ConfigurationEvents


WorkDocument -> Author: Author


WorkDocument -> Editor: Editor


WorkDocument -> Approver: Approver


WorkDocument -> Issuer: Issuer


WorkDocument -> DiagramObject: DiagramObjects


WorkDocument -> InstanceSet: InstanceSet


WorkDocument -> Name: Names


WorkDocument -> ChangeSetMember: PropertiesCIMDataObject


WorkDocument -> ChangeSetMember: TargetingCIMDataObject
