...
DCTopologicalIsland -> DiagramObject: DiagramObjects


DCTopologicalIsland -> InstanceSet: InstanceSet


DCTopologicalIsland -> Name: Names


DCTopologicalIsland -> ChangeSetMember: PropertiesCIMDataObject


DCTopologicalIsland -> ChangeSetMember: TargetingCIMDataObject
