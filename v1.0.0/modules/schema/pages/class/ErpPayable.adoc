...
ErpPayable -> ErpPayableLineItem: ErpPayableLineItems


ErpPayable -> ContractorItem: ContractorItems


ErpPayable -> Status: docStatus


ErpPayable -> ElectronicAddress: electronicAddress


ErpPayable -> Status: status


ErpPayable -> ActivityRecord: ActivityRecord


ErpPayable -> ConfigurationEvent: ConfigurationEvents


ErpPayable -> Author: Author


ErpPayable -> Editor: Editor


ErpPayable -> Approver: Approver


ErpPayable -> Issuer: Issuer


ErpPayable -> DiagramObject: DiagramObjects


ErpPayable -> InstanceSet: InstanceSet


ErpPayable -> Name: Names


ErpPayable -> ChangeSetMember: PropertiesCIMDataObject


ErpPayable -> ChangeSetMember: TargetingCIMDataObject
