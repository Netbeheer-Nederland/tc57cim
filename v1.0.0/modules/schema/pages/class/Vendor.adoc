...
Vendor -> VendorShift: VendorShifts


Vendor -> DiagramObject: DiagramObjects


Vendor -> InstanceSet: InstanceSet


Vendor -> Name: Names


Vendor -> ChangeSetMember: PropertiesCIMDataObject


Vendor -> ChangeSetMember: TargetingCIMDataObject
