...
ErpLedgerBudget -> ErpLedBudLineItem: ErpLedBudLineItems


ErpLedgerBudget -> Status: docStatus


ErpLedgerBudget -> ElectronicAddress: electronicAddress


ErpLedgerBudget -> Status: status


ErpLedgerBudget -> ActivityRecord: ActivityRecord


ErpLedgerBudget -> ConfigurationEvent: ConfigurationEvents


ErpLedgerBudget -> Author: Author


ErpLedgerBudget -> Editor: Editor


ErpLedgerBudget -> Approver: Approver


ErpLedgerBudget -> Issuer: Issuer


ErpLedgerBudget -> DiagramObject: DiagramObjects


ErpLedgerBudget -> InstanceSet: InstanceSet


ErpLedgerBudget -> Name: Names


ErpLedgerBudget -> ChangeSetMember: PropertiesCIMDataObject


ErpLedgerBudget -> ChangeSetMember: TargetingCIMDataObject
