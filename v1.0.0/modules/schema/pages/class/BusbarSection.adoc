...
BusbarSection -> VoltageControlZone: VoltageControlZone


BusbarSection -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


BusbarSection -> SvStatus: SvStatus


BusbarSection -> ProtectionEquipment: ProtectionEquipments
...
BusbarSection -> JumperAction: JumpingAction


BusbarSection -> GroundAction: GroundingAction


BusbarSection -> Outage: Outage


BusbarSection -> WeatherStation: WeatherStation


BusbarSection -> OperationalLimitSet: OperationalLimitSet


BusbarSection -> ContingencyEquipment: ContingencyEquipment


BusbarSection -> EquipmentContainer: EquipmentContainer


BusbarSection -> Fault: Faults


BusbarSection -> LimitDependency: LimitDependencyModel


BusbarSection -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


BusbarSection -> ProtectiveActionEquipment: ProtectiveActionEquipment


BusbarSection -> PinEquipment: PinEquipment


BusbarSection -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


BusbarSection -> EquipmentContainer: AdditionalEquipmentContainer


BusbarSection -> UsagePoint: UsagePoints


BusbarSection -> Outage: Outages


BusbarSection -> OperationalRestriction: OperationalRestrictions


BusbarSection -> Control: Controls


BusbarSection -> Measurement: Measurements


BusbarSection -> PSRType: PSRType


BusbarSection -> ConfigurationEvent: ConfigurationEvent


BusbarSection -> ReportingGroup: ReportingGroup


BusbarSection -> OperatingShare: OperatingShare


BusbarSection -> AssetInfo: AssetDatasheet


BusbarSection -> VerificationAction: VerificationAction


BusbarSection -> ClearanceDocument: Clearances


BusbarSection -> GenericAction: GenericAction


BusbarSection -> PSREvent: PSREvents


BusbarSection -> Asset: Assets


BusbarSection -> Location: Location


BusbarSection -> OperationalTag: OperationalTags


BusbarSection -> DiagramObject: DiagramObjects


BusbarSection -> InstanceSet: InstanceSet


BusbarSection -> Name: Names


BusbarSection -> ChangeSetMember: PropertiesCIMDataObject


BusbarSection -> ChangeSetMember: TargetingCIMDataObject
