...
ScheduledEvent -> Asset: Assets


ScheduledEvent -> ScheduledEventData: ScheduledEventData


ScheduledEvent -> DiagramObject: DiagramObjects


ScheduledEvent -> InstanceSet: InstanceSet


ScheduledEvent -> Name: Names


ScheduledEvent -> ChangeSetMember: PropertiesCIMDataObject


ScheduledEvent -> ChangeSetMember: TargetingCIMDataObject
