...
BranchGroup -> BranchGroupTerminal: BranchGroupTerminal


BranchGroup -> PinBranchGroup: PinBranchGroup


BranchGroup -> DiagramObject: DiagramObjects


BranchGroup -> InstanceSet: InstanceSet


BranchGroup -> Name: Names


BranchGroup -> ChangeSetMember: PropertiesCIMDataObject


BranchGroup -> ChangeSetMember: TargetingCIMDataObject
