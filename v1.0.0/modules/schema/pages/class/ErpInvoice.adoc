...
ErpInvoice -> ErpInvoiceLineItem: ErpInvoiceLineItems


ErpInvoice -> CustomerAccount: CustomerAccount


ErpInvoice -> Status: docStatus


ErpInvoice -> ElectronicAddress: electronicAddress


ErpInvoice -> Status: status


ErpInvoice -> ActivityRecord: ActivityRecord


ErpInvoice -> ConfigurationEvent: ConfigurationEvents


ErpInvoice -> Author: Author


ErpInvoice -> Editor: Editor


ErpInvoice -> Approver: Approver


ErpInvoice -> Issuer: Issuer


ErpInvoice -> DiagramObject: DiagramObjects


ErpInvoice -> InstanceSet: InstanceSet


ErpInvoice -> Name: Names


ErpInvoice -> ChangeSetMember: PropertiesCIMDataObject


ErpInvoice -> ChangeSetMember: TargetingCIMDataObject
