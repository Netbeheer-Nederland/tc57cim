...
Design -> ErpBOM: ErpBOMs


Design -> WorkCostDetail: WorkCostDetails


Design -> OldWorkTask: WorkTasks


Design -> Work: Work


Design -> ConditionFactor: ConditionFactors


Design -> DesignLocationCU: DesignLocationsCUs


Design -> DesignLocation: DesignLocations


Design -> ErpQuoteLineItem: ErpQuoteLineItem


Design -> Status: docStatus


Design -> ElectronicAddress: electronicAddress


Design -> Status: status


Design -> ActivityRecord: ActivityRecord


Design -> ConfigurationEvent: ConfigurationEvents
...
Design -> Issuer: Issuer


Design -> DiagramObject: DiagramObjects


Design -> InstanceSet: InstanceSet


Design -> Name: Names


Design -> ChangeSetMember: PropertiesCIMDataObject


Design -> ChangeSetMember: TargetingCIMDataObject
