...
WireInfo -> WirePhaseInfo: WirePhaseInfo


WireInfo -> ACLineSegmentPhase: ACLineSegmentPhase


WireInfo -> PowerSystemResource: PowerSystemResources


WireInfo -> CatalogAssetType: CatalogAssetType


WireInfo -> Asset: Assets


WireInfo -> ProductAssetModel: ProductAssetModel


WireInfo -> DiagramObject: DiagramObjects


WireInfo -> InstanceSet: InstanceSet


WireInfo -> Name: Names


WireInfo -> ChangeSetMember: PropertiesCIMDataObject


WireInfo -> ChangeSetMember: TargetingCIMDataObject
