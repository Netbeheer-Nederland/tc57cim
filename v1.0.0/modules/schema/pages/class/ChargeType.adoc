...
ChargeType -> ChargeGroup: ChargeGroup


ChargeType -> ChargeComponent: ChargeComponents


ChargeType -> MktUserAttribute: MktUserAttribute


ChargeType -> MajorChargeGroup: MajorChargeGroup


ChargeType -> Status: docStatus


ChargeType -> ElectronicAddress: electronicAddress


ChargeType -> Status: status


ChargeType -> ActivityRecord: ActivityRecord


ChargeType -> ConfigurationEvent: ConfigurationEvents


ChargeType -> Author: Author


ChargeType -> Editor: Editor


ChargeType -> Approver: Approver


ChargeType -> Issuer: Issuer


ChargeType -> DiagramObject: DiagramObjects


ChargeType -> InstanceSet: InstanceSet


ChargeType -> Name: Names


ChargeType -> ChangeSetMember: PropertiesCIMDataObject


ChargeType -> ChangeSetMember: TargetingCIMDataObject
