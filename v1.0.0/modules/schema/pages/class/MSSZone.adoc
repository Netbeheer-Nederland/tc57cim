...
MSSZone -> MeteredSubSystem: MeteredSubSystem


MSSZone -> CnodeDistributionFactor: CnodeDistributionFactor


MSSZone -> SubControlArea: SubControlArea


MSSZone -> Pnode: Pnode


MSSZone -> AreaLoadCurve: AreaLoadCurve
...
MSSZone -> RegisteredResource: RegisteredResource


MSSZone -> DiagramObject: DiagramObjects


MSSZone -> InstanceSet: InstanceSet


MSSZone -> Name: Names


MSSZone -> ChangeSetMember: PropertiesCIMDataObject


MSSZone -> ChangeSetMember: TargetingCIMDataObject
