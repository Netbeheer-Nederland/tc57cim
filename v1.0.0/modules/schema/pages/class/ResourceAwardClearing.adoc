...
ResourceAwardClearing -> RUCAwardInstruction: RUCAwardInstruction


ResourceAwardClearing -> ResourceAwardInstruction: ResourceAwardInstruction


ResourceAwardClearing -> MktActivityRecord: MktActivityRecord


ResourceAwardClearing -> Market: Market


ResourceAwardClearing -> Status: docStatus


ResourceAwardClearing -> ElectronicAddress: electronicAddress


ResourceAwardClearing -> Status: status


ResourceAwardClearing -> ActivityRecord: ActivityRecord


ResourceAwardClearing -> ConfigurationEvent: ConfigurationEvents


ResourceAwardClearing -> Author: Author


ResourceAwardClearing -> Editor: Editor


ResourceAwardClearing -> Approver: Approver


ResourceAwardClearing -> Issuer: Issuer


ResourceAwardClearing -> DiagramObject: DiagramObjects


ResourceAwardClearing -> InstanceSet: InstanceSet


ResourceAwardClearing -> Name: Names


ResourceAwardClearing -> ChangeSetMember: PropertiesCIMDataObject


ResourceAwardClearing -> ChangeSetMember: TargetingCIMDataObject
