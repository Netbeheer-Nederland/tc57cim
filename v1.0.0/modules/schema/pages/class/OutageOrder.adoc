...
OutageOrder -> Location: Location


OutageOrder -> OutagePlan: OutagePlan


OutageOrder -> Status: docStatus


OutageOrder -> ElectronicAddress: electronicAddress


OutageOrder -> Status: status


OutageOrder -> ActivityRecord: ActivityRecord


OutageOrder -> ConfigurationEvent: ConfigurationEvents


OutageOrder -> Author: Author


OutageOrder -> Editor: Editor


OutageOrder -> Approver: Approver


OutageOrder -> Issuer: Issuer


OutageOrder -> DiagramObject: DiagramObjects


OutageOrder -> InstanceSet: InstanceSet


OutageOrder -> Name: Names


OutageOrder -> ChangeSetMember: PropertiesCIMDataObject


OutageOrder -> ChangeSetMember: TargetingCIMDataObject
