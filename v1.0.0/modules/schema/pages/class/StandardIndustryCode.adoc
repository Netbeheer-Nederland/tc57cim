...
StandardIndustryCode -> CustomerAgreement: CustomerAgreements


StandardIndustryCode -> Status: docStatus


StandardIndustryCode -> ElectronicAddress: electronicAddress


StandardIndustryCode -> Status: status


StandardIndustryCode -> ActivityRecord: ActivityRecord


StandardIndustryCode -> ConfigurationEvent: ConfigurationEvents


StandardIndustryCode -> Author: Author


StandardIndustryCode -> Editor: Editor


StandardIndustryCode -> Approver: Approver


StandardIndustryCode -> Issuer: Issuer


StandardIndustryCode -> DiagramObject: DiagramObjects


StandardIndustryCode -> InstanceSet: InstanceSet


StandardIndustryCode -> Name: Names


StandardIndustryCode -> ChangeSetMember: PropertiesCIMDataObject


StandardIndustryCode -> ChangeSetMember: TargetingCIMDataObject
