...
Disconnector -> SwitchPhase: SwitchPhase


Disconnector -> SwitchSchedule: SwitchSchedules


Disconnector -> CompositeSwitch: CompositeSwitch


Disconnector -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


Disconnector -> SvSwitch: SvSwitch


Disconnector -> ConnectDisconnectFunction: ConnectDisconnectFunctions


Disconnector -> SwitchAction: SwitchAction


Disconnector -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Disconnector -> SvStatus: SvStatus


Disconnector -> ProtectionEquipment: ProtectionEquipments
...
Disconnector -> JumperAction: JumpingAction


Disconnector -> GroundAction: GroundingAction


Disconnector -> Outage: Outage


Disconnector -> WeatherStation: WeatherStation


Disconnector -> OperationalLimitSet: OperationalLimitSet


Disconnector -> ContingencyEquipment: ContingencyEquipment


Disconnector -> EquipmentContainer: EquipmentContainer


Disconnector -> Fault: Faults


Disconnector -> LimitDependency: LimitDependencyModel


Disconnector -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Disconnector -> ProtectiveActionEquipment: ProtectiveActionEquipment


Disconnector -> PinEquipment: PinEquipment


Disconnector -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Disconnector -> EquipmentContainer: AdditionalEquipmentContainer


Disconnector -> UsagePoint: UsagePoints


Disconnector -> Outage: Outages


Disconnector -> OperationalRestriction: OperationalRestrictions


Disconnector -> Control: Controls


Disconnector -> Measurement: Measurements


Disconnector -> PSRType: PSRType


Disconnector -> ConfigurationEvent: ConfigurationEvent


Disconnector -> ReportingGroup: ReportingGroup


Disconnector -> OperatingShare: OperatingShare


Disconnector -> AssetInfo: AssetDatasheet


Disconnector -> VerificationAction: VerificationAction


Disconnector -> ClearanceDocument: Clearances


Disconnector -> GenericAction: GenericAction


Disconnector -> PSREvent: PSREvents


Disconnector -> Asset: Assets


Disconnector -> Location: Location


Disconnector -> OperationalTag: OperationalTags


Disconnector -> DiagramObject: DiagramObjects


Disconnector -> InstanceSet: InstanceSet


Disconnector -> Name: Names


Disconnector -> ChangeSetMember: PropertiesCIMDataObject


Disconnector -> ChangeSetMember: TargetingCIMDataObject
