...
PostLineSensor -> Terminal: Terminal


PostLineSensor -> WeatherStation: WeatherStation


PostLineSensor -> OperationalLimitSet: OperationalLimitSet


PostLineSensor -> ContingencyEquipment: ContingencyEquipment


PostLineSensor -> EquipmentContainer: EquipmentContainer


PostLineSensor -> Fault: Faults


PostLineSensor -> LimitDependency: LimitDependencyModel


PostLineSensor -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


PostLineSensor -> ProtectiveActionEquipment: ProtectiveActionEquipment


PostLineSensor -> PinEquipment: PinEquipment


PostLineSensor -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


PostLineSensor -> EquipmentContainer: AdditionalEquipmentContainer


PostLineSensor -> UsagePoint: UsagePoints


PostLineSensor -> Outage: Outages


PostLineSensor -> OperationalRestriction: OperationalRestrictions


PostLineSensor -> Control: Controls


PostLineSensor -> Measurement: Measurements


PostLineSensor -> PSRType: PSRType


PostLineSensor -> ConfigurationEvent: ConfigurationEvent


PostLineSensor -> ReportingGroup: ReportingGroup


PostLineSensor -> OperatingShare: OperatingShare


PostLineSensor -> AssetInfo: AssetDatasheet


PostLineSensor -> VerificationAction: VerificationAction


PostLineSensor -> ClearanceDocument: Clearances


PostLineSensor -> GenericAction: GenericAction


PostLineSensor -> PSREvent: PSREvents


PostLineSensor -> Asset: Assets


PostLineSensor -> Location: Location


PostLineSensor -> OperationalTag: OperationalTags


PostLineSensor -> DiagramObject: DiagramObjects


PostLineSensor -> InstanceSet: InstanceSet


PostLineSensor -> Name: Names


PostLineSensor -> ChangeSetMember: PropertiesCIMDataObject


PostLineSensor -> ChangeSetMember: TargetingCIMDataObject
