...
StartupModel -> ThermalGeneratingUnit: ThermalGeneratingUnit


StartupModel -> StartRampCurve: StartRampCurve


StartupModel -> StartIgnFuelCurve: StartIgnFuelCurve


StartupModel -> StartMainFuelCurve: StartMainFuelCurve


StartupModel -> DiagramObject: DiagramObjects


StartupModel -> InstanceSet: InstanceSet


StartupModel -> Name: Names


StartupModel -> ChangeSetMember: PropertiesCIMDataObject


StartupModel -> ChangeSetMember: TargetingCIMDataObject
