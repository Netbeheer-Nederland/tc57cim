...
CTTempActivePowerCurve -> CombustionTurbine: CombustionTurbine


CTTempActivePowerCurve -> CurveData: CurveDatas


CTTempActivePowerCurve -> DiagramObject: DiagramObjects


CTTempActivePowerCurve -> InstanceSet: InstanceSet


CTTempActivePowerCurve -> Name: Names


CTTempActivePowerCurve -> ChangeSetMember: PropertiesCIMDataObject


CTTempActivePowerCurve -> ChangeSetMember: TargetingCIMDataObject
