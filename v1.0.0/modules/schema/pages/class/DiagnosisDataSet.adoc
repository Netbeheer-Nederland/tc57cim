...
DiagnosisDataSet -> WorkTask: WorkTask


DiagnosisDataSet -> TransformerObservation: TransformerObservations


DiagnosisDataSet -> MeasurementValue: MeasurementValue


DiagnosisDataSet -> Asset: Asset


DiagnosisDataSet -> UserAttribute: Properties


DiagnosisDataSet -> Procedure: Procedure


DiagnosisDataSet -> Status: docStatus


DiagnosisDataSet -> ElectronicAddress: electronicAddress


DiagnosisDataSet -> Status: status


DiagnosisDataSet -> ActivityRecord: ActivityRecord


DiagnosisDataSet -> ConfigurationEvent: ConfigurationEvents


DiagnosisDataSet -> Author: Author


DiagnosisDataSet -> Editor: Editor


DiagnosisDataSet -> Approver: Approver


DiagnosisDataSet -> Issuer: Issuer


DiagnosisDataSet -> DiagramObject: DiagramObjects


DiagnosisDataSet -> InstanceSet: InstanceSet


DiagnosisDataSet -> Name: Names


DiagnosisDataSet -> ChangeSetMember: PropertiesCIMDataObject


DiagnosisDataSet -> ChangeSetMember: TargetingCIMDataObject
