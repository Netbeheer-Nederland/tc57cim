...
ShutdownCurve -> ThermalGeneratingUnit: ThermalGeneratingUnit


ShutdownCurve -> CurveData: CurveDatas


ShutdownCurve -> DiagramObject: DiagramObjects


ShutdownCurve -> InstanceSet: InstanceSet


ShutdownCurve -> Name: Names


ShutdownCurve -> ChangeSetMember: PropertiesCIMDataObject


ShutdownCurve -> ChangeSetMember: TargetingCIMDataObject
