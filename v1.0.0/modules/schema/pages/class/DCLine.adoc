...
DCLine -> DCTopologicalNode: DCTopologicalNode


DCLine -> DCNode: DCNodes


DCLine -> Equipment: Equipments


DCLine -> Equipment: AdditionalGroupedEquipment


DCLine -> TopologicalNode: TopologicalNode


DCLine -> ConnectivityNode: ConnectivityNodes


DCLine -> Control: Controls


DCLine -> Measurement: Measurements


DCLine -> PSRType: PSRType


DCLine -> ConfigurationEvent: ConfigurationEvent


DCLine -> ReportingGroup: ReportingGroup


DCLine -> OperatingShare: OperatingShare


DCLine -> AssetInfo: AssetDatasheet


DCLine -> VerificationAction: VerificationAction


DCLine -> ClearanceDocument: Clearances


DCLine -> GenericAction: GenericAction


DCLine -> PSREvent: PSREvents


DCLine -> Asset: Assets


DCLine -> Location: Location


DCLine -> OperationalTag: OperationalTags


DCLine -> DiagramObject: DiagramObjects


DCLine -> InstanceSet: InstanceSet


DCLine -> Name: Names


DCLine -> ChangeSetMember: PropertiesCIMDataObject


DCLine -> ChangeSetMember: TargetingCIMDataObject
