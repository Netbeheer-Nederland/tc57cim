...
Connector -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Connector -> SvStatus: SvStatus


Connector -> ProtectionEquipment: ProtectionEquipments
...
Connector -> JumperAction: JumpingAction


Connector -> GroundAction: GroundingAction


Connector -> Outage: Outage


Connector -> WeatherStation: WeatherStation


Connector -> OperationalLimitSet: OperationalLimitSet


Connector -> ContingencyEquipment: ContingencyEquipment


Connector -> EquipmentContainer: EquipmentContainer


Connector -> Fault: Faults


Connector -> LimitDependency: LimitDependencyModel


Connector -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Connector -> ProtectiveActionEquipment: ProtectiveActionEquipment


Connector -> PinEquipment: PinEquipment


Connector -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Connector -> EquipmentContainer: AdditionalEquipmentContainer


Connector -> UsagePoint: UsagePoints


Connector -> Outage: Outages


Connector -> OperationalRestriction: OperationalRestrictions


Connector -> Control: Controls


Connector -> Measurement: Measurements


Connector -> PSRType: PSRType


Connector -> ConfigurationEvent: ConfigurationEvent


Connector -> ReportingGroup: ReportingGroup


Connector -> OperatingShare: OperatingShare


Connector -> AssetInfo: AssetDatasheet


Connector -> VerificationAction: VerificationAction


Connector -> ClearanceDocument: Clearances


Connector -> GenericAction: GenericAction


Connector -> PSREvent: PSREvents
...
Connector -> OperationalTag: OperationalTags


Connector -> DiagramObject: DiagramObjects


Connector -> InstanceSet: InstanceSet


Connector -> Name: Names


Connector -> ChangeSetMember: PropertiesCIMDataObject


Connector -> ChangeSetMember: TargetingCIMDataObject
