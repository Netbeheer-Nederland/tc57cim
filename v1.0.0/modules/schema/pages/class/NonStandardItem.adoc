...
NonStandardItem -> Status: docStatus


NonStandardItem -> ElectronicAddress: electronicAddress


NonStandardItem -> Status: status


NonStandardItem -> ActivityRecord: ActivityRecord


NonStandardItem -> ConfigurationEvent: ConfigurationEvents


NonStandardItem -> Author: Author


NonStandardItem -> Editor: Editor


NonStandardItem -> Approver: Approver


NonStandardItem -> Issuer: Issuer


NonStandardItem -> DiagramObject: DiagramObjects


NonStandardItem -> InstanceSet: InstanceSet


NonStandardItem -> Name: Names


NonStandardItem -> ChangeSetMember: PropertiesCIMDataObject


NonStandardItem -> ChangeSetMember: TargetingCIMDataObject
