...
DefaultBidCurve -> DefaultBid: DefaultBid


DefaultBidCurve -> CurveData: CurveDatas


DefaultBidCurve -> DiagramObject: DiagramObjects


DefaultBidCurve -> InstanceSet: InstanceSet


DefaultBidCurve -> Name: Names


DefaultBidCurve -> ChangeSetMember: PropertiesCIMDataObject


DefaultBidCurve -> ChangeSetMember: TargetingCIMDataObject
