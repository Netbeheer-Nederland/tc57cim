...
WorkTask -> TroubleOrder: TroubleOrder


WorkTask -> Asset: Assets


WorkTask -> MaterialItem: MaterialItems


WorkTask -> Crew: Crews


WorkTask -> Asset: OldAsset


WorkTask -> SwitchingPlan: SwitchingPlan


WorkTask -> ProcedureDataSet: ProcedureDataSet
...
WorkTask -> WorkActivityRecord: WorkActivityRecords


WorkTask -> Status: docStatus


WorkTask -> ElectronicAddress: electronicAddress


WorkTask -> Status: status


WorkTask -> ActivityRecord: ActivityRecord


WorkTask -> ConfigurationEvent: ConfigurationEvents
...
WorkTask -> DiagramObject: DiagramObjects


WorkTask -> InstanceSet: InstanceSet


WorkTask -> Name: Names


WorkTask -> ChangeSetMember: PropertiesCIMDataObject


WorkTask -> ChangeSetMember: TargetingCIMDataObject
