...
PFVArControllerType2UserDefined -> ExcitationSystemDynamics: ExcitationSystemDynamics


PFVArControllerType2UserDefined -> DiagramObject: DiagramObjects


PFVArControllerType2UserDefined -> InstanceSet: InstanceSet


PFVArControllerType2UserDefined -> Name: Names


PFVArControllerType2UserDefined -> ChangeSetMember: PropertiesCIMDataObject


PFVArControllerType2UserDefined -> ChangeSetMember: TargetingCIMDataObject
