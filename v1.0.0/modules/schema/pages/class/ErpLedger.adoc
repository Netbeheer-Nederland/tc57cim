...
ErpLedger -> ErpLedgerEntry: ErpLedgerEntries


ErpLedger -> Status: docStatus


ErpLedger -> ElectronicAddress: electronicAddress


ErpLedger -> Status: status


ErpLedger -> ActivityRecord: ActivityRecord


ErpLedger -> ConfigurationEvent: ConfigurationEvents


ErpLedger -> Author: Author


ErpLedger -> Editor: Editor


ErpLedger -> Approver: Approver


ErpLedger -> Issuer: Issuer


ErpLedger -> DiagramObject: DiagramObjects


ErpLedger -> InstanceSet: InstanceSet


ErpLedger -> Name: Names


ErpLedger -> ChangeSetMember: PropertiesCIMDataObject


ErpLedger -> ChangeSetMember: TargetingCIMDataObject
