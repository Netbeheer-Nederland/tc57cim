...
ACDCTerminal -> DiagramObject: DiagramObjects


ACDCTerminal -> InstanceSet: InstanceSet


ACDCTerminal -> Name: Names


ACDCTerminal -> ChangeSetMember: PropertiesCIMDataObject


ACDCTerminal -> ChangeSetMember: TargetingCIMDataObject
