...
StageTrigger -> Gate: GateArmed


StageTrigger -> Gate: GateComCondition


StageTrigger -> Gate: GateTrigger


StageTrigger -> ProtectiveActionCollection: ProtectiveActionCollection


StageTrigger -> DiagramObject: DiagramObjects


StageTrigger -> InstanceSet: InstanceSet


StageTrigger -> Name: Names


StageTrigger -> ChangeSetMember: PropertiesCIMDataObject


StageTrigger -> ChangeSetMember: TargetingCIMDataObject
