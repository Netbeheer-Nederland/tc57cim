...
AssetFunction -> Asset: Asset


AssetFunction -> DiagramObject: DiagramObjects


AssetFunction -> InstanceSet: InstanceSet


AssetFunction -> Name: Names


AssetFunction -> ChangeSetMember: PropertiesCIMDataObject


AssetFunction -> ChangeSetMember: TargetingCIMDataObject
