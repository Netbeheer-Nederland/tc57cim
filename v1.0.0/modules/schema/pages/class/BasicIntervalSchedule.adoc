...
BasicIntervalSchedule -> DiagramObject: DiagramObjects


BasicIntervalSchedule -> InstanceSet: InstanceSet


BasicIntervalSchedule -> Name: Names


BasicIntervalSchedule -> ChangeSetMember: PropertiesCIMDataObject


BasicIntervalSchedule -> ChangeSetMember: TargetingCIMDataObject
