...
ProcedureDataSet -> WorkTask: WorkTask


ProcedureDataSet -> TransformerObservation: TransformerObservations


ProcedureDataSet -> MeasurementValue: MeasurementValue


ProcedureDataSet -> Asset: Asset


ProcedureDataSet -> UserAttribute: Properties


ProcedureDataSet -> Procedure: Procedure


ProcedureDataSet -> Status: docStatus


ProcedureDataSet -> ElectronicAddress: electronicAddress


ProcedureDataSet -> Status: status


ProcedureDataSet -> ActivityRecord: ActivityRecord


ProcedureDataSet -> ConfigurationEvent: ConfigurationEvents


ProcedureDataSet -> Author: Author


ProcedureDataSet -> Editor: Editor


ProcedureDataSet -> Approver: Approver


ProcedureDataSet -> Issuer: Issuer


ProcedureDataSet -> DiagramObject: DiagramObjects


ProcedureDataSet -> InstanceSet: InstanceSet


ProcedureDataSet -> Name: Names


ProcedureDataSet -> ChangeSetMember: PropertiesCIMDataObject


ProcedureDataSet -> ChangeSetMember: TargetingCIMDataObject
