...
Tariff -> TariffProfile: TariffProfiles


Tariff -> PricingStructure: PricingStructures


Tariff -> Status: docStatus


Tariff -> ElectronicAddress: electronicAddress


Tariff -> Status: status


Tariff -> ActivityRecord: ActivityRecord


Tariff -> ConfigurationEvent: ConfigurationEvents


Tariff -> Author: Author


Tariff -> Editor: Editor


Tariff -> Approver: Approver


Tariff -> Issuer: Issuer


Tariff -> DiagramObject: DiagramObjects


Tariff -> InstanceSet: InstanceSet


Tariff -> Name: Names


Tariff -> ChangeSetMember: PropertiesCIMDataObject


Tariff -> ChangeSetMember: TargetingCIMDataObject
