...
PowerTransformer -> TransformerTank: TransformerTanks


PowerTransformer -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


PowerTransformer -> SvStatus: SvStatus


PowerTransformer -> ProtectionEquipment: ProtectionEquipments
...
PowerTransformer -> JumperAction: JumpingAction


PowerTransformer -> GroundAction: GroundingAction


PowerTransformer -> Outage: Outage


PowerTransformer -> WeatherStation: WeatherStation


PowerTransformer -> OperationalLimitSet: OperationalLimitSet


PowerTransformer -> ContingencyEquipment: ContingencyEquipment


PowerTransformer -> EquipmentContainer: EquipmentContainer


PowerTransformer -> Fault: Faults


PowerTransformer -> LimitDependency: LimitDependencyModel


PowerTransformer -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


PowerTransformer -> ProtectiveActionEquipment: ProtectiveActionEquipment


PowerTransformer -> PinEquipment: PinEquipment


PowerTransformer -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


PowerTransformer -> EquipmentContainer: AdditionalEquipmentContainer


PowerTransformer -> UsagePoint: UsagePoints


PowerTransformer -> Outage: Outages


PowerTransformer -> OperationalRestriction: OperationalRestrictions


PowerTransformer -> Control: Controls


PowerTransformer -> Measurement: Measurements


PowerTransformer -> PSRType: PSRType


PowerTransformer -> ConfigurationEvent: ConfigurationEvent


PowerTransformer -> ReportingGroup: ReportingGroup


PowerTransformer -> OperatingShare: OperatingShare


PowerTransformer -> AssetInfo: AssetDatasheet


PowerTransformer -> VerificationAction: VerificationAction


PowerTransformer -> ClearanceDocument: Clearances


PowerTransformer -> GenericAction: GenericAction


PowerTransformer -> PSREvent: PSREvents
...
PowerTransformer -> OperationalTag: OperationalTags


PowerTransformer -> DiagramObject: DiagramObjects


PowerTransformer -> InstanceSet: InstanceSet


PowerTransformer -> Name: Names


PowerTransformer -> ChangeSetMember: PropertiesCIMDataObject


PowerTransformer -> ChangeSetMember: TargetingCIMDataObject
