...
MktSeriesCompensator -> BranchEndFlow: EndAFlow


MktSeriesCompensator -> BranchEndFlow: EndBFlow
...
MktSeriesCompensator -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


MktSeriesCompensator -> SvStatus: SvStatus


MktSeriesCompensator -> ProtectionEquipment: ProtectionEquipments


MktSeriesCompensator -> BaseVoltage: BaseVoltage


MktSeriesCompensator -> Terminal: Terminals


MktSeriesCompensator -> JumperAction: JumpingAction


MktSeriesCompensator -> GroundAction: GroundingAction


MktSeriesCompensator -> Outage: Outage


MktSeriesCompensator -> WeatherStation: WeatherStation


MktSeriesCompensator -> OperationalLimitSet: OperationalLimitSet


MktSeriesCompensator -> ContingencyEquipment: ContingencyEquipment


MktSeriesCompensator -> EquipmentContainer: EquipmentContainer


MktSeriesCompensator -> Fault: Faults


MktSeriesCompensator -> LimitDependency: LimitDependencyModel


MktSeriesCompensator -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


MktSeriesCompensator -> ProtectiveActionEquipment: ProtectiveActionEquipment


MktSeriesCompensator -> PinEquipment: PinEquipment


MktSeriesCompensator -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


MktSeriesCompensator -> EquipmentContainer: AdditionalEquipmentContainer


MktSeriesCompensator -> UsagePoint: UsagePoints


MktSeriesCompensator -> Outage: Outages


MktSeriesCompensator -> OperationalRestriction: OperationalRestrictions


MktSeriesCompensator -> Control: Controls


MktSeriesCompensator -> Measurement: Measurements


MktSeriesCompensator -> PSRType: PSRType


MktSeriesCompensator -> ConfigurationEvent: ConfigurationEvent


MktSeriesCompensator -> ReportingGroup: ReportingGroup


MktSeriesCompensator -> OperatingShare: OperatingShare


MktSeriesCompensator -> AssetInfo: AssetDatasheet


MktSeriesCompensator -> VerificationAction: VerificationAction


MktSeriesCompensator -> ClearanceDocument: Clearances


MktSeriesCompensator -> GenericAction: GenericAction


MktSeriesCompensator -> PSREvent: PSREvents


MktSeriesCompensator -> Asset: Assets


MktSeriesCompensator -> Location: Location


MktSeriesCompensator -> OperationalTag: OperationalTags


MktSeriesCompensator -> DiagramObject: DiagramObjects


MktSeriesCompensator -> InstanceSet: InstanceSet


MktSeriesCompensator -> Name: Names


MktSeriesCompensator -> ChangeSetMember: PropertiesCIMDataObject


MktSeriesCompensator -> ChangeSetMember: TargetingCIMDataObject
