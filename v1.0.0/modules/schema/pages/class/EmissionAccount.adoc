...
EmissionAccount -> ThermalGeneratingUnit: ThermalGeneratingUnit


EmissionAccount -> CurveData: CurveDatas


EmissionAccount -> DiagramObject: DiagramObjects


EmissionAccount -> InstanceSet: InstanceSet


EmissionAccount -> Name: Names


EmissionAccount -> ChangeSetMember: PropertiesCIMDataObject


EmissionAccount -> ChangeSetMember: TargetingCIMDataObject
