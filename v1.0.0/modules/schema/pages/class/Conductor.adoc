...
Conductor -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Conductor -> SvStatus: SvStatus


Conductor -> ProtectionEquipment: ProtectionEquipments
...
Conductor -> JumperAction: JumpingAction


Conductor -> GroundAction: GroundingAction


Conductor -> Outage: Outage


Conductor -> WeatherStation: WeatherStation


Conductor -> OperationalLimitSet: OperationalLimitSet


Conductor -> ContingencyEquipment: ContingencyEquipment


Conductor -> EquipmentContainer: EquipmentContainer


Conductor -> Fault: Faults


Conductor -> LimitDependency: LimitDependencyModel


Conductor -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Conductor -> ProtectiveActionEquipment: ProtectiveActionEquipment


Conductor -> PinEquipment: PinEquipment


Conductor -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Conductor -> EquipmentContainer: AdditionalEquipmentContainer


Conductor -> UsagePoint: UsagePoints


Conductor -> Outage: Outages


Conductor -> OperationalRestriction: OperationalRestrictions


Conductor -> Control: Controls


Conductor -> Measurement: Measurements


Conductor -> PSRType: PSRType


Conductor -> ConfigurationEvent: ConfigurationEvent


Conductor -> ReportingGroup: ReportingGroup


Conductor -> OperatingShare: OperatingShare


Conductor -> AssetInfo: AssetDatasheet


Conductor -> VerificationAction: VerificationAction


Conductor -> ClearanceDocument: Clearances


Conductor -> GenericAction: GenericAction


Conductor -> PSREvent: PSREvents
...
Conductor -> OperationalTag: OperationalTags


Conductor -> DiagramObject: DiagramObjects


Conductor -> InstanceSet: InstanceSet


Conductor -> Name: Names


Conductor -> ChangeSetMember: PropertiesCIMDataObject


Conductor -> ChangeSetMember: TargetingCIMDataObject
