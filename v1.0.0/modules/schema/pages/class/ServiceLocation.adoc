...
ServiceLocation -> TroubleTicket: TroubleTicket


ServiceLocation -> UsagePoint: UsagePoints


ServiceLocation -> EndDevice: EndDevices


ServiceLocation -> ServiceRequest: ServiceRequest


ServiceLocation -> CustomerAgreement: CustomerAgreements


ServiceLocation -> OneCallRequest: OneCallRequest


ServiceLocation -> BaseWork: BaseWorks


ServiceLocation -> DesignLocation: DesignLocations


ServiceLocation -> ElectronicAddress: electronicAddress


ServiceLocation -> StreetAddress: mainAddress


ServiceLocation -> TelephoneNumber: phone1


ServiceLocation -> TelephoneNumber: phone2


ServiceLocation -> StreetAddress: secondaryAddress


ServiceLocation -> Status: status


ServiceLocation -> ConfigurationEvent: ConfigurationEvents


ServiceLocation -> SwitchingOrder: SwitchingOrder


ServiceLocation -> Crew: Crew


ServiceLocation -> PowerSystemResource: PowerSystemResources


ServiceLocation -> CoordinateSystem: CoordinateSystem


ServiceLocation -> PositionPoint: PositionPoints
...
ServiceLocation -> TroubleOrder: TroubleOrder


ServiceLocation -> OutageOrder: OutageOrder
...
ServiceLocation -> LandProperty: LandProperties
...
ServiceLocation -> EnvironmentalLocationType: EnvironmentalLocationKind


ServiceLocation -> EnvironmentalMonitoringStation: EnvironmentalMonitoringStation


ServiceLocation -> DiagramObject: DiagramObjects


ServiceLocation -> InstanceSet: InstanceSet


ServiceLocation -> Name: Names


ServiceLocation -> ChangeSetMember: PropertiesCIMDataObject


ServiceLocation -> ChangeSetMember: TargetingCIMDataObject
