...
OldSwitchInfo -> PowerSystemResource: PowerSystemResources


OldSwitchInfo -> CatalogAssetType: CatalogAssetType


OldSwitchInfo -> Asset: Assets


OldSwitchInfo -> ProductAssetModel: ProductAssetModel


OldSwitchInfo -> DiagramObject: DiagramObjects


OldSwitchInfo -> InstanceSet: InstanceSet


OldSwitchInfo -> Name: Names


OldSwitchInfo -> ChangeSetMember: PropertiesCIMDataObject


OldSwitchInfo -> ChangeSetMember: TargetingCIMDataObject
