...
WindGenTurbineType1bIEC -> WindProtectionIEC: WindProtectionIEC


WindGenTurbineType1bIEC -> WindMechIEC: WindMechIEC


WindGenTurbineType1bIEC -> AsynchronousMachineDynamics: AsynchronousMachineDynamics


WindGenTurbineType1bIEC -> RemoteInputSignal: RemoteInputSignal


WindGenTurbineType1bIEC -> DiagramObject: DiagramObjects


WindGenTurbineType1bIEC -> InstanceSet: InstanceSet


WindGenTurbineType1bIEC -> Name: Names


WindGenTurbineType1bIEC -> ChangeSetMember: PropertiesCIMDataObject


WindGenTurbineType1bIEC -> ChangeSetMember: TargetingCIMDataObject
