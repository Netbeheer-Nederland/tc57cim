...
Jumper -> JumperAction: JumperAction



Jumper -> SwitchPhase: SwitchPhase


Jumper -> SwitchSchedule: SwitchSchedules


Jumper -> CompositeSwitch: CompositeSwitch


Jumper -> UnavailabilitySwitchAction: UnavailabilitySwitchAction


Jumper -> SvSwitch: SvSwitch


Jumper -> ConnectDisconnectFunction: ConnectDisconnectFunctions


Jumper -> SwitchAction: SwitchAction


Jumper -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


Jumper -> SvStatus: SvStatus


Jumper -> ProtectionEquipment: ProtectionEquipments


Jumper -> BaseVoltage: BaseVoltage


Jumper -> Terminal: Terminals


Jumper -> JumperAction: JumpingAction


Jumper -> GroundAction: GroundingAction


Jumper -> Outage: Outage


Jumper -> WeatherStation: WeatherStation


Jumper -> OperationalLimitSet: OperationalLimitSet


Jumper -> ContingencyEquipment: ContingencyEquipment


Jumper -> EquipmentContainer: EquipmentContainer


Jumper -> Fault: Faults


Jumper -> LimitDependency: LimitDependencyModel


Jumper -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


Jumper -> ProtectiveActionEquipment: ProtectiveActionEquipment


Jumper -> PinEquipment: PinEquipment


Jumper -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


Jumper -> EquipmentContainer: AdditionalEquipmentContainer


Jumper -> UsagePoint: UsagePoints


Jumper -> Outage: Outages


Jumper -> OperationalRestriction: OperationalRestrictions


Jumper -> Control: Controls


Jumper -> Measurement: Measurements


Jumper -> PSRType: PSRType


Jumper -> ConfigurationEvent: ConfigurationEvent


Jumper -> ReportingGroup: ReportingGroup


Jumper -> OperatingShare: OperatingShare


Jumper -> AssetInfo: AssetDatasheet


Jumper -> VerificationAction: VerificationAction


Jumper -> ClearanceDocument: Clearances


Jumper -> GenericAction: GenericAction


Jumper -> PSREvent: PSREvents


Jumper -> Asset: Assets


Jumper -> Location: Location


Jumper -> OperationalTag: OperationalTags


Jumper -> DiagramObject: DiagramObjects


Jumper -> InstanceSet: InstanceSet


Jumper -> Name: Names


Jumper -> ChangeSetMember: PropertiesCIMDataObject


Jumper -> ChangeSetMember: TargetingCIMDataObject
