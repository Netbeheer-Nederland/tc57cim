...
OldWorkTask -> ContractorItem: ContractorItems


OldWorkTask -> QualificationRequirement: QualificationRequirements


OldWorkTask -> Usage: Usages


OldWorkTask -> MiscCostItem: MiscCostItems


OldWorkTask -> OverheadCost: OverheadCost


OldWorkTask -> LaborItem: LaborItems


OldWorkTask -> Capability: Capabilities


OldWorkTask -> WorkCostDetail: WorkCostDetails


OldWorkTask -> Design: Design


OldWorkTask -> WorkFlowStep: WorkFlowStep


OldWorkTask -> DesignLocationCU: DesignLocationCUs
...
OldWorkTask -> TroubleOrder: TroubleOrder


OldWorkTask -> Asset: Assets


OldWorkTask -> MaterialItem: MaterialItems


OldWorkTask -> Crew: Crews


OldWorkTask -> Asset: OldAsset


OldWorkTask -> SwitchingPlan: SwitchingPlan


OldWorkTask -> ProcedureDataSet: ProcedureDataSet
...
OldWorkTask -> WorkTimeSchedule: TimeSchedules


OldWorkTask -> WorkLocation: WorkLocation


OldWorkTask -> WorkActivityRecord: WorkActivityRecords


OldWorkTask -> Status: docStatus


OldWorkTask -> ElectronicAddress: electronicAddress


OldWorkTask -> Status: status


OldWorkTask -> ActivityRecord: ActivityRecord


OldWorkTask -> ConfigurationEvent: ConfigurationEvents
...
OldWorkTask -> DiagramObject: DiagramObjects


OldWorkTask -> InstanceSet: InstanceSet


OldWorkTask -> Name: Names


OldWorkTask -> ChangeSetMember: PropertiesCIMDataObject


OldWorkTask -> ChangeSetMember: TargetingCIMDataObject
