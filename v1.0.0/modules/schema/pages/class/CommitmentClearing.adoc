...
CommitmentClearing -> Commitments: Commitments


CommitmentClearing -> MktActivityRecord: MktActivityRecord


CommitmentClearing -> Market: Market


CommitmentClearing -> Status: docStatus


CommitmentClearing -> ElectronicAddress: electronicAddress


CommitmentClearing -> Status: status


CommitmentClearing -> ActivityRecord: ActivityRecord


CommitmentClearing -> ConfigurationEvent: ConfigurationEvents


CommitmentClearing -> Author: Author


CommitmentClearing -> Editor: Editor


CommitmentClearing -> Approver: Approver


CommitmentClearing -> Issuer: Issuer


CommitmentClearing -> DiagramObject: DiagramObjects


CommitmentClearing -> InstanceSet: InstanceSet


CommitmentClearing -> Name: Names


CommitmentClearing -> ChangeSetMember: PropertiesCIMDataObject


CommitmentClearing -> ChangeSetMember: TargetingCIMDataObject
