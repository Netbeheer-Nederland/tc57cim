...
AssetGroup -> AnalyticScore: AnalyticScore


AssetGroup -> Asset: Asset


AssetGroup -> Analytic: Analytic


AssetGroup -> Status: docStatus


AssetGroup -> ElectronicAddress: electronicAddress


AssetGroup -> Status: status


AssetGroup -> ActivityRecord: ActivityRecord


AssetGroup -> ConfigurationEvent: ConfigurationEvents


AssetGroup -> Author: Author


AssetGroup -> Editor: Editor


AssetGroup -> Approver: Approver


AssetGroup -> Issuer: Issuer


AssetGroup -> DiagramObject: DiagramObjects


AssetGroup -> InstanceSet: InstanceSet


AssetGroup -> Name: Names


AssetGroup -> ChangeSetMember: PropertiesCIMDataObject


AssetGroup -> ChangeSetMember: TargetingCIMDataObject
