...
InspectionAnalog -> TestStandard: TestStandard


InspectionAnalog -> AnalogValue: AnalogValues


InspectionAnalog -> AnalogLimitSet: LimitSets


InspectionAnalog -> ACDCTerminal: Terminal


InspectionAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


InspectionAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


InspectionAnalog -> PowerSystemResource: PowerSystemResource


InspectionAnalog -> PinMeasurement: PinMeasurement


InspectionAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


InspectionAnalog -> Asset: Asset


InspectionAnalog -> MeasurementAction: MeasurementAction


InspectionAnalog -> Location: Locations


InspectionAnalog -> Procedure: Procedures


InspectionAnalog -> DiagramObject: DiagramObjects


InspectionAnalog -> InstanceSet: InstanceSet


InspectionAnalog -> Name: Names


InspectionAnalog -> ChangeSetMember: PropertiesCIMDataObject


InspectionAnalog -> ChangeSetMember: TargetingCIMDataObject
