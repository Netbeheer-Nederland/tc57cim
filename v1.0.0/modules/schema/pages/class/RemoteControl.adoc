...
RemoteControl -> RemoteUnit: RemoteUnit


RemoteControl -> DiagramObject: DiagramObjects


RemoteControl -> InstanceSet: InstanceSet


RemoteControl -> Name: Names


RemoteControl -> ChangeSetMember: PropertiesCIMDataObject


RemoteControl -> ChangeSetMember: TargetingCIMDataObject
