...
ErpPOLineItem -> ErpPurchaseOrder: ErpPurchaseOrder


ErpPOLineItem -> ErpRecDelvLineItem: ErpRecDelLineItem


ErpPOLineItem -> ErpReqLineItem: ErpReqLineItem


ErpPOLineItem -> AssetModelCatalogueItem: AssetModelCatalogueItem


ErpPOLineItem -> Status: docStatus


ErpPOLineItem -> ElectronicAddress: electronicAddress


ErpPOLineItem -> Status: status


ErpPOLineItem -> ActivityRecord: ActivityRecord


ErpPOLineItem -> ConfigurationEvent: ConfigurationEvents


ErpPOLineItem -> Author: Author


ErpPOLineItem -> Editor: Editor


ErpPOLineItem -> Approver: Approver


ErpPOLineItem -> Issuer: Issuer


ErpPOLineItem -> DiagramObject: DiagramObjects


ErpPOLineItem -> InstanceSet: InstanceSet


ErpPOLineItem -> Name: Names


ErpPOLineItem -> ChangeSetMember: PropertiesCIMDataObject


ErpPOLineItem -> ChangeSetMember: TargetingCIMDataObject
