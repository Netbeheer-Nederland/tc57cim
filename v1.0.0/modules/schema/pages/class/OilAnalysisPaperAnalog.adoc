...
OilAnalysisPaperAnalog -> TestStandard: TestStandard


OilAnalysisPaperAnalog -> AnalogValue: AnalogValues


OilAnalysisPaperAnalog -> AnalogLimitSet: LimitSets


OilAnalysisPaperAnalog -> ACDCTerminal: Terminal


OilAnalysisPaperAnalog -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


OilAnalysisPaperAnalog -> CalculationMethodHierarchy: CalculationMethodHierarchy


OilAnalysisPaperAnalog -> PowerSystemResource: PowerSystemResource


OilAnalysisPaperAnalog -> PinMeasurement: PinMeasurement


OilAnalysisPaperAnalog -> MeasurementCalculatorInput: MeasurementCalculatorInput


OilAnalysisPaperAnalog -> Asset: Asset


OilAnalysisPaperAnalog -> MeasurementAction: MeasurementAction


OilAnalysisPaperAnalog -> Location: Locations


OilAnalysisPaperAnalog -> Procedure: Procedures


OilAnalysisPaperAnalog -> DiagramObject: DiagramObjects


OilAnalysisPaperAnalog -> InstanceSet: InstanceSet


OilAnalysisPaperAnalog -> Name: Names


OilAnalysisPaperAnalog -> ChangeSetMember: PropertiesCIMDataObject


OilAnalysisPaperAnalog -> ChangeSetMember: TargetingCIMDataObject
