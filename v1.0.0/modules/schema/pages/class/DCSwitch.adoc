...
DCSwitch -> DCTerminal: DCTerminals


DCSwitch -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


DCSwitch -> WeatherStation: WeatherStation


DCSwitch -> OperationalLimitSet: OperationalLimitSet


DCSwitch -> ContingencyEquipment: ContingencyEquipment


DCSwitch -> EquipmentContainer: EquipmentContainer


DCSwitch -> Fault: Faults


DCSwitch -> LimitDependency: LimitDependencyModel


DCSwitch -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


DCSwitch -> ProtectiveActionEquipment: ProtectiveActionEquipment


DCSwitch -> PinEquipment: PinEquipment


DCSwitch -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


DCSwitch -> EquipmentContainer: AdditionalEquipmentContainer


DCSwitch -> UsagePoint: UsagePoints


DCSwitch -> Outage: Outages


DCSwitch -> OperationalRestriction: OperationalRestrictions


DCSwitch -> Control: Controls


DCSwitch -> Measurement: Measurements


DCSwitch -> PSRType: PSRType


DCSwitch -> ConfigurationEvent: ConfigurationEvent


DCSwitch -> ReportingGroup: ReportingGroup


DCSwitch -> OperatingShare: OperatingShare


DCSwitch -> AssetInfo: AssetDatasheet


DCSwitch -> VerificationAction: VerificationAction


DCSwitch -> ClearanceDocument: Clearances


DCSwitch -> GenericAction: GenericAction


DCSwitch -> PSREvent: PSREvents


DCSwitch -> Asset: Assets


DCSwitch -> Location: Location


DCSwitch -> OperationalTag: OperationalTags


DCSwitch -> DiagramObject: DiagramObjects


DCSwitch -> InstanceSet: InstanceSet


DCSwitch -> Name: Names


DCSwitch -> ChangeSetMember: PropertiesCIMDataObject


DCSwitch -> ChangeSetMember: TargetingCIMDataObject
