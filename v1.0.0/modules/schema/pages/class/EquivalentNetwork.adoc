...
EquivalentNetwork -> TopologicalNode: TopologicalNode


EquivalentNetwork -> ConnectivityNode: ConnectivityNodes


EquivalentNetwork -> Control: Controls


EquivalentNetwork -> Measurement: Measurements


EquivalentNetwork -> PSRType: PSRType


EquivalentNetwork -> ConfigurationEvent: ConfigurationEvent


EquivalentNetwork -> ReportingGroup: ReportingGroup


EquivalentNetwork -> OperatingShare: OperatingShare


EquivalentNetwork -> AssetInfo: AssetDatasheet


EquivalentNetwork -> VerificationAction: VerificationAction


EquivalentNetwork -> ClearanceDocument: Clearances


EquivalentNetwork -> GenericAction: GenericAction


EquivalentNetwork -> PSREvent: PSREvents


EquivalentNetwork -> Asset: Assets


EquivalentNetwork -> Location: Location


EquivalentNetwork -> OperationalTag: OperationalTags


EquivalentNetwork -> DiagramObject: DiagramObjects


EquivalentNetwork -> InstanceSet: InstanceSet


EquivalentNetwork -> Name: Names


EquivalentNetwork -> ChangeSetMember: PropertiesCIMDataObject


EquivalentNetwork -> ChangeSetMember: TargetingCIMDataObject
