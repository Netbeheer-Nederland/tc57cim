...
EmissionCurve -> ThermalGeneratingUnit: ThermalGeneratingUnit


EmissionCurve -> CurveData: CurveDatas


EmissionCurve -> DiagramObject: DiagramObjects


EmissionCurve -> InstanceSet: InstanceSet


EmissionCurve -> Name: Names


EmissionCurve -> ChangeSetMember: PropertiesCIMDataObject


EmissionCurve -> ChangeSetMember: TargetingCIMDataObject
