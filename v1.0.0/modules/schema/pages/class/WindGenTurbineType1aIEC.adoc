...
WindGenTurbineType1aIEC -> WindProtectionIEC: WindProtectionIEC


WindGenTurbineType1aIEC -> WindMechIEC: WindMechIEC


WindGenTurbineType1aIEC -> AsynchronousMachineDynamics: AsynchronousMachineDynamics


WindGenTurbineType1aIEC -> RemoteInputSignal: RemoteInputSignal


WindGenTurbineType1aIEC -> DiagramObject: DiagramObjects


WindGenTurbineType1aIEC -> InstanceSet: InstanceSet


WindGenTurbineType1aIEC -> Name: Names


WindGenTurbineType1aIEC -> ChangeSetMember: PropertiesCIMDataObject


WindGenTurbineType1aIEC -> ChangeSetMember: TargetingCIMDataObject
