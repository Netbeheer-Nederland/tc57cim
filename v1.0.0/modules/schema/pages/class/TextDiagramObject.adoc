...
TextDiagramObject -> VisibilityLayer: VisibilityLayers


TextDiagramObject -> DiagramObjectPoint: DiagramObjectPoints


TextDiagramObject -> DiagramObjectStyle: DiagramObjectStyle


TextDiagramObject -> IdentifiedObject: IdentifiedObject


TextDiagramObject -> DiagramObject: DiagramObjects


TextDiagramObject -> InstanceSet: InstanceSet


TextDiagramObject -> Name: Names


TextDiagramObject -> ChangeSetMember: PropertiesCIMDataObject


TextDiagramObject -> ChangeSetMember: TargetingCIMDataObject
