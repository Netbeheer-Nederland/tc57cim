...
TailbayLossCurve -> HydroGeneratingUnit: HydroGeneratingUnit


TailbayLossCurve -> CurveData: CurveDatas


TailbayLossCurve -> DiagramObject: DiagramObjects


TailbayLossCurve -> InstanceSet: InstanceSet


TailbayLossCurve -> Name: Names


TailbayLossCurve -> ChangeSetMember: PropertiesCIMDataObject


TailbayLossCurve -> ChangeSetMember: TargetingCIMDataObject
