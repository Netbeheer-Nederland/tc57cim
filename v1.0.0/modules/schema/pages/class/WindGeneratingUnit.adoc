...
WindGeneratingUnit -> RotatingMachine: RotatingMachine


WindGeneratingUnit -> GenUnitOpSchedule: GenUnitOpSchedule


WindGeneratingUnit -> ControlAreaGeneratingUnit: ControlAreaGeneratingUnit


WindGeneratingUnit -> GrossToNetActivePowerCurve: GrossToNetActivePowerCurves


WindGeneratingUnit -> GenUnitOpCostCurve: GenUnitOpCostCurves


WindGeneratingUnit -> WeatherStation: WeatherStation


WindGeneratingUnit -> OperationalLimitSet: OperationalLimitSet


WindGeneratingUnit -> ContingencyEquipment: ContingencyEquipment


WindGeneratingUnit -> EquipmentContainer: EquipmentContainer


WindGeneratingUnit -> Fault: Faults


WindGeneratingUnit -> LimitDependency: LimitDependencyModel


WindGeneratingUnit -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


WindGeneratingUnit -> ProtectiveActionEquipment: ProtectiveActionEquipment


WindGeneratingUnit -> PinEquipment: PinEquipment


WindGeneratingUnit -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


WindGeneratingUnit -> EquipmentContainer: AdditionalEquipmentContainer


WindGeneratingUnit -> UsagePoint: UsagePoints


WindGeneratingUnit -> Outage: Outages


WindGeneratingUnit -> OperationalRestriction: OperationalRestrictions


WindGeneratingUnit -> Control: Controls


WindGeneratingUnit -> Measurement: Measurements


WindGeneratingUnit -> PSRType: PSRType


WindGeneratingUnit -> ConfigurationEvent: ConfigurationEvent


WindGeneratingUnit -> ReportingGroup: ReportingGroup


WindGeneratingUnit -> OperatingShare: OperatingShare


WindGeneratingUnit -> AssetInfo: AssetDatasheet


WindGeneratingUnit -> VerificationAction: VerificationAction


WindGeneratingUnit -> ClearanceDocument: Clearances


WindGeneratingUnit -> GenericAction: GenericAction


WindGeneratingUnit -> PSREvent: PSREvents


WindGeneratingUnit -> Asset: Assets


WindGeneratingUnit -> Location: Location


WindGeneratingUnit -> OperationalTag: OperationalTags


WindGeneratingUnit -> DiagramObject: DiagramObjects


WindGeneratingUnit -> InstanceSet: InstanceSet


WindGeneratingUnit -> Name: Names


WindGeneratingUnit -> ChangeSetMember: PropertiesCIMDataObject


WindGeneratingUnit -> ChangeSetMember: TargetingCIMDataObject
