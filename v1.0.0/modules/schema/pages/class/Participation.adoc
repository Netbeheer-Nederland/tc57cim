...
Participation -> DiagramObject: DiagramObjects


Participation -> InstanceSet: InstanceSet


Participation -> Name: Names


Participation -> ChangeSetMember: PropertiesCIMDataObject


Participation -> ChangeSetMember: TargetingCIMDataObject
