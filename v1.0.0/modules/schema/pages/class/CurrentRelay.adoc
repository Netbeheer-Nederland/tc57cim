...
CurrentRelay -> ProtectedSwitch: ProtectedSwitches


CurrentRelay -> ConductingEquipment: ConductingEquipments


CurrentRelay -> ProtectiveAction: ProtectiveAction


CurrentRelay -> WeatherStation: WeatherStation


CurrentRelay -> OperationalLimitSet: OperationalLimitSet


CurrentRelay -> ContingencyEquipment: ContingencyEquipment


CurrentRelay -> EquipmentContainer: EquipmentContainer


CurrentRelay -> Fault: Faults


CurrentRelay -> LimitDependency: LimitDependencyModel


CurrentRelay -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


CurrentRelay -> ProtectiveActionEquipment: ProtectiveActionEquipment


CurrentRelay -> PinEquipment: PinEquipment


CurrentRelay -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


CurrentRelay -> EquipmentContainer: AdditionalEquipmentContainer


CurrentRelay -> UsagePoint: UsagePoints


CurrentRelay -> Outage: Outages


CurrentRelay -> OperationalRestriction: OperationalRestrictions
...
CurrentRelay -> ConfigurationEvent: ConfigurationEvent


CurrentRelay -> ReportingGroup: ReportingGroup


CurrentRelay -> OperatingShare: OperatingShare


CurrentRelay -> AssetInfo: AssetDatasheet


CurrentRelay -> VerificationAction: VerificationAction


CurrentRelay -> ClearanceDocument: Clearances


CurrentRelay -> GenericAction: GenericAction
...
CurrentRelay -> OperationalTag: OperationalTags


CurrentRelay -> DiagramObject: DiagramObjects


CurrentRelay -> InstanceSet: InstanceSet


CurrentRelay -> Name: Names


CurrentRelay -> ChangeSetMember: PropertiesCIMDataObject


CurrentRelay -> ChangeSetMember: TargetingCIMDataObject
