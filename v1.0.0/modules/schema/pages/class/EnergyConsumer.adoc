...
EnergyConsumer -> EnergyConsumerPhase: EnergyConsumerPhase


EnergyConsumer -> EnergyConsumerAction: EnergyConsumerAction


EnergyConsumer -> PowerCutZone: PowerCutZone


EnergyConsumer -> LoadDynamics: LoadDynamics


EnergyConsumer -> EnergyComponent: EnergyComponent


EnergyConsumer -> ProtectiveActionAdjustment: ProtectiveActionAdjustment


EnergyConsumer -> SvStatus: SvStatus


EnergyConsumer -> ProtectionEquipment: ProtectionEquipments
...
EnergyConsumer -> JumperAction: JumpingAction


EnergyConsumer -> GroundAction: GroundingAction


EnergyConsumer -> Outage: Outage


EnergyConsumer -> WeatherStation: WeatherStation


EnergyConsumer -> OperationalLimitSet: OperationalLimitSet


EnergyConsumer -> ContingencyEquipment: ContingencyEquipment


EnergyConsumer -> EquipmentContainer: EquipmentContainer


EnergyConsumer -> Fault: Faults


EnergyConsumer -> LimitDependency: LimitDependencyModel


EnergyConsumer -> EquipmentLimitSeriesComponent: EqiupmentLimitSeriesComponent


EnergyConsumer -> ProtectiveActionEquipment: ProtectiveActionEquipment


EnergyConsumer -> PinEquipment: PinEquipment


EnergyConsumer -> EquipmentUnavailabilitySchedule: EquipmentUnavailabilitySchedule


EnergyConsumer -> EquipmentContainer: AdditionalEquipmentContainer


EnergyConsumer -> UsagePoint: UsagePoints


EnergyConsumer -> Outage: Outages


EnergyConsumer -> OperationalRestriction: OperationalRestrictions


EnergyConsumer -> Control: Controls


EnergyConsumer -> Measurement: Measurements


EnergyConsumer -> PSRType: PSRType


EnergyConsumer -> ConfigurationEvent: ConfigurationEvent


EnergyConsumer -> ReportingGroup: ReportingGroup


EnergyConsumer -> OperatingShare: OperatingShare


EnergyConsumer -> AssetInfo: AssetDatasheet


EnergyConsumer -> VerificationAction: VerificationAction


EnergyConsumer -> ClearanceDocument: Clearances


EnergyConsumer -> GenericAction: GenericAction


EnergyConsumer -> PSREvent: PSREvents
...
EnergyConsumer -> OperationalTag: OperationalTags


EnergyConsumer -> DiagramObject: DiagramObjects


EnergyConsumer -> InstanceSet: InstanceSet


EnergyConsumer -> Name: Names


EnergyConsumer -> ChangeSetMember: PropertiesCIMDataObject


EnergyConsumer -> ChangeSetMember: TargetingCIMDataObject
